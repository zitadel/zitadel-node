 ...
 */
export class BetaActionServiceFunctionExecution {
  /**
  ...
  constructor(data?: Partial<BetaActionServiceFunctionExecution>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaActionServiceFunctionExecution)) {
      return false;
    }
    if (
      !BetaActionServiceFunctionExecution.__deepEquals(
        this.name,
        (other as BetaActionServiceFunctionExecution).name,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaActionServiceFunctionExecution.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaActionServiceFunctionExecution.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaActionServiceFunctionExecution.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaActionServiceFunctionExecution.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
