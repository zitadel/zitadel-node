...
export class BetaActionServiceListExecutionServicesResponse {
  /**
  ...
  constructor(data?: Partial<BetaActionServiceListExecutionServicesResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaActionServiceListExecutionServicesResponse)) {
      return false;
    }
    if (
      !BetaActionServiceListExecutionServicesResponse.__deepEquals(
        this.services,
        (other as BetaActionServiceListExecutionServicesResponse).services,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaActionServiceListExecutionServicesResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaActionServiceListExecutionServicesResponse.__deepEquals(v, w),
        ),
      );
    }
