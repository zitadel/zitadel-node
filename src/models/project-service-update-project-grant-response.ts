...
export class ProjectServiceUpdateProjectGrantResponse {
  /**
  ...
  constructor(data?: Partial<ProjectServiceUpdateProjectGrantResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ProjectServiceUpdateProjectGrantResponse)) {
      return false;
    }
    if (
      !ProjectServiceUpdateProjectGrantResponse.__deepEquals(
        this.changeDate,
        (other as ProjectServiceUpdateProjectGrantResponse).changeDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ProjectServiceUpdateProjectGrantResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          ProjectServiceUpdateProjectGrantResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !ProjectServiceUpdateProjectGrantResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ProjectServiceUpdateProjectGrantResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
