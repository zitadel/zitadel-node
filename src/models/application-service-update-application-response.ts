...
export class ApplicationServiceUpdateApplicationResponse {
  /**
  ...
  constructor(data?: Partial<ApplicationServiceUpdateApplicationResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ApplicationServiceUpdateApplicationResponse)) {
      return false;
    }
    if (
      !ApplicationServiceUpdateApplicationResponse.__deepEquals(
        this.changeDate,
        (other as ApplicationServiceUpdateApplicationResponse).changeDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ApplicationServiceUpdateApplicationResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          ApplicationServiceUpdateApplicationResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !ApplicationServiceUpdateApplicationResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
