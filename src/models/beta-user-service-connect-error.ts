...
import { BetaUserServiceAny } from "./beta-user-service-any.js";
import { Expose, Type } from "class-transformer";

/**
 * Error type returned by Connect: https://connectrpc.com/docs/go/errors/#http-representation
 */
export class BetaUserServiceConnectError {
  /**
  ...
  constructor(data?: Partial<BetaUserServiceConnectError>) {
    ...
    if (this.code != null) {
      const codeValues = Object.values(
        BetaUserServiceConnectErrorCodeEnum,
      ).filter(
        (v) =>
          typeof (
            BetaUserServiceConnectErrorCodeEnum as Record<string, unknown>
          )[v as string] !== "number",
      );
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaUserServiceConnectError)) {
      return false;
    }
    if (
      !BetaUserServiceConnectError.__deepEquals(
        this.code,
        (other as BetaUserServiceConnectError).code,
      )
    ) {
      return false;
    }
    if (
      !BetaUserServiceConnectError.__deepEquals(
        this.message,
        (other as BetaUserServiceConnectError).message,
      )
    ) {
      return false;
    }
    if (
      !BetaUserServiceConnectError.__deepEquals(
        this.details,
        (other as BetaUserServiceConnectError).details,
      )
    ) {
      return false;
    }
    {
      ...
      for (const k of selfKeys) {
        ...
        if (
          !BetaUserServiceConnectError.__deepEquals(selfRec[k], otherRec[k])
        ) {
          return false;
        }
      }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaUserServiceConnectError.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaUserServiceConnectError.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaUserServiceConnectError.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaUserServiceConnectError.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
...
export enum BetaUserServiceConnectErrorCodeEnum {
  Canceled = "canceled",
  Unknown = "unknown",
