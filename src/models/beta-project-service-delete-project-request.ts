...
export class BetaProjectServiceDeleteProjectRequest {
  /**
  ...
  constructor(data?: Partial<BetaProjectServiceDeleteProjectRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaProjectServiceDeleteProjectRequest)) {
      return false;
    }
    if (
      !BetaProjectServiceDeleteProjectRequest.__deepEquals(
        this.id,
        (other as BetaProjectServiceDeleteProjectRequest).id,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaProjectServiceDeleteProjectRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaProjectServiceDeleteProjectRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaProjectServiceDeleteProjectRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaProjectServiceDeleteProjectRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
