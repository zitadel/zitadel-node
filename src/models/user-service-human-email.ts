...
export class UserServiceHumanEmail {
  /**
  ...
  constructor(data?: Partial<UserServiceHumanEmail>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceHumanEmail)) {
      return false;
    }
    if (
      !UserServiceHumanEmail.__deepEquals(
        this.email,
        (other as UserServiceHumanEmail).email,
      )
    ) {
      return false;
    }
    if (
      !UserServiceHumanEmail.__deepEquals(
        this.isVerified,
        (other as UserServiceHumanEmail).isVerified,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => UserServiceHumanEmail.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceHumanEmail.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !UserServiceHumanEmail.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceHumanEmail.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
