...
export class BetaProjectServiceUpdateProjectRoleResponse {
  /**
  ...
  constructor(data?: Partial<BetaProjectServiceUpdateProjectRoleResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaProjectServiceUpdateProjectRoleResponse)) {
      return false;
    }
    if (
      !BetaProjectServiceUpdateProjectRoleResponse.__deepEquals(
        this.changeDate,
        (other as BetaProjectServiceUpdateProjectRoleResponse).changeDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaProjectServiceUpdateProjectRoleResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaProjectServiceUpdateProjectRoleResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaProjectServiceUpdateProjectRoleResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
