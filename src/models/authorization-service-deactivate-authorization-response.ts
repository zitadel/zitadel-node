...
export class AuthorizationServiceDeactivateAuthorizationResponse {
  /**
  ...
  constructor(
    data?: Partial<AuthorizationServiceDeactivateAuthorizationResponse>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !(other instanceof AuthorizationServiceDeactivateAuthorizationResponse)
    ) {
      return false;
    }
    if (
      !AuthorizationServiceDeactivateAuthorizationResponse.__deepEquals(
        this.changeDate,
        (other as AuthorizationServiceDeactivateAuthorizationResponse)
          .changeDate,
      )
    ) {
      return false;
