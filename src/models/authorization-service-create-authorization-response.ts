...
export class AuthorizationServiceCreateAuthorizationResponse {
  /**
  ...
  constructor(data?: Partial<AuthorizationServiceCreateAuthorizationResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof AuthorizationServiceCreateAuthorizationResponse)) {
      return false;
    }
    if (
      !AuthorizationServiceCreateAuthorizationResponse.__deepEquals(
        this.id,
        (other as AuthorizationServiceCreateAuthorizationResponse).id,
      )
    ) {
      return false;
    }
    if (
      !AuthorizationServiceCreateAuthorizationResponse.__deepEquals(
        this.creationDate,
        (other as AuthorizationServiceCreateAuthorizationResponse).creationDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        AuthorizationServiceCreateAuthorizationResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          AuthorizationServiceCreateAuthorizationResponse.__deepEquals(v, w),
        ),
      );
    }
