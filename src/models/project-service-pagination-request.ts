...
export class ProjectServicePaginationRequest {
  /**
  ...
  constructor(data?: Partial<ProjectServicePaginationRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ProjectServicePaginationRequest)) {
      return false;
    }
    if (
      !ProjectServicePaginationRequest.__deepEquals(
        this.offset,
        (other as ProjectServicePaginationRequest).offset,
      )
    ) {
      return false;
    }
    if (
      !ProjectServicePaginationRequest.__deepEquals(
        this.limit,
        (other as ProjectServicePaginationRequest).limit,
      )
    ) {
      return false;
    }
    if (
      !ProjectServicePaginationRequest.__deepEquals(
        this.asc,
        (other as ProjectServicePaginationRequest).asc,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ProjectServicePaginationRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => ProjectServicePaginationRequest.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !ProjectServicePaginationRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ProjectServicePaginationRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
