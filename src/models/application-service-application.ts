...
import { ApplicationServiceAPIConfiguration } from "./application-service-api-configuration.js";
import { ApplicationServiceApplicationState } from "./application-service-application-state.js";
import { ApplicationServiceOIDCConfiguration } from "./application-service-oidc-configuration.js";
import { ApplicationServiceSAMLConfiguration } from "./application-service-saml-configuration.js";
import { Expose, Type } from "class-transformer";

export class ApplicationServiceApplication {
  /**
  ...
  constructor(data?: Partial<ApplicationServiceApplication>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ApplicationServiceApplication)) {
      return false;
    }
    if (
      !ApplicationServiceApplication.__deepEquals(
        this.applicationId,
        (other as ApplicationServiceApplication).applicationId,
      )
    ) {
      return false;
    }
    if (
      !ApplicationServiceApplication.__deepEquals(
        this.creationDate,
        (other as ApplicationServiceApplication).creationDate,
      )
    ) {
      return false;
    }
    if (
      !ApplicationServiceApplication.__deepEquals(
        this.changeDate,
        (other as ApplicationServiceApplication).changeDate,
      )
    ) {
      return false;
    }
    if (
      !ApplicationServiceApplication.__deepEquals(
        this.state,
        (other as ApplicationServiceApplication).state,
      )
    ) {
      return false;
    }
    if (
      !ApplicationServiceApplication.__deepEquals(
        this.name,
        (other as ApplicationServiceApplication).name,
      )
    ) {
      return false;
    }
    if (
      !ApplicationServiceApplication.__deepEquals(
        this.projectId,
        (other as ApplicationServiceApplication).projectId,
      )
    ) {
      return false;
    }
    if (
      !ApplicationServiceApplication.__deepEquals(
        ...
        (other as ApplicationServiceApplication).apiConfiguration,
      )
    ) {
      return false;
    }
    if (
      !ApplicationServiceApplication.__deepEquals(
        ...
        (other as ApplicationServiceApplication).oidcConfiguration,
      )
    ) {
      return false;
    }
    if (
      !ApplicationServiceApplication.__deepEquals(
        ...
        (other as ApplicationServiceApplication).samlConfiguration,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ApplicationServiceApplication.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => ApplicationServiceApplication.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !ApplicationServiceApplication.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ApplicationServiceApplication.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
