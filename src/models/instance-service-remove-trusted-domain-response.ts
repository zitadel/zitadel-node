...
export class InstanceServiceRemoveTrustedDomainResponse {
  /**
  ...
  constructor(data?: Partial<InstanceServiceRemoveTrustedDomainResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof InstanceServiceRemoveTrustedDomainResponse)) {
      return false;
    }
    if (
      !InstanceServiceRemoveTrustedDomainResponse.__deepEquals(
        this.deletionDate,
        (other as InstanceServiceRemoveTrustedDomainResponse).deletionDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        InstanceServiceRemoveTrustedDomainResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          InstanceServiceRemoveTrustedDomainResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !InstanceServiceRemoveTrustedDomainResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          InstanceServiceRemoveTrustedDomainResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
