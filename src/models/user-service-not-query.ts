 ...
 */
export class UserServiceNotQuery {
  /**
  ...
  constructor(data?: Partial<UserServiceNotQuery>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceNotQuery)) {
      return false;
    }
    if (
      !UserServiceNotQuery.__deepEquals(
        this.query,
        (other as UserServiceNotQuery).query,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => UserServiceNotQuery.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceNotQuery.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !UserServiceNotQuery.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceNotQuery.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
