...
export class BetaInternalPermissionServiceProjectGrant {
  /**
  ...
  constructor(data?: Partial<BetaInternalPermissionServiceProjectGrant>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaInternalPermissionServiceProjectGrant)) {
      return false;
    }
    if (
      !BetaInternalPermissionServiceProjectGrant.__deepEquals(
        this.projectId,
        (other as BetaInternalPermissionServiceProjectGrant).projectId,
      )
    ) {
      return false;
    }
    if (
      !BetaInternalPermissionServiceProjectGrant.__deepEquals(
        this.organizationId,
        (other as BetaInternalPermissionServiceProjectGrant).organizationId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaInternalPermissionServiceProjectGrant.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaInternalPermissionServiceProjectGrant.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaInternalPermissionServiceProjectGrant.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaInternalPermissionServiceProjectGrant.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
