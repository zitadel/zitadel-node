...
export class BetaOrganizationServiceGenerateOrganizationDomainValidationResponse {
  /**
  ...
  constructor(
    data?: Partial<BetaOrganizationServiceGenerateOrganizationDomainValidationResponse>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !BetaOrganizationServiceGenerateOrganizationDomainValidationResponse.__deepEquals(
        this.token,
        (
          other as BetaOrganizationServiceGenerateOrganizationDomainValidationResponse
        ).token,
      )
    ) {
      return false;
