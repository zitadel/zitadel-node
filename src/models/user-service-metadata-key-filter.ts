...
import { UserServiceTextFilterMethod } from "./user-service-text-filter-method.js";
import { Expose, Type } from "class-transformer";

export class UserServiceMetadataKeyFilter {
  /**
  ...
  constructor(data?: Partial<UserServiceMetadataKeyFilter>) {
    Object.assign(this, data);
    if (this.key != null && typeof this.key !== "string") {
      throw new TypeError(`key must be a string, got ${typeof this.key}`);
    }
    if (this.method != null) {
      const methodValues = Object.values(UserServiceTextFilterMethod).filter(
        (v) =>
          typeof (UserServiceTextFilterMethod as Record<string, unknown>)[
            v as string
          ] !== "number",
      );
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceMetadataKeyFilter)) {
      return false;
    }
    if (
      !UserServiceMetadataKeyFilter.__deepEquals(
        this.key,
        (other as UserServiceMetadataKeyFilter).key,
      )
    ) {
      return false;
    }
    if (
      !UserServiceMetadataKeyFilter.__deepEquals(
        this.method,
        (other as UserServiceMetadataKeyFilter).method,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceMetadataKeyFilter.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceMetadataKeyFilter.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceMetadataKeyFilter.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceMetadataKeyFilter.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
