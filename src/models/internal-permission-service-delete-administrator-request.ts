...
export class InternalPermissionServiceDeleteAdministratorRequest {
  /**
  ...
  constructor(
    data?: Partial<InternalPermissionServiceDeleteAdministratorRequest>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !(other instanceof InternalPermissionServiceDeleteAdministratorRequest)
    ) {
      return false;
    }
    if (
      !InternalPermissionServiceDeleteAdministratorRequest.__deepEquals(
        this.userId,
        (other as InternalPermissionServiceDeleteAdministratorRequest).userId,
      )
    ) {
      return false;
    }
    if (
      !InternalPermissionServiceDeleteAdministratorRequest.__deepEquals(
        this.resource,
        (other as InternalPermissionServiceDeleteAdministratorRequest).resource,
      )
    ) {
      return false;
    }
