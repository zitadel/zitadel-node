...
export class InstanceServiceDeleteInstanceRequest {
  /**
  ...
  constructor(data?: Partial<InstanceServiceDeleteInstanceRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof InstanceServiceDeleteInstanceRequest)) {
      return false;
    }
    if (
      !InstanceServiceDeleteInstanceRequest.__deepEquals(
        this.instanceId,
        (other as InstanceServiceDeleteInstanceRequest).instanceId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        InstanceServiceDeleteInstanceRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          InstanceServiceDeleteInstanceRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !InstanceServiceDeleteInstanceRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          InstanceServiceDeleteInstanceRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
