 ...
 */
export class BetaUserServiceInUserIDQuery {
  /**
  ...
  constructor(data?: Partial<BetaUserServiceInUserIDQuery>) {
    Object.assign(this, data);
    if (
      this.userIds != null &&
      !Array.isArray(this.userIds) &&
      !((this.userIds as unknown) instanceof Set)
    ) {
      throw new TypeError(
        `userIds must be an array, got ${typeof this.userIds}`,
      );
    }
  }
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaUserServiceInUserIDQuery)) {
      return false;
    }
    if (
      !BetaUserServiceInUserIDQuery.__deepEquals(
        this.userIds,
        (other as BetaUserServiceInUserIDQuery).userIds,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaUserServiceInUserIDQuery.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaUserServiceInUserIDQuery.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaUserServiceInUserIDQuery.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaUserServiceInUserIDQuery.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
