...
export class BetaProjectServiceRemoveProjectRoleRequest {
  /**
  ...
  constructor(data?: Partial<BetaProjectServiceRemoveProjectRoleRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaProjectServiceRemoveProjectRoleRequest)) {
      return false;
    }
    if (
      !BetaProjectServiceRemoveProjectRoleRequest.__deepEquals(
        this.projectId,
        (other as BetaProjectServiceRemoveProjectRoleRequest).projectId,
      )
    ) {
      return false;
    }
    if (
      !BetaProjectServiceRemoveProjectRoleRequest.__deepEquals(
        this.roleKey,
        (other as BetaProjectServiceRemoveProjectRoleRequest).roleKey,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaProjectServiceRemoveProjectRoleRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaProjectServiceRemoveProjectRoleRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaProjectServiceRemoveProjectRoleRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaProjectServiceRemoveProjectRoleRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
