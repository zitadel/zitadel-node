...
import { SessionServiceTimestampQueryMethod } from "./session-service-timestamp-query-method.js";
import { Expose, Type } from "class-transformer";

export class SessionServiceCreationDateQuery {
  /**
  ...
  constructor(data?: Partial<SessionServiceCreationDateQuery>) {
    ...
    if (this.method != null) {
      const methodValues = Object.values(
        ...
        (v) =>
          typeof (
            SessionServiceTimestampQueryMethod as Record<string, unknown>
          )[v as string] !== "number",
      );
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof SessionServiceCreationDateQuery)) {
      return false;
    }
    if (
      !SessionServiceCreationDateQuery.__deepEquals(
        this.creationDate,
        (other as SessionServiceCreationDateQuery).creationDate,
      )
    ) {
      return false;
    }
    if (
      !SessionServiceCreationDateQuery.__deepEquals(
        this.method,
        (other as SessionServiceCreationDateQuery).method,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        SessionServiceCreationDateQuery.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => SessionServiceCreationDateQuery.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !SessionServiceCreationDateQuery.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          SessionServiceCreationDateQuery.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
