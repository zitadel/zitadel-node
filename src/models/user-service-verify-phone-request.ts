...
export class UserServiceVerifyPhoneRequest {
  /**
  ...
  constructor(data?: Partial<UserServiceVerifyPhoneRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceVerifyPhoneRequest)) {
      return false;
    }
    if (
      !UserServiceVerifyPhoneRequest.__deepEquals(
        this.userId,
        (other as UserServiceVerifyPhoneRequest).userId,
      )
    ) {
      return false;
    }
    if (
      !UserServiceVerifyPhoneRequest.__deepEquals(
        ...
        (other as UserServiceVerifyPhoneRequest).verificationCode,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceVerifyPhoneRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceVerifyPhoneRequest.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceVerifyPhoneRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceVerifyPhoneRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
