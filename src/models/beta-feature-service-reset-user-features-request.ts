...
export class BetaFeatureServiceResetUserFeaturesRequest {
  /**
  ...
  constructor(data?: Partial<BetaFeatureServiceResetUserFeaturesRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaFeatureServiceResetUserFeaturesRequest)) {
      return false;
    }
    if (
      !BetaFeatureServiceResetUserFeaturesRequest.__deepEquals(
        this.userId,
        (other as BetaFeatureServiceResetUserFeaturesRequest).userId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaFeatureServiceResetUserFeaturesRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaFeatureServiceResetUserFeaturesRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaFeatureServiceResetUserFeaturesRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaFeatureServiceResetUserFeaturesRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
