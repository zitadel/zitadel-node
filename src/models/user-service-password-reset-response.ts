...
export class UserServicePasswordResetResponse {
  /**
  ...
  constructor(data?: Partial<UserServicePasswordResetResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServicePasswordResetResponse)) {
      return false;
    }
    if (
      !UserServicePasswordResetResponse.__deepEquals(
        this.details,
        (other as UserServicePasswordResetResponse).details,
      )
    ) {
      return false;
    }
    if (
      !UserServicePasswordResetResponse.__deepEquals(
        ...
        (other as UserServicePasswordResetResponse).verificationCode,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServicePasswordResetResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServicePasswordResetResponse.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServicePasswordResetResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServicePasswordResetResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
