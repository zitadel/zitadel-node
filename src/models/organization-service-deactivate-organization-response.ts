...
export class OrganizationServiceDeactivateOrganizationResponse {
  /**
  ...
  constructor(
    data?: Partial<OrganizationServiceDeactivateOrganizationResponse>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof OrganizationServiceDeactivateOrganizationResponse)) {
      return false;
    }
    if (
      !OrganizationServiceDeactivateOrganizationResponse.__deepEquals(
        this.changeDate,
        (other as OrganizationServiceDeactivateOrganizationResponse).changeDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        OrganizationServiceDeactivateOrganizationResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          OrganizationServiceDeactivateOrganizationResponse.__deepEquals(v, w),
        ),
      );
    }
