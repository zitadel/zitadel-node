...
export class FeatureServiceSetOrganizationFeaturesRequest {
  /**
  ...
  constructor(data?: Partial<FeatureServiceSetOrganizationFeaturesRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof FeatureServiceSetOrganizationFeaturesRequest)) {
      return false;
    }
    if (
      !FeatureServiceSetOrganizationFeaturesRequest.__deepEquals(
        this.organizationId,
        (other as FeatureServiceSetOrganizationFeaturesRequest).organizationId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        FeatureServiceSetOrganizationFeaturesRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          FeatureServiceSetOrganizationFeaturesRequest.__deepEquals(v, w),
        ),
      );
    }
