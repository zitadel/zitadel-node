...
export class BetaInstanceServiceDeleteInstanceResponse {
  /**
  ...
  constructor(data?: Partial<BetaInstanceServiceDeleteInstanceResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaInstanceServiceDeleteInstanceResponse)) {
      return false;
    }
    if (
      !BetaInstanceServiceDeleteInstanceResponse.__deepEquals(
        this.deletionDate,
        (other as BetaInstanceServiceDeleteInstanceResponse).deletionDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaInstanceServiceDeleteInstanceResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaInstanceServiceDeleteInstanceResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaInstanceServiceDeleteInstanceResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaInstanceServiceDeleteInstanceResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
