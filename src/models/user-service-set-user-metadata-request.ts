...
export class UserServiceSetUserMetadataRequest {
  /**
  ...
  constructor(data?: Partial<UserServiceSetUserMetadataRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceSetUserMetadataRequest)) {
      return false;
    }
    if (
      !UserServiceSetUserMetadataRequest.__deepEquals(
        this.userId,
        (other as UserServiceSetUserMetadataRequest).userId,
      )
    ) {
      return false;
    }
    if (
      !UserServiceSetUserMetadataRequest.__deepEquals(
        this.metadata,
        (other as UserServiceSetUserMetadataRequest).metadata,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceSetUserMetadataRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceSetUserMetadataRequest.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceSetUserMetadataRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceSetUserMetadataRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
