...
export class BetaUserServiceResendEmailCodeRequest {
  ...
  constructor(data?: Partial<BetaUserServiceResendEmailCodeRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaUserServiceResendEmailCodeRequest)) {
      return false;
    }
    if (
      !BetaUserServiceResendEmailCodeRequest.__deepEquals(
        this.userId,
        (other as BetaUserServiceResendEmailCodeRequest).userId,
      )
    ) {
      return false;
    }
    if (
      !BetaUserServiceResendEmailCodeRequest.__deepEquals(
        this.returnCode,
        (other as BetaUserServiceResendEmailCodeRequest).returnCode,
      )
    ) {
      return false;
    }
    if (
      !BetaUserServiceResendEmailCodeRequest.__deepEquals(
        this.sendCode,
        (other as BetaUserServiceResendEmailCodeRequest).sendCode,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaUserServiceResendEmailCodeRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaUserServiceResendEmailCodeRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaUserServiceResendEmailCodeRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaUserServiceResendEmailCodeRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
