...
export class UserServiceSendEmailVerificationCode {
  /**
  ...
  constructor(data?: Partial<UserServiceSendEmailVerificationCode>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceSendEmailVerificationCode)) {
      return false;
    }
    if (
      !UserServiceSendEmailVerificationCode.__deepEquals(
        this.urlTemplate,
        (other as UserServiceSendEmailVerificationCode).urlTemplate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceSendEmailVerificationCode.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          UserServiceSendEmailVerificationCode.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceSendEmailVerificationCode.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceSendEmailVerificationCode.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
