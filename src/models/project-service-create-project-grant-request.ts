...
export class ProjectServiceCreateProjectGrantRequest {
  /**
  ...
  constructor(data?: Partial<ProjectServiceCreateProjectGrantRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ProjectServiceCreateProjectGrantRequest)) {
      return false;
    }
    if (
      !ProjectServiceCreateProjectGrantRequest.__deepEquals(
        this.projectId,
        (other as ProjectServiceCreateProjectGrantRequest).projectId,
      )
    ) {
      return false;
    }
    if (
      !ProjectServiceCreateProjectGrantRequest.__deepEquals(
        ...
        (other as ProjectServiceCreateProjectGrantRequest)
    ...
    if (
      !ProjectServiceCreateProjectGrantRequest.__deepEquals(
        this.roleKeys,
        (other as ProjectServiceCreateProjectGrantRequest).roleKeys,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ProjectServiceCreateProjectGrantRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          ProjectServiceCreateProjectGrantRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !ProjectServiceCreateProjectGrantRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ProjectServiceCreateProjectGrantRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
