...
export class ApplicationServiceEntityIDFilter {
  /**
  ...
  constructor(data?: Partial<ApplicationServiceEntityIDFilter>) {
    Object.assign(this, data);
    if (this.entityId != null && typeof this.entityId !== "string") {
      throw new TypeError(
        `entityId must be a string, got ${typeof this.entityId}`,
      );
    }
  }
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ApplicationServiceEntityIDFilter)) {
      return false;
    }
    if (
      !ApplicationServiceEntityIDFilter.__deepEquals(
        this.entityId,
        (other as ApplicationServiceEntityIDFilter).entityId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ApplicationServiceEntityIDFilter.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => ApplicationServiceEntityIDFilter.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !ApplicationServiceEntityIDFilter.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ApplicationServiceEntityIDFilter.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
