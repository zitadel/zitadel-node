  ...
  constructor(data?: Partial<BetaProjectServiceProject>) {
    ...
    if (this.state != null) {
      const stateValues = Object.values(BetaProjectServiceProjectState).filter(
        (v) =>
          typeof (BetaProjectServiceProjectState as Record<string, unknown>)[
            v as string
          ] !== "number",
      );
    ...
    if (this.grantedState != null) {
      const grantedStateValues = Object.values(
        BetaProjectServiceGrantedProjectState,
      ).filter(
        (v) =>
          typeof (
            BetaProjectServiceGrantedProjectState as Record<string, unknown>
          )[v as string] !== "number",
      );
      if (
