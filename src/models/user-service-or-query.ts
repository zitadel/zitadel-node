 ...
 */
export class UserServiceOrQuery {
  /**
  ...
  constructor(data?: Partial<UserServiceOrQuery>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceOrQuery)) {
      return false;
    }
    if (
      !UserServiceOrQuery.__deepEquals(
        this.queries,
        (other as UserServiceOrQuery).queries,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => UserServiceOrQuery.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceOrQuery.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !UserServiceOrQuery.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceOrQuery.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
