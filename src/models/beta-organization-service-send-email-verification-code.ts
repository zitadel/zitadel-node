...
export class BetaOrganizationServiceSendEmailVerificationCode {
  /**
  ...
  constructor(
    data?: Partial<BetaOrganizationServiceSendEmailVerificationCode>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaOrganizationServiceSendEmailVerificationCode)) {
      return false;
    }
    if (
      !BetaOrganizationServiceSendEmailVerificationCode.__deepEquals(
        this.urlTemplate,
        (other as BetaOrganizationServiceSendEmailVerificationCode).urlTemplate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaOrganizationServiceSendEmailVerificationCode.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaOrganizationServiceSendEmailVerificationCode.__deepEquals(v, w),
        ),
      );
    }
