...
export class ActionServiceInConditionsFilter {
  /**
  ...
  constructor(data?: Partial<ActionServiceInConditionsFilter>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ActionServiceInConditionsFilter)) {
      return false;
    }
    if (
      !ActionServiceInConditionsFilter.__deepEquals(
        this.conditions,
        (other as ActionServiceInConditionsFilter).conditions,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ActionServiceInConditionsFilter.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => ActionServiceInConditionsFilter.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !ActionServiceInConditionsFilter.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ActionServiceInConditionsFilter.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
