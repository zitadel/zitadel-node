...
import { BetaUserServiceIDPInformation } from "./beta-user-service-idp-information.js";
import { Expose, Type } from "class-transformer";

export class BetaUserServiceRetrieveIdentityProviderIntentResponse {
  /**
  ...
  constructor(
    data?: Partial<BetaUserServiceRetrieveIdentityProviderIntentResponse>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !(other instanceof BetaUserServiceRetrieveIdentityProviderIntentResponse)
    ) {
      return false;
    }
    if (
      !BetaUserServiceRetrieveIdentityProviderIntentResponse.__deepEquals(
        this.details,
        (other as BetaUserServiceRetrieveIdentityProviderIntentResponse)
          .details,
      )
    ) {
      return false;
    ...
    if (
      !BetaUserServiceRetrieveIdentityProviderIntentResponse.__deepEquals(
        this.userId,
        (other as BetaUserServiceRetrieveIdentityProviderIntentResponse).userId,
      )
    ) {
      return false;
    }
