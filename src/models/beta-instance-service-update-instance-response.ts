...
export class BetaInstanceServiceUpdateInstanceResponse {
  /**
  ...
  constructor(data?: Partial<BetaInstanceServiceUpdateInstanceResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaInstanceServiceUpdateInstanceResponse)) {
      return false;
    }
    if (
      !BetaInstanceServiceUpdateInstanceResponse.__deepEquals(
        this.changeDate,
        (other as BetaInstanceServiceUpdateInstanceResponse).changeDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaInstanceServiceUpdateInstanceResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaInstanceServiceUpdateInstanceResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaInstanceServiceUpdateInstanceResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaInstanceServiceUpdateInstanceResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
