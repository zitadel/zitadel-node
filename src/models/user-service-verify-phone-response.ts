...
export class UserServiceVerifyPhoneResponse {
  /**
  ...
  constructor(data?: Partial<UserServiceVerifyPhoneResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceVerifyPhoneResponse)) {
      return false;
    }
    if (
      !UserServiceVerifyPhoneResponse.__deepEquals(
        this.details,
        (other as UserServiceVerifyPhoneResponse).details,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceVerifyPhoneResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceVerifyPhoneResponse.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceVerifyPhoneResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceVerifyPhoneResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
