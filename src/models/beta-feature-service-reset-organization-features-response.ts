...
export class BetaFeatureServiceResetOrganizationFeaturesResponse {
  /**
  ...
  constructor(
    data?: Partial<BetaFeatureServiceResetOrganizationFeaturesResponse>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !(other instanceof BetaFeatureServiceResetOrganizationFeaturesResponse)
    ) {
      return false;
    }
    if (
      !BetaFeatureServiceResetOrganizationFeaturesResponse.__deepEquals(
        this.details,
        (other as BetaFeatureServiceResetOrganizationFeaturesResponse).details,
      )
    ) {
      return false;
    }
