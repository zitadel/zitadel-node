...
export class ProjectServiceAddProjectRoleRequest {
  ...
  constructor(data?: Partial<ProjectServiceAddProjectRoleRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ProjectServiceAddProjectRoleRequest)) {
      return false;
    }
    if (
      !ProjectServiceAddProjectRoleRequest.__deepEquals(
        this.projectId,
        (other as ProjectServiceAddProjectRoleRequest).projectId,
      )
    ) {
      return false;
    }
    if (
      !ProjectServiceAddProjectRoleRequest.__deepEquals(
        this.roleKey,
        (other as ProjectServiceAddProjectRoleRequest).roleKey,
      )
    ) {
      return false;
    }
    if (
      !ProjectServiceAddProjectRoleRequest.__deepEquals(
        this.displayName,
        (other as ProjectServiceAddProjectRoleRequest).displayName,
      )
    ) {
      return false;
    }
    if (
      !ProjectServiceAddProjectRoleRequest.__deepEquals(
        this.group,
        (other as ProjectServiceAddProjectRoleRequest).group,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ProjectServiceAddProjectRoleRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          ProjectServiceAddProjectRoleRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !ProjectServiceAddProjectRoleRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ProjectServiceAddProjectRoleRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
