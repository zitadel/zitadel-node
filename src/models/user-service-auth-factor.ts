...
import { UserServiceAuthFactorU2F } from "./user-service-auth-factor-u2-f.js";
...
export class UserServiceAuthFactor {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceAuthFactor)) {
      return false;
    }
    if (
      !UserServiceAuthFactor.__deepEquals(
        this.state,
        (other as UserServiceAuthFactor).state,
      )
    ) {
      return false;
    }
    if (
      !UserServiceAuthFactor.__deepEquals(
        this.otp,
        (other as UserServiceAuthFactor).otp,
      )
    ) {
      return false;
    }
    if (
      !UserServiceAuthFactor.__deepEquals(
        this.otpEmail,
        (other as UserServiceAuthFactor).otpEmail,
      )
    ) {
      return false;
    }
    if (
      !UserServiceAuthFactor.__deepEquals(
        this.otpSms,
        (other as UserServiceAuthFactor).otpSms,
      )
    ) {
      return false;
    }
    if (
      !UserServiceAuthFactor.__deepEquals(
        this.u2f,
        (other as UserServiceAuthFactor).u2f,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => UserServiceAuthFactor.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceAuthFactor.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !UserServiceAuthFactor.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceAuthFactor.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
