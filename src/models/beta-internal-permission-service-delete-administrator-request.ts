...
export class BetaInternalPermissionServiceDeleteAdministratorRequest {
  /**
  ...
  constructor(
    data?: Partial<BetaInternalPermissionServiceDeleteAdministratorRequest>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !(
        other instanceof BetaInternalPermissionServiceDeleteAdministratorRequest
      )
    ) {
      return false;
    }
    if (
      !BetaInternalPermissionServiceDeleteAdministratorRequest.__deepEquals(
        this.userId,
        (other as BetaInternalPermissionServiceDeleteAdministratorRequest)
          .userId,
      )
    ) {
      return false;
