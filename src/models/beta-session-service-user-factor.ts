...
export class BetaSessionServiceUserFactor {
  /**
  ...
  constructor(data?: Partial<BetaSessionServiceUserFactor>) {
    Object.assign(this, data);
    if (this.id != null && typeof this.id !== "string") {
      throw new TypeError(`id must be a string, got ${typeof this.id}`);
    }
    if (this.loginName != null && typeof this.loginName !== "string") {
      throw new TypeError(
        `loginName must be a string, got ${typeof this.loginName}`,
      );
    }
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaSessionServiceUserFactor)) {
      return false;
    }
    if (
      !BetaSessionServiceUserFactor.__deepEquals(
        this.verifiedAt,
        (other as BetaSessionServiceUserFactor).verifiedAt,
      )
    ) {
      return false;
    }
    if (
      !BetaSessionServiceUserFactor.__deepEquals(
        this.id,
        (other as BetaSessionServiceUserFactor).id,
      )
    ) {
      return false;
    }
    if (
      !BetaSessionServiceUserFactor.__deepEquals(
        this.loginName,
        (other as BetaSessionServiceUserFactor).loginName,
      )
    ) {
      return false;
    }
    if (
      !BetaSessionServiceUserFactor.__deepEquals(
        this.displayName,
        (other as BetaSessionServiceUserFactor).displayName,
      )
    ) {
      return false;
    }
    if (
      !BetaSessionServiceUserFactor.__deepEquals(
        this.organizationId,
        (other as BetaSessionServiceUserFactor).organizationId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaSessionServiceUserFactor.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaSessionServiceUserFactor.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaSessionServiceUserFactor.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaSessionServiceUserFactor.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
