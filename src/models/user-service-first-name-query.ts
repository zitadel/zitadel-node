 ...
 */
export class UserServiceFirstNameQuery {
  /**
  ...
  constructor(data?: Partial<UserServiceFirstNameQuery>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceFirstNameQuery)) {
      return false;
    }
    if (
      !UserServiceFirstNameQuery.__deepEquals(
        this.firstName,
        (other as UserServiceFirstNameQuery).firstName,
      )
    ) {
      return false;
    }
    if (
      !UserServiceFirstNameQuery.__deepEquals(
        this.method,
        (other as UserServiceFirstNameQuery).method,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => UserServiceFirstNameQuery.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceFirstNameQuery.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !UserServiceFirstNameQuery.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceFirstNameQuery.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
