...
export class BetaFeatureServiceGetOrganizationFeaturesRequest {
  /**
  ...
  constructor(
    data?: Partial<BetaFeatureServiceGetOrganizationFeaturesRequest>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaFeatureServiceGetOrganizationFeaturesRequest)) {
      return false;
    }
    if (
      !BetaFeatureServiceGetOrganizationFeaturesRequest.__deepEquals(
        this.organizationId,
        (other as BetaFeatureServiceGetOrganizationFeaturesRequest)
          .organizationId,
      )
    ) {
      return false;
    ...
    if (
      !BetaFeatureServiceGetOrganizationFeaturesRequest.__deepEquals(
        this.inheritance,
        (other as BetaFeatureServiceGetOrganizationFeaturesRequest).inheritance,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaFeatureServiceGetOrganizationFeaturesRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaFeatureServiceGetOrganizationFeaturesRequest.__deepEquals(v, w),
        ),
      );
    }
