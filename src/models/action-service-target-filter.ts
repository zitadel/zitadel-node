...
export class ActionServiceTargetFilter {
  /**
  ...
  constructor(data?: Partial<ActionServiceTargetFilter>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ActionServiceTargetFilter)) {
      return false;
    }
    if (
      !ActionServiceTargetFilter.__deepEquals(
        this.targetId,
        (other as ActionServiceTargetFilter).targetId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => ActionServiceTargetFilter.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => ActionServiceTargetFilter.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !ActionServiceTargetFilter.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ActionServiceTargetFilter.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
