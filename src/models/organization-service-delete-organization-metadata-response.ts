...
export class OrganizationServiceDeleteOrganizationMetadataResponse {
  /**
  ...
  constructor(
    data?: Partial<OrganizationServiceDeleteOrganizationMetadataResponse>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !(other instanceof OrganizationServiceDeleteOrganizationMetadataResponse)
    ) {
      return false;
    }
    if (
      !OrganizationServiceDeleteOrganizationMetadataResponse.__deepEquals(
        this.deletionDate,
        (other as OrganizationServiceDeleteOrganizationMetadataResponse)
          .deletionDate,
      )
    ) {
      return false;
