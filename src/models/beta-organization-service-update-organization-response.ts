...
export class BetaOrganizationServiceUpdateOrganizationResponse {
  /**
  ...
  constructor(
    data?: Partial<BetaOrganizationServiceUpdateOrganizationResponse>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaOrganizationServiceUpdateOrganizationResponse)) {
      return false;
    }
    if (
      !BetaOrganizationServiceUpdateOrganizationResponse.__deepEquals(
        this.changeDate,
        (other as BetaOrganizationServiceUpdateOrganizationResponse).changeDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaOrganizationServiceUpdateOrganizationResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaOrganizationServiceUpdateOrganizationResponse.__deepEquals(v, w),
        ),
      );
    }
