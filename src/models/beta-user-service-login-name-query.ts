 ...
 */
export class BetaUserServiceLoginNameQuery {
  /**
  ...
  constructor(data?: Partial<BetaUserServiceLoginNameQuery>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaUserServiceLoginNameQuery)) {
      return false;
    }
    if (
      !BetaUserServiceLoginNameQuery.__deepEquals(
        this.loginName,
        (other as BetaUserServiceLoginNameQuery).loginName,
      )
    ) {
      return false;
    }
    if (
      !BetaUserServiceLoginNameQuery.__deepEquals(
        this.method,
        (other as BetaUserServiceLoginNameQuery).method,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaUserServiceLoginNameQuery.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaUserServiceLoginNameQuery.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaUserServiceLoginNameQuery.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaUserServiceLoginNameQuery.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
