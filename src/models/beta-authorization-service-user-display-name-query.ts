...
export class BetaAuthorizationServiceUserDisplayNameQuery {
  /**
  ...
  constructor(data?: Partial<BetaAuthorizationServiceUserDisplayNameQuery>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaAuthorizationServiceUserDisplayNameQuery)) {
      return false;
    }
    if (
      !BetaAuthorizationServiceUserDisplayNameQuery.__deepEquals(
        this.displayName,
        (other as BetaAuthorizationServiceUserDisplayNameQuery).displayName,
      )
    ) {
      return false;
    }
    if (
      !BetaAuthorizationServiceUserDisplayNameQuery.__deepEquals(
        this.method,
        (other as BetaAuthorizationServiceUserDisplayNameQuery).method,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaAuthorizationServiceUserDisplayNameQuery.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaAuthorizationServiceUserDisplayNameQuery.__deepEquals(v, w),
        ),
      );
    }
