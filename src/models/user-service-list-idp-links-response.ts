...
export class UserServiceListIDPLinksResponse {
  /**
  ...
  constructor(data?: Partial<UserServiceListIDPLinksResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceListIDPLinksResponse)) {
      return false;
    }
    if (
      !UserServiceListIDPLinksResponse.__deepEquals(
        this.details,
        (other as UserServiceListIDPLinksResponse).details,
      )
    ) {
      return false;
    }
    if (
      !UserServiceListIDPLinksResponse.__deepEquals(
        this.result,
        (other as UserServiceListIDPLinksResponse).result,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceListIDPLinksResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceListIDPLinksResponse.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceListIDPLinksResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceListIDPLinksResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
