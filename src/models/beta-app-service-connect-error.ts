...
export class BetaAppServiceConnectError {
   ...
   */
  @Expose({ name: "code" })
  code?: BetaAppServiceConnectErrorCodeEnum;
  /**
  ...
  constructor(data?: Partial<BetaAppServiceConnectError>) {
    ...
    if (this.code != null) {
      const codeValues = Object.values(
        BetaAppServiceConnectErrorCodeEnum,
      ).filter(
        (v) =>
          typeof (
            BetaAppServiceConnectErrorCodeEnum as Record<string, unknown>
          )[v as string] !== "number",
      );
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaAppServiceConnectError)) {
      return false;
    }
    if (
      !BetaAppServiceConnectError.__deepEquals(
        this.code,
        (other as BetaAppServiceConnectError).code,
      )
    ) {
      return false;
    }
    if (
      !BetaAppServiceConnectError.__deepEquals(
        this.message,
        (other as BetaAppServiceConnectError).message,
      )
    ) {
      return false;
    }
    if (
      !BetaAppServiceConnectError.__deepEquals(
        this.details,
        (other as BetaAppServiceConnectError).details,
      )
    ) {
      return false;
    }
    {
      ...
      for (const k of selfKeys) {
        ...
        if (!BetaAppServiceConnectError.__deepEquals(selfRec[k], otherRec[k])) {
          return false;
        }
      }
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaAppServiceConnectError.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaAppServiceConnectError.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaAppServiceConnectError.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaAppServiceConnectError.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
...
export enum BetaAppServiceConnectErrorCodeEnum {
  Canceled = "canceled",
  Unknown = "unknown",
