...
export class BetaWebKeyServiceDeleteWebKeyRequest {
  /**
  ...
  constructor(data?: Partial<BetaWebKeyServiceDeleteWebKeyRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaWebKeyServiceDeleteWebKeyRequest)) {
      return false;
    }
    if (
      !BetaWebKeyServiceDeleteWebKeyRequest.__deepEquals(
        this.id,
        (other as BetaWebKeyServiceDeleteWebKeyRequest).id,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaWebKeyServiceDeleteWebKeyRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaWebKeyServiceDeleteWebKeyRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaWebKeyServiceDeleteWebKeyRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaWebKeyServiceDeleteWebKeyRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
