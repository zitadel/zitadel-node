...
export class FeatureServiceLoginV2FeatureFlag {
  /**
  ...
  constructor(data?: Partial<FeatureServiceLoginV2FeatureFlag>) {
    Object.assign(this, data);
    if (this.required != null && typeof this.required !== "boolean") {
      throw new TypeError(
        `required must be a boolean, got ${typeof this.required}`,
      );
    }
    if (this.baseUri != null && typeof this.baseUri !== "string") {
      throw new TypeError(
        `baseUri must be a string, got ${typeof this.baseUri}`,
      );
    }
    if (this.source != null) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof FeatureServiceLoginV2FeatureFlag)) {
      return false;
    }
    if (
      !FeatureServiceLoginV2FeatureFlag.__deepEquals(
        this.required,
        (other as FeatureServiceLoginV2FeatureFlag).required,
      )
    ) {
      return false;
    }
    if (
      !FeatureServiceLoginV2FeatureFlag.__deepEquals(
        this.baseUri,
        (other as FeatureServiceLoginV2FeatureFlag).baseUri,
      )
    ) {
      return false;
    }
    if (
      !FeatureServiceLoginV2FeatureFlag.__deepEquals(
        this.source,
        (other as FeatureServiceLoginV2FeatureFlag).source,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        FeatureServiceLoginV2FeatureFlag.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => FeatureServiceLoginV2FeatureFlag.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !FeatureServiceLoginV2FeatureFlag.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          FeatureServiceLoginV2FeatureFlag.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
