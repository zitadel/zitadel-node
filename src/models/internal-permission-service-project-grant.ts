...
export class InternalPermissionServiceProjectGrant {
  /**
  ...
  constructor(data?: Partial<InternalPermissionServiceProjectGrant>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof InternalPermissionServiceProjectGrant)) {
      return false;
    }
    if (
      !InternalPermissionServiceProjectGrant.__deepEquals(
        this.projectId,
        (other as InternalPermissionServiceProjectGrant).projectId,
      )
    ) {
      return false;
    }
    if (
      !InternalPermissionServiceProjectGrant.__deepEquals(
        this.organizationId,
        (other as InternalPermissionServiceProjectGrant).organizationId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        InternalPermissionServiceProjectGrant.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          InternalPermissionServiceProjectGrant.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !InternalPermissionServiceProjectGrant.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          InternalPermissionServiceProjectGrant.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
