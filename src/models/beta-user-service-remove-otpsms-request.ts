...
export class BetaUserServiceRemoveOTPSMSRequest {
  /**
  ...
  constructor(data?: Partial<BetaUserServiceRemoveOTPSMSRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaUserServiceRemoveOTPSMSRequest)) {
      return false;
    }
    if (
      !BetaUserServiceRemoveOTPSMSRequest.__deepEquals(
        this.userId,
        (other as BetaUserServiceRemoveOTPSMSRequest).userId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaUserServiceRemoveOTPSMSRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaUserServiceRemoveOTPSMSRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaUserServiceRemoveOTPSMSRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaUserServiceRemoveOTPSMSRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
