...
export class SessionServiceExpirationDateQuery {
  /**
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof SessionServiceExpirationDateQuery)) {
      return false;
    }
    if (
      !SessionServiceExpirationDateQuery.__deepEquals(
        this.expirationDate,
        (other as SessionServiceExpirationDateQuery).expirationDate,
      )
    ) {
      return false;
    }
    if (
      !SessionServiceExpirationDateQuery.__deepEquals(
        this.method,
        (other as SessionServiceExpirationDateQuery).method,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        SessionServiceExpirationDateQuery.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => SessionServiceExpirationDateQuery.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !SessionServiceExpirationDateQuery.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          SessionServiceExpirationDateQuery.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
