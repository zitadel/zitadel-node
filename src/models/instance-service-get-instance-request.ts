...
export class InstanceServiceGetInstanceRequest {
  /**
  ...
  constructor(data?: Partial<InstanceServiceGetInstanceRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof InstanceServiceGetInstanceRequest)) {
      return false;
    }
    if (
      !InstanceServiceGetInstanceRequest.__deepEquals(
        this.instanceId,
        (other as InstanceServiceGetInstanceRequest).instanceId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        InstanceServiceGetInstanceRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => InstanceServiceGetInstanceRequest.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !InstanceServiceGetInstanceRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          InstanceServiceGetInstanceRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
