...
export class ActionServiceActivatePublicKeyResponse {
  /**
  ...
  constructor(data?: Partial<ActionServiceActivatePublicKeyResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ActionServiceActivatePublicKeyResponse)) {
      return false;
    }
    if (
      !ActionServiceActivatePublicKeyResponse.__deepEquals(
        this.changeDate,
        (other as ActionServiceActivatePublicKeyResponse).changeDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ActionServiceActivatePublicKeyResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          ActionServiceActivatePublicKeyResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !ActionServiceActivatePublicKeyResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ActionServiceActivatePublicKeyResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
