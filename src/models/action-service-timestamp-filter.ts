...
import { ActionServiceTimestampFilterMethod } from "./action-service-timestamp-filter-method.js";
import { Expose, Type } from "class-transformer";

export class ActionServiceTimestampFilter {
  /**
  ...
  constructor(data?: Partial<ActionServiceTimestampFilter>) {
    ...
    if (this.method != null) {
      const methodValues = Object.values(
        ...
        (v) =>
          typeof (
            ActionServiceTimestampFilterMethod as Record<string, unknown>
          )[v as string] !== "number",
      );
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ActionServiceTimestampFilter)) {
      return false;
    }
    if (
      !ActionServiceTimestampFilter.__deepEquals(
        this.timestamp,
        (other as ActionServiceTimestampFilter).timestamp,
      )
    ) {
      return false;
    }
    if (
      !ActionServiceTimestampFilter.__deepEquals(
        this.method,
        (other as ActionServiceTimestampFilter).method,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ActionServiceTimestampFilter.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => ActionServiceTimestampFilter.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !ActionServiceTimestampFilter.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ActionServiceTimestampFilter.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
