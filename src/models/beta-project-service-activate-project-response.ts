...
export class BetaProjectServiceActivateProjectResponse {
  /**
  ...
  constructor(data?: Partial<BetaProjectServiceActivateProjectResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaProjectServiceActivateProjectResponse)) {
      return false;
    }
    if (
      !BetaProjectServiceActivateProjectResponse.__deepEquals(
        this.changeDate,
        (other as BetaProjectServiceActivateProjectResponse).changeDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaProjectServiceActivateProjectResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaProjectServiceActivateProjectResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaProjectServiceActivateProjectResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaProjectServiceActivateProjectResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
