...
export class OIDCServiceGetDeviceAuthorizationRequestRequest {
  /**
  ...
  constructor(data?: Partial<OIDCServiceGetDeviceAuthorizationRequestRequest>) {
    Object.assign(this, data);
    if (this.userCode != null && typeof this.userCode !== "string") {
      throw new TypeError(
        `userCode must be a string, got ${typeof this.userCode}`,
      );
    }
  }
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof OIDCServiceGetDeviceAuthorizationRequestRequest)) {
      return false;
    }
    if (
      !OIDCServiceGetDeviceAuthorizationRequestRequest.__deepEquals(
        this.userCode,
        (other as OIDCServiceGetDeviceAuthorizationRequestRequest).userCode,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        OIDCServiceGetDeviceAuthorizationRequestRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          OIDCServiceGetDeviceAuthorizationRequestRequest.__deepEquals(v, w),
        ),
      );
    }
