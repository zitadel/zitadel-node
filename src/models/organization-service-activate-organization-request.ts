...
export class OrganizationServiceActivateOrganizationRequest {
  /**
  ...
  constructor(data?: Partial<OrganizationServiceActivateOrganizationRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof OrganizationServiceActivateOrganizationRequest)) {
      return false;
    }
    if (
      !OrganizationServiceActivateOrganizationRequest.__deepEquals(
        this.organizationId,
        (other as OrganizationServiceActivateOrganizationRequest)
          .organizationId,
      )
    ) {
      return false;
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        OrganizationServiceActivateOrganizationRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          OrganizationServiceActivateOrganizationRequest.__deepEquals(v, w),
        ),
      );
    }
