...
import { ApplicationServiceAPIAuthMethodType } from "./application-service-api-auth-method-type.js";
...
export class ApplicationServiceAPIConfiguration {
  ...
  constructor(data?: Partial<ApplicationServiceAPIConfiguration>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ApplicationServiceAPIConfiguration)) {
      return false;
    }
    if (
      !ApplicationServiceAPIConfiguration.__deepEquals(
        this.clientId,
        (other as ApplicationServiceAPIConfiguration).clientId,
      )
    ) {
      return false;
    }
    if (
      !ApplicationServiceAPIConfiguration.__deepEquals(
        this.authMethodType,
        (other as ApplicationServiceAPIConfiguration).authMethodType,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ApplicationServiceAPIConfiguration.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          ApplicationServiceAPIConfiguration.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !ApplicationServiceAPIConfiguration.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ApplicationServiceAPIConfiguration.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
