...
export class UserServiceRegisterU2FRequest {
  /**
  ...
  constructor(data?: Partial<UserServiceRegisterU2FRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceRegisterU2FRequest)) {
      return false;
    }
    if (
      !UserServiceRegisterU2FRequest.__deepEquals(
        this.userId,
        (other as UserServiceRegisterU2FRequest).userId,
      )
    ) {
      return false;
    }
    if (
      !UserServiceRegisterU2FRequest.__deepEquals(
        this.domain,
        (other as UserServiceRegisterU2FRequest).domain,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceRegisterU2FRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceRegisterU2FRequest.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceRegisterU2FRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceRegisterU2FRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
