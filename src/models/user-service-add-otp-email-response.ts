...
export class UserServiceAddOTPEmailResponse {
  /**
  ...
  constructor(data?: Partial<UserServiceAddOTPEmailResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceAddOTPEmailResponse)) {
      return false;
    }
    if (
      !UserServiceAddOTPEmailResponse.__deepEquals(
        this.details,
        (other as UserServiceAddOTPEmailResponse).details,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceAddOTPEmailResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceAddOTPEmailResponse.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceAddOTPEmailResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceAddOTPEmailResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
