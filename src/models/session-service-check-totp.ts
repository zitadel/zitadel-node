...
export class SessionServiceCheckTOTP {
  /**
  ...
  constructor(data?: Partial<SessionServiceCheckTOTP>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof SessionServiceCheckTOTP)) {
      return false;
    }
    if (
      !SessionServiceCheckTOTP.__deepEquals(
        this.code,
        (other as SessionServiceCheckTOTP).code,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => SessionServiceCheckTOTP.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => SessionServiceCheckTOTP.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !SessionServiceCheckTOTP.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          SessionServiceCheckTOTP.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
