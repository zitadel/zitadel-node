...
export class UserServiceHumanMFAInitSkippedRequest {
  /**
  ...
  constructor(data?: Partial<UserServiceHumanMFAInitSkippedRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceHumanMFAInitSkippedRequest)) {
      return false;
    }
    if (
      !UserServiceHumanMFAInitSkippedRequest.__deepEquals(
        this.userId,
        (other as UserServiceHumanMFAInitSkippedRequest).userId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceHumanMFAInitSkippedRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          UserServiceHumanMFAInitSkippedRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceHumanMFAInitSkippedRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceHumanMFAInitSkippedRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
