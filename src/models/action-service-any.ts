...
export class ActionServiceAny {
  ...
  constructor(data?: Partial<ActionServiceAny>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ActionServiceAny)) {
      return false;
    }
    if (
      !ActionServiceAny.__deepEquals(
        this.type,
        (other as ActionServiceAny).type,
      )
    ) {
      return false;
    }
    if (
      !ActionServiceAny.__deepEquals(
        this.value,
        (other as ActionServiceAny).value,
      )
    ) {
      return false;
    }
    if (
      !ActionServiceAny.__deepEquals(
        this.debug,
        (other as ActionServiceAny).debug,
      )
    ) {
      return false;
    }
    {
      ...
      for (const k of selfKeys) {
        ...
        if (!ActionServiceAny.__deepEquals(selfRec[k], otherRec[k])) {
          return false;
        }
      }
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => ActionServiceAny.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => ActionServiceAny.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !ActionServiceAny.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ActionServiceAny.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
