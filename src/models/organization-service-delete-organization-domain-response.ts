...
export class OrganizationServiceDeleteOrganizationDomainResponse {
  /**
  ...
  constructor(
    data?: Partial<OrganizationServiceDeleteOrganizationDomainResponse>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !(other instanceof OrganizationServiceDeleteOrganizationDomainResponse)
    ) {
      return false;
    }
    if (
      !OrganizationServiceDeleteOrganizationDomainResponse.__deepEquals(
        this.deletionDate,
        (other as OrganizationServiceDeleteOrganizationDomainResponse)
          .deletionDate,
      )
    ) {
      return false;
