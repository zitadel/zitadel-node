...
export class InternalPermissionServiceOrganization {
  /**
  ...
  constructor(data?: Partial<InternalPermissionServiceOrganization>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof InternalPermissionServiceOrganization)) {
      return false;
    }
    if (
      !InternalPermissionServiceOrganization.__deepEquals(
        this.id,
        (other as InternalPermissionServiceOrganization).id,
      )
    ) {
      return false;
    }
    if (
      !InternalPermissionServiceOrganization.__deepEquals(
        this.name,
        (other as InternalPermissionServiceOrganization).name,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        InternalPermissionServiceOrganization.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          InternalPermissionServiceOrganization.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !InternalPermissionServiceOrganization.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          InternalPermissionServiceOrganization.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
