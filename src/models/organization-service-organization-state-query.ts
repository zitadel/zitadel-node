...
export class OrganizationServiceOrganizationStateQuery {
  /**
  ...
  constructor(data?: Partial<OrganizationServiceOrganizationStateQuery>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof OrganizationServiceOrganizationStateQuery)) {
      return false;
    }
    if (
      !OrganizationServiceOrganizationStateQuery.__deepEquals(
        this.state,
        (other as OrganizationServiceOrganizationStateQuery).state,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        OrganizationServiceOrganizationStateQuery.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          OrganizationServiceOrganizationStateQuery.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !OrganizationServiceOrganizationStateQuery.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          OrganizationServiceOrganizationStateQuery.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
