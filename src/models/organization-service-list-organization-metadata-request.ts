...
import { OrganizationServiceMetadataSearchFilter } from "./organization-service-metadata-search-filter.js";
import { OrganizationServicePaginationRequest } from "./organization-service-pagination-request.js";
import { Expose, Type } from "class-transformer";

export class OrganizationServiceListOrganizationMetadataRequest {
  /**
   ...
   */
  @Expose({ name: "filters" })
  @Type(() => OrganizationServiceMetadataSearchFilter)
  filters?: Array<OrganizationServiceMetadataSearchFilter>;

  constructor(
    data?: Partial<OrganizationServiceListOrganizationMetadataRequest>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !(other instanceof OrganizationServiceListOrganizationMetadataRequest)
    ) {
      return false;
    }
    if (
      !OrganizationServiceListOrganizationMetadataRequest.__deepEquals(
        this.organizationId,
        (other as OrganizationServiceListOrganizationMetadataRequest)
          .organizationId,
      )
    ) {
      return false;
    ...
    if (
      !OrganizationServiceListOrganizationMetadataRequest.__deepEquals(
        this.filters,
        (other as OrganizationServiceListOrganizationMetadataRequest).filters,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          OrganizationServiceListOrganizationMetadataRequest.__deepEquals(v, w),
        ),
      );
    }
