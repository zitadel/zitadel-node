...
export class ApplicationServiceDeleteApplicationKeyResponse {
  /**
  ...
  constructor(data?: Partial<ApplicationServiceDeleteApplicationKeyResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ApplicationServiceDeleteApplicationKeyResponse)) {
      return false;
    }
    if (
      !ApplicationServiceDeleteApplicationKeyResponse.__deepEquals(
        this.deletionDate,
        (other as ApplicationServiceDeleteApplicationKeyResponse).deletionDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ApplicationServiceDeleteApplicationKeyResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          ApplicationServiceDeleteApplicationKeyResponse.__deepEquals(v, w),
        ),
      );
    }
