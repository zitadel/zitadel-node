...
import { IdentityProviderServiceAzureADTenantType } from "./identity-provider-service-azure-ad-tenant-type.js";
...
export class IdentityProviderServiceAzureADTenant {
  ...
  constructor(data?: Partial<IdentityProviderServiceAzureADTenant>) {
    Object.assign(this, data);
    if (this.tenantId != null && typeof this.tenantId !== "string") {
      throw new TypeError(
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof IdentityProviderServiceAzureADTenant)) {
      return false;
    }
    if (
      !IdentityProviderServiceAzureADTenant.__deepEquals(
        this.tenantId,
        (other as IdentityProviderServiceAzureADTenant).tenantId,
      )
    ) {
      return false;
    }
    if (
      !IdentityProviderServiceAzureADTenant.__deepEquals(
        this.tenantType,
        (other as IdentityProviderServiceAzureADTenant).tenantType,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        IdentityProviderServiceAzureADTenant.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          IdentityProviderServiceAzureADTenant.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !IdentityProviderServiceAzureADTenant.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          IdentityProviderServiceAzureADTenant.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
