...
export class FeatureServiceResetUserFeaturesRequest {
  /**
  ...
  constructor(data?: Partial<FeatureServiceResetUserFeaturesRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof FeatureServiceResetUserFeaturesRequest)) {
      return false;
    }
    if (
      !FeatureServiceResetUserFeaturesRequest.__deepEquals(
        this.userId,
        (other as FeatureServiceResetUserFeaturesRequest).userId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        FeatureServiceResetUserFeaturesRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          FeatureServiceResetUserFeaturesRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !FeatureServiceResetUserFeaturesRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          FeatureServiceResetUserFeaturesRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
