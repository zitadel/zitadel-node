...
export class UserServicePaginationRequest {
  /**
  ...
  constructor(data?: Partial<UserServicePaginationRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServicePaginationRequest)) {
      return false;
    }
    if (
      !UserServicePaginationRequest.__deepEquals(
        this.offset,
        (other as UserServicePaginationRequest).offset,
      )
    ) {
      return false;
    }
    if (
      !UserServicePaginationRequest.__deepEquals(
        this.limit,
        (other as UserServicePaginationRequest).limit,
      )
    ) {
      return false;
    }
    if (
      !UserServicePaginationRequest.__deepEquals(
        this.asc,
        (other as UserServicePaginationRequest).asc,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServicePaginationRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServicePaginationRequest.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServicePaginationRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServicePaginationRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
