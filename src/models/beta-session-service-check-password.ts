...
export class BetaSessionServiceCheckPassword {
  /**
  ...
  constructor(data?: Partial<BetaSessionServiceCheckPassword>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaSessionServiceCheckPassword)) {
      return false;
    }
    if (
      !BetaSessionServiceCheckPassword.__deepEquals(
        this.password,
        (other as BetaSessionServiceCheckPassword).password,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaSessionServiceCheckPassword.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaSessionServiceCheckPassword.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaSessionServiceCheckPassword.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaSessionServiceCheckPassword.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
