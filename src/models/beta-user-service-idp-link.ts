...
export class BetaUserServiceIDPLink {
  /**
  ...
  constructor(data?: Partial<BetaUserServiceIDPLink>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaUserServiceIDPLink)) {
      return false;
    }
    if (
      !BetaUserServiceIDPLink.__deepEquals(
        this.idpId,
        (other as BetaUserServiceIDPLink).idpId,
      )
    ) {
      return false;
    }
    if (
      !BetaUserServiceIDPLink.__deepEquals(
        this.userId,
        (other as BetaUserServiceIDPLink).userId,
      )
    ) {
      return false;
    }
    if (
      !BetaUserServiceIDPLink.__deepEquals(
        this.userName,
        (other as BetaUserServiceIDPLink).userName,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => BetaUserServiceIDPLink.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaUserServiceIDPLink.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !BetaUserServiceIDPLink.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaUserServiceIDPLink.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
