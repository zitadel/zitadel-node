...
export class BetaInstanceServiceRemoveTrustedDomainResponse {
  /**
  ...
  constructor(data?: Partial<BetaInstanceServiceRemoveTrustedDomainResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaInstanceServiceRemoveTrustedDomainResponse)) {
      return false;
    }
    if (
      !BetaInstanceServiceRemoveTrustedDomainResponse.__deepEquals(
        this.deletionDate,
        (other as BetaInstanceServiceRemoveTrustedDomainResponse).deletionDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaInstanceServiceRemoveTrustedDomainResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaInstanceServiceRemoveTrustedDomainResponse.__deepEquals(v, w),
        ),
      );
    }
