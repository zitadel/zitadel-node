...
export class BetaAppServiceDeleteApplicationRequest {
  /**
  ...
  constructor(data?: Partial<BetaAppServiceDeleteApplicationRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaAppServiceDeleteApplicationRequest)) {
      return false;
    }
    if (
      !BetaAppServiceDeleteApplicationRequest.__deepEquals(
        this.projectId,
        (other as BetaAppServiceDeleteApplicationRequest).projectId,
      )
    ) {
      return false;
    }
    if (
      !BetaAppServiceDeleteApplicationRequest.__deepEquals(
        this.id,
        (other as BetaAppServiceDeleteApplicationRequest).id,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaAppServiceDeleteApplicationRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaAppServiceDeleteApplicationRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaAppServiceDeleteApplicationRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaAppServiceDeleteApplicationRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
