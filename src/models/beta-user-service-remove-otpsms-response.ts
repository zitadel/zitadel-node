...
export class BetaUserServiceRemoveOTPSMSResponse {
  /**
  ...
  constructor(data?: Partial<BetaUserServiceRemoveOTPSMSResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaUserServiceRemoveOTPSMSResponse)) {
      return false;
    }
    if (
      !BetaUserServiceRemoveOTPSMSResponse.__deepEquals(
        this.details,
        (other as BetaUserServiceRemoveOTPSMSResponse).details,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaUserServiceRemoveOTPSMSResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaUserServiceRemoveOTPSMSResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaUserServiceRemoveOTPSMSResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaUserServiceRemoveOTPSMSResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
