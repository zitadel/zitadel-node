...
export class InstanceServicePaginationResponse {
  /**
  ...
  constructor(data?: Partial<InstanceServicePaginationResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof InstanceServicePaginationResponse)) {
      return false;
    }
    if (
      !InstanceServicePaginationResponse.__deepEquals(
        this.totalResult,
        (other as InstanceServicePaginationResponse).totalResult,
      )
    ) {
      return false;
    }
    if (
      !InstanceServicePaginationResponse.__deepEquals(
        this.appliedLimit,
        (other as InstanceServicePaginationResponse).appliedLimit,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        InstanceServicePaginationResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => InstanceServicePaginationResponse.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !InstanceServicePaginationResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          InstanceServicePaginationResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
