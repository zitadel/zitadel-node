...
export class UserServiceRemoveRecoveryCodesRequest {
  /**
  ...
  constructor(data?: Partial<UserServiceRemoveRecoveryCodesRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceRemoveRecoveryCodesRequest)) {
      return false;
    }
    if (
      !UserServiceRemoveRecoveryCodesRequest.__deepEquals(
        this.userId,
        (other as UserServiceRemoveRecoveryCodesRequest).userId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceRemoveRecoveryCodesRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          UserServiceRemoveRecoveryCodesRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceRemoveRecoveryCodesRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceRemoveRecoveryCodesRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
