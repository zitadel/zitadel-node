...
export class BetaProjectServiceDeactivateProjectResponse {
  /**
  ...
  constructor(data?: Partial<BetaProjectServiceDeactivateProjectResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaProjectServiceDeactivateProjectResponse)) {
      return false;
    }
    if (
      !BetaProjectServiceDeactivateProjectResponse.__deepEquals(
        this.changeDate,
        (other as BetaProjectServiceDeactivateProjectResponse).changeDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaProjectServiceDeactivateProjectResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaProjectServiceDeactivateProjectResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaProjectServiceDeactivateProjectResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
