...
import { BetaWebKeyServiceAny } from "./beta-web-key-service-any.js";
import { Expose, Type } from "class-transformer";

/**
 * Error type returned by Connect: https://connectrpc.com/docs/go/errors/#http-representation
 */
export class BetaWebKeyServiceConnectError {
  /**
   ...
   */
  @Expose({ name: "code" })
  code?: BetaWebKeyServiceConnectErrorCodeEnum;
  /**
  ...
  constructor(data?: Partial<BetaWebKeyServiceConnectError>) {
    ...
    if (this.code != null) {
      const codeValues = Object.values(
        BetaWebKeyServiceConnectErrorCodeEnum,
      ).filter(
        (v) =>
          typeof (
            BetaWebKeyServiceConnectErrorCodeEnum as Record<string, unknown>
          )[v as string] !== "number",
      );
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaWebKeyServiceConnectError)) {
      return false;
    }
    if (
      !BetaWebKeyServiceConnectError.__deepEquals(
        this.code,
        (other as BetaWebKeyServiceConnectError).code,
      )
    ) {
      return false;
    }
    if (
      !BetaWebKeyServiceConnectError.__deepEquals(
        this.message,
        (other as BetaWebKeyServiceConnectError).message,
      )
    ) {
      return false;
    }
    if (
      !BetaWebKeyServiceConnectError.__deepEquals(
        this.details,
        (other as BetaWebKeyServiceConnectError).details,
      )
    ) {
      return false;
    }
    {
      ...
      for (const k of selfKeys) {
        ...
        if (
          !BetaWebKeyServiceConnectError.__deepEquals(selfRec[k], otherRec[k])
        ) {
          return false;
        }
      }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaWebKeyServiceConnectError.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaWebKeyServiceConnectError.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaWebKeyServiceConnectError.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaWebKeyServiceConnectError.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
...
export enum BetaWebKeyServiceConnectErrorCodeEnum {
  Canceled = "canceled",
  Unknown = "unknown",
