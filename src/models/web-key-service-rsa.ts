...
import { WebKeyServiceRSABits } from "./web-key-service-rsa-bits.js";
import { WebKeyServiceRSAHasher } from "./web-key-service-rsa-hasher.js";
...
export class WebKeyServiceRSA {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof WebKeyServiceRSA)) {
      return false;
    }
    if (
      !WebKeyServiceRSA.__deepEquals(
        this.bits,
        (other as WebKeyServiceRSA).bits,
      )
    ) {
      return false;
    }
    if (
      !WebKeyServiceRSA.__deepEquals(
        this.hasher,
        (other as WebKeyServiceRSA).hasher,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => WebKeyServiceRSA.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => WebKeyServiceRSA.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !WebKeyServiceRSA.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          WebKeyServiceRSA.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
