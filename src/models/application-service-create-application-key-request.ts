...
export class ApplicationServiceCreateApplicationKeyRequest {
  /**
  ...
  constructor(data?: Partial<ApplicationServiceCreateApplicationKeyRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ApplicationServiceCreateApplicationKeyRequest)) {
      return false;
    }
    if (
      !ApplicationServiceCreateApplicationKeyRequest.__deepEquals(
        this.applicationId,
        (other as ApplicationServiceCreateApplicationKeyRequest).applicationId,
      )
    ) {
      return false;
    }
    if (
      !ApplicationServiceCreateApplicationKeyRequest.__deepEquals(
        this.projectId,
        (other as ApplicationServiceCreateApplicationKeyRequest).projectId,
      )
    ) {
      return false;
    }
    if (
      !ApplicationServiceCreateApplicationKeyRequest.__deepEquals(
        this.expirationDate,
        (other as ApplicationServiceCreateApplicationKeyRequest).expirationDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ApplicationServiceCreateApplicationKeyRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          ApplicationServiceCreateApplicationKeyRequest.__deepEquals(v, w),
        ),
      );
    }
