 ...
 */
export class BetaProjectServiceAny {
  /**
  ...
  constructor(data?: Partial<BetaProjectServiceAny>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaProjectServiceAny)) {
      return false;
    }
    if (
      !BetaProjectServiceAny.__deepEquals(
        this.type,
        (other as BetaProjectServiceAny).type,
      )
    ) {
      return false;
    }
    if (
      !BetaProjectServiceAny.__deepEquals(
        this.value,
        (other as BetaProjectServiceAny).value,
      )
    ) {
      return false;
    }
    if (
      !BetaProjectServiceAny.__deepEquals(
        this.debug,
        (other as BetaProjectServiceAny).debug,
      )
    ) {
      return false;
    }
    {
      ...
      for (const k of selfKeys) {
        ...
        if (!BetaProjectServiceAny.__deepEquals(selfRec[k], otherRec[k])) {
          return false;
        }
      }
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => BetaProjectServiceAny.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaProjectServiceAny.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !BetaProjectServiceAny.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaProjectServiceAny.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
