...
export class InstanceServiceTrustedDomainFilter {
  /**
  ...
  constructor(data?: Partial<InstanceServiceTrustedDomainFilter>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof InstanceServiceTrustedDomainFilter)) {
      return false;
    }
    if (
      !InstanceServiceTrustedDomainFilter.__deepEquals(
        this.domainFilter,
        (other as InstanceServiceTrustedDomainFilter).domainFilter,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        InstanceServiceTrustedDomainFilter.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          InstanceServiceTrustedDomainFilter.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !InstanceServiceTrustedDomainFilter.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          InstanceServiceTrustedDomainFilter.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
