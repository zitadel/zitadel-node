...
export class ProjectServiceActivateProjectGrantRequest {
  /**
  ...
  constructor(data?: Partial<ProjectServiceActivateProjectGrantRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ProjectServiceActivateProjectGrantRequest)) {
      return false;
    }
    if (
      !ProjectServiceActivateProjectGrantRequest.__deepEquals(
        this.projectId,
        (other as ProjectServiceActivateProjectGrantRequest).projectId,
      )
    ) {
      return false;
    }
    if (
      !ProjectServiceActivateProjectGrantRequest.__deepEquals(
        ...
        (other as ProjectServiceActivateProjectGrantRequest)
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ProjectServiceActivateProjectGrantRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          ProjectServiceActivateProjectGrantRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !ProjectServiceActivateProjectGrantRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ProjectServiceActivateProjectGrantRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
