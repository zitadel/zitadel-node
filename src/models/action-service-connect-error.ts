...
export class ActionServiceConnectError {
  ...
  constructor(data?: Partial<ActionServiceConnectError>) {
    ...
    if (this.code != null) {
      const codeValues = Object.values(
        ActionServiceConnectErrorCodeEnum,
      ).filter(
        (v) =>
          typeof (ActionServiceConnectErrorCodeEnum as Record<string, unknown>)[
            v as string
          ] !== "number",
      );
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ActionServiceConnectError)) {
      return false;
    }
    if (
      !ActionServiceConnectError.__deepEquals(
        this.code,
        (other as ActionServiceConnectError).code,
      )
    ) {
      return false;
    }
    if (
      !ActionServiceConnectError.__deepEquals(
        this.message,
        (other as ActionServiceConnectError).message,
      )
    ) {
      return false;
    }
    if (
      !ActionServiceConnectError.__deepEquals(
        this.details,
        (other as ActionServiceConnectError).details,
      )
    ) {
      return false;
    }
    {
      ...
      for (const k of selfKeys) {
        ...
        if (!ActionServiceConnectError.__deepEquals(selfRec[k], otherRec[k])) {
          return false;
        }
      }
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => ActionServiceConnectError.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => ActionServiceConnectError.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !ActionServiceConnectError.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ActionServiceConnectError.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
...
export enum ActionServiceConnectErrorCodeEnum {
  Canceled = "canceled",
  Unknown = "unknown",
