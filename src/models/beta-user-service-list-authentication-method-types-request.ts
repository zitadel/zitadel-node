...
export class BetaUserServiceListAuthenticationMethodTypesRequest {
  /**
  ...
  constructor(
    data?: Partial<BetaUserServiceListAuthenticationMethodTypesRequest>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !(other instanceof BetaUserServiceListAuthenticationMethodTypesRequest)
    ) {
      return false;
    }
    if (
      !BetaUserServiceListAuthenticationMethodTypesRequest.__deepEquals(
        this.userId,
        (other as BetaUserServiceListAuthenticationMethodTypesRequest).userId,
      )
    ) {
      return false;
    }
