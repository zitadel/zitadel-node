...
export class InstanceServiceCustomDomain {
  /**
  ...
  constructor(data?: Partial<InstanceServiceCustomDomain>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof InstanceServiceCustomDomain)) {
      return false;
    }
    if (
      !InstanceServiceCustomDomain.__deepEquals(
        this.instanceId,
        (other as InstanceServiceCustomDomain).instanceId,
      )
    ) {
      return false;
    }
    if (
      !InstanceServiceCustomDomain.__deepEquals(
        this.creationDate,
        (other as InstanceServiceCustomDomain).creationDate,
      )
    ) {
      return false;
    }
    if (
      !InstanceServiceCustomDomain.__deepEquals(
        this.domain,
        (other as InstanceServiceCustomDomain).domain,
      )
    ) {
      return false;
    }
    if (
      !InstanceServiceCustomDomain.__deepEquals(
        this.primary,
        (other as InstanceServiceCustomDomain).primary,
      )
    ) {
      return false;
    }
    if (
      !InstanceServiceCustomDomain.__deepEquals(
        this.generated,
        (other as InstanceServiceCustomDomain).generated,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        InstanceServiceCustomDomain.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => InstanceServiceCustomDomain.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !InstanceServiceCustomDomain.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          InstanceServiceCustomDomain.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
