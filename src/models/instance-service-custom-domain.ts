 ...
 * 
 * @export
 * @interface InstanceServiceCustomDomain
 */
export interface InstanceServiceCustomDomain {
    /**
     * InstanceID is the unique identifier of the instance the domain belongs to.
     * @type {string}
     * @memberof InstanceServiceCustomDomain
     */
    instanceId?: string;
    /**
...
/**
 * Check if a given object implements the InstanceServiceCustomDomain interface.
 */
export function instanceOfInstanceServiceCustomDomain(value: object): value is InstanceServiceCustomDomain {
    return true;
}

export function InstanceServiceCustomDomainFromJSON(json: any): InstanceServiceCustomDomain {
    return InstanceServiceCustomDomainFromJSONTyped(json, false);
}

export function InstanceServiceCustomDomainFromJSONTyped(json: any, ignoreDiscriminator: boolean): InstanceServiceCustomDomain {
    if (json == null) {
        return json;
    }
    return {
...
export function InstanceServiceCustomDomainToJSON(json: any): InstanceServiceCustomDomain {
    return InstanceServiceCustomDomainToJSONTyped(json, false);
}

export function InstanceServiceCustomDomainToJSONTyped(value?: InstanceServiceCustomDomain | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
