...
export class BetaInstanceServiceAddTrustedDomainResponse {
  /**
  ...
  constructor(data?: Partial<BetaInstanceServiceAddTrustedDomainResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaInstanceServiceAddTrustedDomainResponse)) {
      return false;
    }
    if (
      !BetaInstanceServiceAddTrustedDomainResponse.__deepEquals(
        this.creationDate,
        (other as BetaInstanceServiceAddTrustedDomainResponse).creationDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaInstanceServiceAddTrustedDomainResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaInstanceServiceAddTrustedDomainResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaInstanceServiceAddTrustedDomainResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
