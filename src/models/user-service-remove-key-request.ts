...
export class UserServiceRemoveKeyRequest {
  /**
  ...
  constructor(data?: Partial<UserServiceRemoveKeyRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceRemoveKeyRequest)) {
      return false;
    }
    if (
      !UserServiceRemoveKeyRequest.__deepEquals(
        this.userId,
        (other as UserServiceRemoveKeyRequest).userId,
      )
    ) {
      return false;
    }
    if (
      !UserServiceRemoveKeyRequest.__deepEquals(
        this.keyId,
        (other as UserServiceRemoveKeyRequest).keyId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceRemoveKeyRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceRemoveKeyRequest.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceRemoveKeyRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceRemoveKeyRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
