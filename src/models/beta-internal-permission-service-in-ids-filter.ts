...
export class BetaInternalPermissionServiceInIDsFilter {
  /**
  ...
  constructor(data?: Partial<BetaInternalPermissionServiceInIDsFilter>) {
    Object.assign(this, data);
    if (
      this.ids != null &&
      !Array.isArray(this.ids) &&
      !((this.ids as unknown) instanceof Set)
    ) {
      throw new TypeError(`ids must be an array, got ${typeof this.ids}`);
    }
  }
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaInternalPermissionServiceInIDsFilter)) {
      return false;
    }
    if (
      !BetaInternalPermissionServiceInIDsFilter.__deepEquals(
        this.ids,
        (other as BetaInternalPermissionServiceInIDsFilter).ids,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaInternalPermissionServiceInIDsFilter.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaInternalPermissionServiceInIDsFilter.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaInternalPermissionServiceInIDsFilter.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaInternalPermissionServiceInIDsFilter.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
