 ...
 */
export class BetaUserServiceAndQuery {
  /**
  ...
  constructor(data?: Partial<BetaUserServiceAndQuery>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaUserServiceAndQuery)) {
      return false;
    }
    if (
      !BetaUserServiceAndQuery.__deepEquals(
        this.queries,
        (other as BetaUserServiceAndQuery).queries,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => BetaUserServiceAndQuery.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaUserServiceAndQuery.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !BetaUserServiceAndQuery.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaUserServiceAndQuery.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
