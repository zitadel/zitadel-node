...
export class ApplicationServiceUpdateOIDCApplicationConfigurationRequest {
  /**
  ...
  constructor(
    data?: Partial<ApplicationServiceUpdateOIDCApplicationConfigurationRequest>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !ApplicationServiceUpdateOIDCApplicationConfigurationRequest.__deepEquals(
        this.redirectUris,
        (other as ApplicationServiceUpdateOIDCApplicationConfigurationRequest)
          .redirectUris,
      )
    ) {
      return false;
