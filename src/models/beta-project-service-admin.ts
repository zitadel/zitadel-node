...
export class BetaProjectServiceAdmin {
  /**
  ...
  constructor(data?: Partial<BetaProjectServiceAdmin>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaProjectServiceAdmin)) {
      return false;
    }
    if (
      !BetaProjectServiceAdmin.__deepEquals(
        this.userId,
        (other as BetaProjectServiceAdmin).userId,
      )
    ) {
      return false;
    }
    if (
      !BetaProjectServiceAdmin.__deepEquals(
        this.roles,
        (other as BetaProjectServiceAdmin).roles,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => BetaProjectServiceAdmin.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaProjectServiceAdmin.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !BetaProjectServiceAdmin.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaProjectServiceAdmin.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
