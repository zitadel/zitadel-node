...
export class UserServiceRemoveOTPSMSRequest {
  /**
  ...
  constructor(data?: Partial<UserServiceRemoveOTPSMSRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceRemoveOTPSMSRequest)) {
      return false;
    }
    if (
      !UserServiceRemoveOTPSMSRequest.__deepEquals(
        this.userId,
        (other as UserServiceRemoveOTPSMSRequest).userId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceRemoveOTPSMSRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceRemoveOTPSMSRequest.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceRemoveOTPSMSRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceRemoveOTPSMSRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
