...
export class FeatureServiceGetOrganizationFeaturesRequest {
  /**
  ...
  constructor(data?: Partial<FeatureServiceGetOrganizationFeaturesRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof FeatureServiceGetOrganizationFeaturesRequest)) {
      return false;
    }
    if (
      !FeatureServiceGetOrganizationFeaturesRequest.__deepEquals(
        this.organizationId,
        (other as FeatureServiceGetOrganizationFeaturesRequest).organizationId,
      )
    ) {
      return false;
    }
    if (
      !FeatureServiceGetOrganizationFeaturesRequest.__deepEquals(
        this.inheritance,
        (other as FeatureServiceGetOrganizationFeaturesRequest).inheritance,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        FeatureServiceGetOrganizationFeaturesRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          FeatureServiceGetOrganizationFeaturesRequest.__deepEquals(v, w),
        ),
      );
    }
