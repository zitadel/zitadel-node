...
export class InstanceServiceUpdateInstanceRequest {
  /**
  ...
  constructor(data?: Partial<InstanceServiceUpdateInstanceRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof InstanceServiceUpdateInstanceRequest)) {
      return false;
    }
    if (
      !InstanceServiceUpdateInstanceRequest.__deepEquals(
        this.instanceId,
        (other as InstanceServiceUpdateInstanceRequest).instanceId,
      )
    ) {
      return false;
    }
    if (
      !InstanceServiceUpdateInstanceRequest.__deepEquals(
        this.instanceName,
        (other as InstanceServiceUpdateInstanceRequest).instanceName,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        InstanceServiceUpdateInstanceRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          InstanceServiceUpdateInstanceRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !InstanceServiceUpdateInstanceRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          InstanceServiceUpdateInstanceRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
