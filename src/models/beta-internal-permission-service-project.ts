...
export class BetaInternalPermissionServiceProject {
  /**
  ...
  constructor(data?: Partial<BetaInternalPermissionServiceProject>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaInternalPermissionServiceProject)) {
      return false;
    }
    if (
      !BetaInternalPermissionServiceProject.__deepEquals(
        this.id,
        (other as BetaInternalPermissionServiceProject).id,
      )
    ) {
      return false;
    }
    if (
      !BetaInternalPermissionServiceProject.__deepEquals(
        this.name,
        (other as BetaInternalPermissionServiceProject).name,
      )
    ) {
      return false;
    }
    if (
      !BetaInternalPermissionServiceProject.__deepEquals(
        this.organizationId,
        (other as BetaInternalPermissionServiceProject).organizationId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaInternalPermissionServiceProject.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaInternalPermissionServiceProject.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaInternalPermissionServiceProject.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaInternalPermissionServiceProject.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
