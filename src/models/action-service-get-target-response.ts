...
export class ActionServiceGetTargetResponse {
  /**
  ...
  constructor(data?: Partial<ActionServiceGetTargetResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ActionServiceGetTargetResponse)) {
      return false;
    }
    if (
      !ActionServiceGetTargetResponse.__deepEquals(
        this.target,
        (other as ActionServiceGetTargetResponse).target,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ActionServiceGetTargetResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => ActionServiceGetTargetResponse.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !ActionServiceGetTargetResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ActionServiceGetTargetResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
