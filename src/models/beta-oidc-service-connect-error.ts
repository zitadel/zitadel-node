...
import { BetaOIDCServiceAny } from "./beta-oidc-service-any.js";
import { Expose, Type } from "class-transformer";

/**
 * Error type returned by Connect: https://connectrpc.com/docs/go/errors/#http-representation
 */
export class BetaOIDCServiceConnectError {
  /**
  ...
  constructor(data?: Partial<BetaOIDCServiceConnectError>) {
    ...
    if (this.code != null) {
      const codeValues = Object.values(
        BetaOIDCServiceConnectErrorCodeEnum,
      ).filter(
        (v) =>
          typeof (
            BetaOIDCServiceConnectErrorCodeEnum as Record<string, unknown>
          )[v as string] !== "number",
      );
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaOIDCServiceConnectError)) {
      return false;
    }
    if (
      !BetaOIDCServiceConnectError.__deepEquals(
        this.code,
        (other as BetaOIDCServiceConnectError).code,
      )
    ) {
      return false;
    }
    if (
      !BetaOIDCServiceConnectError.__deepEquals(
        this.message,
        (other as BetaOIDCServiceConnectError).message,
      )
    ) {
      return false;
    }
    if (
      !BetaOIDCServiceConnectError.__deepEquals(
        this.details,
        (other as BetaOIDCServiceConnectError).details,
      )
    ) {
      return false;
    }
    {
      ...
      for (const k of selfKeys) {
        ...
        if (
          !BetaOIDCServiceConnectError.__deepEquals(selfRec[k], otherRec[k])
        ) {
          return false;
        }
      }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaOIDCServiceConnectError.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaOIDCServiceConnectError.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaOIDCServiceConnectError.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaOIDCServiceConnectError.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
...
export enum BetaOIDCServiceConnectErrorCodeEnum {
  Canceled = "canceled",
  Unknown = "unknown",
