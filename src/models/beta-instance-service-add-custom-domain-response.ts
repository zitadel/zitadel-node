...
export class BetaInstanceServiceAddCustomDomainResponse {
  /**
  ...
  constructor(data?: Partial<BetaInstanceServiceAddCustomDomainResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaInstanceServiceAddCustomDomainResponse)) {
      return false;
    }
    if (
      !BetaInstanceServiceAddCustomDomainResponse.__deepEquals(
        this.creationDate,
        (other as BetaInstanceServiceAddCustomDomainResponse).creationDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaInstanceServiceAddCustomDomainResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaInstanceServiceAddCustomDomainResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaInstanceServiceAddCustomDomainResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaInstanceServiceAddCustomDomainResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
