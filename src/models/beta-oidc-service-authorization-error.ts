...
import { BetaOIDCServiceErrorReason } from "./beta-oidc-service-error-reason.js";
...
export class BetaOIDCServiceAuthorizationError {
  ...
  constructor(data?: Partial<BetaOIDCServiceAuthorizationError>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaOIDCServiceAuthorizationError)) {
      return false;
    }
    if (
      !BetaOIDCServiceAuthorizationError.__deepEquals(
        this.error,
        (other as BetaOIDCServiceAuthorizationError).error,
      )
    ) {
      return false;
    }
    if (
      !BetaOIDCServiceAuthorizationError.__deepEquals(
        ...
        (other as BetaOIDCServiceAuthorizationError).errorDescription,
      )
    ) {
      return false;
    }
    if (
      !BetaOIDCServiceAuthorizationError.__deepEquals(
        this.errorUri,
        (other as BetaOIDCServiceAuthorizationError).errorUri,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaOIDCServiceAuthorizationError.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaOIDCServiceAuthorizationError.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaOIDCServiceAuthorizationError.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaOIDCServiceAuthorizationError.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
