...
export class OrganizationServiceDeleteOrganizationResponse {
  /**
  ...
  constructor(data?: Partial<OrganizationServiceDeleteOrganizationResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof OrganizationServiceDeleteOrganizationResponse)) {
      return false;
    }
    if (
      !OrganizationServiceDeleteOrganizationResponse.__deepEquals(
        this.deletionDate,
        (other as OrganizationServiceDeleteOrganizationResponse).deletionDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        OrganizationServiceDeleteOrganizationResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          OrganizationServiceDeleteOrganizationResponse.__deepEquals(v, w),
        ),
      );
    }
