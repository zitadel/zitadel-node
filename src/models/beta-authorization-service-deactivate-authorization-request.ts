...
export class BetaAuthorizationServiceDeactivateAuthorizationRequest {
  /**
  ...
  constructor(
    data?: Partial<BetaAuthorizationServiceDeactivateAuthorizationRequest>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !(other instanceof BetaAuthorizationServiceDeactivateAuthorizationRequest)
    ) {
      return false;
    }
    if (
      !BetaAuthorizationServiceDeactivateAuthorizationRequest.__deepEquals(
        this.id,
        (other as BetaAuthorizationServiceDeactivateAuthorizationRequest).id,
      )
    ) {
      return false;
    }
