...
export class BetaOrganizationServiceDeactivateOrganizationRequest {
  /**
  ...
  constructor(
    data?: Partial<BetaOrganizationServiceDeactivateOrganizationRequest>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !(other instanceof BetaOrganizationServiceDeactivateOrganizationRequest)
    ) {
      return false;
    }
    if (
      !BetaOrganizationServiceDeactivateOrganizationRequest.__deepEquals(
        this.id,
        (other as BetaOrganizationServiceDeactivateOrganizationRequest).id,
      )
    ) {
      return false;
    }
