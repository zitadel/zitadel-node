...
export class OrganizationServiceUpdateOrganizationRequest {
  /**
  ...
  constructor(data?: Partial<OrganizationServiceUpdateOrganizationRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof OrganizationServiceUpdateOrganizationRequest)) {
      return false;
    }
    if (
      !OrganizationServiceUpdateOrganizationRequest.__deepEquals(
        this.organizationId,
        (other as OrganizationServiceUpdateOrganizationRequest).organizationId,
      )
    ) {
      return false;
    }
    if (
      !OrganizationServiceUpdateOrganizationRequest.__deepEquals(
        this.name,
        (other as OrganizationServiceUpdateOrganizationRequest).name,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        OrganizationServiceUpdateOrganizationRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          OrganizationServiceUpdateOrganizationRequest.__deepEquals(v, w),
        ),
      );
    }
