...
export class UserServiceCreateUserResponse {
  /**
  ...
  constructor(data?: Partial<UserServiceCreateUserResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceCreateUserResponse)) {
      return false;
    }
    if (
      !UserServiceCreateUserResponse.__deepEquals(
        this.id,
        (other as UserServiceCreateUserResponse).id,
      )
    ) {
      return false;
    }
    if (
      !UserServiceCreateUserResponse.__deepEquals(
        this.creationDate,
        (other as UserServiceCreateUserResponse).creationDate,
      )
    ) {
      return false;
    }
    if (
      !UserServiceCreateUserResponse.__deepEquals(
        this.emailCode,
        (other as UserServiceCreateUserResponse).emailCode,
      )
    ) {
      return false;
    }
    if (
      !UserServiceCreateUserResponse.__deepEquals(
        this.phoneCode,
        (other as UserServiceCreateUserResponse).phoneCode,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceCreateUserResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceCreateUserResponse.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceCreateUserResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceCreateUserResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
