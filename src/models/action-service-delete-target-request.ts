...
export class ActionServiceDeleteTargetRequest {
  /**
  ...
  constructor(data?: Partial<ActionServiceDeleteTargetRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ActionServiceDeleteTargetRequest)) {
      return false;
    }
    if (
      !ActionServiceDeleteTargetRequest.__deepEquals(
        this.id,
        (other as ActionServiceDeleteTargetRequest).id,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ActionServiceDeleteTargetRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => ActionServiceDeleteTargetRequest.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !ActionServiceDeleteTargetRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ActionServiceDeleteTargetRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
