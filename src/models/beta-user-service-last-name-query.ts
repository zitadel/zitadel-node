 ...
 */
export class BetaUserServiceLastNameQuery {
  /**
  ...
  constructor(data?: Partial<BetaUserServiceLastNameQuery>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaUserServiceLastNameQuery)) {
      return false;
    }
    if (
      !BetaUserServiceLastNameQuery.__deepEquals(
        this.lastName,
        (other as BetaUserServiceLastNameQuery).lastName,
      )
    ) {
      return false;
    }
    if (
      !BetaUserServiceLastNameQuery.__deepEquals(
        this.method,
        (other as BetaUserServiceLastNameQuery).method,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaUserServiceLastNameQuery.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaUserServiceLastNameQuery.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaUserServiceLastNameQuery.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaUserServiceLastNameQuery.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
