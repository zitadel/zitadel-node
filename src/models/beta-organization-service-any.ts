 ...
 */
export class BetaOrganizationServiceAny {
  /**
  ...
  constructor(data?: Partial<BetaOrganizationServiceAny>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaOrganizationServiceAny)) {
      return false;
    }
    if (
      !BetaOrganizationServiceAny.__deepEquals(
        this.type,
        (other as BetaOrganizationServiceAny).type,
      )
    ) {
      return false;
    }
    if (
      !BetaOrganizationServiceAny.__deepEquals(
        this.value,
        (other as BetaOrganizationServiceAny).value,
      )
    ) {
      return false;
    }
    if (
      !BetaOrganizationServiceAny.__deepEquals(
        this.debug,
        (other as BetaOrganizationServiceAny).debug,
      )
    ) {
      return false;
    }
    {
      ...
      for (const k of selfKeys) {
        ...
        if (!BetaOrganizationServiceAny.__deepEquals(selfRec[k], otherRec[k])) {
          return false;
        }
      }
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaOrganizationServiceAny.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaOrganizationServiceAny.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaOrganizationServiceAny.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaOrganizationServiceAny.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
