...
export class BetaActionServicePaginationRequest {
  /**
  ...
  constructor(data?: Partial<BetaActionServicePaginationRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaActionServicePaginationRequest)) {
      return false;
    }
    if (
      !BetaActionServicePaginationRequest.__deepEquals(
        this.offset,
        (other as BetaActionServicePaginationRequest).offset,
      )
    ) {
      return false;
    }
    if (
      !BetaActionServicePaginationRequest.__deepEquals(
        this.limit,
        (other as BetaActionServicePaginationRequest).limit,
      )
    ) {
      return false;
    }
    if (
      !BetaActionServicePaginationRequest.__deepEquals(
        this.asc,
        (other as BetaActionServicePaginationRequest).asc,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaActionServicePaginationRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaActionServicePaginationRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaActionServicePaginationRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaActionServicePaginationRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
