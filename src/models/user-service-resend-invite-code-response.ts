...
export class UserServiceResendInviteCodeResponse {
  /**
  ...
  constructor(data?: Partial<UserServiceResendInviteCodeResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceResendInviteCodeResponse)) {
      return false;
    }
    if (
      !UserServiceResendInviteCodeResponse.__deepEquals(
        this.details,
        (other as UserServiceResendInviteCodeResponse).details,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceResendInviteCodeResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          UserServiceResendInviteCodeResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceResendInviteCodeResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceResendInviteCodeResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
