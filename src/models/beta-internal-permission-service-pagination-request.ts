...
export class BetaInternalPermissionServicePaginationRequest {
  /**
  ...
  constructor(data?: Partial<BetaInternalPermissionServicePaginationRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaInternalPermissionServicePaginationRequest)) {
      return false;
    }
    if (
      !BetaInternalPermissionServicePaginationRequest.__deepEquals(
        this.offset,
        (other as BetaInternalPermissionServicePaginationRequest).offset,
      )
    ) {
      return false;
    }
    if (
      !BetaInternalPermissionServicePaginationRequest.__deepEquals(
        this.limit,
        (other as BetaInternalPermissionServicePaginationRequest).limit,
      )
    ) {
      return false;
    }
    if (
      !BetaInternalPermissionServicePaginationRequest.__deepEquals(
        this.asc,
        (other as BetaInternalPermissionServicePaginationRequest).asc,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaInternalPermissionServicePaginationRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaInternalPermissionServicePaginationRequest.__deepEquals(v, w),
        ),
      );
    }
