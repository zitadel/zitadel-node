...
export class SessionServiceSetSessionResponse {
  /**
  ...
  constructor(data?: Partial<SessionServiceSetSessionResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof SessionServiceSetSessionResponse)) {
      return false;
    }
    if (
      !SessionServiceSetSessionResponse.__deepEquals(
        this.details,
        (other as SessionServiceSetSessionResponse).details,
      )
    ) {
      return false;
    }
    if (
      !SessionServiceSetSessionResponse.__deepEquals(
        this.sessionToken,
        (other as SessionServiceSetSessionResponse).sessionToken,
      )
    ) {
      return false;
    }
    if (
      !SessionServiceSetSessionResponse.__deepEquals(
        this.challenges,
        (other as SessionServiceSetSessionResponse).challenges,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        SessionServiceSetSessionResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => SessionServiceSetSessionResponse.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !SessionServiceSetSessionResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          SessionServiceSetSessionResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
