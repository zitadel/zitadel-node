...
export class AuthorizationServiceDeactivateAuthorizationRequest {
  /**
  ...
  constructor(
    data?: Partial<AuthorizationServiceDeactivateAuthorizationRequest>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !(other instanceof AuthorizationServiceDeactivateAuthorizationRequest)
    ) {
      return false;
    }
    if (
      !AuthorizationServiceDeactivateAuthorizationRequest.__deepEquals(
        this.id,
        (other as AuthorizationServiceDeactivateAuthorizationRequest).id,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          AuthorizationServiceDeactivateAuthorizationRequest.__deepEquals(v, w),
        ),
      );
    }
