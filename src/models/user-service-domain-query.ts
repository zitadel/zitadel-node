...
export class UserServiceDomainQuery {
  /**
   ...
   */
  @Expose({ name: "includeWithoutDomain" })
  ...
  constructor(data?: Partial<UserServiceDomainQuery>) {
    Object.assign(this, data);
    if (
      this.includeWithoutDomain != null &&
      typeof this.includeWithoutDomain !== "boolean"
    ) {
      throw new TypeError(
        `includeWithoutDomain must be a boolean, got ${typeof this.includeWithoutDomain}`,
      );
    }
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceDomainQuery)) {
      return false;
    }
    if (
      !UserServiceDomainQuery.__deepEquals(
        this.includeWithoutDomain,
        (other as UserServiceDomainQuery).includeWithoutDomain,
      )
    ) {
      return false;
    }
    if (
      !UserServiceDomainQuery.__deepEquals(
        this.domain,
        (other as UserServiceDomainQuery).domain,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => UserServiceDomainQuery.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceDomainQuery.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !UserServiceDomainQuery.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceDomainQuery.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
