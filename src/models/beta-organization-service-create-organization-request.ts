...
import { BetaOrganizationServiceAdmin } from "./beta-organization-service-admin.js";
import { Expose, Type } from "class-transformer";

export class BetaOrganizationServiceCreateOrganizationRequest {
  /**
  ...
  constructor(
    data?: Partial<BetaOrganizationServiceCreateOrganizationRequest>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaOrganizationServiceCreateOrganizationRequest)) {
      return false;
    }
    if (
      !BetaOrganizationServiceCreateOrganizationRequest.__deepEquals(
        this.name,
        (other as BetaOrganizationServiceCreateOrganizationRequest).name,
      )
    ) {
      return false;
    }
    if (
      !BetaOrganizationServiceCreateOrganizationRequest.__deepEquals(
        this.id,
        (other as BetaOrganizationServiceCreateOrganizationRequest).id,
      )
    ) {
      return false;
    }
    if (
      !BetaOrganizationServiceCreateOrganizationRequest.__deepEquals(
        this.admins,
        (other as BetaOrganizationServiceCreateOrganizationRequest).admins,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaOrganizationServiceCreateOrganizationRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaOrganizationServiceCreateOrganizationRequest.__deepEquals(v, w),
        ),
      );
    }
