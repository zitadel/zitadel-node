...
export class BetaUserServiceVerifyPhoneResponse {
  /**
  ...
  constructor(data?: Partial<BetaUserServiceVerifyPhoneResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaUserServiceVerifyPhoneResponse)) {
      return false;
    }
    if (
      !BetaUserServiceVerifyPhoneResponse.__deepEquals(
        this.details,
        (other as BetaUserServiceVerifyPhoneResponse).details,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaUserServiceVerifyPhoneResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaUserServiceVerifyPhoneResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaUserServiceVerifyPhoneResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaUserServiceVerifyPhoneResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
