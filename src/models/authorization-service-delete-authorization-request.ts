...
export class AuthorizationServiceDeleteAuthorizationRequest {
  /**
  ...
  constructor(data?: Partial<AuthorizationServiceDeleteAuthorizationRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof AuthorizationServiceDeleteAuthorizationRequest)) {
      return false;
    }
    if (
      !AuthorizationServiceDeleteAuthorizationRequest.__deepEquals(
        this.id,
        (other as AuthorizationServiceDeleteAuthorizationRequest).id,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        AuthorizationServiceDeleteAuthorizationRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          AuthorizationServiceDeleteAuthorizationRequest.__deepEquals(v, w),
        ),
      );
    }
