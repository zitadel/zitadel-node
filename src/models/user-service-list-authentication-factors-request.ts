...
export class UserServiceListAuthenticationFactorsRequest {
  ...
  constructor(data?: Partial<UserServiceListAuthenticationFactorsRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceListAuthenticationFactorsRequest)) {
      return false;
    }
    if (
      !UserServiceListAuthenticationFactorsRequest.__deepEquals(
        this.userId,
        (other as UserServiceListAuthenticationFactorsRequest).userId,
      )
    ) {
      return false;
    }
    if (
      !UserServiceListAuthenticationFactorsRequest.__deepEquals(
        this.authFactors,
        (other as UserServiceListAuthenticationFactorsRequest).authFactors,
      )
    ) {
      return false;
    }
    if (
      !UserServiceListAuthenticationFactorsRequest.__deepEquals(
        this.states,
        (other as UserServiceListAuthenticationFactorsRequest).states,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceListAuthenticationFactorsRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          UserServiceListAuthenticationFactorsRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceListAuthenticationFactorsRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
