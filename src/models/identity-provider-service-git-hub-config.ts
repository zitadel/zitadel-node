...
export class IdentityProviderServiceGitHubConfig {
  /**
  ...
  constructor(data?: Partial<IdentityProviderServiceGitHubConfig>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof IdentityProviderServiceGitHubConfig)) {
      return false;
    }
    if (
      !IdentityProviderServiceGitHubConfig.__deepEquals(
        this.clientId,
        (other as IdentityProviderServiceGitHubConfig).clientId,
      )
    ) {
      return false;
    }
    if (
      !IdentityProviderServiceGitHubConfig.__deepEquals(
        this.scopes,
        (other as IdentityProviderServiceGitHubConfig).scopes,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        IdentityProviderServiceGitHubConfig.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          IdentityProviderServiceGitHubConfig.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !IdentityProviderServiceGitHubConfig.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          IdentityProviderServiceGitHubConfig.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
