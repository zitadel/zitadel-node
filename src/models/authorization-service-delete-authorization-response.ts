...
export class AuthorizationServiceDeleteAuthorizationResponse {
  /**
  ...
  constructor(data?: Partial<AuthorizationServiceDeleteAuthorizationResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof AuthorizationServiceDeleteAuthorizationResponse)) {
      return false;
    }
    if (
      !AuthorizationServiceDeleteAuthorizationResponse.__deepEquals(
        this.deletionDate,
        (other as AuthorizationServiceDeleteAuthorizationResponse).deletionDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        AuthorizationServiceDeleteAuthorizationResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          AuthorizationServiceDeleteAuthorizationResponse.__deepEquals(v, w),
        ),
      );
    }
