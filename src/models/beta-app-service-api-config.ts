...
export class BetaAppServiceAPIConfig {
  /**
  ...
  constructor(data?: Partial<BetaAppServiceAPIConfig>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaAppServiceAPIConfig)) {
      return false;
    }
    if (
      !BetaAppServiceAPIConfig.__deepEquals(
        this.clientId,
        (other as BetaAppServiceAPIConfig).clientId,
      )
    ) {
      return false;
    }
    if (
      !BetaAppServiceAPIConfig.__deepEquals(
        this.authMethodType,
        (other as BetaAppServiceAPIConfig).authMethodType,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => BetaAppServiceAPIConfig.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaAppServiceAPIConfig.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !BetaAppServiceAPIConfig.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaAppServiceAPIConfig.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
