...
export class ApplicationServiceCreateApplicationKeyResponse {
  /**
  ...
  constructor(data?: Partial<ApplicationServiceCreateApplicationKeyResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ApplicationServiceCreateApplicationKeyResponse)) {
      return false;
    }
    if (
      !ApplicationServiceCreateApplicationKeyResponse.__deepEquals(
        this.keyId,
        (other as ApplicationServiceCreateApplicationKeyResponse).keyId,
      )
    ) {
      return false;
    }
    if (
      !ApplicationServiceCreateApplicationKeyResponse.__deepEquals(
        this.creationDate,
        (other as ApplicationServiceCreateApplicationKeyResponse).creationDate,
      )
    ) {
      return false;
    }
    if (
      !ApplicationServiceCreateApplicationKeyResponse.__deepEquals(
        this.keyDetails,
        (other as ApplicationServiceCreateApplicationKeyResponse).keyDetails,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ApplicationServiceCreateApplicationKeyResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          ApplicationServiceCreateApplicationKeyResponse.__deepEquals(v, w),
        ),
      );
    }
