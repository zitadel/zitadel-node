...
export class BetaOrganizationServiceDeleteOrganizationMetadataRequest {
  /**
  ...
  constructor(
    data?: Partial<BetaOrganizationServiceDeleteOrganizationMetadataRequest>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !BetaOrganizationServiceDeleteOrganizationMetadataRequest.__deepEquals(
        this.organizationId,
        (other as BetaOrganizationServiceDeleteOrganizationMetadataRequest)
          .organizationId,
      )
    ) {
      return false;
