...
export class BetaUserServiceAddIDPLinkResponse {
  /**
  ...
  constructor(data?: Partial<BetaUserServiceAddIDPLinkResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaUserServiceAddIDPLinkResponse)) {
      return false;
    }
    if (
      !BetaUserServiceAddIDPLinkResponse.__deepEquals(
        this.details,
        (other as BetaUserServiceAddIDPLinkResponse).details,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaUserServiceAddIDPLinkResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaUserServiceAddIDPLinkResponse.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaUserServiceAddIDPLinkResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaUserServiceAddIDPLinkResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
