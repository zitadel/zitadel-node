...
export class SessionServiceRecoveryCodeFactor {
  /**
  ...
  constructor(data?: Partial<SessionServiceRecoveryCodeFactor>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof SessionServiceRecoveryCodeFactor)) {
      return false;
    }
    if (
      !SessionServiceRecoveryCodeFactor.__deepEquals(
        this.verifiedAt,
        (other as SessionServiceRecoveryCodeFactor).verifiedAt,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        SessionServiceRecoveryCodeFactor.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => SessionServiceRecoveryCodeFactor.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !SessionServiceRecoveryCodeFactor.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          SessionServiceRecoveryCodeFactor.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
