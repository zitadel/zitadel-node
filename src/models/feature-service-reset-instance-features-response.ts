...
export class FeatureServiceResetInstanceFeaturesResponse {
  /**
  ...
  constructor(data?: Partial<FeatureServiceResetInstanceFeaturesResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof FeatureServiceResetInstanceFeaturesResponse)) {
      return false;
    }
    if (
      !FeatureServiceResetInstanceFeaturesResponse.__deepEquals(
        this.details,
        (other as FeatureServiceResetInstanceFeaturesResponse).details,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        FeatureServiceResetInstanceFeaturesResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          FeatureServiceResetInstanceFeaturesResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !FeatureServiceResetInstanceFeaturesResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
