 ...
 */
export class UserServiceInUserIDQuery {
  /**
  ...
  constructor(data?: Partial<UserServiceInUserIDQuery>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceInUserIDQuery)) {
      return false;
    }
    if (
      !UserServiceInUserIDQuery.__deepEquals(
        this.userIds,
        (other as UserServiceInUserIDQuery).userIds,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => UserServiceInUserIDQuery.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceInUserIDQuery.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !UserServiceInUserIDQuery.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceInUserIDQuery.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
