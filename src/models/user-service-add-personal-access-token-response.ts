...
export class UserServiceAddPersonalAccessTokenResponse {
  /**
  ...
  constructor(data?: Partial<UserServiceAddPersonalAccessTokenResponse>) {
    Object.assign(this, data);
    if (this.tokenId != null && typeof this.tokenId !== "string") {
      throw new TypeError(
        `tokenId must be a string, got ${typeof this.tokenId}`,
      );
    }
    if (this.token != null && typeof this.token !== "string") {
      throw new TypeError(`token must be a string, got ${typeof this.token}`);
    }
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceAddPersonalAccessTokenResponse)) {
      return false;
    }
    if (
      !UserServiceAddPersonalAccessTokenResponse.__deepEquals(
        this.creationDate,
        (other as UserServiceAddPersonalAccessTokenResponse).creationDate,
      )
    ) {
      return false;
    }
    if (
      !UserServiceAddPersonalAccessTokenResponse.__deepEquals(
        this.tokenId,
        (other as UserServiceAddPersonalAccessTokenResponse).tokenId,
      )
    ) {
      return false;
    }
    if (
      !UserServiceAddPersonalAccessTokenResponse.__deepEquals(
        this.token,
        (other as UserServiceAddPersonalAccessTokenResponse).token,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceAddPersonalAccessTokenResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          UserServiceAddPersonalAccessTokenResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceAddPersonalAccessTokenResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceAddPersonalAccessTokenResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
