...
export class UserServiceMetadataSearchFilter {
  /**
  ...
  constructor(data?: Partial<UserServiceMetadataSearchFilter>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceMetadataSearchFilter)) {
      return false;
    }
    if (
      !UserServiceMetadataSearchFilter.__deepEquals(
        this.keyFilter,
        (other as UserServiceMetadataSearchFilter).keyFilter,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceMetadataSearchFilter.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceMetadataSearchFilter.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceMetadataSearchFilter.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceMetadataSearchFilter.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
