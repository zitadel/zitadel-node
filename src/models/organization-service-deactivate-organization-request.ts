...
export class OrganizationServiceDeactivateOrganizationRequest {
  /**
  ...
  constructor(
    data?: Partial<OrganizationServiceDeactivateOrganizationRequest>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof OrganizationServiceDeactivateOrganizationRequest)) {
      return false;
    }
    if (
      !OrganizationServiceDeactivateOrganizationRequest.__deepEquals(
        this.organizationId,
        (other as OrganizationServiceDeactivateOrganizationRequest)
          .organizationId,
      )
    ) {
      return false;
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        OrganizationServiceDeactivateOrganizationRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          OrganizationServiceDeactivateOrganizationRequest.__deepEquals(v, w),
        ),
      );
    }
