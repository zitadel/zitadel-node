...
export class OrganizationServiceSetMetadataEntry {
  /**
  ...
  constructor(data?: Partial<OrganizationServiceSetMetadataEntry>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof OrganizationServiceSetMetadataEntry)) {
      return false;
    }
    if (
      !OrganizationServiceSetMetadataEntry.__deepEquals(
        this.key,
        (other as OrganizationServiceSetMetadataEntry).key,
      )
    ) {
      return false;
    }
    if (
      !OrganizationServiceSetMetadataEntry.__deepEquals(
        this.value,
        (other as OrganizationServiceSetMetadataEntry).value,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        OrganizationServiceSetMetadataEntry.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          OrganizationServiceSetMetadataEntry.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !OrganizationServiceSetMetadataEntry.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          OrganizationServiceSetMetadataEntry.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
