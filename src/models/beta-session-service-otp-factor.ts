...
export class BetaSessionServiceOTPFactor {
  /**
  ...
  constructor(data?: Partial<BetaSessionServiceOTPFactor>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaSessionServiceOTPFactor)) {
      return false;
    }
    if (
      !BetaSessionServiceOTPFactor.__deepEquals(
        this.verifiedAt,
        (other as BetaSessionServiceOTPFactor).verifiedAt,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaSessionServiceOTPFactor.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaSessionServiceOTPFactor.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaSessionServiceOTPFactor.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaSessionServiceOTPFactor.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
