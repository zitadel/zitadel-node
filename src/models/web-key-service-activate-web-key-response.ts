...
export class WebKeyServiceActivateWebKeyResponse {
  /**
  ...
  constructor(data?: Partial<WebKeyServiceActivateWebKeyResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof WebKeyServiceActivateWebKeyResponse)) {
      return false;
    }
    if (
      !WebKeyServiceActivateWebKeyResponse.__deepEquals(
        this.changeDate,
        (other as WebKeyServiceActivateWebKeyResponse).changeDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        WebKeyServiceActivateWebKeyResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          WebKeyServiceActivateWebKeyResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !WebKeyServiceActivateWebKeyResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          WebKeyServiceActivateWebKeyResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
