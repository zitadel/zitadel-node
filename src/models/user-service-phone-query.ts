 ...
 */
export class UserServicePhoneQuery {
  /**
  ...
  constructor(data?: Partial<UserServicePhoneQuery>) {
    Object.assign(this, data);
    if (this.number != null && typeof this.number !== "string") {
      throw new TypeError(`number must be a string, got ${typeof this.number}`);
    }
    if (this.method != null) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServicePhoneQuery)) {
      return false;
    }
    if (
      !UserServicePhoneQuery.__deepEquals(
        this.number,
        (other as UserServicePhoneQuery).number,
      )
    ) {
      return false;
    }
    if (
      !UserServicePhoneQuery.__deepEquals(
        this.method,
        (other as UserServicePhoneQuery).method,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => UserServicePhoneQuery.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServicePhoneQuery.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !UserServicePhoneQuery.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServicePhoneQuery.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
