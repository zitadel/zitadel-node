...
export class BetaUserServiceDetails {
  /**
  ...
  constructor(data?: Partial<BetaUserServiceDetails>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaUserServiceDetails)) {
      return false;
    }
    if (
      !BetaUserServiceDetails.__deepEquals(
        this.sequence,
        (other as BetaUserServiceDetails).sequence,
      )
    ) {
      return false;
    }
    if (
      !BetaUserServiceDetails.__deepEquals(
        this.changeDate,
        (other as BetaUserServiceDetails).changeDate,
      )
    ) {
      return false;
    }
    if (
      !BetaUserServiceDetails.__deepEquals(
        this.resourceOwner,
        (other as BetaUserServiceDetails).resourceOwner,
      )
    ) {
      return false;
    }
    if (
      !BetaUserServiceDetails.__deepEquals(
        this.creationDate,
        (other as BetaUserServiceDetails).creationDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => BetaUserServiceDetails.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaUserServiceDetails.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !BetaUserServiceDetails.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaUserServiceDetails.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
