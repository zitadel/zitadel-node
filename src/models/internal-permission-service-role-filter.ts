...
export class InternalPermissionServiceRoleFilter {
  /**
  ...
  constructor(data?: Partial<InternalPermissionServiceRoleFilter>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof InternalPermissionServiceRoleFilter)) {
      return false;
    }
    if (
      !InternalPermissionServiceRoleFilter.__deepEquals(
        this.roleKey,
        (other as InternalPermissionServiceRoleFilter).roleKey,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        InternalPermissionServiceRoleFilter.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          InternalPermissionServiceRoleFilter.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !InternalPermissionServiceRoleFilter.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          InternalPermissionServiceRoleFilter.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
