...
export class BetaOrganizationServiceVerifyOrganizationDomainRequest {
  /**
  ...
  constructor(
    data?: Partial<BetaOrganizationServiceVerifyOrganizationDomainRequest>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !(other instanceof BetaOrganizationServiceVerifyOrganizationDomainRequest)
    ) {
      return false;
    }
    if (
      !BetaOrganizationServiceVerifyOrganizationDomainRequest.__deepEquals(
        this.organizationId,
        (other as BetaOrganizationServiceVerifyOrganizationDomainRequest)
          .organizationId,
      )
    ) {
      return false;
