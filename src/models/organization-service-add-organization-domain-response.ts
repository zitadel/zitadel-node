...
export class OrganizationServiceAddOrganizationDomainResponse {
  /**
  ...
  constructor(
    data?: Partial<OrganizationServiceAddOrganizationDomainResponse>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof OrganizationServiceAddOrganizationDomainResponse)) {
      return false;
    }
    if (
      !OrganizationServiceAddOrganizationDomainResponse.__deepEquals(
        this.creationDate,
        (other as OrganizationServiceAddOrganizationDomainResponse)
          .creationDate,
      )
    ) {
      return false;
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        OrganizationServiceAddOrganizationDomainResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          OrganizationServiceAddOrganizationDomainResponse.__deepEquals(v, w),
        ),
      );
    }
