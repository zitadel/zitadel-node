...
export class ProjectServiceUpdateProjectResponse {
  /**
  ...
  constructor(data?: Partial<ProjectServiceUpdateProjectResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ProjectServiceUpdateProjectResponse)) {
      return false;
    }
    if (
      !ProjectServiceUpdateProjectResponse.__deepEquals(
        this.changeDate,
        (other as ProjectServiceUpdateProjectResponse).changeDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ProjectServiceUpdateProjectResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          ProjectServiceUpdateProjectResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !ProjectServiceUpdateProjectResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ProjectServiceUpdateProjectResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
