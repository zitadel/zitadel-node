...
export class InternalPermissionServiceCreateAdministratorRequest {
  /**
  ...
  constructor(
    data?: Partial<InternalPermissionServiceCreateAdministratorRequest>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !(other instanceof InternalPermissionServiceCreateAdministratorRequest)
    ) {
      return false;
    }
    if (
      !InternalPermissionServiceCreateAdministratorRequest.__deepEquals(
        this.userId,
        (other as InternalPermissionServiceCreateAdministratorRequest).userId,
      )
    ) {
      return false;
    }
    if (
      !InternalPermissionServiceCreateAdministratorRequest.__deepEquals(
        this.resource,
        (other as InternalPermissionServiceCreateAdministratorRequest).resource,
      )
    ) {
      return false;
    }
    if (
      !InternalPermissionServiceCreateAdministratorRequest.__deepEquals(
        this.roles,
        (other as InternalPermissionServiceCreateAdministratorRequest).roles,
      )
    ) {
      return false;
    }
