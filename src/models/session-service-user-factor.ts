...
export class SessionServiceUserFactor {
  /**
  ...
  constructor(data?: Partial<SessionServiceUserFactor>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof SessionServiceUserFactor)) {
      return false;
    }
    if (
      !SessionServiceUserFactor.__deepEquals(
        this.verifiedAt,
        (other as SessionServiceUserFactor).verifiedAt,
      )
    ) {
      return false;
    }
    if (
      !SessionServiceUserFactor.__deepEquals(
        this.id,
        (other as SessionServiceUserFactor).id,
      )
    ) {
      return false;
    }
    if (
      !SessionServiceUserFactor.__deepEquals(
        this.loginName,
        (other as SessionServiceUserFactor).loginName,
      )
    ) {
      return false;
    }
    if (
      !SessionServiceUserFactor.__deepEquals(
        this.displayName,
        (other as SessionServiceUserFactor).displayName,
      )
    ) {
      return false;
    }
    if (
      !SessionServiceUserFactor.__deepEquals(
        this.organizationId,
        (other as SessionServiceUserFactor).organizationId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => SessionServiceUserFactor.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => SessionServiceUserFactor.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !SessionServiceUserFactor.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          SessionServiceUserFactor.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
