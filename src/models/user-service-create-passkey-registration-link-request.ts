...
import { UserServiceSendPasskeyRegistrationLink } from "./user-service-send-passkey-registration-link.js";
import { Expose, Type } from "class-transformer";

export class UserServiceCreatePasskeyRegistrationLinkRequest {
  /**
  ...
  constructor(data?: Partial<UserServiceCreatePasskeyRegistrationLinkRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceCreatePasskeyRegistrationLinkRequest)) {
      return false;
    }
    if (
      !UserServiceCreatePasskeyRegistrationLinkRequest.__deepEquals(
        this.userId,
        (other as UserServiceCreatePasskeyRegistrationLinkRequest).userId,
      )
    ) {
      return false;
    }
    if (
      !UserServiceCreatePasskeyRegistrationLinkRequest.__deepEquals(
        this.returnCode,
        (other as UserServiceCreatePasskeyRegistrationLinkRequest).returnCode,
      )
    ) {
      return false;
    }
    if (
      !UserServiceCreatePasskeyRegistrationLinkRequest.__deepEquals(
        this.sendLink,
        (other as UserServiceCreatePasskeyRegistrationLinkRequest).sendLink,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceCreatePasskeyRegistrationLinkRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          UserServiceCreatePasskeyRegistrationLinkRequest.__deepEquals(v, w),
        ),
      );
    }
