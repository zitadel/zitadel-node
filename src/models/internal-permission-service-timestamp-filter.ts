...
import { InternalPermissionServiceTimestampFilterMethod } from "./internal-permission-service-timestamp-filter-method.js";
import { Expose, Type } from "class-transformer";

export class InternalPermissionServiceTimestampFilter {
  /**
  ...
  constructor(data?: Partial<InternalPermissionServiceTimestampFilter>) {
    ...
    if (this.method != null) {
      const methodValues = Object.values(
        ...
        (v) =>
          typeof (
            InternalPermissionServiceTimestampFilterMethod as Record<
              string,
              unknown
            >
          )[v as string] !== "number",
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof InternalPermissionServiceTimestampFilter)) {
      return false;
    }
    if (
      !InternalPermissionServiceTimestampFilter.__deepEquals(
        this.timestamp,
        (other as InternalPermissionServiceTimestampFilter).timestamp,
      )
    ) {
      return false;
    }
    if (
      !InternalPermissionServiceTimestampFilter.__deepEquals(
        this.method,
        (other as InternalPermissionServiceTimestampFilter).method,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        InternalPermissionServiceTimestampFilter.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          InternalPermissionServiceTimestampFilter.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !InternalPermissionServiceTimestampFilter.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          InternalPermissionServiceTimestampFilter.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
