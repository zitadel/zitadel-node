...
import { BetaUserServiceNotificationType } from "./beta-user-service-notification-type.js";
import { Expose } from "class-transformer";

export class BetaUserServiceSendPasswordResetLink {
  /**
  ...
  constructor(data?: Partial<BetaUserServiceSendPasswordResetLink>) {
    ...
    if (this.notificationType != null) {
      const notificationTypeValues = Object.values(
        ...
        (v) =>
          typeof (BetaUserServiceNotificationType as Record<string, unknown>)[
            v as string
          ] !== "number",
      );
      if (
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaUserServiceSendPasswordResetLink)) {
      return false;
    }
    if (
      !BetaUserServiceSendPasswordResetLink.__deepEquals(
        this.notificationType,
        (other as BetaUserServiceSendPasswordResetLink).notificationType,
      )
    ) {
      return false;
    }
    if (
      !BetaUserServiceSendPasswordResetLink.__deepEquals(
        this.urlTemplate,
        (other as BetaUserServiceSendPasswordResetLink).urlTemplate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaUserServiceSendPasswordResetLink.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaUserServiceSendPasswordResetLink.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaUserServiceSendPasswordResetLink.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaUserServiceSendPasswordResetLink.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
