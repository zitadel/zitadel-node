...
export class InternalPermissionServiceCreateAdministratorResponse {
  /**
  ...
  constructor(
    data?: Partial<InternalPermissionServiceCreateAdministratorResponse>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !(other instanceof InternalPermissionServiceCreateAdministratorResponse)
    ) {
      return false;
    }
    if (
      !InternalPermissionServiceCreateAdministratorResponse.__deepEquals(
        this.creationDate,
        (other as InternalPermissionServiceCreateAdministratorResponse)
          .creationDate,
      )
    ) {
      return false;
