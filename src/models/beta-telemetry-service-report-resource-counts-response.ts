...
export class BetaTelemetryServiceReportResourceCountsResponse {
  ...
  constructor(
    data?: Partial<BetaTelemetryServiceReportResourceCountsResponse>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaTelemetryServiceReportResourceCountsResponse)) {
      return false;
    }
    if (
      !BetaTelemetryServiceReportResourceCountsResponse.__deepEquals(
        this.reportId,
        (other as BetaTelemetryServiceReportResourceCountsResponse).reportId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaTelemetryServiceReportResourceCountsResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaTelemetryServiceReportResourceCountsResponse.__deepEquals(v, w),
        ),
      );
    }
