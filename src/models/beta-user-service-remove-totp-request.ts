...
export class BetaUserServiceRemoveTOTPRequest {
  /**
  ...
  constructor(data?: Partial<BetaUserServiceRemoveTOTPRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaUserServiceRemoveTOTPRequest)) {
      return false;
    }
    if (
      !BetaUserServiceRemoveTOTPRequest.__deepEquals(
        this.userId,
        (other as BetaUserServiceRemoveTOTPRequest).userId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaUserServiceRemoveTOTPRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaUserServiceRemoveTOTPRequest.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaUserServiceRemoveTOTPRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaUserServiceRemoveTOTPRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
