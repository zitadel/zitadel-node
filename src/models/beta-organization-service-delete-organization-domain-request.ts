...
export class BetaOrganizationServiceDeleteOrganizationDomainRequest {
  /**
  ...
  constructor(
    data?: Partial<BetaOrganizationServiceDeleteOrganizationDomainRequest>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !(other instanceof BetaOrganizationServiceDeleteOrganizationDomainRequest)
    ) {
      return false;
    }
    if (
      !BetaOrganizationServiceDeleteOrganizationDomainRequest.__deepEquals(
        this.organizationId,
        (other as BetaOrganizationServiceDeleteOrganizationDomainRequest)
          .organizationId,
      )
    ) {
      return false;
