...
export class SessionServiceSendCode {
  /**
  ...
  constructor(data?: Partial<SessionServiceSendCode>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof SessionServiceSendCode)) {
      return false;
    }
    if (
      !SessionServiceSendCode.__deepEquals(
        this.urlTemplate,
        (other as SessionServiceSendCode).urlTemplate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => SessionServiceSendCode.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => SessionServiceSendCode.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !SessionServiceSendCode.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          SessionServiceSendCode.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
