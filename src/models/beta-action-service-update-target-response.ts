...
export class BetaActionServiceUpdateTargetResponse {
  /**
  ...
  constructor(data?: Partial<BetaActionServiceUpdateTargetResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaActionServiceUpdateTargetResponse)) {
      return false;
    }
    if (
      !BetaActionServiceUpdateTargetResponse.__deepEquals(
        this.changeDate,
        (other as BetaActionServiceUpdateTargetResponse).changeDate,
      )
    ) {
      return false;
    }
    if (
      !BetaActionServiceUpdateTargetResponse.__deepEquals(
        this.signingKey,
        (other as BetaActionServiceUpdateTargetResponse).signingKey,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaActionServiceUpdateTargetResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaActionServiceUpdateTargetResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaActionServiceUpdateTargetResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaActionServiceUpdateTargetResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
