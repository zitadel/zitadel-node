...
import { OrganizationServiceTextQueryMethod } from "./organization-service-text-query-method.js";
import { Expose } from "class-transformer";

export class OrganizationServiceOrganizationDomainQuery {
  /**
  ...
  constructor(data?: Partial<OrganizationServiceOrganizationDomainQuery>) {
    ...
    if (this.method != null) {
      const methodValues = Object.values(
        ...
        (v) =>
          typeof (
            OrganizationServiceTextQueryMethod as Record<string, unknown>
          )[v as string] !== "number",
      );
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof OrganizationServiceOrganizationDomainQuery)) {
      return false;
    }
    if (
      !OrganizationServiceOrganizationDomainQuery.__deepEquals(
        this.domain,
        (other as OrganizationServiceOrganizationDomainQuery).domain,
      )
    ) {
      return false;
    }
    if (
      !OrganizationServiceOrganizationDomainQuery.__deepEquals(
        this.method,
        (other as OrganizationServiceOrganizationDomainQuery).method,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        OrganizationServiceOrganizationDomainQuery.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          OrganizationServiceOrganizationDomainQuery.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !OrganizationServiceOrganizationDomainQuery.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          OrganizationServiceOrganizationDomainQuery.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
