...
export class OrganizationServicePaginationResponse {
  /**
  ...
  constructor(data?: Partial<OrganizationServicePaginationResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof OrganizationServicePaginationResponse)) {
      return false;
    }
    if (
      !OrganizationServicePaginationResponse.__deepEquals(
        this.totalResult,
        (other as OrganizationServicePaginationResponse).totalResult,
      )
    ) {
      return false;
    }
    if (
      !OrganizationServicePaginationResponse.__deepEquals(
        this.appliedLimit,
        (other as OrganizationServicePaginationResponse).appliedLimit,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        OrganizationServicePaginationResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          OrganizationServicePaginationResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !OrganizationServicePaginationResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          OrganizationServicePaginationResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
