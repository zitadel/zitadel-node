...
export class InstanceServiceRemoveTrustedDomainRequest {
  ...
  constructor(data?: Partial<InstanceServiceRemoveTrustedDomainRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof InstanceServiceRemoveTrustedDomainRequest)) {
      return false;
    }
    if (
      !InstanceServiceRemoveTrustedDomainRequest.__deepEquals(
        this.instanceId,
        (other as InstanceServiceRemoveTrustedDomainRequest).instanceId,
      )
    ) {
      return false;
    }
    if (
      !InstanceServiceRemoveTrustedDomainRequest.__deepEquals(
        this.trustedDomain,
        (other as InstanceServiceRemoveTrustedDomainRequest).trustedDomain,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        InstanceServiceRemoveTrustedDomainRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          InstanceServiceRemoveTrustedDomainRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !InstanceServiceRemoveTrustedDomainRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          InstanceServiceRemoveTrustedDomainRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
