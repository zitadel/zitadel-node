...
export class ApplicationServiceDeactivateApplicationResponse {
  /**
  ...
  constructor(data?: Partial<ApplicationServiceDeactivateApplicationResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ApplicationServiceDeactivateApplicationResponse)) {
      return false;
    }
    if (
      !ApplicationServiceDeactivateApplicationResponse.__deepEquals(
        this.deactivationDate,
        (other as ApplicationServiceDeactivateApplicationResponse)
          .deactivationDate,
      )
    ) {
      return false;
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ApplicationServiceDeactivateApplicationResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          ApplicationServiceDeactivateApplicationResponse.__deepEquals(v, w),
        ),
      );
    }
