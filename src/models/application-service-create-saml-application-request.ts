...
export class ApplicationServiceCreateSAMLApplicationRequest {
  ...
  constructor(data?: Partial<ApplicationServiceCreateSAMLApplicationRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ApplicationServiceCreateSAMLApplicationRequest)) {
      return false;
    }
    if (
      !ApplicationServiceCreateSAMLApplicationRequest.__deepEquals(
        this.loginVersion,
        (other as ApplicationServiceCreateSAMLApplicationRequest).loginVersion,
      )
    ) {
      return false;
    }
    if (
      !ApplicationServiceCreateSAMLApplicationRequest.__deepEquals(
        this.metadataUrl,
        (other as ApplicationServiceCreateSAMLApplicationRequest).metadataUrl,
      )
    ) {
      return false;
    }
    if (
      !ApplicationServiceCreateSAMLApplicationRequest.__deepEquals(
        this.metadataXml,
        (other as ApplicationServiceCreateSAMLApplicationRequest).metadataXml,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ApplicationServiceCreateSAMLApplicationRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          ApplicationServiceCreateSAMLApplicationRequest.__deepEquals(v, w),
        ),
      );
    }
