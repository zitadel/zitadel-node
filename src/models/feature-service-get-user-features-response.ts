...
export class FeatureServiceGetUserFeaturesResponse {
  /**
  ...
  constructor(data?: Partial<FeatureServiceGetUserFeaturesResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof FeatureServiceGetUserFeaturesResponse)) {
      return false;
    }
    if (
      !FeatureServiceGetUserFeaturesResponse.__deepEquals(
        this.details,
        (other as FeatureServiceGetUserFeaturesResponse).details,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        FeatureServiceGetUserFeaturesResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          FeatureServiceGetUserFeaturesResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !FeatureServiceGetUserFeaturesResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          FeatureServiceGetUserFeaturesResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
