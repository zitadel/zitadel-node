...
import { BetaActionServiceExecutionTypeFilter } from "./beta-action-service-execution-type-filter.js";
import { BetaActionServiceInConditionsFilter } from "./beta-action-service-in-conditions-filter.js";
import { BetaActionServiceTargetFilter } from "./beta-action-service-target-filter.js";
...
export class BetaActionServiceExecutionSearchFilter {
  ...
  constructor(data?: Partial<BetaActionServiceExecutionSearchFilter>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaActionServiceExecutionSearchFilter)) {
      return false;
    }
    if (
      !BetaActionServiceExecutionSearchFilter.__deepEquals(
        this.executionTypeFilter,
        (other as BetaActionServiceExecutionSearchFilter).executionTypeFilter,
      )
    ) {
      return false;
    }
    if (
      !BetaActionServiceExecutionSearchFilter.__deepEquals(
        ...
        (other as BetaActionServiceExecutionSearchFilter).inConditionsFilter,
      )
    ) {
      return false;
    }
    if (
      !BetaActionServiceExecutionSearchFilter.__deepEquals(
        this.targetFilter,
        (other as BetaActionServiceExecutionSearchFilter).targetFilter,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaActionServiceExecutionSearchFilter.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaActionServiceExecutionSearchFilter.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaActionServiceExecutionSearchFilter.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaActionServiceExecutionSearchFilter.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
