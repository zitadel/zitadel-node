 ...
 */
export class BetaUserServiceInUserEmailsQuery {
  /**
  ...
  @Expose({ name: "userEmails" })
  userEmails?: Array<string>;

  constructor(data?: Partial<BetaUserServiceInUserEmailsQuery>) {
    Object.assign(this, data);
    if (
      this.userEmails != null &&
      !Array.isArray(this.userEmails) &&
      !((this.userEmails as unknown) instanceof Set)
    ) {
      throw new TypeError(
        `userEmails must be an array, got ${typeof this.userEmails}`,
      );
    }
  }
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaUserServiceInUserEmailsQuery)) {
      return false;
    }
    if (
      !BetaUserServiceInUserEmailsQuery.__deepEquals(
        this.userEmails,
        (other as BetaUserServiceInUserEmailsQuery).userEmails,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaUserServiceInUserEmailsQuery.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaUserServiceInUserEmailsQuery.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaUserServiceInUserEmailsQuery.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaUserServiceInUserEmailsQuery.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
