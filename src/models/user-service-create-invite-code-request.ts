...
import { UserServiceSendInviteCode } from "./user-service-send-invite-code.js";
import { Expose, Type } from "class-transformer";

export class UserServiceCreateInviteCodeRequest {
  /**
  ...
  constructor(data?: Partial<UserServiceCreateInviteCodeRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceCreateInviteCodeRequest)) {
      return false;
    }
    if (
      !UserServiceCreateInviteCodeRequest.__deepEquals(
        this.userId,
        (other as UserServiceCreateInviteCodeRequest).userId,
      )
    ) {
      return false;
    }
    if (
      !UserServiceCreateInviteCodeRequest.__deepEquals(
        this.returnCode,
        (other as UserServiceCreateInviteCodeRequest).returnCode,
      )
    ) {
      return false;
    }
    if (
      !UserServiceCreateInviteCodeRequest.__deepEquals(
        this.sendCode,
        (other as UserServiceCreateInviteCodeRequest).sendCode,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceCreateInviteCodeRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          UserServiceCreateInviteCodeRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceCreateInviteCodeRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceCreateInviteCodeRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
