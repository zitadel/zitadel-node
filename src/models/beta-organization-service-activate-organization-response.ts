...
export class BetaOrganizationServiceActivateOrganizationResponse {
  /**
  ...
  constructor(
    data?: Partial<BetaOrganizationServiceActivateOrganizationResponse>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !(other instanceof BetaOrganizationServiceActivateOrganizationResponse)
    ) {
      return false;
    }
    if (
      !BetaOrganizationServiceActivateOrganizationResponse.__deepEquals(
        this.changeDate,
        (other as BetaOrganizationServiceActivateOrganizationResponse)
          .changeDate,
      )
    ) {
      return false;
