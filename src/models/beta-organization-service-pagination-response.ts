...
export class BetaOrganizationServicePaginationResponse {
  /**
  ...
  constructor(data?: Partial<BetaOrganizationServicePaginationResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaOrganizationServicePaginationResponse)) {
      return false;
    }
    if (
      !BetaOrganizationServicePaginationResponse.__deepEquals(
        this.totalResult,
        (other as BetaOrganizationServicePaginationResponse).totalResult,
      )
    ) {
      return false;
    }
    if (
      !BetaOrganizationServicePaginationResponse.__deepEquals(
        this.appliedLimit,
        (other as BetaOrganizationServicePaginationResponse).appliedLimit,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaOrganizationServicePaginationResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaOrganizationServicePaginationResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaOrganizationServicePaginationResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaOrganizationServicePaginationResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
