...
export class BetaUserServiceSetMetadataEntry {
  /**
  ...
  constructor(data?: Partial<BetaUserServiceSetMetadataEntry>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaUserServiceSetMetadataEntry)) {
      return false;
    }
    if (
      !BetaUserServiceSetMetadataEntry.__deepEquals(
        this.key,
        (other as BetaUserServiceSetMetadataEntry).key,
      )
    ) {
      return false;
    }
    if (
      !BetaUserServiceSetMetadataEntry.__deepEquals(
        this.value,
        (other as BetaUserServiceSetMetadataEntry).value,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaUserServiceSetMetadataEntry.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaUserServiceSetMetadataEntry.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaUserServiceSetMetadataEntry.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaUserServiceSetMetadataEntry.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
