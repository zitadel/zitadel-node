...
export class SessionServiceCheckPassword {
  /**
  ...
  constructor(data?: Partial<SessionServiceCheckPassword>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof SessionServiceCheckPassword)) {
      return false;
    }
    if (
      !SessionServiceCheckPassword.__deepEquals(
        this.password,
        (other as SessionServiceCheckPassword).password,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        SessionServiceCheckPassword.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => SessionServiceCheckPassword.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !SessionServiceCheckPassword.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          SessionServiceCheckPassword.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
