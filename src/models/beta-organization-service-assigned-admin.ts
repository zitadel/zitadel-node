...
export class BetaOrganizationServiceAssignedAdmin {
  /**
  ...
  constructor(data?: Partial<BetaOrganizationServiceAssignedAdmin>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaOrganizationServiceAssignedAdmin)) {
      return false;
    }
    if (
      !BetaOrganizationServiceAssignedAdmin.__deepEquals(
        this.userId,
        (other as BetaOrganizationServiceAssignedAdmin).userId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaOrganizationServiceAssignedAdmin.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaOrganizationServiceAssignedAdmin.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaOrganizationServiceAssignedAdmin.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaOrganizationServiceAssignedAdmin.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
