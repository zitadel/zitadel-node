...
export class SAMLServiceAny {
  ...
  constructor(data?: Partial<SAMLServiceAny>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof SAMLServiceAny)) {
      return false;
    }
    if (
      !SAMLServiceAny.__deepEquals(this.type, (other as SAMLServiceAny).type)
    ) {
      return false;
    }
    if (
      !SAMLServiceAny.__deepEquals(this.value, (other as SAMLServiceAny).value)
    ) {
      return false;
    }
    if (
      !SAMLServiceAny.__deepEquals(this.debug, (other as SAMLServiceAny).debug)
    ) {
      return false;
    }
    {
      ...
      for (const k of selfKeys) {
        ...
        if (!SAMLServiceAny.__deepEquals(selfRec[k], otherRec[k])) {
          return false;
        }
      }
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => SAMLServiceAny.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => SAMLServiceAny.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !SAMLServiceAny.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          SAMLServiceAny.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
