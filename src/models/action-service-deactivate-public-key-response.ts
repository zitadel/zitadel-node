...
export class ActionServiceDeactivatePublicKeyResponse {
  /**
  ...
  constructor(data?: Partial<ActionServiceDeactivatePublicKeyResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ActionServiceDeactivatePublicKeyResponse)) {
      return false;
    }
    if (
      !ActionServiceDeactivatePublicKeyResponse.__deepEquals(
        this.changeDate,
        (other as ActionServiceDeactivatePublicKeyResponse).changeDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ActionServiceDeactivatePublicKeyResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          ActionServiceDeactivatePublicKeyResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !ActionServiceDeactivatePublicKeyResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ActionServiceDeactivatePublicKeyResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
