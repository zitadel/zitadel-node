...
export class BetaProjectServiceDeleteProjectGrantRequest {
  /**
  ...
  constructor(data?: Partial<BetaProjectServiceDeleteProjectGrantRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaProjectServiceDeleteProjectGrantRequest)) {
      return false;
    }
    if (
      !BetaProjectServiceDeleteProjectGrantRequest.__deepEquals(
        this.projectId,
        (other as BetaProjectServiceDeleteProjectGrantRequest).projectId,
      )
    ) {
      return false;
    }
    if (
      !BetaProjectServiceDeleteProjectGrantRequest.__deepEquals(
        ...
        (other as BetaProjectServiceDeleteProjectGrantRequest)
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaProjectServiceDeleteProjectGrantRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaProjectServiceDeleteProjectGrantRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaProjectServiceDeleteProjectGrantRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
