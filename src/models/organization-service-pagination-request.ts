...
export class OrganizationServicePaginationRequest {
  /**
  ...
  constructor(data?: Partial<OrganizationServicePaginationRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof OrganizationServicePaginationRequest)) {
      return false;
    }
    if (
      !OrganizationServicePaginationRequest.__deepEquals(
        this.offset,
        (other as OrganizationServicePaginationRequest).offset,
      )
    ) {
      return false;
    }
    if (
      !OrganizationServicePaginationRequest.__deepEquals(
        this.limit,
        (other as OrganizationServicePaginationRequest).limit,
      )
    ) {
      return false;
    }
    if (
      !OrganizationServicePaginationRequest.__deepEquals(
        this.asc,
        (other as OrganizationServicePaginationRequest).asc,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        OrganizationServicePaginationRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          OrganizationServicePaginationRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !OrganizationServicePaginationRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          OrganizationServicePaginationRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
