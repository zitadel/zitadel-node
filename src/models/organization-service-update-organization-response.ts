...
export class OrganizationServiceUpdateOrganizationResponse {
  /**
  ...
  constructor(data?: Partial<OrganizationServiceUpdateOrganizationResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof OrganizationServiceUpdateOrganizationResponse)) {
      return false;
    }
    if (
      !OrganizationServiceUpdateOrganizationResponse.__deepEquals(
        this.changeDate,
        (other as OrganizationServiceUpdateOrganizationResponse).changeDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        OrganizationServiceUpdateOrganizationResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          OrganizationServiceUpdateOrganizationResponse.__deepEquals(v, w),
        ),
      );
    }
