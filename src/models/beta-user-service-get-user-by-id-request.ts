...
export class BetaUserServiceGetUserByIDRequest {
  /**
  ...
  constructor(data?: Partial<BetaUserServiceGetUserByIDRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaUserServiceGetUserByIDRequest)) {
      return false;
    }
    if (
      !BetaUserServiceGetUserByIDRequest.__deepEquals(
        this.userId,
        (other as BetaUserServiceGetUserByIDRequest).userId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaUserServiceGetUserByIDRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaUserServiceGetUserByIDRequest.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaUserServiceGetUserByIDRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaUserServiceGetUserByIDRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
