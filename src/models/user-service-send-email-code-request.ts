...
export class UserServiceSendEmailCodeRequest {
  /**
  ...
  constructor(data?: Partial<UserServiceSendEmailCodeRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceSendEmailCodeRequest)) {
      return false;
    }
    if (
      !UserServiceSendEmailCodeRequest.__deepEquals(
        this.userId,
        (other as UserServiceSendEmailCodeRequest).userId,
      )
    ) {
      return false;
    }
    if (
      !UserServiceSendEmailCodeRequest.__deepEquals(
        this.returnCode,
        (other as UserServiceSendEmailCodeRequest).returnCode,
      )
    ) {
      return false;
    }
    if (
      !UserServiceSendEmailCodeRequest.__deepEquals(
        this.sendCode,
        (other as UserServiceSendEmailCodeRequest).sendCode,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceSendEmailCodeRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceSendEmailCodeRequest.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceSendEmailCodeRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceSendEmailCodeRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
