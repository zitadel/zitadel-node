...
export class BetaActionServiceInConditionsFilter {
  /**
  ...
  constructor(data?: Partial<BetaActionServiceInConditionsFilter>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaActionServiceInConditionsFilter)) {
      return false;
    }
    if (
      !BetaActionServiceInConditionsFilter.__deepEquals(
        this.conditions,
        (other as BetaActionServiceInConditionsFilter).conditions,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaActionServiceInConditionsFilter.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaActionServiceInConditionsFilter.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaActionServiceInConditionsFilter.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaActionServiceInConditionsFilter.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
