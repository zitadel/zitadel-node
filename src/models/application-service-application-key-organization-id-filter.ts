...
export class ApplicationServiceApplicationKeyOrganizationIDFilter {
  /**
  ...
  constructor(
    data?: Partial<ApplicationServiceApplicationKeyOrganizationIDFilter>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !(other instanceof ApplicationServiceApplicationKeyOrganizationIDFilter)
    ) {
      return false;
    }
    if (
      !ApplicationServiceApplicationKeyOrganizationIDFilter.__deepEquals(
        this.organizationId,
        (other as ApplicationServiceApplicationKeyOrganizationIDFilter)
          .organizationId,
      )
    ) {
      return false;
