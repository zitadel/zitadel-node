...
export class FeatureServiceSetUserFeatureRequest {
  /**
  ...
  constructor(data?: Partial<FeatureServiceSetUserFeatureRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof FeatureServiceSetUserFeatureRequest)) {
      return false;
    }
    if (
      !FeatureServiceSetUserFeatureRequest.__deepEquals(
        this.userId,
        (other as FeatureServiceSetUserFeatureRequest).userId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        FeatureServiceSetUserFeatureRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          FeatureServiceSetUserFeatureRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !FeatureServiceSetUserFeatureRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          FeatureServiceSetUserFeatureRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
