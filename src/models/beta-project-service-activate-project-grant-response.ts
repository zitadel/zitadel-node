...
export class BetaProjectServiceActivateProjectGrantResponse {
  /**
  ...
  constructor(data?: Partial<BetaProjectServiceActivateProjectGrantResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaProjectServiceActivateProjectGrantResponse)) {
      return false;
    }
    if (
      !BetaProjectServiceActivateProjectGrantResponse.__deepEquals(
        this.changeDate,
        (other as BetaProjectServiceActivateProjectGrantResponse).changeDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaProjectServiceActivateProjectGrantResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaProjectServiceActivateProjectGrantResponse.__deepEquals(v, w),
        ),
      );
    }
