...
export class BetaUserServiceRemoveTOTPResponse {
  /**
  ...
  constructor(data?: Partial<BetaUserServiceRemoveTOTPResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaUserServiceRemoveTOTPResponse)) {
      return false;
    }
    if (
      !BetaUserServiceRemoveTOTPResponse.__deepEquals(
        this.details,
        (other as BetaUserServiceRemoveTOTPResponse).details,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaUserServiceRemoveTOTPResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaUserServiceRemoveTOTPResponse.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaUserServiceRemoveTOTPResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaUserServiceRemoveTOTPResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
