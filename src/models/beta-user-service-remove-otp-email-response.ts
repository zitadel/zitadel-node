...
export class BetaUserServiceRemoveOTPEmailResponse {
  /**
  ...
  constructor(data?: Partial<BetaUserServiceRemoveOTPEmailResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaUserServiceRemoveOTPEmailResponse)) {
      return false;
    }
    if (
      !BetaUserServiceRemoveOTPEmailResponse.__deepEquals(
        this.details,
        (other as BetaUserServiceRemoveOTPEmailResponse).details,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaUserServiceRemoveOTPEmailResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaUserServiceRemoveOTPEmailResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaUserServiceRemoveOTPEmailResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaUserServiceRemoveOTPEmailResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
