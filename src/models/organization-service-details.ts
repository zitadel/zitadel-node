...
export class OrganizationServiceDetails {
  /**
  ...
  constructor(data?: Partial<OrganizationServiceDetails>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof OrganizationServiceDetails)) {
      return false;
    }
    if (
      !OrganizationServiceDetails.__deepEquals(
        this.sequence,
        (other as OrganizationServiceDetails).sequence,
      )
    ) {
      return false;
    }
    if (
      !OrganizationServiceDetails.__deepEquals(
        this.changeDate,
        (other as OrganizationServiceDetails).changeDate,
      )
    ) {
      return false;
    }
    if (
      !OrganizationServiceDetails.__deepEquals(
        this.resourceOwner,
        (other as OrganizationServiceDetails).resourceOwner,
      )
    ) {
      return false;
    }
    if (
      !OrganizationServiceDetails.__deepEquals(
        this.creationDate,
        (other as OrganizationServiceDetails).creationDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        OrganizationServiceDetails.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => OrganizationServiceDetails.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !OrganizationServiceDetails.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          OrganizationServiceDetails.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
