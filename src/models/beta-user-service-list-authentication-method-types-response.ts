...
import { BetaUserServiceAuthenticationMethodType } from "./beta-user-service-authentication-method-type.js";
import { BetaUserServiceListDetails } from "./beta-user-service-list-details.js";
import { Expose, Type } from "class-transformer";

export class BetaUserServiceListAuthenticationMethodTypesResponse {
  /**
  ...
  constructor(
    data?: Partial<BetaUserServiceListAuthenticationMethodTypesResponse>,
  ) {
    ...
    if (this.authMethodTypes != null) {
      const authMethodTypesValues = Object.values(
        ...
        (v) =>
          typeof (
            BetaUserServiceAuthenticationMethodType as Record<string, unknown>
          )[v as string] !== "number",
      );
      if (
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !(other instanceof BetaUserServiceListAuthenticationMethodTypesResponse)
    ) {
      return false;
    }
    if (
      !BetaUserServiceListAuthenticationMethodTypesResponse.__deepEquals(
        this.details,
        (other as BetaUserServiceListAuthenticationMethodTypesResponse).details,
      )
    ) {
      return false;
    }
    if (
      !BetaUserServiceListAuthenticationMethodTypesResponse.__deepEquals(
        this.authMethodTypes,
        (other as BetaUserServiceListAuthenticationMethodTypesResponse)
          .authMethodTypes,
      )
    ) {
      return false;
