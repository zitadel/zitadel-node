...
export class BetaActionServiceGetTargetRequest {
  /**
  ...
  constructor(data?: Partial<BetaActionServiceGetTargetRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaActionServiceGetTargetRequest)) {
      return false;
    }
    if (
      !BetaActionServiceGetTargetRequest.__deepEquals(
        this.id,
        (other as BetaActionServiceGetTargetRequest).id,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaActionServiceGetTargetRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaActionServiceGetTargetRequest.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaActionServiceGetTargetRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaActionServiceGetTargetRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
