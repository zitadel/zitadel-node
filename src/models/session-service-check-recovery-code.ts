...
export class SessionServiceCheckRecoveryCode {
  /**
  ...
  constructor(data?: Partial<SessionServiceCheckRecoveryCode>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof SessionServiceCheckRecoveryCode)) {
      return false;
    }
    if (
      !SessionServiceCheckRecoveryCode.__deepEquals(
        this.code,
        (other as SessionServiceCheckRecoveryCode).code,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        SessionServiceCheckRecoveryCode.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => SessionServiceCheckRecoveryCode.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !SessionServiceCheckRecoveryCode.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          SessionServiceCheckRecoveryCode.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
