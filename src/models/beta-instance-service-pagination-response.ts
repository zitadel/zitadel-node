...
export class BetaInstanceServicePaginationResponse {
  /**
  ...
  constructor(data?: Partial<BetaInstanceServicePaginationResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaInstanceServicePaginationResponse)) {
      return false;
    }
    if (
      !BetaInstanceServicePaginationResponse.__deepEquals(
        this.totalResult,
        (other as BetaInstanceServicePaginationResponse).totalResult,
      )
    ) {
      return false;
    }
    if (
      !BetaInstanceServicePaginationResponse.__deepEquals(
        this.appliedLimit,
        (other as BetaInstanceServicePaginationResponse).appliedLimit,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaInstanceServicePaginationResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaInstanceServicePaginationResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaInstanceServicePaginationResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaInstanceServicePaginationResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
