...
export class UserServiceGetUserByIDRequest {
  /**
  ...
  constructor(data?: Partial<UserServiceGetUserByIDRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceGetUserByIDRequest)) {
      return false;
    }
    if (
      !UserServiceGetUserByIDRequest.__deepEquals(
        this.userId,
        (other as UserServiceGetUserByIDRequest).userId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceGetUserByIDRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceGetUserByIDRequest.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceGetUserByIDRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceGetUserByIDRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
