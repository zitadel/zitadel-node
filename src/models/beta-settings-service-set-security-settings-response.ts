...
export class BetaSettingsServiceSetSecuritySettingsResponse {
  /**
  ...
  constructor(data?: Partial<BetaSettingsServiceSetSecuritySettingsResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaSettingsServiceSetSecuritySettingsResponse)) {
      return false;
    }
    if (
      !BetaSettingsServiceSetSecuritySettingsResponse.__deepEquals(
        this.details,
        (other as BetaSettingsServiceSetSecuritySettingsResponse).details,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaSettingsServiceSetSecuritySettingsResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaSettingsServiceSetSecuritySettingsResponse.__deepEquals(v, w),
        ),
      );
    }
