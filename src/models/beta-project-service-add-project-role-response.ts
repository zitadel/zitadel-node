...
export class BetaProjectServiceAddProjectRoleResponse {
  /**
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaProjectServiceAddProjectRoleResponse)) {
      return false;
    }
    if (
      !BetaProjectServiceAddProjectRoleResponse.__deepEquals(
        this.creationDate,
        (other as BetaProjectServiceAddProjectRoleResponse).creationDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaProjectServiceAddProjectRoleResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaProjectServiceAddProjectRoleResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaProjectServiceAddProjectRoleResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaProjectServiceAddProjectRoleResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
