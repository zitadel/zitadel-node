...
export class UserServiceRemoveU2FRequest {
  /**
  ...
  constructor(data?: Partial<UserServiceRemoveU2FRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceRemoveU2FRequest)) {
      return false;
    }
    if (
      !UserServiceRemoveU2FRequest.__deepEquals(
        this.userId,
        (other as UserServiceRemoveU2FRequest).userId,
      )
    ) {
      return false;
    }
    if (
      !UserServiceRemoveU2FRequest.__deepEquals(
        this.u2fId,
        (other as UserServiceRemoveU2FRequest).u2fId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceRemoveU2FRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceRemoveU2FRequest.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceRemoveU2FRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceRemoveU2FRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
