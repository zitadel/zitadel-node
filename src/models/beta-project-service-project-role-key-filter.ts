...
export class BetaProjectServiceProjectRoleKeyFilter {
  /**
  ...
  constructor(data?: Partial<BetaProjectServiceProjectRoleKeyFilter>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaProjectServiceProjectRoleKeyFilter)) {
      return false;
    }
    if (
      !BetaProjectServiceProjectRoleKeyFilter.__deepEquals(
        this.key,
        (other as BetaProjectServiceProjectRoleKeyFilter).key,
      )
    ) {
      return false;
    }
    if (
      !BetaProjectServiceProjectRoleKeyFilter.__deepEquals(
        this.method,
        (other as BetaProjectServiceProjectRoleKeyFilter).method,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaProjectServiceProjectRoleKeyFilter.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaProjectServiceProjectRoleKeyFilter.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaProjectServiceProjectRoleKeyFilter.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaProjectServiceProjectRoleKeyFilter.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
