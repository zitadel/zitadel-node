...
export class BetaInternalPermissionServiceDeleteAdministratorResponse {
  /**
  ...
  constructor(
    data?: Partial<BetaInternalPermissionServiceDeleteAdministratorResponse>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !BetaInternalPermissionServiceDeleteAdministratorResponse.__deepEquals(
        this.deletionDate,
        (other as BetaInternalPermissionServiceDeleteAdministratorResponse)
          .deletionDate,
      )
    ) {
      return false;
