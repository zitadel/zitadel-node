...
export class ApplicationServiceApplicationKeyApplicationIDFilter {
  /**
  ...
  constructor(
    data?: Partial<ApplicationServiceApplicationKeyApplicationIDFilter>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !(other instanceof ApplicationServiceApplicationKeyApplicationIDFilter)
    ) {
      return false;
    }
    if (
      !ApplicationServiceApplicationKeyApplicationIDFilter.__deepEquals(
        this.applicationId,
        (other as ApplicationServiceApplicationKeyApplicationIDFilter)
          .applicationId,
      )
    ) {
      return false;
