...
export class UserServiceAddKeyRequest {
  /**
  ...
  constructor(data?: Partial<UserServiceAddKeyRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceAddKeyRequest)) {
      return false;
    }
    if (
      !UserServiceAddKeyRequest.__deepEquals(
        this.userId,
        (other as UserServiceAddKeyRequest).userId,
      )
    ) {
      return false;
    }
    if (
      !UserServiceAddKeyRequest.__deepEquals(
        this.expirationDate,
        (other as UserServiceAddKeyRequest).expirationDate,
      )
    ) {
      return false;
    }
    if (
      !UserServiceAddKeyRequest.__deepEquals(
        this.publicKey,
        (other as UserServiceAddKeyRequest).publicKey,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => UserServiceAddKeyRequest.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceAddKeyRequest.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !UserServiceAddKeyRequest.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceAddKeyRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
