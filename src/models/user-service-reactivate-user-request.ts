...
export class UserServiceReactivateUserRequest {
  /**
  ...
  constructor(data?: Partial<UserServiceReactivateUserRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceReactivateUserRequest)) {
      return false;
    }
    if (
      !UserServiceReactivateUserRequest.__deepEquals(
        this.userId,
        (other as UserServiceReactivateUserRequest).userId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceReactivateUserRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceReactivateUserRequest.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceReactivateUserRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceReactivateUserRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
