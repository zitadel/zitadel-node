...
export class BetaUserServiceRegisterU2FRequest {
  /**
  ...
  constructor(data?: Partial<BetaUserServiceRegisterU2FRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaUserServiceRegisterU2FRequest)) {
      return false;
    }
    if (
      !BetaUserServiceRegisterU2FRequest.__deepEquals(
        this.userId,
        (other as BetaUserServiceRegisterU2FRequest).userId,
      )
    ) {
      return false;
    }
    if (
      !BetaUserServiceRegisterU2FRequest.__deepEquals(
        this.domain,
        (other as BetaUserServiceRegisterU2FRequest).domain,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaUserServiceRegisterU2FRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaUserServiceRegisterU2FRequest.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaUserServiceRegisterU2FRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaUserServiceRegisterU2FRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
