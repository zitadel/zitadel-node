...
export class UserServiceRemovePersonalAccessTokenRequest {
  /**
  ...
  constructor(data?: Partial<UserServiceRemovePersonalAccessTokenRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceRemovePersonalAccessTokenRequest)) {
      return false;
    }
    if (
      !UserServiceRemovePersonalAccessTokenRequest.__deepEquals(
        this.userId,
        (other as UserServiceRemovePersonalAccessTokenRequest).userId,
      )
    ) {
      return false;
    }
    if (
      !UserServiceRemovePersonalAccessTokenRequest.__deepEquals(
        this.tokenId,
        (other as UserServiceRemovePersonalAccessTokenRequest).tokenId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceRemovePersonalAccessTokenRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          UserServiceRemovePersonalAccessTokenRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceRemovePersonalAccessTokenRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
