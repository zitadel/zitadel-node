...
export class ActionServiceListExecutionMethodsResponse {
  /**
  ...
  constructor(data?: Partial<ActionServiceListExecutionMethodsResponse>) {
    Object.assign(this, data);
    if (
      this.methods != null &&
      !Array.isArray(this.methods) &&
      !((this.methods as unknown) instanceof Set)
    ) {
      throw new TypeError(
        `methods must be an array, got ${typeof this.methods}`,
      );
    }
  }
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ActionServiceListExecutionMethodsResponse)) {
      return false;
    }
    if (
      !ActionServiceListExecutionMethodsResponse.__deepEquals(
        this.methods,
        (other as ActionServiceListExecutionMethodsResponse).methods,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ActionServiceListExecutionMethodsResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          ActionServiceListExecutionMethodsResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !ActionServiceListExecutionMethodsResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ActionServiceListExecutionMethodsResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
