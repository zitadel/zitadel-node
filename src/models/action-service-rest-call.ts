...
export class ActionServiceRESTCall {
  /**
  ...
  constructor(data?: Partial<ActionServiceRESTCall>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ActionServiceRESTCall)) {
      return false;
    }
    if (
      !ActionServiceRESTCall.__deepEquals(
        this.interruptOnError,
        (other as ActionServiceRESTCall).interruptOnError,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => ActionServiceRESTCall.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => ActionServiceRESTCall.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !ActionServiceRESTCall.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ActionServiceRESTCall.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
