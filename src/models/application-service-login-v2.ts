...
export class ApplicationServiceLoginV2 {
  /**
  ...
  constructor(data?: Partial<ApplicationServiceLoginV2>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ApplicationServiceLoginV2)) {
      return false;
    }
    if (
      !ApplicationServiceLoginV2.__deepEquals(
        this.baseUri,
        (other as ApplicationServiceLoginV2).baseUri,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => ApplicationServiceLoginV2.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => ApplicationServiceLoginV2.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !ApplicationServiceLoginV2.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ApplicationServiceLoginV2.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
