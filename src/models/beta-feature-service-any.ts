 ...
 */
export class BetaFeatureServiceAny {
  /**
  ...
  constructor(data?: Partial<BetaFeatureServiceAny>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaFeatureServiceAny)) {
      return false;
    }
    if (
      !BetaFeatureServiceAny.__deepEquals(
        this.type,
        (other as BetaFeatureServiceAny).type,
      )
    ) {
      return false;
    }
    if (
      !BetaFeatureServiceAny.__deepEquals(
        this.value,
        (other as BetaFeatureServiceAny).value,
      )
    ) {
      return false;
    }
    if (
      !BetaFeatureServiceAny.__deepEquals(
        this.debug,
        (other as BetaFeatureServiceAny).debug,
      )
    ) {
      return false;
    }
    {
      ...
      for (const k of selfKeys) {
        ...
        if (!BetaFeatureServiceAny.__deepEquals(selfRec[k], otherRec[k])) {
          return false;
        }
      }
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => BetaFeatureServiceAny.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaFeatureServiceAny.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !BetaFeatureServiceAny.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaFeatureServiceAny.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
