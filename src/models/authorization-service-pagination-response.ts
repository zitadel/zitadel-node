...
export class AuthorizationServicePaginationResponse {
  /**
  ...
  constructor(data?: Partial<AuthorizationServicePaginationResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof AuthorizationServicePaginationResponse)) {
      return false;
    }
    if (
      !AuthorizationServicePaginationResponse.__deepEquals(
        this.totalResult,
        (other as AuthorizationServicePaginationResponse).totalResult,
      )
    ) {
      return false;
    }
    if (
      !AuthorizationServicePaginationResponse.__deepEquals(
        this.appliedLimit,
        (other as AuthorizationServicePaginationResponse).appliedLimit,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        AuthorizationServicePaginationResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          AuthorizationServicePaginationResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !AuthorizationServicePaginationResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          AuthorizationServicePaginationResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
