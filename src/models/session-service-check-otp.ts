...
export class SessionServiceCheckOTP {
  /**
  ...
  constructor(data?: Partial<SessionServiceCheckOTP>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof SessionServiceCheckOTP)) {
      return false;
    }
    if (
      !SessionServiceCheckOTP.__deepEquals(
        this.code,
        (other as SessionServiceCheckOTP).code,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => SessionServiceCheckOTP.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => SessionServiceCheckOTP.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !SessionServiceCheckOTP.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          SessionServiceCheckOTP.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
