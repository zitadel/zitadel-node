...
export class SessionServiceOTPFactor {
  /**
  ...
  constructor(data?: Partial<SessionServiceOTPFactor>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof SessionServiceOTPFactor)) {
      return false;
    }
    if (
      !SessionServiceOTPFactor.__deepEquals(
        this.verifiedAt,
        (other as SessionServiceOTPFactor).verifiedAt,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => SessionServiceOTPFactor.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => SessionServiceOTPFactor.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !SessionServiceOTPFactor.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          SessionServiceOTPFactor.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
