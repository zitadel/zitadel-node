...
export class SAMLServicePostResponse {
  /**
  ...
  constructor(data?: Partial<SAMLServicePostResponse>) {
    ...
    if (this.samlResponse != null && typeof this.samlResponse !== "string") {
      throw new TypeError(
        `samlResponse must be a string, got ${typeof this.samlResponse}`,
      );
    }
  }
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof SAMLServicePostResponse)) {
      return false;
    }
    if (
      !SAMLServicePostResponse.__deepEquals(
        this.relayState,
        (other as SAMLServicePostResponse).relayState,
      )
    ) {
      return false;
    }
    if (
      !SAMLServicePostResponse.__deepEquals(
        this.samlResponse,
        (other as SAMLServicePostResponse).samlResponse,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => SAMLServicePostResponse.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => SAMLServicePostResponse.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !SAMLServicePostResponse.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          SAMLServicePostResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
