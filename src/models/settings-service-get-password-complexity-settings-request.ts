...
export class SettingsServiceGetPasswordComplexitySettingsRequest {
  /**
  ...
  constructor(
    data?: Partial<SettingsServiceGetPasswordComplexitySettingsRequest>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !(other instanceof SettingsServiceGetPasswordComplexitySettingsRequest)
    ) {
      return false;
    }
    if (
      !SettingsServiceGetPasswordComplexitySettingsRequest.__deepEquals(
        this.ctx,
        (other as SettingsServiceGetPasswordComplexitySettingsRequest).ctx,
      )
    ) {
      return false;
    }
