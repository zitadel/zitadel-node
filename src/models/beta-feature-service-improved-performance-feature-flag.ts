...
export class BetaFeatureServiceImprovedPerformanceFeatureFlag {
  ...
  constructor(
    data?: Partial<BetaFeatureServiceImprovedPerformanceFeatureFlag>,
  ) {
    ...
    if (this.source != null) {
      const sourceValues = Object.values(BetaFeatureServiceSource).filter(
        (v) =>
          typeof (BetaFeatureServiceSource as Record<string, unknown>)[
            v as string
          ] !== "number",
      );
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaFeatureServiceImprovedPerformanceFeatureFlag)) {
      return false;
    }
    if (
      !BetaFeatureServiceImprovedPerformanceFeatureFlag.__deepEquals(
        this.executionPaths,
        (other as BetaFeatureServiceImprovedPerformanceFeatureFlag)
          .executionPaths,
      )
    ) {
      return false;
    ...
    if (
      !BetaFeatureServiceImprovedPerformanceFeatureFlag.__deepEquals(
        this.source,
        (other as BetaFeatureServiceImprovedPerformanceFeatureFlag).source,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaFeatureServiceImprovedPerformanceFeatureFlag.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaFeatureServiceImprovedPerformanceFeatureFlag.__deepEquals(v, w),
        ),
      );
    }
