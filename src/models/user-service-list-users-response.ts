...
import { UserServiceListDetails } from "./user-service-list-details.js";
import { UserServiceUser } from "./user-service-user.js";
import { UserServiceUserFieldName } from "./user-service-user-field-name.js";
import { Expose, Type } from "class-transformer";

export class UserServiceListUsersResponse {
  /**
  ...
  constructor(data?: Partial<UserServiceListUsersResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceListUsersResponse)) {
      return false;
    }
    if (
      !UserServiceListUsersResponse.__deepEquals(
        this.details,
        (other as UserServiceListUsersResponse).details,
      )
    ) {
      return false;
    }
    if (
      !UserServiceListUsersResponse.__deepEquals(
        this.sortingColumn,
        (other as UserServiceListUsersResponse).sortingColumn,
      )
    ) {
      return false;
    }
    if (
      !UserServiceListUsersResponse.__deepEquals(
        this.result,
        (other as UserServiceListUsersResponse).result,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceListUsersResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceListUsersResponse.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceListUsersResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceListUsersResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
