...
export class BetaOrganizationServiceVerifyOrganizationDomainResponse {
  /**
  ...
  constructor(
    data?: Partial<BetaOrganizationServiceVerifyOrganizationDomainResponse>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !(
        other instanceof BetaOrganizationServiceVerifyOrganizationDomainResponse
      )
    ) {
      return false;
    }
    if (
      !BetaOrganizationServiceVerifyOrganizationDomainResponse.__deepEquals(
        this.changeDate,
        (other as BetaOrganizationServiceVerifyOrganizationDomainResponse)
          .changeDate,
      )
    ) {
      return false;
