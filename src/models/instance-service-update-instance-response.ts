...
export class InstanceServiceUpdateInstanceResponse {
  /**
  ...
  constructor(data?: Partial<InstanceServiceUpdateInstanceResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof InstanceServiceUpdateInstanceResponse)) {
      return false;
    }
    if (
      !InstanceServiceUpdateInstanceResponse.__deepEquals(
        this.changeDate,
        (other as InstanceServiceUpdateInstanceResponse).changeDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        InstanceServiceUpdateInstanceResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          InstanceServiceUpdateInstanceResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !InstanceServiceUpdateInstanceResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          InstanceServiceUpdateInstanceResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
