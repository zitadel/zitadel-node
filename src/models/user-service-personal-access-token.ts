...
export class UserServicePersonalAccessToken {
  /**
  ...
  constructor(data?: Partial<UserServicePersonalAccessToken>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServicePersonalAccessToken)) {
      return false;
    }
    if (
      !UserServicePersonalAccessToken.__deepEquals(
        this.creationDate,
        (other as UserServicePersonalAccessToken).creationDate,
      )
    ) {
      return false;
    }
    if (
      !UserServicePersonalAccessToken.__deepEquals(
        this.changeDate,
        (other as UserServicePersonalAccessToken).changeDate,
      )
    ) {
      return false;
    }
    if (
      !UserServicePersonalAccessToken.__deepEquals(
        this.id,
        (other as UserServicePersonalAccessToken).id,
      )
    ) {
      return false;
    }
    if (
      !UserServicePersonalAccessToken.__deepEquals(
        this.userId,
        (other as UserServicePersonalAccessToken).userId,
      )
    ) {
      return false;
    }
    if (
      !UserServicePersonalAccessToken.__deepEquals(
        this.organizationId,
        (other as UserServicePersonalAccessToken).organizationId,
      )
    ) {
      return false;
    }
    if (
      !UserServicePersonalAccessToken.__deepEquals(
        this.expirationDate,
        (other as UserServicePersonalAccessToken).expirationDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServicePersonalAccessToken.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServicePersonalAccessToken.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServicePersonalAccessToken.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServicePersonalAccessToken.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
