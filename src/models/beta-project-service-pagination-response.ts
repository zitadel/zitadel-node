...
export class BetaProjectServicePaginationResponse {
  /**
  ...
  constructor(data?: Partial<BetaProjectServicePaginationResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaProjectServicePaginationResponse)) {
      return false;
    }
    if (
      !BetaProjectServicePaginationResponse.__deepEquals(
        this.totalResult,
        (other as BetaProjectServicePaginationResponse).totalResult,
      )
    ) {
      return false;
    }
    if (
      !BetaProjectServicePaginationResponse.__deepEquals(
        this.appliedLimit,
        (other as BetaProjectServicePaginationResponse).appliedLimit,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaProjectServicePaginationResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaProjectServicePaginationResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaProjectServicePaginationResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaProjectServicePaginationResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
