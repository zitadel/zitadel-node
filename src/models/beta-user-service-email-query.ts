...
export class BetaUserServiceEmailQuery {
  ...
  constructor(data?: Partial<BetaUserServiceEmailQuery>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaUserServiceEmailQuery)) {
      return false;
    }
    if (
      !BetaUserServiceEmailQuery.__deepEquals(
        this.emailAddress,
        (other as BetaUserServiceEmailQuery).emailAddress,
      )
    ) {
      return false;
    }
    if (
      !BetaUserServiceEmailQuery.__deepEquals(
        this.method,
        (other as BetaUserServiceEmailQuery).method,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => BetaUserServiceEmailQuery.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaUserServiceEmailQuery.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !BetaUserServiceEmailQuery.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaUserServiceEmailQuery.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
