...
export class UserServiceIDPLink {
  /**
  ...
  constructor(data?: Partial<UserServiceIDPLink>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceIDPLink)) {
      return false;
    }
    if (
      !UserServiceIDPLink.__deepEquals(
        this.idpId,
        (other as UserServiceIDPLink).idpId,
      )
    ) {
      return false;
    }
    if (
      !UserServiceIDPLink.__deepEquals(
        this.userId,
        (other as UserServiceIDPLink).userId,
      )
    ) {
      return false;
    }
    if (
      !UserServiceIDPLink.__deepEquals(
        this.userName,
        (other as UserServiceIDPLink).userName,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => UserServiceIDPLink.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceIDPLink.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !UserServiceIDPLink.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceIDPLink.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
