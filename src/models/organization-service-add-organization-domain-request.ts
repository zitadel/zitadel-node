...
export class OrganizationServiceAddOrganizationDomainRequest {
  /**
  ...
  constructor(data?: Partial<OrganizationServiceAddOrganizationDomainRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof OrganizationServiceAddOrganizationDomainRequest)) {
      return false;
    }
    if (
      !OrganizationServiceAddOrganizationDomainRequest.__deepEquals(
        this.organizationId,
        (other as OrganizationServiceAddOrganizationDomainRequest)
          .organizationId,
      )
    ) {
      return false;
    ...
    if (
      !OrganizationServiceAddOrganizationDomainRequest.__deepEquals(
        this.domain,
        (other as OrganizationServiceAddOrganizationDomainRequest).domain,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        OrganizationServiceAddOrganizationDomainRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          OrganizationServiceAddOrganizationDomainRequest.__deepEquals(v, w),
        ),
      );
    }
