...
export class UserServiceListIDPLinksRequest {
  /**
  ...
  constructor(data?: Partial<UserServiceListIDPLinksRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceListIDPLinksRequest)) {
      return false;
    }
    if (
      !UserServiceListIDPLinksRequest.__deepEquals(
        this.userId,
        (other as UserServiceListIDPLinksRequest).userId,
      )
    ) {
      return false;
    }
    if (
      !UserServiceListIDPLinksRequest.__deepEquals(
        this.query,
        (other as UserServiceListIDPLinksRequest).query,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceListIDPLinksRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceListIDPLinksRequest.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceListIDPLinksRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceListIDPLinksRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
