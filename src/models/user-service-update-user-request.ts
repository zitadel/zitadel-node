...
export class UserServiceUpdateUserRequest {
  ...
  constructor(data?: Partial<UserServiceUpdateUserRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceUpdateUserRequest)) {
      return false;
    }
    if (
      !UserServiceUpdateUserRequest.__deepEquals(
        this.userId,
        (other as UserServiceUpdateUserRequest).userId,
      )
    ) {
      return false;
    }
    if (
      !UserServiceUpdateUserRequest.__deepEquals(
        this.username,
        (other as UserServiceUpdateUserRequest).username,
      )
    ) {
      return false;
    }
    if (
      !UserServiceUpdateUserRequest.__deepEquals(
        this.human,
        (other as UserServiceUpdateUserRequest).human,
      )
    ) {
      return false;
    }
    if (
      !UserServiceUpdateUserRequest.__deepEquals(
        this.machine,
        (other as UserServiceUpdateUserRequest).machine,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceUpdateUserRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceUpdateUserRequest.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceUpdateUserRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceUpdateUserRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
