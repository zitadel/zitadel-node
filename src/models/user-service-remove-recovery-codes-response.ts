...
export class UserServiceRemoveRecoveryCodesResponse {
  /**
  ...
  constructor(data?: Partial<UserServiceRemoveRecoveryCodesResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceRemoveRecoveryCodesResponse)) {
      return false;
    }
    if (
      !UserServiceRemoveRecoveryCodesResponse.__deepEquals(
        this.details,
        (other as UserServiceRemoveRecoveryCodesResponse).details,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceRemoveRecoveryCodesResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          UserServiceRemoveRecoveryCodesResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceRemoveRecoveryCodesResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceRemoveRecoveryCodesResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
