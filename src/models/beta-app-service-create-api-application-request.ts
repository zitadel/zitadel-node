...
import { BetaAppServiceAPIAuthMethodType } from "./beta-app-service-api-auth-method-type.js";
import { Expose, Type } from "class-transformer";

export class BetaAppServiceCreateAPIApplicationRequest {
  /**
  ...
  constructor(data?: Partial<BetaAppServiceCreateAPIApplicationRequest>) {
    ...
    if (this.authMethodType != null) {
      const authMethodTypeValues = Object.values(
        ...
        (v) =>
          typeof (BetaAppServiceAPIAuthMethodType as Record<string, unknown>)[
            v as string
          ] !== "number",
      );
      if (
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaAppServiceCreateAPIApplicationRequest)) {
      return false;
    }
    if (
      !BetaAppServiceCreateAPIApplicationRequest.__deepEquals(
        this.authMethodType,
        (other as BetaAppServiceCreateAPIApplicationRequest).authMethodType,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaAppServiceCreateAPIApplicationRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaAppServiceCreateAPIApplicationRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaAppServiceCreateAPIApplicationRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaAppServiceCreateAPIApplicationRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
