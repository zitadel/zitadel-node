...
export class BetaProjectServiceCreateProjectResponse {
  /**
  ...
  constructor(data?: Partial<BetaProjectServiceCreateProjectResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaProjectServiceCreateProjectResponse)) {
      return false;
    }
    if (
      !BetaProjectServiceCreateProjectResponse.__deepEquals(
        this.id,
        (other as BetaProjectServiceCreateProjectResponse).id,
      )
    ) {
      return false;
    }
    if (
      !BetaProjectServiceCreateProjectResponse.__deepEquals(
        this.creationDate,
        (other as BetaProjectServiceCreateProjectResponse).creationDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaProjectServiceCreateProjectResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaProjectServiceCreateProjectResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaProjectServiceCreateProjectResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaProjectServiceCreateProjectResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
