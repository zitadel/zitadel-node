...
export class BetaProjectServicePaginationRequest {
  /**
  ...
  constructor(data?: Partial<BetaProjectServicePaginationRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaProjectServicePaginationRequest)) {
      return false;
    }
    if (
      !BetaProjectServicePaginationRequest.__deepEquals(
        this.offset,
        (other as BetaProjectServicePaginationRequest).offset,
      )
    ) {
      return false;
    }
    if (
      !BetaProjectServicePaginationRequest.__deepEquals(
        this.limit,
        (other as BetaProjectServicePaginationRequest).limit,
      )
    ) {
      return false;
    }
    if (
      !BetaProjectServicePaginationRequest.__deepEquals(
        this.asc,
        (other as BetaProjectServicePaginationRequest).asc,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaProjectServicePaginationRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaProjectServicePaginationRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaProjectServicePaginationRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaProjectServicePaginationRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
