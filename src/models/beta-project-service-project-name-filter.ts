...
import { BetaProjectServiceTextFilterMethod } from "./beta-project-service-text-filter-method.js";
import { Expose, Type } from "class-transformer";

export class BetaProjectServiceProjectNameFilter {
  /**
  ...
  constructor(data?: Partial<BetaProjectServiceProjectNameFilter>) {
    ...
    if (this.method != null) {
      const methodValues = Object.values(
        ...
        (v) =>
          typeof (
            BetaProjectServiceTextFilterMethod as Record<string, unknown>
          )[v as string] !== "number",
      );
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaProjectServiceProjectNameFilter)) {
      return false;
    }
    if (
      !BetaProjectServiceProjectNameFilter.__deepEquals(
        this.projectName,
        (other as BetaProjectServiceProjectNameFilter).projectName,
      )
    ) {
      return false;
    }
    if (
      !BetaProjectServiceProjectNameFilter.__deepEquals(
        this.method,
        (other as BetaProjectServiceProjectNameFilter).method,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaProjectServiceProjectNameFilter.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaProjectServiceProjectNameFilter.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaProjectServiceProjectNameFilter.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaProjectServiceProjectNameFilter.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
