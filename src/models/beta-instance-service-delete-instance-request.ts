...
export class BetaInstanceServiceDeleteInstanceRequest {
  /**
  ...
  constructor(data?: Partial<BetaInstanceServiceDeleteInstanceRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaInstanceServiceDeleteInstanceRequest)) {
      return false;
    }
    if (
      !BetaInstanceServiceDeleteInstanceRequest.__deepEquals(
        this.instanceId,
        (other as BetaInstanceServiceDeleteInstanceRequest).instanceId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaInstanceServiceDeleteInstanceRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaInstanceServiceDeleteInstanceRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaInstanceServiceDeleteInstanceRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaInstanceServiceDeleteInstanceRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
