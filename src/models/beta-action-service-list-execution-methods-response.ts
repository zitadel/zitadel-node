...
export class BetaActionServiceListExecutionMethodsResponse {
  /**
  ...
  constructor(data?: Partial<BetaActionServiceListExecutionMethodsResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaActionServiceListExecutionMethodsResponse)) {
      return false;
    }
    if (
      !BetaActionServiceListExecutionMethodsResponse.__deepEquals(
        this.methods,
        (other as BetaActionServiceListExecutionMethodsResponse).methods,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaActionServiceListExecutionMethodsResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaActionServiceListExecutionMethodsResponse.__deepEquals(v, w),
        ),
      );
    }
