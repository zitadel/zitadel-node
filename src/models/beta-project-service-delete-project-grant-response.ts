...
export class BetaProjectServiceDeleteProjectGrantResponse {
  /**
  ...
  constructor(data?: Partial<BetaProjectServiceDeleteProjectGrantResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaProjectServiceDeleteProjectGrantResponse)) {
      return false;
    }
    if (
      !BetaProjectServiceDeleteProjectGrantResponse.__deepEquals(
        this.deletionDate,
        (other as BetaProjectServiceDeleteProjectGrantResponse).deletionDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaProjectServiceDeleteProjectGrantResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaProjectServiceDeleteProjectGrantResponse.__deepEquals(v, w),
        ),
      );
    }
