...
export class ProjectServiceDeleteProjectRequest {
  /**
  ...
  constructor(data?: Partial<ProjectServiceDeleteProjectRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ProjectServiceDeleteProjectRequest)) {
      return false;
    }
    if (
      !ProjectServiceDeleteProjectRequest.__deepEquals(
        this.projectId,
        (other as ProjectServiceDeleteProjectRequest).projectId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ProjectServiceDeleteProjectRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          ProjectServiceDeleteProjectRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !ProjectServiceDeleteProjectRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ProjectServiceDeleteProjectRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
