...
export class BetaUserServiceSetEmailRequest {
  /**
  ...
  constructor(data?: Partial<BetaUserServiceSetEmailRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaUserServiceSetEmailRequest)) {
      return false;
    }
    if (
      !BetaUserServiceSetEmailRequest.__deepEquals(
        this.userId,
        (other as BetaUserServiceSetEmailRequest).userId,
      )
    ) {
      return false;
    }
    if (
      !BetaUserServiceSetEmailRequest.__deepEquals(
        this.email,
        (other as BetaUserServiceSetEmailRequest).email,
      )
    ) {
      return false;
    }
    if (
      !BetaUserServiceSetEmailRequest.__deepEquals(
        this.isVerified,
        (other as BetaUserServiceSetEmailRequest).isVerified,
      )
    ) {
      return false;
    }
    if (
      !BetaUserServiceSetEmailRequest.__deepEquals(
        this.returnCode,
        (other as BetaUserServiceSetEmailRequest).returnCode,
      )
    ) {
      return false;
    }
    if (
      !BetaUserServiceSetEmailRequest.__deepEquals(
        this.sendCode,
        (other as BetaUserServiceSetEmailRequest).sendCode,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaUserServiceSetEmailRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaUserServiceSetEmailRequest.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaUserServiceSetEmailRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaUserServiceSetEmailRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
