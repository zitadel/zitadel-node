...
export class BetaUserServiceSetPasswordResponse {
  /**
  ...
  constructor(data?: Partial<BetaUserServiceSetPasswordResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaUserServiceSetPasswordResponse)) {
      return false;
    }
    if (
      !BetaUserServiceSetPasswordResponse.__deepEquals(
        this.details,
        (other as BetaUserServiceSetPasswordResponse).details,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaUserServiceSetPasswordResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaUserServiceSetPasswordResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaUserServiceSetPasswordResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaUserServiceSetPasswordResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
