...
export class BetaOrganizationServiceDeleteOrganizationDomainResponse {
  /**
  ...
  constructor(
    data?: Partial<BetaOrganizationServiceDeleteOrganizationDomainResponse>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !(
        other instanceof BetaOrganizationServiceDeleteOrganizationDomainResponse
      )
    ) {
      return false;
    }
    if (
      !BetaOrganizationServiceDeleteOrganizationDomainResponse.__deepEquals(
        this.deletionDate,
        (other as BetaOrganizationServiceDeleteOrganizationDomainResponse)
          .deletionDate,
      )
    ) {
      return false;
