 ...
 */
export class UserServiceUserNameQuery {
  /**
  ...
  constructor(data?: Partial<UserServiceUserNameQuery>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceUserNameQuery)) {
      return false;
    }
    if (
      !UserServiceUserNameQuery.__deepEquals(
        this.userName,
        (other as UserServiceUserNameQuery).userName,
      )
    ) {
      return false;
    }
    if (
      !UserServiceUserNameQuery.__deepEquals(
        this.method,
        (other as UserServiceUserNameQuery).method,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => UserServiceUserNameQuery.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceUserNameQuery.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !UserServiceUserNameQuery.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceUserNameQuery.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
