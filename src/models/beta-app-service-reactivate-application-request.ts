...
export class BetaAppServiceReactivateApplicationRequest {
  /**
  ...
  constructor(data?: Partial<BetaAppServiceReactivateApplicationRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaAppServiceReactivateApplicationRequest)) {
      return false;
    }
    if (
      !BetaAppServiceReactivateApplicationRequest.__deepEquals(
        this.projectId,
        (other as BetaAppServiceReactivateApplicationRequest).projectId,
      )
    ) {
      return false;
    }
    if (
      !BetaAppServiceReactivateApplicationRequest.__deepEquals(
        this.id,
        (other as BetaAppServiceReactivateApplicationRequest).id,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaAppServiceReactivateApplicationRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaAppServiceReactivateApplicationRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaAppServiceReactivateApplicationRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaAppServiceReactivateApplicationRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
