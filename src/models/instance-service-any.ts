 ...
 */
export class InstanceServiceAny {
  /**
  ...
  constructor(data?: Partial<InstanceServiceAny>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof InstanceServiceAny)) {
      return false;
    }
    if (
      !InstanceServiceAny.__deepEquals(
        this.type,
        (other as InstanceServiceAny).type,
      )
    ) {
      return false;
    }
    if (
      !InstanceServiceAny.__deepEquals(
        this.value,
        (other as InstanceServiceAny).value,
      )
    ) {
      return false;
    }
    if (
      !InstanceServiceAny.__deepEquals(
        this.debug,
        (other as InstanceServiceAny).debug,
      )
    ) {
      return false;
    }
    {
      ...
      for (const k of selfKeys) {
        ...
        if (!InstanceServiceAny.__deepEquals(selfRec[k], otherRec[k])) {
          return false;
        }
      }
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => InstanceServiceAny.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => InstanceServiceAny.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !InstanceServiceAny.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          InstanceServiceAny.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
