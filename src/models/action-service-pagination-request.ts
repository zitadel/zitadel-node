...
export class ActionServicePaginationRequest {
  /**
  ...
  constructor(data?: Partial<ActionServicePaginationRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ActionServicePaginationRequest)) {
      return false;
    }
    if (
      !ActionServicePaginationRequest.__deepEquals(
        this.offset,
        (other as ActionServicePaginationRequest).offset,
      )
    ) {
      return false;
    }
    if (
      !ActionServicePaginationRequest.__deepEquals(
        this.limit,
        (other as ActionServicePaginationRequest).limit,
      )
    ) {
      return false;
    }
    if (
      !ActionServicePaginationRequest.__deepEquals(
        this.asc,
        (other as ActionServicePaginationRequest).asc,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ActionServicePaginationRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => ActionServicePaginationRequest.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !ActionServicePaginationRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ActionServicePaginationRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
