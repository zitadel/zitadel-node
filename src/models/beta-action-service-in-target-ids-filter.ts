...
export class BetaActionServiceInTargetIDsFilter {
  /**
  ...
  constructor(data?: Partial<BetaActionServiceInTargetIDsFilter>) {
    Object.assign(this, data);
    if (
      this.targetIds != null &&
      !Array.isArray(this.targetIds) &&
      !((this.targetIds as unknown) instanceof Set)
    ) {
      throw new TypeError(
        `targetIds must be an array, got ${typeof this.targetIds}`,
      );
    }
  }
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaActionServiceInTargetIDsFilter)) {
      return false;
    }
    if (
      !BetaActionServiceInTargetIDsFilter.__deepEquals(
        this.targetIds,
        (other as BetaActionServiceInTargetIDsFilter).targetIds,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaActionServiceInTargetIDsFilter.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaActionServiceInTargetIDsFilter.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaActionServiceInTargetIDsFilter.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaActionServiceInTargetIDsFilter.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
