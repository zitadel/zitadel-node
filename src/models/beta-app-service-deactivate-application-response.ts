...
export class BetaAppServiceDeactivateApplicationResponse {
  /**
   ...
   */
  @Expose({ name: "deactivationDate" })
  @Type(() => Date)
  deactivationDate?: Date;

  constructor(data?: Partial<BetaAppServiceDeactivateApplicationResponse>) {
    ...
    if (
      ...
      (!(this.deactivationDate instanceof Date) ||
        Number.isNaN(this.deactivationDate.getTime()))
    ) {
      throw new TypeError(
        `deactivationDate must be a valid Date, got ${String(this.deactivationDate)}`,
      );
    }
  }
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaAppServiceDeactivateApplicationResponse)) {
      return false;
    }
    if (
      !BetaAppServiceDeactivateApplicationResponse.__deepEquals(
        this.deactivationDate,
        (other as BetaAppServiceDeactivateApplicationResponse).deactivationDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaAppServiceDeactivateApplicationResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaAppServiceDeactivateApplicationResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaAppServiceDeactivateApplicationResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
