...
import { BetaAppServiceApplicationNameQuery } from "./beta-app-service-application-name-query.js";
...
export class BetaAppServiceApplicationSearchFilter {
  ...
  constructor(data?: Partial<BetaAppServiceApplicationSearchFilter>) {
    Object.assign(this, data);
    if (this.apiAppOnly != null && typeof this.apiAppOnly !== "boolean") {
      throw new TypeError(
        `apiAppOnly must be a boolean, got ${typeof this.apiAppOnly}`,
      );
    }
    if (this.oidcAppOnly != null && typeof this.oidcAppOnly !== "boolean") {
      throw new TypeError(
        `oidcAppOnly must be a boolean, got ${typeof this.oidcAppOnly}`,
      );
    }
    if (this.samlAppOnly != null && typeof this.samlAppOnly !== "boolean") {
      throw new TypeError(
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaAppServiceApplicationSearchFilter)) {
      return false;
    }
    if (
      !BetaAppServiceApplicationSearchFilter.__deepEquals(
        this.apiAppOnly,
        (other as BetaAppServiceApplicationSearchFilter).apiAppOnly,
      )
    ) {
      return false;
    }
    if (
      !BetaAppServiceApplicationSearchFilter.__deepEquals(
        this.nameFilter,
        (other as BetaAppServiceApplicationSearchFilter).nameFilter,
      )
    ) {
      return false;
    }
    if (
      !BetaAppServiceApplicationSearchFilter.__deepEquals(
        this.oidcAppOnly,
        (other as BetaAppServiceApplicationSearchFilter).oidcAppOnly,
      )
    ) {
      return false;
    }
    if (
      !BetaAppServiceApplicationSearchFilter.__deepEquals(
        this.samlAppOnly,
        (other as BetaAppServiceApplicationSearchFilter).samlAppOnly,
      )
    ) {
      return false;
    }
    if (
      !BetaAppServiceApplicationSearchFilter.__deepEquals(
        this.stateFilter,
        (other as BetaAppServiceApplicationSearchFilter).stateFilter,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaAppServiceApplicationSearchFilter.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaAppServiceApplicationSearchFilter.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaAppServiceApplicationSearchFilter.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaAppServiceApplicationSearchFilter.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
