...
export class BetaActionServiceSetExecutionResponse {
  /**
  ...
  constructor(data?: Partial<BetaActionServiceSetExecutionResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaActionServiceSetExecutionResponse)) {
      return false;
    }
    if (
      !BetaActionServiceSetExecutionResponse.__deepEquals(
        this.setDate,
        (other as BetaActionServiceSetExecutionResponse).setDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaActionServiceSetExecutionResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaActionServiceSetExecutionResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaActionServiceSetExecutionResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaActionServiceSetExecutionResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
