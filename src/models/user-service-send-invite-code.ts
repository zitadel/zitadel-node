...
export class UserServiceSendInviteCode {
  /**
  ...
  constructor(data?: Partial<UserServiceSendInviteCode>) {
    ...
    if (
      ...
      typeof this.applicationName !== "string"
    ) {
      throw new TypeError(
        `applicationName must be a string, got ${typeof this.applicationName}`,
      );
    }
  }
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceSendInviteCode)) {
      return false;
    }
    if (
      !UserServiceSendInviteCode.__deepEquals(
        this.urlTemplate,
        (other as UserServiceSendInviteCode).urlTemplate,
      )
    ) {
      return false;
    }
    if (
      !UserServiceSendInviteCode.__deepEquals(
        ...
        (other as UserServiceSendInviteCode).applicationName,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => UserServiceSendInviteCode.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceSendInviteCode.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !UserServiceSendInviteCode.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceSendInviteCode.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
