...
export class ProjectServiceConnectError {
  ...
  constructor(data?: Partial<ProjectServiceConnectError>) {
    ...
    if (this.code != null) {
      const codeValues = Object.values(
        ProjectServiceConnectErrorCodeEnum,
      ).filter(
        (v) =>
          typeof (
            ProjectServiceConnectErrorCodeEnum as Record<string, unknown>
          )[v as string] !== "number",
      );
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ProjectServiceConnectError)) {
      return false;
    }
    if (
      !ProjectServiceConnectError.__deepEquals(
        this.code,
        (other as ProjectServiceConnectError).code,
      )
    ) {
      return false;
    }
    if (
      !ProjectServiceConnectError.__deepEquals(
        this.message,
        (other as ProjectServiceConnectError).message,
      )
    ) {
      return false;
    }
    if (
      !ProjectServiceConnectError.__deepEquals(
        this.details,
        (other as ProjectServiceConnectError).details,
      )
    ) {
      return false;
    }
    {
      ...
      for (const k of selfKeys) {
        ...
        if (!ProjectServiceConnectError.__deepEquals(selfRec[k], otherRec[k])) {
          return false;
        }
      }
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ProjectServiceConnectError.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => ProjectServiceConnectError.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !ProjectServiceConnectError.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ProjectServiceConnectError.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
...
export enum ProjectServiceConnectErrorCodeEnum {
  Canceled = "canceled",
  Unknown = "unknown",
