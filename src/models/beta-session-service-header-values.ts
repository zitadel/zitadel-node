 ...
 */
export class BetaSessionServiceHeaderValues {
  /**
  ...
  constructor(data?: Partial<BetaSessionServiceHeaderValues>) {
    Object.assign(this, data);
    if (
      this.values != null &&
      !Array.isArray(this.values) &&
      !((this.values as unknown) instanceof Set)
    ) {
      throw new TypeError(`values must be an array, got ${typeof this.values}`);
    }
  }
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaSessionServiceHeaderValues)) {
      return false;
    }
    if (
      !BetaSessionServiceHeaderValues.__deepEquals(
        this.values,
        (other as BetaSessionServiceHeaderValues).values,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaSessionServiceHeaderValues.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaSessionServiceHeaderValues.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaSessionServiceHeaderValues.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaSessionServiceHeaderValues.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
