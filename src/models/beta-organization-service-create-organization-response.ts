...
import { BetaOrganizationServiceOrganizationAdmin } from "./beta-organization-service-organization-admin.js";
import { Expose, Type } from "class-transformer";

export class BetaOrganizationServiceCreateOrganizationResponse {
  /**
   ...
   */
  @Expose({ name: "organizationAdmins" })
  @Type(() => BetaOrganizationServiceOrganizationAdmin)
  organizationAdmins?: Array<BetaOrganizationServiceOrganizationAdmin>;

  constructor(
    data?: Partial<BetaOrganizationServiceCreateOrganizationResponse>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaOrganizationServiceCreateOrganizationResponse)) {
      return false;
    }
    if (
      !BetaOrganizationServiceCreateOrganizationResponse.__deepEquals(
        this.creationDate,
        (other as BetaOrganizationServiceCreateOrganizationResponse)
          .creationDate,
      )
    ) {
      return false;
    ...
    if (
      !BetaOrganizationServiceCreateOrganizationResponse.__deepEquals(
        this.id,
        (other as BetaOrganizationServiceCreateOrganizationResponse).id,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaOrganizationServiceCreateOrganizationResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaOrganizationServiceCreateOrganizationResponse.__deepEquals(v, w),
        ),
      );
    }
