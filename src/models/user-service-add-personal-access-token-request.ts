...
export class UserServiceAddPersonalAccessTokenRequest {
  /**
  ...
  constructor(data?: Partial<UserServiceAddPersonalAccessTokenRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceAddPersonalAccessTokenRequest)) {
      return false;
    }
    if (
      !UserServiceAddPersonalAccessTokenRequest.__deepEquals(
        this.userId,
        (other as UserServiceAddPersonalAccessTokenRequest).userId,
      )
    ) {
      return false;
    }
    if (
      !UserServiceAddPersonalAccessTokenRequest.__deepEquals(
        this.expirationDate,
        (other as UserServiceAddPersonalAccessTokenRequest).expirationDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceAddPersonalAccessTokenRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          UserServiceAddPersonalAccessTokenRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceAddPersonalAccessTokenRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceAddPersonalAccessTokenRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
