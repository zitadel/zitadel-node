 ...
 */
export class BetaUserServicePhoneQuery {
  /**
  ...
  constructor(data?: Partial<BetaUserServicePhoneQuery>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaUserServicePhoneQuery)) {
      return false;
    }
    if (
      !BetaUserServicePhoneQuery.__deepEquals(
        this.number,
        (other as BetaUserServicePhoneQuery).number,
      )
    ) {
      return false;
    }
    if (
      !BetaUserServicePhoneQuery.__deepEquals(
        this.method,
        (other as BetaUserServicePhoneQuery).method,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => BetaUserServicePhoneQuery.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaUserServicePhoneQuery.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !BetaUserServicePhoneQuery.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaUserServicePhoneQuery.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
