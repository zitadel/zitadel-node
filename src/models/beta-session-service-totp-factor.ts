...
export class BetaSessionServiceTOTPFactor {
  /**
  ...
  constructor(data?: Partial<BetaSessionServiceTOTPFactor>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaSessionServiceTOTPFactor)) {
      return false;
    }
    if (
      !BetaSessionServiceTOTPFactor.__deepEquals(
        this.verifiedAt,
        (other as BetaSessionServiceTOTPFactor).verifiedAt,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaSessionServiceTOTPFactor.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaSessionServiceTOTPFactor.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaSessionServiceTOTPFactor.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaSessionServiceTOTPFactor.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
