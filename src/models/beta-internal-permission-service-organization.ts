...
export class BetaInternalPermissionServiceOrganization {
  /**
  ...
  constructor(data?: Partial<BetaInternalPermissionServiceOrganization>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaInternalPermissionServiceOrganization)) {
      return false;
    }
    if (
      !BetaInternalPermissionServiceOrganization.__deepEquals(
        this.id,
        (other as BetaInternalPermissionServiceOrganization).id,
      )
    ) {
      return false;
    }
    if (
      !BetaInternalPermissionServiceOrganization.__deepEquals(
        this.name,
        (other as BetaInternalPermissionServiceOrganization).name,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaInternalPermissionServiceOrganization.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaInternalPermissionServiceOrganization.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaInternalPermissionServiceOrganization.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaInternalPermissionServiceOrganization.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
