...
export class BetaWebKeyServiceCreateWebKeyResponse {
  /**
  ...
  constructor(data?: Partial<BetaWebKeyServiceCreateWebKeyResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaWebKeyServiceCreateWebKeyResponse)) {
      return false;
    }
    if (
      !BetaWebKeyServiceCreateWebKeyResponse.__deepEquals(
        this.id,
        (other as BetaWebKeyServiceCreateWebKeyResponse).id,
      )
    ) {
      return false;
    }
    if (
      !BetaWebKeyServiceCreateWebKeyResponse.__deepEquals(
        this.creationDate,
        (other as BetaWebKeyServiceCreateWebKeyResponse).creationDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaWebKeyServiceCreateWebKeyResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaWebKeyServiceCreateWebKeyResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaWebKeyServiceCreateWebKeyResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaWebKeyServiceCreateWebKeyResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
