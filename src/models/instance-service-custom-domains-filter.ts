...
export class InstanceServiceCustomDomainsFilter {
  /**
  ...
  constructor(data?: Partial<InstanceServiceCustomDomainsFilter>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof InstanceServiceCustomDomainsFilter)) {
      return false;
    }
    if (
      !InstanceServiceCustomDomainsFilter.__deepEquals(
        this.domains,
        (other as InstanceServiceCustomDomainsFilter).domains,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        InstanceServiceCustomDomainsFilter.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          InstanceServiceCustomDomainsFilter.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !InstanceServiceCustomDomainsFilter.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          InstanceServiceCustomDomainsFilter.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
