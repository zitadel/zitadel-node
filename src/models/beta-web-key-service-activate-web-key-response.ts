...
export class BetaWebKeyServiceActivateWebKeyResponse {
  /**
  ...
  constructor(data?: Partial<BetaWebKeyServiceActivateWebKeyResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaWebKeyServiceActivateWebKeyResponse)) {
      return false;
    }
    if (
      !BetaWebKeyServiceActivateWebKeyResponse.__deepEquals(
        this.changeDate,
        (other as BetaWebKeyServiceActivateWebKeyResponse).changeDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaWebKeyServiceActivateWebKeyResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaWebKeyServiceActivateWebKeyResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaWebKeyServiceActivateWebKeyResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaWebKeyServiceActivateWebKeyResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
