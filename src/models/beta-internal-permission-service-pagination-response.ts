...
export class BetaInternalPermissionServicePaginationResponse {
  /**
  ...
  constructor(data?: Partial<BetaInternalPermissionServicePaginationResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaInternalPermissionServicePaginationResponse)) {
      return false;
    }
    if (
      !BetaInternalPermissionServicePaginationResponse.__deepEquals(
        this.totalResult,
        (other as BetaInternalPermissionServicePaginationResponse).totalResult,
      )
    ) {
      return false;
    }
    if (
      !BetaInternalPermissionServicePaginationResponse.__deepEquals(
        this.appliedLimit,
        (other as BetaInternalPermissionServicePaginationResponse).appliedLimit,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaInternalPermissionServicePaginationResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaInternalPermissionServicePaginationResponse.__deepEquals(v, w),
        ),
      );
    }
