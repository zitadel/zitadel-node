...
export class BetaInstanceServiceIdsQuery {
  /**
  ...
  constructor(data?: Partial<BetaInstanceServiceIdsQuery>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaInstanceServiceIdsQuery)) {
      return false;
    }
    if (
      !BetaInstanceServiceIdsQuery.__deepEquals(
        this.ids,
        (other as BetaInstanceServiceIdsQuery).ids,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaInstanceServiceIdsQuery.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaInstanceServiceIdsQuery.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaInstanceServiceIdsQuery.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaInstanceServiceIdsQuery.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
