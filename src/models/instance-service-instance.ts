...
import { InstanceServiceCustomDomain } from "./instance-service-custom-domain.js";
import { InstanceServiceState } from "./instance-service-state.js";
import { Expose, Type } from "class-transformer";

export class InstanceServiceInstance {
  /**
  ...
  @Type(() => InstanceServiceCustomDomain)
  customDomains?: Array<InstanceServiceCustomDomain>;

  constructor(data?: Partial<InstanceServiceInstance>) {
    ...
    if (this.state != null) {
      const stateValues = Object.values(InstanceServiceState).filter(
        (v) =>
          typeof (InstanceServiceState as Record<string, unknown>)[
            v as string
          ] !== "number",
      );
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof InstanceServiceInstance)) {
      return false;
    }
    if (
      !InstanceServiceInstance.__deepEquals(
        this.id,
        (other as InstanceServiceInstance).id,
      )
    ) {
      return false;
    }
    if (
      !InstanceServiceInstance.__deepEquals(
        this.changeDate,
        (other as InstanceServiceInstance).changeDate,
      )
    ) {
      return false;
    }
    if (
      !InstanceServiceInstance.__deepEquals(
        this.creationDate,
        (other as InstanceServiceInstance).creationDate,
      )
    ) {
      return false;
    }
    if (
      !InstanceServiceInstance.__deepEquals(
        this.state,
        (other as InstanceServiceInstance).state,
      )
    ) {
      return false;
    }
    if (
      !InstanceServiceInstance.__deepEquals(
        this.name,
        (other as InstanceServiceInstance).name,
      )
    ) {
      return false;
    }
    if (
      !InstanceServiceInstance.__deepEquals(
        this.version,
        (other as InstanceServiceInstance).version,
      )
    ) {
      return false;
    }
    if (
      !InstanceServiceInstance.__deepEquals(
        this.customDomains,
        (other as InstanceServiceInstance).customDomains,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => InstanceServiceInstance.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => InstanceServiceInstance.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !InstanceServiceInstance.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          InstanceServiceInstance.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
