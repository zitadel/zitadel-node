...
export class UserServiceAny {
  ...
  constructor(data?: Partial<UserServiceAny>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceAny)) {
      return false;
    }
    if (
      !UserServiceAny.__deepEquals(this.type, (other as UserServiceAny).type)
    ) {
      return false;
    }
    if (
      !UserServiceAny.__deepEquals(this.value, (other as UserServiceAny).value)
    ) {
      return false;
    }
    if (
      !UserServiceAny.__deepEquals(this.debug, (other as UserServiceAny).debug)
    ) {
      return false;
    }
    {
      ...
      for (const k of selfKeys) {
        ...
        if (!UserServiceAny.__deepEquals(selfRec[k], otherRec[k])) {
          return false;
        }
      }
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => UserServiceAny.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceAny.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !UserServiceAny.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceAny.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
