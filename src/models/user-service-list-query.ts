...
export class UserServiceListQuery {
  /**
  ...
  constructor(data?: Partial<UserServiceListQuery>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceListQuery)) {
      return false;
    }
    if (
      !UserServiceListQuery.__deepEquals(
        this.offset,
        (other as UserServiceListQuery).offset,
      )
    ) {
      return false;
    }
    if (
      !UserServiceListQuery.__deepEquals(
        this.limit,
        (other as UserServiceListQuery).limit,
      )
    ) {
      return false;
    }
    if (
      !UserServiceListQuery.__deepEquals(
        this.asc,
        (other as UserServiceListQuery).asc,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => UserServiceListQuery.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceListQuery.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !UserServiceListQuery.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceListQuery.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
