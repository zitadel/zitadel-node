...
export class BetaUserServiceUpdateHumanUserRequest {
  ...
  constructor(data?: Partial<BetaUserServiceUpdateHumanUserRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaUserServiceUpdateHumanUserRequest)) {
      return false;
    }
    if (
      !BetaUserServiceUpdateHumanUserRequest.__deepEquals(
        this.userId,
        (other as BetaUserServiceUpdateHumanUserRequest).userId,
      )
    ) {
      return false;
    }
    if (
      !BetaUserServiceUpdateHumanUserRequest.__deepEquals(
        this.username,
        (other as BetaUserServiceUpdateHumanUserRequest).username,
      )
    ) {
      return false;
    }
    if (
      !BetaUserServiceUpdateHumanUserRequest.__deepEquals(
        this.profile,
        (other as BetaUserServiceUpdateHumanUserRequest).profile,
      )
    ) {
      return false;
    }
    if (
      !BetaUserServiceUpdateHumanUserRequest.__deepEquals(
        this.email,
        (other as BetaUserServiceUpdateHumanUserRequest).email,
      )
    ) {
      return false;
    }
    if (
      !BetaUserServiceUpdateHumanUserRequest.__deepEquals(
        this.phone,
        (other as BetaUserServiceUpdateHumanUserRequest).phone,
      )
    ) {
      return false;
    }
    if (
      !BetaUserServiceUpdateHumanUserRequest.__deepEquals(
        this.password,
        (other as BetaUserServiceUpdateHumanUserRequest).password,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaUserServiceUpdateHumanUserRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaUserServiceUpdateHumanUserRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaUserServiceUpdateHumanUserRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaUserServiceUpdateHumanUserRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
