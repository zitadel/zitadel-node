...
import { UserServiceByteFilterMethod } from "./user-service-byte-filter-method.js";
...
export class UserServiceMetadataValueFilter {
  ...
  constructor(data?: Partial<UserServiceMetadataValueFilter>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceMetadataValueFilter)) {
      return false;
    }
    if (
      !UserServiceMetadataValueFilter.__deepEquals(
        this.value,
        (other as UserServiceMetadataValueFilter).value,
      )
    ) {
      return false;
    }
    if (
      !UserServiceMetadataValueFilter.__deepEquals(
        this.method,
        (other as UserServiceMetadataValueFilter).method,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceMetadataValueFilter.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceMetadataValueFilter.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceMetadataValueFilter.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceMetadataValueFilter.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
