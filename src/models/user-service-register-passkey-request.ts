...
import { UserServicePasskeyAuthenticator } from "./user-service-passkey-authenticator.js";
import { UserServicePasskeyRegistrationCode } from "./user-service-passkey-registration-code.js";
...
export class UserServiceRegisterPasskeyRequest {
  ...
  constructor(data?: Partial<UserServiceRegisterPasskeyRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceRegisterPasskeyRequest)) {
      return false;
    }
    if (
      !UserServiceRegisterPasskeyRequest.__deepEquals(
        this.userId,
        (other as UserServiceRegisterPasskeyRequest).userId,
      )
    ) {
      return false;
    }
    if (
      !UserServiceRegisterPasskeyRequest.__deepEquals(
        this.code,
        (other as UserServiceRegisterPasskeyRequest).code,
      )
    ) {
      return false;
    }
    if (
      !UserServiceRegisterPasskeyRequest.__deepEquals(
        this.authenticator,
        (other as UserServiceRegisterPasskeyRequest).authenticator,
      )
    ) {
      return false;
    }
    if (
      !UserServiceRegisterPasskeyRequest.__deepEquals(
        this.domain,
        (other as UserServiceRegisterPasskeyRequest).domain,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceRegisterPasskeyRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceRegisterPasskeyRequest.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceRegisterPasskeyRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceRegisterPasskeyRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
