...
export class BetaOrganizationServiceActivateOrganizationRequest {
  /**
  ...
  constructor(
    data?: Partial<BetaOrganizationServiceActivateOrganizationRequest>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !(other instanceof BetaOrganizationServiceActivateOrganizationRequest)
    ) {
      return false;
    }
    if (
      !BetaOrganizationServiceActivateOrganizationRequest.__deepEquals(
        this.id,
        (other as BetaOrganizationServiceActivateOrganizationRequest).id,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaOrganizationServiceActivateOrganizationRequest.__deepEquals(v, w),
        ),
      );
    }
