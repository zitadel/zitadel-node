...
export class BetaWebKeyServiceActivateWebKeyRequest {
  /**
  ...
  constructor(data?: Partial<BetaWebKeyServiceActivateWebKeyRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaWebKeyServiceActivateWebKeyRequest)) {
      return false;
    }
    if (
      !BetaWebKeyServiceActivateWebKeyRequest.__deepEquals(
        this.id,
        (other as BetaWebKeyServiceActivateWebKeyRequest).id,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaWebKeyServiceActivateWebKeyRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaWebKeyServiceActivateWebKeyRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaWebKeyServiceActivateWebKeyRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaWebKeyServiceActivateWebKeyRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
