...
export class FeatureServiceFeatureFlag {
  ...
  constructor(data?: Partial<FeatureServiceFeatureFlag>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof FeatureServiceFeatureFlag)) {
      return false;
    }
    if (
      !FeatureServiceFeatureFlag.__deepEquals(
        this.enabled,
        (other as FeatureServiceFeatureFlag).enabled,
      )
    ) {
      return false;
    }
    if (
      !FeatureServiceFeatureFlag.__deepEquals(
        this.source,
        (other as FeatureServiceFeatureFlag).source,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => FeatureServiceFeatureFlag.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => FeatureServiceFeatureFlag.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !FeatureServiceFeatureFlag.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          FeatureServiceFeatureFlag.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
