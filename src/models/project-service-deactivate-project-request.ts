...
export class ProjectServiceDeactivateProjectRequest {
  /**
  ...
  constructor(data?: Partial<ProjectServiceDeactivateProjectRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ProjectServiceDeactivateProjectRequest)) {
      return false;
    }
    if (
      !ProjectServiceDeactivateProjectRequest.__deepEquals(
        this.projectId,
        (other as ProjectServiceDeactivateProjectRequest).projectId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ProjectServiceDeactivateProjectRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          ProjectServiceDeactivateProjectRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !ProjectServiceDeactivateProjectRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ProjectServiceDeactivateProjectRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
