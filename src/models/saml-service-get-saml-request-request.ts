...
export class SAMLServiceGetSAMLRequestRequest {
  /**
  ...
  constructor(data?: Partial<SAMLServiceGetSAMLRequestRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof SAMLServiceGetSAMLRequestRequest)) {
      return false;
    }
    if (
      !SAMLServiceGetSAMLRequestRequest.__deepEquals(
        this.samlRequestId,
        (other as SAMLServiceGetSAMLRequestRequest).samlRequestId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        SAMLServiceGetSAMLRequestRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => SAMLServiceGetSAMLRequestRequest.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !SAMLServiceGetSAMLRequestRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          SAMLServiceGetSAMLRequestRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
