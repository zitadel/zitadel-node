...
export class UserServiceListDetails {
  /**
  ...
  constructor(data?: Partial<UserServiceListDetails>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceListDetails)) {
      return false;
    }
    if (
      !UserServiceListDetails.__deepEquals(
        this.totalResult,
        (other as UserServiceListDetails).totalResult,
      )
    ) {
      return false;
    }
    if (
      !UserServiceListDetails.__deepEquals(
        ...
        (other as UserServiceListDetails).processedSequence,
      )
    ) {
      return false;
    }
    if (
      !UserServiceListDetails.__deepEquals(
        this.timestamp,
        (other as UserServiceListDetails).timestamp,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => UserServiceListDetails.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceListDetails.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !UserServiceListDetails.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceListDetails.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
