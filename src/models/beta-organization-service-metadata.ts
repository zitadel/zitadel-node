...
export class BetaOrganizationServiceMetadata {
  /**
  ...
  constructor(data?: Partial<BetaOrganizationServiceMetadata>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaOrganizationServiceMetadata)) {
      return false;
    }
    if (
      !BetaOrganizationServiceMetadata.__deepEquals(
        this.key,
        (other as BetaOrganizationServiceMetadata).key,
      )
    ) {
      return false;
    }
    if (
      !BetaOrganizationServiceMetadata.__deepEquals(
        this.value,
        (other as BetaOrganizationServiceMetadata).value,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaOrganizationServiceMetadata.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaOrganizationServiceMetadata.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaOrganizationServiceMetadata.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaOrganizationServiceMetadata.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
