...
export class BetaUserServiceRemovePhoneRequest {
  /**
  ...
  constructor(data?: Partial<BetaUserServiceRemovePhoneRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaUserServiceRemovePhoneRequest)) {
      return false;
    }
    if (
      !BetaUserServiceRemovePhoneRequest.__deepEquals(
        this.userId,
        (other as BetaUserServiceRemovePhoneRequest).userId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaUserServiceRemovePhoneRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaUserServiceRemovePhoneRequest.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaUserServiceRemovePhoneRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaUserServiceRemovePhoneRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
