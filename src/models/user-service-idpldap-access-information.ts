...
export class UserServiceIDPLDAPAccessInformation {
  /**
  ...
  constructor(data?: Partial<UserServiceIDPLDAPAccessInformation>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceIDPLDAPAccessInformation)) {
      return false;
    }
    if (
      !UserServiceIDPLDAPAccessInformation.__deepEquals(
        this.attributes,
        (other as UserServiceIDPLDAPAccessInformation).attributes,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceIDPLDAPAccessInformation.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          UserServiceIDPLDAPAccessInformation.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceIDPLDAPAccessInformation.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceIDPLDAPAccessInformation.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
