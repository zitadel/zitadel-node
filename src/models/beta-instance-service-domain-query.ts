...
import { BetaInstanceServiceTextQueryMethod } from "./beta-instance-service-text-query-method.js";
import { Expose } from "class-transformer";

export class BetaInstanceServiceDomainQuery {
  /**
  ...
  constructor(data?: Partial<BetaInstanceServiceDomainQuery>) {
    ...
    if (this.method != null) {
      const methodValues = Object.values(
        ...
        (v) =>
          typeof (
            BetaInstanceServiceTextQueryMethod as Record<string, unknown>
          )[v as string] !== "number",
      );
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaInstanceServiceDomainQuery)) {
      return false;
    }
    if (
      !BetaInstanceServiceDomainQuery.__deepEquals(
        this.domain,
        (other as BetaInstanceServiceDomainQuery).domain,
      )
    ) {
      return false;
    }
    if (
      !BetaInstanceServiceDomainQuery.__deepEquals(
        this.method,
        (other as BetaInstanceServiceDomainQuery).method,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaInstanceServiceDomainQuery.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaInstanceServiceDomainQuery.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaInstanceServiceDomainQuery.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaInstanceServiceDomainQuery.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
