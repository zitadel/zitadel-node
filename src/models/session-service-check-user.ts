...
export class SessionServiceCheckUser {
  /**
  ...
  constructor(data?: Partial<SessionServiceCheckUser>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof SessionServiceCheckUser)) {
      return false;
    }
    if (
      !SessionServiceCheckUser.__deepEquals(
        this.loginName,
        (other as SessionServiceCheckUser).loginName,
      )
    ) {
      return false;
    }
    if (
      !SessionServiceCheckUser.__deepEquals(
        this.userId,
        (other as SessionServiceCheckUser).userId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => SessionServiceCheckUser.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => SessionServiceCheckUser.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !SessionServiceCheckUser.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          SessionServiceCheckUser.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
