...
export class OrganizationServiceDeleteOrganizationRequest {
  /**
  ...
  constructor(data?: Partial<OrganizationServiceDeleteOrganizationRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof OrganizationServiceDeleteOrganizationRequest)) {
      return false;
    }
    if (
      !OrganizationServiceDeleteOrganizationRequest.__deepEquals(
        this.organizationId,
        (other as OrganizationServiceDeleteOrganizationRequest).organizationId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        OrganizationServiceDeleteOrganizationRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          OrganizationServiceDeleteOrganizationRequest.__deepEquals(v, w),
        ),
      );
    }
