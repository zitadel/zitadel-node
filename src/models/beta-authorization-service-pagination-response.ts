...
export class BetaAuthorizationServicePaginationResponse {
  /**
   ...
   */
  @Expose({ name: "totalResult" })
  totalResult?: unknown;
  /**
   * Applied limit from query, defines maximum amount of objects per request, to compare if all objects are returned.
   */
  @Expose({ name: "appliedLimit" })
  appliedLimit?: unknown;

  constructor(data?: Partial<BetaAuthorizationServicePaginationResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaAuthorizationServicePaginationResponse)) {
      return false;
    }
    if (
      !BetaAuthorizationServicePaginationResponse.__deepEquals(
        this.totalResult,
        (other as BetaAuthorizationServicePaginationResponse).totalResult,
      )
    ) {
      return false;
    }
    if (
      !BetaAuthorizationServicePaginationResponse.__deepEquals(
        this.appliedLimit,
        (other as BetaAuthorizationServicePaginationResponse).appliedLimit,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaAuthorizationServicePaginationResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaAuthorizationServicePaginationResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaAuthorizationServicePaginationResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaAuthorizationServicePaginationResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
