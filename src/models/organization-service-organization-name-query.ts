...
export class OrganizationServiceOrganizationNameQuery {
  /**
  ...
  constructor(data?: Partial<OrganizationServiceOrganizationNameQuery>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof OrganizationServiceOrganizationNameQuery)) {
      return false;
    }
    if (
      !OrganizationServiceOrganizationNameQuery.__deepEquals(
        this.name,
        (other as OrganizationServiceOrganizationNameQuery).name,
      )
    ) {
      return false;
    }
    if (
      !OrganizationServiceOrganizationNameQuery.__deepEquals(
        this.method,
        (other as OrganizationServiceOrganizationNameQuery).method,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        OrganizationServiceOrganizationNameQuery.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          OrganizationServiceOrganizationNameQuery.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !OrganizationServiceOrganizationNameQuery.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          OrganizationServiceOrganizationNameQuery.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
