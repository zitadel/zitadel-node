...
export class ApplicationServicePaginationResponse {
  /**
  ...
  constructor(data?: Partial<ApplicationServicePaginationResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ApplicationServicePaginationResponse)) {
      return false;
    }
    if (
      !ApplicationServicePaginationResponse.__deepEquals(
        this.totalResult,
        (other as ApplicationServicePaginationResponse).totalResult,
      )
    ) {
      return false;
    }
    if (
      !ApplicationServicePaginationResponse.__deepEquals(
        this.appliedLimit,
        (other as ApplicationServicePaginationResponse).appliedLimit,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ApplicationServicePaginationResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          ApplicationServicePaginationResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !ApplicationServicePaginationResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ApplicationServicePaginationResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
