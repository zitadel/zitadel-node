...
export class UserServiceResendEmailCodeRequest {
  /**
  ...
  constructor(data?: Partial<UserServiceResendEmailCodeRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceResendEmailCodeRequest)) {
      return false;
    }
    if (
      !UserServiceResendEmailCodeRequest.__deepEquals(
        this.userId,
        (other as UserServiceResendEmailCodeRequest).userId,
      )
    ) {
      return false;
    }
    if (
      !UserServiceResendEmailCodeRequest.__deepEquals(
        this.returnCode,
        (other as UserServiceResendEmailCodeRequest).returnCode,
      )
    ) {
      return false;
    }
    if (
      !UserServiceResendEmailCodeRequest.__deepEquals(
        this.sendCode,
        (other as UserServiceResendEmailCodeRequest).sendCode,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceResendEmailCodeRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceResendEmailCodeRequest.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceResendEmailCodeRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceResendEmailCodeRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
