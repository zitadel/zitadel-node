...
export class BetaAppServiceDeleteApplicationResponse {
  /**
  ...
  constructor(data?: Partial<BetaAppServiceDeleteApplicationResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaAppServiceDeleteApplicationResponse)) {
      return false;
    }
    if (
      !BetaAppServiceDeleteApplicationResponse.__deepEquals(
        this.deletionDate,
        (other as BetaAppServiceDeleteApplicationResponse).deletionDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaAppServiceDeleteApplicationResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaAppServiceDeleteApplicationResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaAppServiceDeleteApplicationResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaAppServiceDeleteApplicationResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
