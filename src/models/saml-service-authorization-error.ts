...
import { SAMLServiceErrorReason } from "./saml-service-error-reason.js";
...
export class SAMLServiceAuthorizationError {
  ...
  constructor(data?: Partial<SAMLServiceAuthorizationError>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof SAMLServiceAuthorizationError)) {
      return false;
    }
    if (
      !SAMLServiceAuthorizationError.__deepEquals(
        this.error,
        (other as SAMLServiceAuthorizationError).error,
      )
    ) {
      return false;
    }
    if (
      !SAMLServiceAuthorizationError.__deepEquals(
        ...
        (other as SAMLServiceAuthorizationError).errorDescription,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        SAMLServiceAuthorizationError.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => SAMLServiceAuthorizationError.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !SAMLServiceAuthorizationError.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          SAMLServiceAuthorizationError.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
