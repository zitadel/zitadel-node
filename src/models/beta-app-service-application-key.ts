...
export class BetaAppServiceApplicationKey {
  /**
  ...
  constructor(data?: Partial<BetaAppServiceApplicationKey>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaAppServiceApplicationKey)) {
      return false;
    }
    if (
      !BetaAppServiceApplicationKey.__deepEquals(
        this.id,
        (other as BetaAppServiceApplicationKey).id,
      )
    ) {
      return false;
    }
    if (
      !BetaAppServiceApplicationKey.__deepEquals(
        this.applicationId,
        (other as BetaAppServiceApplicationKey).applicationId,
      )
    ) {
      return false;
    }
    if (
      !BetaAppServiceApplicationKey.__deepEquals(
        this.projectId,
        (other as BetaAppServiceApplicationKey).projectId,
      )
    ) {
      return false;
    }
    if (
      !BetaAppServiceApplicationKey.__deepEquals(
        this.creationDate,
        (other as BetaAppServiceApplicationKey).creationDate,
      )
    ) {
      return false;
    }
    if (
      !BetaAppServiceApplicationKey.__deepEquals(
        this.organizationId,
        (other as BetaAppServiceApplicationKey).organizationId,
      )
    ) {
      return false;
    }
    if (
      !BetaAppServiceApplicationKey.__deepEquals(
        this.expirationDate,
        (other as BetaAppServiceApplicationKey).expirationDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaAppServiceApplicationKey.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaAppServiceApplicationKey.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaAppServiceApplicationKey.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaAppServiceApplicationKey.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
