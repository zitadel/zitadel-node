...
export class BetaUserServiceResendPhoneCodeRequest {
  /**
  ...
  constructor(data?: Partial<BetaUserServiceResendPhoneCodeRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaUserServiceResendPhoneCodeRequest)) {
      return false;
    }
    if (
      !BetaUserServiceResendPhoneCodeRequest.__deepEquals(
        this.userId,
        (other as BetaUserServiceResendPhoneCodeRequest).userId,
      )
    ) {
      return false;
    }
    if (
      !BetaUserServiceResendPhoneCodeRequest.__deepEquals(
        this.returnCode,
        (other as BetaUserServiceResendPhoneCodeRequest).returnCode,
      )
    ) {
      return false;
    }
    if (
      !BetaUserServiceResendPhoneCodeRequest.__deepEquals(
        this.sendCode,
        (other as BetaUserServiceResendPhoneCodeRequest).sendCode,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaUserServiceResendPhoneCodeRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaUserServiceResendPhoneCodeRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaUserServiceResendPhoneCodeRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaUserServiceResendPhoneCodeRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
