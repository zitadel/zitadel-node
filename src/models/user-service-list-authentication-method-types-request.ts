...
import { UserServiceDomainQuery } from "./user-service-domain-query.js";
import { Expose, Type } from "class-transformer";

export class UserServiceListAuthenticationMethodTypesRequest {
  /**
  ...
  constructor(data?: Partial<UserServiceListAuthenticationMethodTypesRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceListAuthenticationMethodTypesRequest)) {
      return false;
    }
    if (
      !UserServiceListAuthenticationMethodTypesRequest.__deepEquals(
        this.userId,
        (other as UserServiceListAuthenticationMethodTypesRequest).userId,
      )
    ) {
      return false;
    }
    if (
      !UserServiceListAuthenticationMethodTypesRequest.__deepEquals(
        this.domainQuery,
        (other as UserServiceListAuthenticationMethodTypesRequest).domainQuery,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceListAuthenticationMethodTypesRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          UserServiceListAuthenticationMethodTypesRequest.__deepEquals(v, w),
        ),
      );
    }
