...
export class BetaProjectServiceProjectRole {
  /**
  ...
  constructor(data?: Partial<BetaProjectServiceProjectRole>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaProjectServiceProjectRole)) {
      return false;
    }
    if (
      !BetaProjectServiceProjectRole.__deepEquals(
        this.projectId,
        (other as BetaProjectServiceProjectRole).projectId,
      )
    ) {
      return false;
    }
    if (
      !BetaProjectServiceProjectRole.__deepEquals(
        this.key,
        (other as BetaProjectServiceProjectRole).key,
      )
    ) {
      return false;
    }
    if (
      !BetaProjectServiceProjectRole.__deepEquals(
        this.creationDate,
        (other as BetaProjectServiceProjectRole).creationDate,
      )
    ) {
      return false;
    }
    if (
      !BetaProjectServiceProjectRole.__deepEquals(
        this.changeDate,
        (other as BetaProjectServiceProjectRole).changeDate,
      )
    ) {
      return false;
    }
    if (
      !BetaProjectServiceProjectRole.__deepEquals(
        this.displayName,
        (other as BetaProjectServiceProjectRole).displayName,
      )
    ) {
      return false;
    }
    if (
      !BetaProjectServiceProjectRole.__deepEquals(
        this.group,
        (other as BetaProjectServiceProjectRole).group,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaProjectServiceProjectRole.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaProjectServiceProjectRole.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaProjectServiceProjectRole.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaProjectServiceProjectRole.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
