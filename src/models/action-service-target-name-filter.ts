...
import { ActionServiceTextFilterMethod } from "./action-service-text-filter-method.js";
import { Expose } from "class-transformer";

export class ActionServiceTargetNameFilter {
  /**
  ...
  constructor(data?: Partial<ActionServiceTargetNameFilter>) {
    Object.assign(this, data);
    if (this.targetName != null && typeof this.targetName !== "string") {
      throw new TypeError(
        `targetName must be a string, got ${typeof this.targetName}`,
      );
    }
    if (this.method != null) {
      const methodValues = Object.values(ActionServiceTextFilterMethod).filter(
        (v) =>
          typeof (ActionServiceTextFilterMethod as Record<string, unknown>)[
            v as string
          ] !== "number",
      );
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ActionServiceTargetNameFilter)) {
      return false;
    }
    if (
      !ActionServiceTargetNameFilter.__deepEquals(
        this.targetName,
        (other as ActionServiceTargetNameFilter).targetName,
      )
    ) {
      return false;
    }
    if (
      !ActionServiceTargetNameFilter.__deepEquals(
        this.method,
        (other as ActionServiceTargetNameFilter).method,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ActionServiceTargetNameFilter.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => ActionServiceTargetNameFilter.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !ActionServiceTargetNameFilter.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ActionServiceTargetNameFilter.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
