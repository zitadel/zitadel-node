...
export class BetaAppServiceGetApplicationRequest {
  /**
  ...
  constructor(data?: Partial<BetaAppServiceGetApplicationRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaAppServiceGetApplicationRequest)) {
      return false;
    }
    if (
      !BetaAppServiceGetApplicationRequest.__deepEquals(
        this.id,
        (other as BetaAppServiceGetApplicationRequest).id,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaAppServiceGetApplicationRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaAppServiceGetApplicationRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaAppServiceGetApplicationRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaAppServiceGetApplicationRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
