...
export class ProjectServiceRemoveProjectRoleRequest {
  ...
  constructor(data?: Partial<ProjectServiceRemoveProjectRoleRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ProjectServiceRemoveProjectRoleRequest)) {
      return false;
    }
    if (
      !ProjectServiceRemoveProjectRoleRequest.__deepEquals(
        this.projectId,
        (other as ProjectServiceRemoveProjectRoleRequest).projectId,
      )
    ) {
      return false;
    }
    if (
      !ProjectServiceRemoveProjectRoleRequest.__deepEquals(
        this.roleKey,
        (other as ProjectServiceRemoveProjectRoleRequest).roleKey,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ProjectServiceRemoveProjectRoleRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          ProjectServiceRemoveProjectRoleRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !ProjectServiceRemoveProjectRoleRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ProjectServiceRemoveProjectRoleRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
