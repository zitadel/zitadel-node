...
export class BetaActionServiceEventExecution {
  /**
  ...
  constructor(data?: Partial<BetaActionServiceEventExecution>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaActionServiceEventExecution)) {
      return false;
    }
    if (
      !BetaActionServiceEventExecution.__deepEquals(
        this.all,
        (other as BetaActionServiceEventExecution).all,
      )
    ) {
      return false;
    }
    if (
      !BetaActionServiceEventExecution.__deepEquals(
        this.event,
        (other as BetaActionServiceEventExecution).event,
      )
    ) {
      return false;
    }
    if (
      !BetaActionServiceEventExecution.__deepEquals(
        this.group,
        (other as BetaActionServiceEventExecution).group,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaActionServiceEventExecution.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaActionServiceEventExecution.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaActionServiceEventExecution.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaActionServiceEventExecution.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
