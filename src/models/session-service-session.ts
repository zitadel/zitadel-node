...
import { SessionServiceFactors } from "./session-service-factors.js";
import { SessionServiceUserAgent } from "./session-service-user-agent.js";
import { Expose, Type } from "class-transformer";

export class SessionServiceSession {
  /**
  ...
  constructor(data?: Partial<SessionServiceSession>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof SessionServiceSession)) {
      return false;
    }
    if (
      !SessionServiceSession.__deepEquals(
        this.id,
        (other as SessionServiceSession).id,
      )
    ) {
      return false;
    }
    if (
      !SessionServiceSession.__deepEquals(
        this.creationDate,
        (other as SessionServiceSession).creationDate,
      )
    ) {
      return false;
    }
    if (
      !SessionServiceSession.__deepEquals(
        this.changeDate,
        (other as SessionServiceSession).changeDate,
      )
    ) {
      return false;
    }
    if (
      !SessionServiceSession.__deepEquals(
        this.sequence,
        (other as SessionServiceSession).sequence,
      )
    ) {
      return false;
    }
    if (
      !SessionServiceSession.__deepEquals(
        this.factors,
        (other as SessionServiceSession).factors,
      )
    ) {
      return false;
    }
    if (
      !SessionServiceSession.__deepEquals(
        this.metadata,
        (other as SessionServiceSession).metadata,
      )
    ) {
      return false;
    }
    if (
      !SessionServiceSession.__deepEquals(
        this.userAgent,
        (other as SessionServiceSession).userAgent,
      )
    ) {
      return false;
    }
    if (
      !SessionServiceSession.__deepEquals(
        this.expirationDate,
        (other as SessionServiceSession).expirationDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => SessionServiceSession.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => SessionServiceSession.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !SessionServiceSession.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          SessionServiceSession.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
