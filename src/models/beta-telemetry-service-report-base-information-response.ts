...
export class BetaTelemetryServiceReportBaseInformationResponse {
  /**
  ...
  constructor(
    data?: Partial<BetaTelemetryServiceReportBaseInformationResponse>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaTelemetryServiceReportBaseInformationResponse)) {
      return false;
    }
    if (
      !BetaTelemetryServiceReportBaseInformationResponse.__deepEquals(
        this.reportId,
        (other as BetaTelemetryServiceReportBaseInformationResponse).reportId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaTelemetryServiceReportBaseInformationResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaTelemetryServiceReportBaseInformationResponse.__deepEquals(v, w),
        ),
      );
    }
