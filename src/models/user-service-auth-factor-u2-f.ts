...
export class UserServiceAuthFactorU2F {
  /**
  ...
  constructor(data?: Partial<UserServiceAuthFactorU2F>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceAuthFactorU2F)) {
      return false;
    }
    if (
      !UserServiceAuthFactorU2F.__deepEquals(
        this.id,
        (other as UserServiceAuthFactorU2F).id,
      )
    ) {
      return false;
    }
    if (
      !UserServiceAuthFactorU2F.__deepEquals(
        this.name,
        (other as UserServiceAuthFactorU2F).name,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => UserServiceAuthFactorU2F.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceAuthFactorU2F.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !UserServiceAuthFactorU2F.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceAuthFactorU2F.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
