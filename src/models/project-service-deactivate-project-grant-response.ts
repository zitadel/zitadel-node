...
export class ProjectServiceDeactivateProjectGrantResponse {
  /**
  ...
  constructor(data?: Partial<ProjectServiceDeactivateProjectGrantResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ProjectServiceDeactivateProjectGrantResponse)) {
      return false;
    }
    if (
      !ProjectServiceDeactivateProjectGrantResponse.__deepEquals(
        this.changeDate,
        (other as ProjectServiceDeactivateProjectGrantResponse).changeDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ProjectServiceDeactivateProjectGrantResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          ProjectServiceDeactivateProjectGrantResponse.__deepEquals(v, w),
        ),
      );
    }
