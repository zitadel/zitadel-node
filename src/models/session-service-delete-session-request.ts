...
export class SessionServiceDeleteSessionRequest {
  /**
  ...
  constructor(data?: Partial<SessionServiceDeleteSessionRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof SessionServiceDeleteSessionRequest)) {
      return false;
    }
    if (
      !SessionServiceDeleteSessionRequest.__deepEquals(
        this.sessionId,
        (other as SessionServiceDeleteSessionRequest).sessionId,
      )
    ) {
      return false;
    }
    if (
      !SessionServiceDeleteSessionRequest.__deepEquals(
        this.sessionToken,
        (other as SessionServiceDeleteSessionRequest).sessionToken,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        SessionServiceDeleteSessionRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          SessionServiceDeleteSessionRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !SessionServiceDeleteSessionRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          SessionServiceDeleteSessionRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
