...
export class SessionServiceDeleteSessionResponse {
  /**
  ...
  constructor(data?: Partial<SessionServiceDeleteSessionResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof SessionServiceDeleteSessionResponse)) {
      return false;
    }
    if (
      !SessionServiceDeleteSessionResponse.__deepEquals(
        this.details,
        (other as SessionServiceDeleteSessionResponse).details,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        SessionServiceDeleteSessionResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          SessionServiceDeleteSessionResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !SessionServiceDeleteSessionResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          SessionServiceDeleteSessionResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
