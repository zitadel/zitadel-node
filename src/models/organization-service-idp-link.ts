...
export class OrganizationServiceIDPLink {
  /**
  ...
  constructor(data?: Partial<OrganizationServiceIDPLink>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof OrganizationServiceIDPLink)) {
      return false;
    }
    if (
      !OrganizationServiceIDPLink.__deepEquals(
        this.idpId,
        (other as OrganizationServiceIDPLink).idpId,
      )
    ) {
      return false;
    }
    if (
      !OrganizationServiceIDPLink.__deepEquals(
        this.userId,
        (other as OrganizationServiceIDPLink).userId,
      )
    ) {
      return false;
    }
    if (
      !OrganizationServiceIDPLink.__deepEquals(
        this.userName,
        (other as OrganizationServiceIDPLink).userName,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        OrganizationServiceIDPLink.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => OrganizationServiceIDPLink.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !OrganizationServiceIDPLink.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          OrganizationServiceIDPLink.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
