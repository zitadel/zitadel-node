...
export class BetaOrganizationServiceDeleteOrganizationMetadataResponse {
  /**
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !BetaOrganizationServiceDeleteOrganizationMetadataResponse.__deepEquals(
        this.deletionDate,
        (other as BetaOrganizationServiceDeleteOrganizationMetadataResponse)
          .deletionDate,
      )
    ) {
      return false;
