...
export class UserServiceKey {
  ...
  constructor(data?: Partial<UserServiceKey>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceKey)) {
      return false;
    }
    if (
      !UserServiceKey.__deepEquals(
        this.creationDate,
        (other as UserServiceKey).creationDate,
      )
    ) {
      return false;
    }
    if (
      !UserServiceKey.__deepEquals(
        this.changeDate,
        (other as UserServiceKey).changeDate,
      )
    ) {
      return false;
    }
    if (!UserServiceKey.__deepEquals(this.id, (other as UserServiceKey).id)) {
      return false;
    }
    if (
      !UserServiceKey.__deepEquals(
        this.userId,
        (other as UserServiceKey).userId,
      )
    ) {
      return false;
    }
    if (
      !UserServiceKey.__deepEquals(
        this.organizationId,
        (other as UserServiceKey).organizationId,
      )
    ) {
      return false;
    }
    if (
      !UserServiceKey.__deepEquals(
        this.expirationDate,
        (other as UserServiceKey).expirationDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => UserServiceKey.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceKey.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !UserServiceKey.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceKey.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
