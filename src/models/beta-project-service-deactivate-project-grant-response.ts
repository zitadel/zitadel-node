...
export class BetaProjectServiceDeactivateProjectGrantResponse {
  /**
  ...
  constructor(
    data?: Partial<BetaProjectServiceDeactivateProjectGrantResponse>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaProjectServiceDeactivateProjectGrantResponse)) {
      return false;
    }
    if (
      !BetaProjectServiceDeactivateProjectGrantResponse.__deepEquals(
        this.changeDate,
        (other as BetaProjectServiceDeactivateProjectGrantResponse).changeDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaProjectServiceDeactivateProjectGrantResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaProjectServiceDeactivateProjectGrantResponse.__deepEquals(v, w),
        ),
      );
    }
