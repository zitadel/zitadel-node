...
import { BetaProjectServiceAny } from "./beta-project-service-any.js";
import { Expose, Type } from "class-transformer";

/**
 * Error type returned by Connect: https://connectrpc.com/docs/go/errors/#http-representation
 */
export class BetaProjectServiceConnectError {
  /**
  ...
  constructor(data?: Partial<BetaProjectServiceConnectError>) {
    ...
    if (this.code != null) {
      const codeValues = Object.values(
        BetaProjectServiceConnectErrorCodeEnum,
      ).filter(
        (v) =>
          typeof (
            BetaProjectServiceConnectErrorCodeEnum as Record<string, unknown>
          )[v as string] !== "number",
      );
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaProjectServiceConnectError)) {
      return false;
    }
    if (
      !BetaProjectServiceConnectError.__deepEquals(
        this.code,
        (other as BetaProjectServiceConnectError).code,
      )
    ) {
      return false;
    }
    if (
      !BetaProjectServiceConnectError.__deepEquals(
        this.message,
        (other as BetaProjectServiceConnectError).message,
      )
    ) {
      return false;
    }
    if (
      !BetaProjectServiceConnectError.__deepEquals(
        this.details,
        (other as BetaProjectServiceConnectError).details,
      )
    ) {
      return false;
    }
    {
      ...
      for (const k of selfKeys) {
        ...
        if (
          !BetaProjectServiceConnectError.__deepEquals(selfRec[k], otherRec[k])
        ) {
          return false;
        }
      }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaProjectServiceConnectError.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaProjectServiceConnectError.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaProjectServiceConnectError.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaProjectServiceConnectError.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
...
export enum BetaProjectServiceConnectErrorCodeEnum {
  Canceled = "canceled",
  Unknown = "unknown",
