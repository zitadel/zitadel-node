...
export class UserServiceAddSecretResponse {
  /**
  ...
  constructor(data?: Partial<UserServiceAddSecretResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceAddSecretResponse)) {
      return false;
    }
    if (
      !UserServiceAddSecretResponse.__deepEquals(
        this.creationDate,
        (other as UserServiceAddSecretResponse).creationDate,
      )
    ) {
      return false;
    }
    if (
      !UserServiceAddSecretResponse.__deepEquals(
        this.clientSecret,
        (other as UserServiceAddSecretResponse).clientSecret,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceAddSecretResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceAddSecretResponse.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceAddSecretResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceAddSecretResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
