...
export class UserServiceAddKeyResponse {
  /**
  ...
  constructor(data?: Partial<UserServiceAddKeyResponse>) {
     ...
     */
    if (this.keyContent != null && typeof this.keyContent === "string") {
      this.keyContent = Buffer.from(
        this.keyContent as unknown as string,
        "base64",
      ) as unknown as Buffer;
    } else if (this.keyContent != null && !Buffer.isBuffer(this.keyContent)) {
      throw new TypeError(
        `keyContent must be a Buffer or base64 string, got ${typeof this.keyContent}`,
      );
    }
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceAddKeyResponse)) {
      return false;
    }
    if (
      !UserServiceAddKeyResponse.__deepEquals(
        this.creationDate,
        (other as UserServiceAddKeyResponse).creationDate,
      )
    ) {
      return false;
    }
    if (
      !UserServiceAddKeyResponse.__deepEquals(
        this.keyId,
        (other as UserServiceAddKeyResponse).keyId,
      )
    ) {
      return false;
    }
    if (
      !UserServiceAddKeyResponse.__deepEquals(
        this.keyContent,
        (other as UserServiceAddKeyResponse).keyContent,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => UserServiceAddKeyResponse.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceAddKeyResponse.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !UserServiceAddKeyResponse.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceAddKeyResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
