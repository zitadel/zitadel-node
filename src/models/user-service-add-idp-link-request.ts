...
export class UserServiceAddIDPLinkRequest {
  /**
  ...
  constructor(data?: Partial<UserServiceAddIDPLinkRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceAddIDPLinkRequest)) {
      return false;
    }
    if (
      !UserServiceAddIDPLinkRequest.__deepEquals(
        this.userId,
        (other as UserServiceAddIDPLinkRequest).userId,
      )
    ) {
      return false;
    }
    if (
      !UserServiceAddIDPLinkRequest.__deepEquals(
        this.idpLink,
        (other as UserServiceAddIDPLinkRequest).idpLink,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceAddIDPLinkRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceAddIDPLinkRequest.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceAddIDPLinkRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceAddIDPLinkRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
