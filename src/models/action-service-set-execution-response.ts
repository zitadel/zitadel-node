...
export class ActionServiceSetExecutionResponse {
  /**
  ...
  constructor(data?: Partial<ActionServiceSetExecutionResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ActionServiceSetExecutionResponse)) {
      return false;
    }
    if (
      !ActionServiceSetExecutionResponse.__deepEquals(
        this.setDate,
        (other as ActionServiceSetExecutionResponse).setDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ActionServiceSetExecutionResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => ActionServiceSetExecutionResponse.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !ActionServiceSetExecutionResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ActionServiceSetExecutionResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
