...
export class ApplicationServiceCreateAPIApplicationRequest {
  /**
  ...
  constructor(data?: Partial<ApplicationServiceCreateAPIApplicationRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ApplicationServiceCreateAPIApplicationRequest)) {
      return false;
    }
    if (
      !ApplicationServiceCreateAPIApplicationRequest.__deepEquals(
        this.authMethodType,
        (other as ApplicationServiceCreateAPIApplicationRequest).authMethodType,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ApplicationServiceCreateAPIApplicationRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          ApplicationServiceCreateAPIApplicationRequest.__deepEquals(v, w),
        ),
      );
    }
