...
export class ApplicationServiceApplicationKeyProjectIDFilter {
  /**
  ...
  constructor(data?: Partial<ApplicationServiceApplicationKeyProjectIDFilter>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ApplicationServiceApplicationKeyProjectIDFilter)) {
      return false;
    }
    if (
      !ApplicationServiceApplicationKeyProjectIDFilter.__deepEquals(
        this.projectId,
        (other as ApplicationServiceApplicationKeyProjectIDFilter).projectId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ApplicationServiceApplicationKeyProjectIDFilter.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          ApplicationServiceApplicationKeyProjectIDFilter.__deepEquals(v, w),
        ),
      );
    }
