...
export class BetaSessionServiceOTPSMS {
  /**
  ...
  constructor(data?: Partial<BetaSessionServiceOTPSMS>) {
    Object.assign(this, data);
    if (this.returnCode != null && typeof this.returnCode !== "boolean") {
      throw new TypeError(
        `returnCode must be a boolean, got ${typeof this.returnCode}`,
      );
    }
  }
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaSessionServiceOTPSMS)) {
      return false;
    }
    if (
      !BetaSessionServiceOTPSMS.__deepEquals(
        this.returnCode,
        (other as BetaSessionServiceOTPSMS).returnCode,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => BetaSessionServiceOTPSMS.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaSessionServiceOTPSMS.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !BetaSessionServiceOTPSMS.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaSessionServiceOTPSMS.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
