...
export class BetaOrganizationServiceOrgDomainFilter {
  /**
  ...
  constructor(data?: Partial<BetaOrganizationServiceOrgDomainFilter>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaOrganizationServiceOrgDomainFilter)) {
      return false;
    }
    if (
      !BetaOrganizationServiceOrgDomainFilter.__deepEquals(
        this.domain,
        (other as BetaOrganizationServiceOrgDomainFilter).domain,
      )
    ) {
      return false;
    }
    if (
      !BetaOrganizationServiceOrgDomainFilter.__deepEquals(
        this.method,
        (other as BetaOrganizationServiceOrgDomainFilter).method,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaOrganizationServiceOrgDomainFilter.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaOrganizationServiceOrgDomainFilter.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaOrganizationServiceOrgDomainFilter.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaOrganizationServiceOrgDomainFilter.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
