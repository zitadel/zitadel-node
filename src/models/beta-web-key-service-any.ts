 ...
 */
export class BetaWebKeyServiceAny {
  /**
  ...
  constructor(data?: Partial<BetaWebKeyServiceAny>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaWebKeyServiceAny)) {
      return false;
    }
    if (
      !BetaWebKeyServiceAny.__deepEquals(
        this.type,
        (other as BetaWebKeyServiceAny).type,
      )
    ) {
      return false;
    }
    if (
      !BetaWebKeyServiceAny.__deepEquals(
        this.value,
        (other as BetaWebKeyServiceAny).value,
      )
    ) {
      return false;
    }
    if (
      !BetaWebKeyServiceAny.__deepEquals(
        this.debug,
        (other as BetaWebKeyServiceAny).debug,
      )
    ) {
      return false;
    }
    {
      ...
      for (const k of selfKeys) {
        ...
        if (!BetaWebKeyServiceAny.__deepEquals(selfRec[k], otherRec[k])) {
          return false;
        }
      }
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => BetaWebKeyServiceAny.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaWebKeyServiceAny.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !BetaWebKeyServiceAny.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaWebKeyServiceAny.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
