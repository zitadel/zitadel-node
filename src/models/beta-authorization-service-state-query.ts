...
export class BetaAuthorizationServiceStateQuery {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaAuthorizationServiceStateQuery)) {
      return false;
    }
    if (
      !BetaAuthorizationServiceStateQuery.__deepEquals(
        this.state,
        (other as BetaAuthorizationServiceStateQuery).state,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaAuthorizationServiceStateQuery.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaAuthorizationServiceStateQuery.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaAuthorizationServiceStateQuery.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaAuthorizationServiceStateQuery.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
