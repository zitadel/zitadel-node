...
export class BetaActionServiceDeleteTargetResponse {
  /**
  ...
  constructor(data?: Partial<BetaActionServiceDeleteTargetResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaActionServiceDeleteTargetResponse)) {
      return false;
    }
    if (
      !BetaActionServiceDeleteTargetResponse.__deepEquals(
        this.deletionDate,
        (other as BetaActionServiceDeleteTargetResponse).deletionDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaActionServiceDeleteTargetResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaActionServiceDeleteTargetResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaActionServiceDeleteTargetResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaActionServiceDeleteTargetResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
