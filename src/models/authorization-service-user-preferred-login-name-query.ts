...
export class AuthorizationServiceUserPreferredLoginNameQuery {
  /**
  ...
  constructor(data?: Partial<AuthorizationServiceUserPreferredLoginNameQuery>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof AuthorizationServiceUserPreferredLoginNameQuery)) {
      return false;
    }
    if (
      !AuthorizationServiceUserPreferredLoginNameQuery.__deepEquals(
        this.loginName,
        (other as AuthorizationServiceUserPreferredLoginNameQuery).loginName,
      )
    ) {
      return false;
    }
    if (
      !AuthorizationServiceUserPreferredLoginNameQuery.__deepEquals(
        this.method,
        (other as AuthorizationServiceUserPreferredLoginNameQuery).method,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        AuthorizationServiceUserPreferredLoginNameQuery.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          AuthorizationServiceUserPreferredLoginNameQuery.__deepEquals(v, w),
        ),
      );
    }
