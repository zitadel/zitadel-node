...
export class BetaUserServiceDeactivateUserResponse {
  /**
  ...
  constructor(data?: Partial<BetaUserServiceDeactivateUserResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaUserServiceDeactivateUserResponse)) {
      return false;
    }
    if (
      !BetaUserServiceDeactivateUserResponse.__deepEquals(
        this.details,
        (other as BetaUserServiceDeactivateUserResponse).details,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaUserServiceDeactivateUserResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaUserServiceDeactivateUserResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaUserServiceDeactivateUserResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaUserServiceDeactivateUserResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
