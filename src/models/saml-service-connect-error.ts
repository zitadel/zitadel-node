...
export class SAMLServiceConnectError {
  ...
  constructor(data?: Partial<SAMLServiceConnectError>) {
    ...
    if (this.code != null) {
      const codeValues = Object.values(SAMLServiceConnectErrorCodeEnum).filter(
        (v) =>
          typeof (SAMLServiceConnectErrorCodeEnum as Record<string, unknown>)[
            v as string
          ] !== "number",
      );
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof SAMLServiceConnectError)) {
      return false;
    }
    if (
      !SAMLServiceConnectError.__deepEquals(
        this.code,
        (other as SAMLServiceConnectError).code,
      )
    ) {
      return false;
    }
    if (
      !SAMLServiceConnectError.__deepEquals(
        this.message,
        (other as SAMLServiceConnectError).message,
      )
    ) {
      return false;
    }
    if (
      !SAMLServiceConnectError.__deepEquals(
        this.details,
        (other as SAMLServiceConnectError).details,
      )
    ) {
      return false;
    }
    {
      ...
      for (const k of selfKeys) {
        ...
        if (!SAMLServiceConnectError.__deepEquals(selfRec[k], otherRec[k])) {
          return false;
        }
      }
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => SAMLServiceConnectError.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => SAMLServiceConnectError.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !SAMLServiceConnectError.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          SAMLServiceConnectError.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
...
export enum SAMLServiceConnectErrorCodeEnum {
  Canceled = "canceled",
  Unknown = "unknown",
