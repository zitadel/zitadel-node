...
export class AuthorizationServiceInIDsFilter {
  /**
  ...
  constructor(data?: Partial<AuthorizationServiceInIDsFilter>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof AuthorizationServiceInIDsFilter)) {
      return false;
    }
    if (
      !AuthorizationServiceInIDsFilter.__deepEquals(
        this.ids,
        (other as AuthorizationServiceInIDsFilter).ids,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        AuthorizationServiceInIDsFilter.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => AuthorizationServiceInIDsFilter.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !AuthorizationServiceInIDsFilter.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          AuthorizationServiceInIDsFilter.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
