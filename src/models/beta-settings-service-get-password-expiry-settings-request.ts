...
export class BetaSettingsServiceGetPasswordExpirySettingsRequest {
  /**
  ...
  constructor(
    data?: Partial<BetaSettingsServiceGetPasswordExpirySettingsRequest>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !(other instanceof BetaSettingsServiceGetPasswordExpirySettingsRequest)
    ) {
      return false;
    }
    if (
      !BetaSettingsServiceGetPasswordExpirySettingsRequest.__deepEquals(
        this.ctx,
        (other as BetaSettingsServiceGetPasswordExpirySettingsRequest).ctx,
      )
    ) {
      return false;
    }
