...
import { BetaUserServiceAccessTokenType } from "./beta-user-service-access-token-type.js";
import { Expose } from "class-transformer";

export class BetaUserServiceMachineUser {
  /**
  ...
  constructor(data?: Partial<BetaUserServiceMachineUser>) {
    ...
    if (this.accessTokenType != null) {
      const accessTokenTypeValues = Object.values(
        ...
        (v) =>
          typeof (BetaUserServiceAccessTokenType as Record<string, unknown>)[
            v as string
          ] !== "number",
      );
      if (
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaUserServiceMachineUser)) {
      return false;
    }
    if (
      !BetaUserServiceMachineUser.__deepEquals(
        this.name,
        (other as BetaUserServiceMachineUser).name,
      )
    ) {
      return false;
    }
    if (
      !BetaUserServiceMachineUser.__deepEquals(
        this.description,
        (other as BetaUserServiceMachineUser).description,
      )
    ) {
      return false;
    }
    if (
      !BetaUserServiceMachineUser.__deepEquals(
        this.hasSecret,
        (other as BetaUserServiceMachineUser).hasSecret,
      )
    ) {
      return false;
    }
    if (
      !BetaUserServiceMachineUser.__deepEquals(
        this.accessTokenType,
        (other as BetaUserServiceMachineUser).accessTokenType,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaUserServiceMachineUser.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaUserServiceMachineUser.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaUserServiceMachineUser.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaUserServiceMachineUser.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
