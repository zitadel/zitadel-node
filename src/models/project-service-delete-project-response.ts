...
export class ProjectServiceDeleteProjectResponse {
  /**
  ...
  constructor(data?: Partial<ProjectServiceDeleteProjectResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ProjectServiceDeleteProjectResponse)) {
      return false;
    }
    if (
      !ProjectServiceDeleteProjectResponse.__deepEquals(
        this.deletionDate,
        (other as ProjectServiceDeleteProjectResponse).deletionDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ProjectServiceDeleteProjectResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          ProjectServiceDeleteProjectResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !ProjectServiceDeleteProjectResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ProjectServiceDeleteProjectResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
