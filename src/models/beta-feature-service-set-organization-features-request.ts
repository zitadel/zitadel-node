...
export class BetaFeatureServiceSetOrganizationFeaturesRequest {
  /**
  ...
  constructor(
    data?: Partial<BetaFeatureServiceSetOrganizationFeaturesRequest>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaFeatureServiceSetOrganizationFeaturesRequest)) {
      return false;
    }
    if (
      !BetaFeatureServiceSetOrganizationFeaturesRequest.__deepEquals(
        this.organizationId,
        (other as BetaFeatureServiceSetOrganizationFeaturesRequest)
          .organizationId,
      )
    ) {
      return false;
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaFeatureServiceSetOrganizationFeaturesRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaFeatureServiceSetOrganizationFeaturesRequest.__deepEquals(v, w),
        ),
      );
    }
