...
export class BetaInternalPermissionServiceResourceType {
  /**
  ...
  constructor(data?: Partial<BetaInternalPermissionServiceResourceType>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaInternalPermissionServiceResourceType)) {
      return false;
    }
    if (
      !BetaInternalPermissionServiceResourceType.__deepEquals(
        this.instance,
        (other as BetaInternalPermissionServiceResourceType).instance,
      )
    ) {
      return false;
    }
    if (
      !BetaInternalPermissionServiceResourceType.__deepEquals(
        this.organizationId,
        (other as BetaInternalPermissionServiceResourceType).organizationId,
      )
    ) {
      return false;
    }
    if (
      !BetaInternalPermissionServiceResourceType.__deepEquals(
        this.projectGrant,
        (other as BetaInternalPermissionServiceResourceType).projectGrant,
      )
    ) {
      return false;
    }
    if (
      !BetaInternalPermissionServiceResourceType.__deepEquals(
        this.projectId,
        (other as BetaInternalPermissionServiceResourceType).projectId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaInternalPermissionServiceResourceType.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaInternalPermissionServiceResourceType.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaInternalPermissionServiceResourceType.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaInternalPermissionServiceResourceType.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
