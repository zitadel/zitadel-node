...
export class ActionServicePublicKey {
  /**
  ...
  constructor(data?: Partial<ActionServicePublicKey>) {
    Object.assign(this, data);
    if (this.keyId != null && typeof this.keyId !== "string") {
      throw new TypeError(`keyId must be a string, got ${typeof this.keyId}`);
    }
    if (this.active != null && typeof this.active !== "boolean") {
      throw new TypeError(
        `active must be a boolean, got ${typeof this.active}`,
      );
    }
    /**
     ...
     */
    if (this.publicKey != null && typeof this.publicKey === "string") {
      this.publicKey = Buffer.from(
        this.publicKey as unknown as string,
        "base64",
      ) as unknown as Buffer;
    } else if (this.publicKey != null && !Buffer.isBuffer(this.publicKey)) {
      throw new TypeError(
        `publicKey must be a Buffer or base64 string, got ${typeof this.publicKey}`,
      );
    }
    if (this.fingerprint != null && typeof this.fingerprint !== "string") {
      throw new TypeError(
        `fingerprint must be a string, got ${typeof this.fingerprint}`,
      );
    }
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ActionServicePublicKey)) {
      return false;
    }
    if (
      !ActionServicePublicKey.__deepEquals(
        this.keyId,
        (other as ActionServicePublicKey).keyId,
      )
    ) {
      return false;
    }
    if (
      !ActionServicePublicKey.__deepEquals(
        this.active,
        (other as ActionServicePublicKey).active,
      )
    ) {
      return false;
    }
    if (
      !ActionServicePublicKey.__deepEquals(
        this.publicKey,
        (other as ActionServicePublicKey).publicKey,
      )
    ) {
      return false;
    }
    if (
      !ActionServicePublicKey.__deepEquals(
        this.fingerprint,
        (other as ActionServicePublicKey).fingerprint,
      )
    ) {
      return false;
    }
    if (
      !ActionServicePublicKey.__deepEquals(
        this.expirationDate,
        (other as ActionServicePublicKey).expirationDate,
      )
    ) {
      return false;
    }
    if (
      !ActionServicePublicKey.__deepEquals(
        this.creationDate,
        (other as ActionServicePublicKey).creationDate,
      )
    ) {
      return false;
    }
    if (
      !ActionServicePublicKey.__deepEquals(
        this.changeDate,
        (other as ActionServicePublicKey).changeDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => ActionServicePublicKey.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => ActionServicePublicKey.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !ActionServicePublicKey.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ActionServicePublicKey.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
