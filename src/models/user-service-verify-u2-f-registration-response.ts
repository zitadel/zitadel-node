...
export class UserServiceVerifyU2FRegistrationResponse {
  /**
  ...
  constructor(data?: Partial<UserServiceVerifyU2FRegistrationResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceVerifyU2FRegistrationResponse)) {
      return false;
    }
    if (
      !UserServiceVerifyU2FRegistrationResponse.__deepEquals(
        this.details,
        (other as UserServiceVerifyU2FRegistrationResponse).details,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceVerifyU2FRegistrationResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          UserServiceVerifyU2FRegistrationResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceVerifyU2FRegistrationResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceVerifyU2FRegistrationResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
