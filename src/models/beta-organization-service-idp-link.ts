...
export class BetaOrganizationServiceIDPLink {
  /**
  ...
  constructor(data?: Partial<BetaOrganizationServiceIDPLink>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaOrganizationServiceIDPLink)) {
      return false;
    }
    if (
      !BetaOrganizationServiceIDPLink.__deepEquals(
        this.idpId,
        (other as BetaOrganizationServiceIDPLink).idpId,
      )
    ) {
      return false;
    }
    if (
      !BetaOrganizationServiceIDPLink.__deepEquals(
        this.userId,
        (other as BetaOrganizationServiceIDPLink).userId,
      )
    ) {
      return false;
    }
    if (
      !BetaOrganizationServiceIDPLink.__deepEquals(
        this.userName,
        (other as BetaOrganizationServiceIDPLink).userName,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaOrganizationServiceIDPLink.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaOrganizationServiceIDPLink.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaOrganizationServiceIDPLink.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaOrganizationServiceIDPLink.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
