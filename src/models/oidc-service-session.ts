...
export class OIDCServiceSession {
  /**
  ...
  constructor(data?: Partial<OIDCServiceSession>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof OIDCServiceSession)) {
      return false;
    }
    if (
      !OIDCServiceSession.__deepEquals(
        this.sessionId,
        (other as OIDCServiceSession).sessionId,
      )
    ) {
      return false;
    }
    if (
      !OIDCServiceSession.__deepEquals(
        this.sessionToken,
        (other as OIDCServiceSession).sessionToken,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => OIDCServiceSession.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => OIDCServiceSession.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !OIDCServiceSession.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          OIDCServiceSession.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
