...
export class BetaInstanceServiceAddCustomDomainRequest {
  /**
  ...
  constructor(data?: Partial<BetaInstanceServiceAddCustomDomainRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaInstanceServiceAddCustomDomainRequest)) {
      return false;
    }
    if (
      !BetaInstanceServiceAddCustomDomainRequest.__deepEquals(
        this.instanceId,
        (other as BetaInstanceServiceAddCustomDomainRequest).instanceId,
      )
    ) {
      return false;
    }
    if (
      !BetaInstanceServiceAddCustomDomainRequest.__deepEquals(
        this.domain,
        (other as BetaInstanceServiceAddCustomDomainRequest).domain,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaInstanceServiceAddCustomDomainRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaInstanceServiceAddCustomDomainRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaInstanceServiceAddCustomDomainRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaInstanceServiceAddCustomDomainRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
