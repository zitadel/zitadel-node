...
export class BetaAuthorizationServiceUpdateAuthorizationResponse {
  /**
  ...
  constructor(
    data?: Partial<BetaAuthorizationServiceUpdateAuthorizationResponse>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !(other instanceof BetaAuthorizationServiceUpdateAuthorizationResponse)
    ) {
      return false;
    }
    if (
      !BetaAuthorizationServiceUpdateAuthorizationResponse.__deepEquals(
        this.changeDate,
        (other as BetaAuthorizationServiceUpdateAuthorizationResponse)
          .changeDate,
      )
    ) {
      return false;
