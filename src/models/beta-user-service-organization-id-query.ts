 ...
 */
export class BetaUserServiceOrganizationIdQuery {
  /**
  ...
  constructor(data?: Partial<BetaUserServiceOrganizationIdQuery>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaUserServiceOrganizationIdQuery)) {
      return false;
    }
    if (
      !BetaUserServiceOrganizationIdQuery.__deepEquals(
        this.organizationId,
        (other as BetaUserServiceOrganizationIdQuery).organizationId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaUserServiceOrganizationIdQuery.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaUserServiceOrganizationIdQuery.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaUserServiceOrganizationIdQuery.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaUserServiceOrganizationIdQuery.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
