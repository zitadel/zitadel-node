...
export class SessionServicePasswordFactor {
  /**
  ...
  constructor(data?: Partial<SessionServicePasswordFactor>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof SessionServicePasswordFactor)) {
      return false;
    }
    if (
      !SessionServicePasswordFactor.__deepEquals(
        this.verifiedAt,
        (other as SessionServicePasswordFactor).verifiedAt,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        SessionServicePasswordFactor.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => SessionServicePasswordFactor.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !SessionServicePasswordFactor.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          SessionServicePasswordFactor.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
