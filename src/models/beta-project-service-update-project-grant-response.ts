...
export class BetaProjectServiceUpdateProjectGrantResponse {
  /**
  ...
  constructor(data?: Partial<BetaProjectServiceUpdateProjectGrantResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaProjectServiceUpdateProjectGrantResponse)) {
      return false;
    }
    if (
      !BetaProjectServiceUpdateProjectGrantResponse.__deepEquals(
        this.changeDate,
        (other as BetaProjectServiceUpdateProjectGrantResponse).changeDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaProjectServiceUpdateProjectGrantResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaProjectServiceUpdateProjectGrantResponse.__deepEquals(v, w),
        ),
      );
    }
