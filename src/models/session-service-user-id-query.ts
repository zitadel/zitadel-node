...
export class SessionServiceUserIDQuery {
  /**
  ...
  constructor(data?: Partial<SessionServiceUserIDQuery>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof SessionServiceUserIDQuery)) {
      return false;
    }
    if (
      !SessionServiceUserIDQuery.__deepEquals(
        this.id,
        (other as SessionServiceUserIDQuery).id,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => SessionServiceUserIDQuery.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => SessionServiceUserIDQuery.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !SessionServiceUserIDQuery.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          SessionServiceUserIDQuery.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
