...
export class BetaProjectServiceRemoveProjectRoleResponse {
  /**
  ...
  constructor(data?: Partial<BetaProjectServiceRemoveProjectRoleResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaProjectServiceRemoveProjectRoleResponse)) {
      return false;
    }
    if (
      !BetaProjectServiceRemoveProjectRoleResponse.__deepEquals(
        this.removalDate,
        (other as BetaProjectServiceRemoveProjectRoleResponse).removalDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaProjectServiceRemoveProjectRoleResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaProjectServiceRemoveProjectRoleResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaProjectServiceRemoveProjectRoleResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
