...
export class BetaSessionServiceCheckUser {
  /**
  ...
  constructor(data?: Partial<BetaSessionServiceCheckUser>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaSessionServiceCheckUser)) {
      return false;
    }
    if (
      !BetaSessionServiceCheckUser.__deepEquals(
        this.loginName,
        (other as BetaSessionServiceCheckUser).loginName,
      )
    ) {
      return false;
    }
    if (
      !BetaSessionServiceCheckUser.__deepEquals(
        this.userId,
        (other as BetaSessionServiceCheckUser).userId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaSessionServiceCheckUser.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaSessionServiceCheckUser.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaSessionServiceCheckUser.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaSessionServiceCheckUser.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
