...
import { UserServiceAuthFactor } from "./user-service-auth-factor.js";
import { Expose, Type } from "class-transformer";

export class UserServiceListAuthenticationFactorsResponse {
  /**
  ...
  constructor(data?: Partial<UserServiceListAuthenticationFactorsResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceListAuthenticationFactorsResponse)) {
      return false;
    }
    if (
      !UserServiceListAuthenticationFactorsResponse.__deepEquals(
        this.result,
        (other as UserServiceListAuthenticationFactorsResponse).result,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceListAuthenticationFactorsResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          UserServiceListAuthenticationFactorsResponse.__deepEquals(v, w),
        ),
      );
    }
