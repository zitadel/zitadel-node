...
export class UserServiceRemoveOTPEmailRequest {
  /**
  ...
  constructor(data?: Partial<UserServiceRemoveOTPEmailRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceRemoveOTPEmailRequest)) {
      return false;
    }
    if (
      !UserServiceRemoveOTPEmailRequest.__deepEquals(
        this.userId,
        (other as UserServiceRemoveOTPEmailRequest).userId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceRemoveOTPEmailRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceRemoveOTPEmailRequest.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceRemoveOTPEmailRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceRemoveOTPEmailRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
