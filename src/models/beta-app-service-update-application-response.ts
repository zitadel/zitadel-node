...
export class BetaAppServiceUpdateApplicationResponse {
  /**
  ...
  constructor(data?: Partial<BetaAppServiceUpdateApplicationResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaAppServiceUpdateApplicationResponse)) {
      return false;
    }
    if (
      !BetaAppServiceUpdateApplicationResponse.__deepEquals(
        this.changeDate,
        (other as BetaAppServiceUpdateApplicationResponse).changeDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaAppServiceUpdateApplicationResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaAppServiceUpdateApplicationResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaAppServiceUpdateApplicationResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaAppServiceUpdateApplicationResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
