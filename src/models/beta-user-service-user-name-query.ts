 ...
 */
export class BetaUserServiceUserNameQuery {
  /**
  ...
  constructor(data?: Partial<BetaUserServiceUserNameQuery>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaUserServiceUserNameQuery)) {
      return false;
    }
    if (
      !BetaUserServiceUserNameQuery.__deepEquals(
        this.userName,
        (other as BetaUserServiceUserNameQuery).userName,
      )
    ) {
      return false;
    }
    if (
      !BetaUserServiceUserNameQuery.__deepEquals(
        this.method,
        (other as BetaUserServiceUserNameQuery).method,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaUserServiceUserNameQuery.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaUserServiceUserNameQuery.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaUserServiceUserNameQuery.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaUserServiceUserNameQuery.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
