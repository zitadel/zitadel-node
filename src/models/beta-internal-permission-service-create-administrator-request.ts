...
export class BetaInternalPermissionServiceCreateAdministratorRequest {
  /**
  ...
  constructor(
    data?: Partial<BetaInternalPermissionServiceCreateAdministratorRequest>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !(
        other instanceof BetaInternalPermissionServiceCreateAdministratorRequest
      )
    ) {
      return false;
    }
    if (
      !BetaInternalPermissionServiceCreateAdministratorRequest.__deepEquals(
        this.userId,
        (other as BetaInternalPermissionServiceCreateAdministratorRequest)
          .userId,
      )
    ) {
      return false;
