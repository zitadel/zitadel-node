...
export class UserServiceUpdateHumanUserRequest {
  ...
  constructor(data?: Partial<UserServiceUpdateHumanUserRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceUpdateHumanUserRequest)) {
      return false;
    }
    if (
      !UserServiceUpdateHumanUserRequest.__deepEquals(
        this.userId,
        (other as UserServiceUpdateHumanUserRequest).userId,
      )
    ) {
      return false;
    }
    if (
      !UserServiceUpdateHumanUserRequest.__deepEquals(
        this.username,
        (other as UserServiceUpdateHumanUserRequest).username,
      )
    ) {
      return false;
    }
    if (
      !UserServiceUpdateHumanUserRequest.__deepEquals(
        this.profile,
        (other as UserServiceUpdateHumanUserRequest).profile,
      )
    ) {
      return false;
    }
    if (
      !UserServiceUpdateHumanUserRequest.__deepEquals(
        this.email,
        (other as UserServiceUpdateHumanUserRequest).email,
      )
    ) {
      return false;
    }
    if (
      !UserServiceUpdateHumanUserRequest.__deepEquals(
        this.phone,
        (other as UserServiceUpdateHumanUserRequest).phone,
      )
    ) {
      return false;
    }
    if (
      !UserServiceUpdateHumanUserRequest.__deepEquals(
        this.password,
        (other as UserServiceUpdateHumanUserRequest).password,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceUpdateHumanUserRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceUpdateHumanUserRequest.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceUpdateHumanUserRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceUpdateHumanUserRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
