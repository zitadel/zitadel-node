...
export class BetaAppServiceUpdateSAMLApplicationConfigurationRequest {
  /**
  ...
  constructor(
    data?: Partial<BetaAppServiceUpdateSAMLApplicationConfigurationRequest>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !(
        other instanceof BetaAppServiceUpdateSAMLApplicationConfigurationRequest
      )
    ) {
      return false;
    }
    if (
      !BetaAppServiceUpdateSAMLApplicationConfigurationRequest.__deepEquals(
        this.loginVersion,
        (other as BetaAppServiceUpdateSAMLApplicationConfigurationRequest)
          .loginVersion,
      )
    ) {
      return false;
