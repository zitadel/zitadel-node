...
import { BetaAppServiceTextFilterMethod } from "./beta-app-service-text-filter-method.js";
import { Expose } from "class-transformer";

export class BetaAppServiceApplicationNameQuery {
  /**
  ...
  constructor(data?: Partial<BetaAppServiceApplicationNameQuery>) {
    Object.assign(this, data);
    if (this.name != null && typeof this.name !== "string") {
      throw new TypeError(`name must be a string, got ${typeof this.name}`);
    }
    if (this.method != null) {
      const methodValues = Object.values(BetaAppServiceTextFilterMethod).filter(
        (v) =>
          typeof (BetaAppServiceTextFilterMethod as Record<string, unknown>)[
            v as string
          ] !== "number",
      );
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaAppServiceApplicationNameQuery)) {
      return false;
    }
    if (
      !BetaAppServiceApplicationNameQuery.__deepEquals(
        this.name,
        (other as BetaAppServiceApplicationNameQuery).name,
      )
    ) {
      return false;
    }
    if (
      !BetaAppServiceApplicationNameQuery.__deepEquals(
        this.method,
        (other as BetaAppServiceApplicationNameQuery).method,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaAppServiceApplicationNameQuery.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaAppServiceApplicationNameQuery.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaAppServiceApplicationNameQuery.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaAppServiceApplicationNameQuery.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
