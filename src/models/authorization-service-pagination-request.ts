...
export class AuthorizationServicePaginationRequest {
  /**
  ...
  constructor(data?: Partial<AuthorizationServicePaginationRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof AuthorizationServicePaginationRequest)) {
      return false;
    }
    if (
      !AuthorizationServicePaginationRequest.__deepEquals(
        this.offset,
        (other as AuthorizationServicePaginationRequest).offset,
      )
    ) {
      return false;
    }
    if (
      !AuthorizationServicePaginationRequest.__deepEquals(
        this.limit,
        (other as AuthorizationServicePaginationRequest).limit,
      )
    ) {
      return false;
    }
    if (
      !AuthorizationServicePaginationRequest.__deepEquals(
        this.asc,
        (other as AuthorizationServicePaginationRequest).asc,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        AuthorizationServicePaginationRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          AuthorizationServicePaginationRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !AuthorizationServicePaginationRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          AuthorizationServicePaginationRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
