...
export class ApplicationServiceDeactivateApplicationRequest {
  /**
  ...
  constructor(data?: Partial<ApplicationServiceDeactivateApplicationRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ApplicationServiceDeactivateApplicationRequest)) {
      return false;
    }
    if (
      !ApplicationServiceDeactivateApplicationRequest.__deepEquals(
        this.applicationId,
        (other as ApplicationServiceDeactivateApplicationRequest).applicationId,
      )
    ) {
      return false;
    }
    if (
      !ApplicationServiceDeactivateApplicationRequest.__deepEquals(
        this.projectId,
        (other as ApplicationServiceDeactivateApplicationRequest).projectId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ApplicationServiceDeactivateApplicationRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          ApplicationServiceDeactivateApplicationRequest.__deepEquals(v, w),
        ),
      );
    }
