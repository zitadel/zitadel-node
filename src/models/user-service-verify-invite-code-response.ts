...
export class UserServiceVerifyInviteCodeResponse {
  /**
  ...
  constructor(data?: Partial<UserServiceVerifyInviteCodeResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceVerifyInviteCodeResponse)) {
      return false;
    }
    if (
      !UserServiceVerifyInviteCodeResponse.__deepEquals(
        this.details,
        (other as UserServiceVerifyInviteCodeResponse).details,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceVerifyInviteCodeResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          UserServiceVerifyInviteCodeResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceVerifyInviteCodeResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceVerifyInviteCodeResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
