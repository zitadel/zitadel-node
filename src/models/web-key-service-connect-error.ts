...
export class WebKeyServiceConnectError {
  ...
  constructor(data?: Partial<WebKeyServiceConnectError>) {
    ...
    if (this.code != null) {
      const codeValues = Object.values(
        WebKeyServiceConnectErrorCodeEnum,
      ).filter(
        (v) =>
          typeof (WebKeyServiceConnectErrorCodeEnum as Record<string, unknown>)[
            v as string
          ] !== "number",
      );
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof WebKeyServiceConnectError)) {
      return false;
    }
    if (
      !WebKeyServiceConnectError.__deepEquals(
        this.code,
        (other as WebKeyServiceConnectError).code,
      )
    ) {
      return false;
    }
    if (
      !WebKeyServiceConnectError.__deepEquals(
        this.message,
        (other as WebKeyServiceConnectError).message,
      )
    ) {
      return false;
    }
    if (
      !WebKeyServiceConnectError.__deepEquals(
        this.details,
        (other as WebKeyServiceConnectError).details,
      )
    ) {
      return false;
    }
    {
      ...
      for (const k of selfKeys) {
        ...
        if (!WebKeyServiceConnectError.__deepEquals(selfRec[k], otherRec[k])) {
          return false;
        }
      }
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => WebKeyServiceConnectError.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => WebKeyServiceConnectError.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !WebKeyServiceConnectError.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          WebKeyServiceConnectError.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
...
export enum WebKeyServiceConnectErrorCodeEnum {
  Canceled = "canceled",
  Unknown = "unknown",
