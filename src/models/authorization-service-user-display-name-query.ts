...
import { AuthorizationServiceTextFilterMethod } from "./authorization-service-text-filter-method.js";
import { Expose } from "class-transformer";

export class AuthorizationServiceUserDisplayNameQuery {
  /**
  ...
  constructor(data?: Partial<AuthorizationServiceUserDisplayNameQuery>) {
    ...
    if (this.method != null) {
      const methodValues = Object.values(
        ...
        (v) =>
          typeof (
            AuthorizationServiceTextFilterMethod as Record<string, unknown>
          )[v as string] !== "number",
      );
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof AuthorizationServiceUserDisplayNameQuery)) {
      return false;
    }
    if (
      !AuthorizationServiceUserDisplayNameQuery.__deepEquals(
        this.displayName,
        (other as AuthorizationServiceUserDisplayNameQuery).displayName,
      )
    ) {
      return false;
    }
    if (
      !AuthorizationServiceUserDisplayNameQuery.__deepEquals(
        this.method,
        (other as AuthorizationServiceUserDisplayNameQuery).method,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        AuthorizationServiceUserDisplayNameQuery.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          AuthorizationServiceUserDisplayNameQuery.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !AuthorizationServiceUserDisplayNameQuery.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          AuthorizationServiceUserDisplayNameQuery.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
