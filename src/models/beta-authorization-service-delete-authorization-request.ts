...
export class BetaAuthorizationServiceDeleteAuthorizationRequest {
  /**
  ...
  constructor(
    data?: Partial<BetaAuthorizationServiceDeleteAuthorizationRequest>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !(other instanceof BetaAuthorizationServiceDeleteAuthorizationRequest)
    ) {
      return false;
    }
    if (
      !BetaAuthorizationServiceDeleteAuthorizationRequest.__deepEquals(
        this.id,
        (other as BetaAuthorizationServiceDeleteAuthorizationRequest).id,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaAuthorizationServiceDeleteAuthorizationRequest.__deepEquals(v, w),
        ),
      );
    }
