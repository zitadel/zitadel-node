...
export class OrganizationServiceVerifyOrganizationDomainRequest {
  /**
  ...
  constructor(
    data?: Partial<OrganizationServiceVerifyOrganizationDomainRequest>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !(other instanceof OrganizationServiceVerifyOrganizationDomainRequest)
    ) {
      return false;
    }
    if (
      !OrganizationServiceVerifyOrganizationDomainRequest.__deepEquals(
        this.organizationId,
        (other as OrganizationServiceVerifyOrganizationDomainRequest)
          .organizationId,
      )
    ) {
      return false;
    ...
    if (
      !OrganizationServiceVerifyOrganizationDomainRequest.__deepEquals(
        this.domain,
        (other as OrganizationServiceVerifyOrganizationDomainRequest).domain,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          OrganizationServiceVerifyOrganizationDomainRequest.__deepEquals(v, w),
        ),
      );
    }
