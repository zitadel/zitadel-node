...
export class ProjectServiceCreateProjectResponse {
  /**
  ...
  constructor(data?: Partial<ProjectServiceCreateProjectResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ProjectServiceCreateProjectResponse)) {
      return false;
    }
    if (
      !ProjectServiceCreateProjectResponse.__deepEquals(
        this.projectId,
        (other as ProjectServiceCreateProjectResponse).projectId,
      )
    ) {
      return false;
    }
    if (
      !ProjectServiceCreateProjectResponse.__deepEquals(
        this.creationDate,
        (other as ProjectServiceCreateProjectResponse).creationDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ProjectServiceCreateProjectResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          ProjectServiceCreateProjectResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !ProjectServiceCreateProjectResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ProjectServiceCreateProjectResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
