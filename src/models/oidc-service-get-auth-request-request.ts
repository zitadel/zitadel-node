...
export class OIDCServiceGetAuthRequestRequest {
  /**
  ...
  constructor(data?: Partial<OIDCServiceGetAuthRequestRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof OIDCServiceGetAuthRequestRequest)) {
      return false;
    }
    if (
      !OIDCServiceGetAuthRequestRequest.__deepEquals(
        this.authRequestId,
        (other as OIDCServiceGetAuthRequestRequest).authRequestId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        OIDCServiceGetAuthRequestRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => OIDCServiceGetAuthRequestRequest.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !OIDCServiceGetAuthRequestRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          OIDCServiceGetAuthRequestRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
