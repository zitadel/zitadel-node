...
export class BetaOrganizationServiceOrgNameFilter {
  /**
  ...
  constructor(data?: Partial<BetaOrganizationServiceOrgNameFilter>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaOrganizationServiceOrgNameFilter)) {
      return false;
    }
    if (
      !BetaOrganizationServiceOrgNameFilter.__deepEquals(
        this.name,
        (other as BetaOrganizationServiceOrgNameFilter).name,
      )
    ) {
      return false;
    }
    if (
      !BetaOrganizationServiceOrgNameFilter.__deepEquals(
        this.method,
        (other as BetaOrganizationServiceOrgNameFilter).method,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaOrganizationServiceOrgNameFilter.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaOrganizationServiceOrgNameFilter.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaOrganizationServiceOrgNameFilter.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaOrganizationServiceOrgNameFilter.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
