...
import { UserServiceAuthenticationMethodType } from "./user-service-authentication-method-type.js";
...
export class UserServiceListAuthenticationMethodTypesResponse {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceListAuthenticationMethodTypesResponse)) {
      return false;
    }
    if (
      !UserServiceListAuthenticationMethodTypesResponse.__deepEquals(
        this.details,
        (other as UserServiceListAuthenticationMethodTypesResponse).details,
      )
    ) {
      return false;
    }
    if (
      !UserServiceListAuthenticationMethodTypesResponse.__deepEquals(
        this.authMethodTypes,
        (other as UserServiceListAuthenticationMethodTypesResponse)
          .authMethodTypes,
      )
    ) {
      return false;
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceListAuthenticationMethodTypesResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          UserServiceListAuthenticationMethodTypesResponse.__deepEquals(v, w),
        ),
      );
    }
