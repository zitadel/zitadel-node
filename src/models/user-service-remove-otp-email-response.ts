...
export class UserServiceRemoveOTPEmailResponse {
  /**
  ...
  constructor(data?: Partial<UserServiceRemoveOTPEmailResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceRemoveOTPEmailResponse)) {
      return false;
    }
    if (
      !UserServiceRemoveOTPEmailResponse.__deepEquals(
        this.details,
        (other as UserServiceRemoveOTPEmailResponse).details,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceRemoveOTPEmailResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceRemoveOTPEmailResponse.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceRemoveOTPEmailResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceRemoveOTPEmailResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
