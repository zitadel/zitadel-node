...
export class BetaOrganizationServiceAddOrganizationDomainResponse {
  /**
  ...
  constructor(
    data?: Partial<BetaOrganizationServiceAddOrganizationDomainResponse>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !(other instanceof BetaOrganizationServiceAddOrganizationDomainResponse)
    ) {
      return false;
    }
    if (
      !BetaOrganizationServiceAddOrganizationDomainResponse.__deepEquals(
        this.creationDate,
        (other as BetaOrganizationServiceAddOrganizationDomainResponse)
          .creationDate,
      )
    ) {
      return false;
