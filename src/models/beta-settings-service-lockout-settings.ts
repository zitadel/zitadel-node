...
export class BetaSettingsServiceLockoutSettings {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaSettingsServiceLockoutSettings)) {
      return false;
    }
    if (
      !BetaSettingsServiceLockoutSettings.__deepEquals(
        this.maxPasswordAttempts,
        (other as BetaSettingsServiceLockoutSettings).maxPasswordAttempts,
      )
    ) {
      return false;
    }
    if (
      !BetaSettingsServiceLockoutSettings.__deepEquals(
        this.resourceOwnerType,
        (other as BetaSettingsServiceLockoutSettings).resourceOwnerType,
      )
    ) {
      return false;
    }
    if (
      !BetaSettingsServiceLockoutSettings.__deepEquals(
        this.maxOtpAttempts,
        (other as BetaSettingsServiceLockoutSettings).maxOtpAttempts,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaSettingsServiceLockoutSettings.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaSettingsServiceLockoutSettings.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaSettingsServiceLockoutSettings.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaSettingsServiceLockoutSettings.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
