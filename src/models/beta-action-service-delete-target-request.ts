...
export class BetaActionServiceDeleteTargetRequest {
  /**
  ...
  constructor(data?: Partial<BetaActionServiceDeleteTargetRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaActionServiceDeleteTargetRequest)) {
      return false;
    }
    if (
      !BetaActionServiceDeleteTargetRequest.__deepEquals(
        this.id,
        (other as BetaActionServiceDeleteTargetRequest).id,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaActionServiceDeleteTargetRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaActionServiceDeleteTargetRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaActionServiceDeleteTargetRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaActionServiceDeleteTargetRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
