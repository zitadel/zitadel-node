...
export class BetaProjectServiceCreateProjectGrantRequest {
  /**
  ...
  constructor(data?: Partial<BetaProjectServiceCreateProjectGrantRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaProjectServiceCreateProjectGrantRequest)) {
      return false;
    }
    if (
      !BetaProjectServiceCreateProjectGrantRequest.__deepEquals(
        this.projectId,
        (other as BetaProjectServiceCreateProjectGrantRequest).projectId,
      )
    ) {
      return false;
    }
    if (
      !BetaProjectServiceCreateProjectGrantRequest.__deepEquals(
        ...
        (other as BetaProjectServiceCreateProjectGrantRequest)
    ...
    if (
      !BetaProjectServiceCreateProjectGrantRequest.__deepEquals(
        this.roleKeys,
        (other as BetaProjectServiceCreateProjectGrantRequest).roleKeys,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaProjectServiceCreateProjectGrantRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaProjectServiceCreateProjectGrantRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaProjectServiceCreateProjectGrantRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
