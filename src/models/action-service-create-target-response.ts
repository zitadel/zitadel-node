...
export class ActionServiceCreateTargetResponse {
  /**
  ...
  constructor(data?: Partial<ActionServiceCreateTargetResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ActionServiceCreateTargetResponse)) {
      return false;
    }
    if (
      !ActionServiceCreateTargetResponse.__deepEquals(
        this.id,
        (other as ActionServiceCreateTargetResponse).id,
      )
    ) {
      return false;
    }
    if (
      !ActionServiceCreateTargetResponse.__deepEquals(
        this.creationDate,
        (other as ActionServiceCreateTargetResponse).creationDate,
      )
    ) {
      return false;
    }
    if (
      !ActionServiceCreateTargetResponse.__deepEquals(
        this.signingKey,
        (other as ActionServiceCreateTargetResponse).signingKey,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ActionServiceCreateTargetResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => ActionServiceCreateTargetResponse.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !ActionServiceCreateTargetResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ActionServiceCreateTargetResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
