...
export class BetaUserServiceRemoveOTPEmailRequest {
  /**
  ...
  constructor(data?: Partial<BetaUserServiceRemoveOTPEmailRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaUserServiceRemoveOTPEmailRequest)) {
      return false;
    }
    if (
      !BetaUserServiceRemoveOTPEmailRequest.__deepEquals(
        this.userId,
        (other as BetaUserServiceRemoveOTPEmailRequest).userId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaUserServiceRemoveOTPEmailRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaUserServiceRemoveOTPEmailRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaUserServiceRemoveOTPEmailRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaUserServiceRemoveOTPEmailRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
