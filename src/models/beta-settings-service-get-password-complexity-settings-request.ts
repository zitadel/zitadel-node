...
export class BetaSettingsServiceGetPasswordComplexitySettingsRequest {
  /**
  ...
  constructor(
    data?: Partial<BetaSettingsServiceGetPasswordComplexitySettingsRequest>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !(
        other instanceof BetaSettingsServiceGetPasswordComplexitySettingsRequest
      )
    ) {
      return false;
    }
    if (
      !BetaSettingsServiceGetPasswordComplexitySettingsRequest.__deepEquals(
        this.ctx,
        (other as BetaSettingsServiceGetPasswordComplexitySettingsRequest).ctx,
      )
    ) {
      return false;
    }
