...
export class UserServiceIDPSAMLAccessInformation {
  /**
  ...
  constructor(data?: Partial<UserServiceIDPSAMLAccessInformation>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceIDPSAMLAccessInformation)) {
      return false;
    }
    if (
      !UserServiceIDPSAMLAccessInformation.__deepEquals(
        this.assertion,
        (other as UserServiceIDPSAMLAccessInformation).assertion,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceIDPSAMLAccessInformation.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          UserServiceIDPSAMLAccessInformation.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceIDPSAMLAccessInformation.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceIDPSAMLAccessInformation.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
