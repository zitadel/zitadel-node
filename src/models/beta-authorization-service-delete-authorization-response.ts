...
export class BetaAuthorizationServiceDeleteAuthorizationResponse {
  /**
  ...
  constructor(
    data?: Partial<BetaAuthorizationServiceDeleteAuthorizationResponse>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !(other instanceof BetaAuthorizationServiceDeleteAuthorizationResponse)
    ) {
      return false;
    }
    if (
      !BetaAuthorizationServiceDeleteAuthorizationResponse.__deepEquals(
        this.deletionDate,
        (other as BetaAuthorizationServiceDeleteAuthorizationResponse)
          .deletionDate,
      )
    ) {
      return false;
