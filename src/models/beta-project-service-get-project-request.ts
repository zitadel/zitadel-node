...
export class BetaProjectServiceGetProjectRequest {
  /**
  ...
  constructor(data?: Partial<BetaProjectServiceGetProjectRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaProjectServiceGetProjectRequest)) {
      return false;
    }
    if (
      !BetaProjectServiceGetProjectRequest.__deepEquals(
        this.id,
        (other as BetaProjectServiceGetProjectRequest).id,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaProjectServiceGetProjectRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaProjectServiceGetProjectRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaProjectServiceGetProjectRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaProjectServiceGetProjectRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
