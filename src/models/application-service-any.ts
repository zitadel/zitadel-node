 ...
 */
export class ApplicationServiceAny {
  /**
  ...
  constructor(data?: Partial<ApplicationServiceAny>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ApplicationServiceAny)) {
      return false;
    }
    if (
      !ApplicationServiceAny.__deepEquals(
        this.type,
        (other as ApplicationServiceAny).type,
      )
    ) {
      return false;
    }
    if (
      !ApplicationServiceAny.__deepEquals(
        this.value,
        (other as ApplicationServiceAny).value,
      )
    ) {
      return false;
    }
    if (
      !ApplicationServiceAny.__deepEquals(
        this.debug,
        (other as ApplicationServiceAny).debug,
      )
    ) {
      return false;
    }
    {
      ...
      for (const k of selfKeys) {
        ...
        if (!ApplicationServiceAny.__deepEquals(selfRec[k], otherRec[k])) {
          return false;
        }
      }
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => ApplicationServiceAny.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => ApplicationServiceAny.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !ApplicationServiceAny.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ApplicationServiceAny.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
