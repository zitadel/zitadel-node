...
export class OrganizationServiceGenerateOrganizationDomainValidationResponse {
  /**
  ...
  constructor(
    data?: Partial<OrganizationServiceGenerateOrganizationDomainValidationResponse>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !OrganizationServiceGenerateOrganizationDomainValidationResponse.__deepEquals(
        this.token,
        (
          other as OrganizationServiceGenerateOrganizationDomainValidationResponse
        ).token,
      )
    ) {
      return false;
