...
export class ActionServicePaginationResponse {
  /**
  ...
  constructor(data?: Partial<ActionServicePaginationResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ActionServicePaginationResponse)) {
      return false;
    }
    if (
      !ActionServicePaginationResponse.__deepEquals(
        this.totalResult,
        (other as ActionServicePaginationResponse).totalResult,
      )
    ) {
      return false;
    }
    if (
      !ActionServicePaginationResponse.__deepEquals(
        this.appliedLimit,
        (other as ActionServicePaginationResponse).appliedLimit,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ActionServicePaginationResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => ActionServicePaginationResponse.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !ActionServicePaginationResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ActionServicePaginationResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
