...
import { BetaAuthorizationServiceAny } from "./beta-authorization-service-any.js";
import { Expose, Type } from "class-transformer";

/**
 * Error type returned by Connect: https://connectrpc.com/docs/go/errors/#http-representation
 */
export class BetaAuthorizationServiceConnectError {
  /**
  ...
  constructor(data?: Partial<BetaAuthorizationServiceConnectError>) {
    ...
    if (this.code != null) {
      const codeValues = Object.values(
        BetaAuthorizationServiceConnectErrorCodeEnum,
      ).filter(
        (v) =>
          typeof (
            BetaAuthorizationServiceConnectErrorCodeEnum as Record<
              string,
              unknown
            >
          )[v as string] !== "number",
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaAuthorizationServiceConnectError)) {
      return false;
    }
    if (
      !BetaAuthorizationServiceConnectError.__deepEquals(
        this.code,
        (other as BetaAuthorizationServiceConnectError).code,
      )
    ) {
      return false;
    }
    if (
      !BetaAuthorizationServiceConnectError.__deepEquals(
        this.message,
        (other as BetaAuthorizationServiceConnectError).message,
      )
    ) {
      return false;
    }
    if (
      !BetaAuthorizationServiceConnectError.__deepEquals(
        this.details,
        (other as BetaAuthorizationServiceConnectError).details,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaAuthorizationServiceConnectError.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaAuthorizationServiceConnectError.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaAuthorizationServiceConnectError.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaAuthorizationServiceConnectError.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
...
export enum BetaAuthorizationServiceConnectErrorCodeEnum {
  Canceled = "canceled",
  Unknown = "unknown",
