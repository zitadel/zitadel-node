...
import { InternalPermissionServiceAny } from "./internal-permission-service-any.js";
import { Expose, Type } from "class-transformer";

/**
 * Error type returned by Connect: https://connectrpc.com/docs/go/errors/#http-representation
 */
export class InternalPermissionServiceConnectError {
  /**
   ...
   */
  @Expose({ name: "details" })
  @Type(() => InternalPermissionServiceAny)
  ...
  constructor(data?: Partial<InternalPermissionServiceConnectError>) {
    ...
    if (this.code != null) {
      const codeValues = Object.values(
        InternalPermissionServiceConnectErrorCodeEnum,
      ).filter(
        (v) =>
          typeof (
            InternalPermissionServiceConnectErrorCodeEnum as Record<
              string,
              unknown
            >
          )[v as string] !== "number",
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof InternalPermissionServiceConnectError)) {
      return false;
    }
    if (
      !InternalPermissionServiceConnectError.__deepEquals(
        this.code,
        (other as InternalPermissionServiceConnectError).code,
      )
    ) {
      return false;
    }
    if (
      !InternalPermissionServiceConnectError.__deepEquals(
        this.message,
        (other as InternalPermissionServiceConnectError).message,
      )
    ) {
      return false;
    }
    if (
      !InternalPermissionServiceConnectError.__deepEquals(
        this.details,
        (other as InternalPermissionServiceConnectError).details,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        InternalPermissionServiceConnectError.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          InternalPermissionServiceConnectError.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !InternalPermissionServiceConnectError.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          InternalPermissionServiceConnectError.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
...
export enum InternalPermissionServiceConnectErrorCodeEnum {
  Canceled = "canceled",
  Unknown = "unknown",
