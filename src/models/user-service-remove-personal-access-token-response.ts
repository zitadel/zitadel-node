...
export class UserServiceRemovePersonalAccessTokenResponse {
  /**
  ...
  constructor(data?: Partial<UserServiceRemovePersonalAccessTokenResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceRemovePersonalAccessTokenResponse)) {
      return false;
    }
    if (
      !UserServiceRemovePersonalAccessTokenResponse.__deepEquals(
        this.deletionDate,
        (other as UserServiceRemovePersonalAccessTokenResponse).deletionDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceRemovePersonalAccessTokenResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          UserServiceRemovePersonalAccessTokenResponse.__deepEquals(v, w),
        ),
      );
    }
