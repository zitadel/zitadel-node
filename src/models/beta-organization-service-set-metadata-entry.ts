...
export class BetaOrganizationServiceSetMetadataEntry {
  /**
  ...
  constructor(data?: Partial<BetaOrganizationServiceSetMetadataEntry>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaOrganizationServiceSetMetadataEntry)) {
      return false;
    }
    if (
      !BetaOrganizationServiceSetMetadataEntry.__deepEquals(
        this.key,
        (other as BetaOrganizationServiceSetMetadataEntry).key,
      )
    ) {
      return false;
    }
    if (
      !BetaOrganizationServiceSetMetadataEntry.__deepEquals(
        this.value,
        (other as BetaOrganizationServiceSetMetadataEntry).value,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaOrganizationServiceSetMetadataEntry.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaOrganizationServiceSetMetadataEntry.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaOrganizationServiceSetMetadataEntry.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaOrganizationServiceSetMetadataEntry.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
