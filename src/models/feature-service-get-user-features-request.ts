...
export class FeatureServiceGetUserFeaturesRequest {
  /**
  ...
  constructor(data?: Partial<FeatureServiceGetUserFeaturesRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof FeatureServiceGetUserFeaturesRequest)) {
      return false;
    }
    if (
      !FeatureServiceGetUserFeaturesRequest.__deepEquals(
        this.userId,
        (other as FeatureServiceGetUserFeaturesRequest).userId,
      )
    ) {
      return false;
    }
    if (
      !FeatureServiceGetUserFeaturesRequest.__deepEquals(
        this.inheritance,
        (other as FeatureServiceGetUserFeaturesRequest).inheritance,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        FeatureServiceGetUserFeaturesRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          FeatureServiceGetUserFeaturesRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !FeatureServiceGetUserFeaturesRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          FeatureServiceGetUserFeaturesRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
