...
export class BetaOrganizationServiceDeleteOrganizationResponse {
  /**
  ...
  constructor(
    data?: Partial<BetaOrganizationServiceDeleteOrganizationResponse>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaOrganizationServiceDeleteOrganizationResponse)) {
      return false;
    }
    if (
      !BetaOrganizationServiceDeleteOrganizationResponse.__deepEquals(
        this.deletionDate,
        (other as BetaOrganizationServiceDeleteOrganizationResponse)
          .deletionDate,
      )
    ) {
      return false;
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaOrganizationServiceDeleteOrganizationResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaOrganizationServiceDeleteOrganizationResponse.__deepEquals(v, w),
        ),
      );
    }
