...
export class UserServiceFormData {
  /**
  ...
  constructor(data?: Partial<UserServiceFormData>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceFormData)) {
      return false;
    }
    if (
      !UserServiceFormData.__deepEquals(
        this.url,
        (other as UserServiceFormData).url,
      )
    ) {
      return false;
    }
    if (
      !UserServiceFormData.__deepEquals(
        this.fields,
        (other as UserServiceFormData).fields,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => UserServiceFormData.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceFormData.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !UserServiceFormData.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceFormData.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
