...
export class BetaFeatureServiceGetUserFeaturesRequest {
  /**
  ...
  constructor(data?: Partial<BetaFeatureServiceGetUserFeaturesRequest>) {
    Object.assign(this, data);
    if (this.userId != null && typeof this.userId !== "string") {
      throw new TypeError(`userId must be a string, got ${typeof this.userId}`);
    }
    if (this.inheritance != null && typeof this.inheritance !== "boolean") {
      throw new TypeError(
        `inheritance must be a boolean, got ${typeof this.inheritance}`,
      );
    }
  }
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaFeatureServiceGetUserFeaturesRequest)) {
      return false;
    }
    if (
      !BetaFeatureServiceGetUserFeaturesRequest.__deepEquals(
        this.userId,
        (other as BetaFeatureServiceGetUserFeaturesRequest).userId,
      )
    ) {
      return false;
    }
    if (
      !BetaFeatureServiceGetUserFeaturesRequest.__deepEquals(
        this.inheritance,
        (other as BetaFeatureServiceGetUserFeaturesRequest).inheritance,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaFeatureServiceGetUserFeaturesRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaFeatureServiceGetUserFeaturesRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaFeatureServiceGetUserFeaturesRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaFeatureServiceGetUserFeaturesRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
