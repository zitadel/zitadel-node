...
export class WebKeyServiceActivateWebKeyRequest {
  /**
  ...
  constructor(data?: Partial<WebKeyServiceActivateWebKeyRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof WebKeyServiceActivateWebKeyRequest)) {
      return false;
    }
    if (
      !WebKeyServiceActivateWebKeyRequest.__deepEquals(
        this.id,
        (other as WebKeyServiceActivateWebKeyRequest).id,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        WebKeyServiceActivateWebKeyRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          WebKeyServiceActivateWebKeyRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !WebKeyServiceActivateWebKeyRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          WebKeyServiceActivateWebKeyRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
