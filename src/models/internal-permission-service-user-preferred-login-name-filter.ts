...
export class InternalPermissionServiceUserPreferredLoginNameFilter {
  /**
  ...
  constructor(
    data?: Partial<InternalPermissionServiceUserPreferredLoginNameFilter>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !(other instanceof InternalPermissionServiceUserPreferredLoginNameFilter)
    ) {
      return false;
    }
    if (
      !InternalPermissionServiceUserPreferredLoginNameFilter.__deepEquals(
        this.preferredLoginName,
        (other as InternalPermissionServiceUserPreferredLoginNameFilter)
          .preferredLoginName,
      )
    ) {
      return false;
    ...
    if (
      !InternalPermissionServiceUserPreferredLoginNameFilter.__deepEquals(
        this.method,
        (other as InternalPermissionServiceUserPreferredLoginNameFilter).method,
      )
    ) {
      return false;
    }
