...
export class OIDCServiceAny {
  ...
  constructor(data?: Partial<OIDCServiceAny>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof OIDCServiceAny)) {
      return false;
    }
    if (
      !OIDCServiceAny.__deepEquals(this.type, (other as OIDCServiceAny).type)
    ) {
      return false;
    }
    if (
      !OIDCServiceAny.__deepEquals(this.value, (other as OIDCServiceAny).value)
    ) {
      return false;
    }
    if (
      !OIDCServiceAny.__deepEquals(this.debug, (other as OIDCServiceAny).debug)
    ) {
      return false;
    }
    {
      ...
      for (const k of selfKeys) {
        ...
        if (!OIDCServiceAny.__deepEquals(selfRec[k], otherRec[k])) {
          return false;
        }
      }
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => OIDCServiceAny.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => OIDCServiceAny.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !OIDCServiceAny.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          OIDCServiceAny.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
