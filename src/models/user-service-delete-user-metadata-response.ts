...
export class UserServiceDeleteUserMetadataResponse {
  /**
  ...
  constructor(data?: Partial<UserServiceDeleteUserMetadataResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceDeleteUserMetadataResponse)) {
      return false;
    }
    if (
      !UserServiceDeleteUserMetadataResponse.__deepEquals(
        this.deletionDate,
        (other as UserServiceDeleteUserMetadataResponse).deletionDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceDeleteUserMetadataResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          UserServiceDeleteUserMetadataResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceDeleteUserMetadataResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceDeleteUserMetadataResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
