...
import { OIDCServiceErrorReason } from "./oidc-service-error-reason.js";
import { Expose } from "class-transformer";

export class OIDCServiceAuthorizationError {
  /**
  ...
  constructor(data?: Partial<OIDCServiceAuthorizationError>) {
    ...
    if (this.errorUri != null && typeof this.errorUri !== "string") {
      throw new TypeError(
        `errorUri must be a string, got ${typeof this.errorUri}`,
      );
    }
    if (this.error != null) {
      const errorValues = Object.values(OIDCServiceErrorReason).filter(
        (v) =>
          typeof (OIDCServiceErrorReason as Record<string, unknown>)[
            v as string
          ] !== "number",
      );
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof OIDCServiceAuthorizationError)) {
      return false;
    }
    if (
      !OIDCServiceAuthorizationError.__deepEquals(
        this.error,
        (other as OIDCServiceAuthorizationError).error,
      )
    ) {
      return false;
    }
    if (
      !OIDCServiceAuthorizationError.__deepEquals(
        ...
        (other as OIDCServiceAuthorizationError).errorDescription,
      )
    ) {
      return false;
    }
    if (
      !OIDCServiceAuthorizationError.__deepEquals(
        this.errorUri,
        (other as OIDCServiceAuthorizationError).errorUri,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        OIDCServiceAuthorizationError.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => OIDCServiceAuthorizationError.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !OIDCServiceAuthorizationError.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          OIDCServiceAuthorizationError.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
