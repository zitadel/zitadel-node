 ...
 */
export class ActionServiceFunctionExecution {
  /**
  ...
  constructor(data?: Partial<ActionServiceFunctionExecution>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ActionServiceFunctionExecution)) {
      return false;
    }
    if (
      !ActionServiceFunctionExecution.__deepEquals(
        this.name,
        (other as ActionServiceFunctionExecution).name,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ActionServiceFunctionExecution.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => ActionServiceFunctionExecution.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !ActionServiceFunctionExecution.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ActionServiceFunctionExecution.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
