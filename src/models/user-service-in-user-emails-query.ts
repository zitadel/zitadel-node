 ...
 */
export class UserServiceInUserEmailsQuery {
  /**
  ...
  constructor(data?: Partial<UserServiceInUserEmailsQuery>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceInUserEmailsQuery)) {
      return false;
    }
    if (
      !UserServiceInUserEmailsQuery.__deepEquals(
        this.userEmails,
        (other as UserServiceInUserEmailsQuery).userEmails,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceInUserEmailsQuery.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceInUserEmailsQuery.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceInUserEmailsQuery.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceInUserEmailsQuery.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
