...
export class BetaActionServicePaginationResponse {
  /**
  ...
  constructor(data?: Partial<BetaActionServicePaginationResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaActionServicePaginationResponse)) {
      return false;
    }
    if (
      !BetaActionServicePaginationResponse.__deepEquals(
        this.totalResult,
        (other as BetaActionServicePaginationResponse).totalResult,
      )
    ) {
      return false;
    }
    if (
      !BetaActionServicePaginationResponse.__deepEquals(
        this.appliedLimit,
        (other as BetaActionServicePaginationResponse).appliedLimit,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaActionServicePaginationResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaActionServicePaginationResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaActionServicePaginationResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaActionServicePaginationResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
