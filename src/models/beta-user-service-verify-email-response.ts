...
export class BetaUserServiceVerifyEmailResponse {
  /**
  ...
  constructor(data?: Partial<BetaUserServiceVerifyEmailResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaUserServiceVerifyEmailResponse)) {
      return false;
    }
    if (
      !BetaUserServiceVerifyEmailResponse.__deepEquals(
        this.details,
        (other as BetaUserServiceVerifyEmailResponse).details,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaUserServiceVerifyEmailResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaUserServiceVerifyEmailResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaUserServiceVerifyEmailResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaUserServiceVerifyEmailResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
