...
import { InstanceServiceDomainFilter } from "./instance-service-domain-filter.js";
...
export class InstanceServiceCustomDomainFilter {
  ...
  constructor(data?: Partial<InstanceServiceCustomDomainFilter>) {
    Object.assign(this, data);
    if (
      this.generatedFilter != null &&
      typeof this.generatedFilter !== "boolean"
    ) {
      throw new TypeError(
        `generatedFilter must be a boolean, got ${typeof this.generatedFilter}`,
      );
    }
    if (this.primaryFilter != null && typeof this.primaryFilter !== "boolean") {
      throw new TypeError(
        `primaryFilter must be a boolean, got ${typeof this.primaryFilter}`,
      );
    }
  }
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof InstanceServiceCustomDomainFilter)) {
      return false;
    }
    if (
      !InstanceServiceCustomDomainFilter.__deepEquals(
        this.domainFilter,
        (other as InstanceServiceCustomDomainFilter).domainFilter,
      )
    ) {
      return false;
    }
    if (
      !InstanceServiceCustomDomainFilter.__deepEquals(
        ...
        (other as InstanceServiceCustomDomainFilter).generatedFilter,
      )
    ) {
      return false;
    }
    if (
      !InstanceServiceCustomDomainFilter.__deepEquals(
        this.primaryFilter,
        (other as InstanceServiceCustomDomainFilter).primaryFilter,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        InstanceServiceCustomDomainFilter.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => InstanceServiceCustomDomainFilter.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !InstanceServiceCustomDomainFilter.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          InstanceServiceCustomDomainFilter.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
