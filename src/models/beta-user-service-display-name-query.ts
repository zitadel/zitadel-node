 ...
 */
export class BetaUserServiceDisplayNameQuery {
  /**
  ...
  constructor(data?: Partial<BetaUserServiceDisplayNameQuery>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaUserServiceDisplayNameQuery)) {
      return false;
    }
    if (
      !BetaUserServiceDisplayNameQuery.__deepEquals(
        this.displayName,
        (other as BetaUserServiceDisplayNameQuery).displayName,
      )
    ) {
      return false;
    }
    if (
      !BetaUserServiceDisplayNameQuery.__deepEquals(
        this.method,
        (other as BetaUserServiceDisplayNameQuery).method,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaUserServiceDisplayNameQuery.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaUserServiceDisplayNameQuery.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaUserServiceDisplayNameQuery.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaUserServiceDisplayNameQuery.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
