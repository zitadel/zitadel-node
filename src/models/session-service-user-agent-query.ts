...
export class SessionServiceUserAgentQuery {
  /**
  ...
  constructor(data?: Partial<SessionServiceUserAgentQuery>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof SessionServiceUserAgentQuery)) {
      return false;
    }
    if (
      !SessionServiceUserAgentQuery.__deepEquals(
        this.fingerprintId,
        (other as SessionServiceUserAgentQuery).fingerprintId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        SessionServiceUserAgentQuery.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => SessionServiceUserAgentQuery.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !SessionServiceUserAgentQuery.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          SessionServiceUserAgentQuery.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
