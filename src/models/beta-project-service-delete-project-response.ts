...
export class BetaProjectServiceDeleteProjectResponse {
  /**
  ...
  constructor(data?: Partial<BetaProjectServiceDeleteProjectResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaProjectServiceDeleteProjectResponse)) {
      return false;
    }
    if (
      !BetaProjectServiceDeleteProjectResponse.__deepEquals(
        this.deletionDate,
        (other as BetaProjectServiceDeleteProjectResponse).deletionDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaProjectServiceDeleteProjectResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaProjectServiceDeleteProjectResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaProjectServiceDeleteProjectResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaProjectServiceDeleteProjectResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
