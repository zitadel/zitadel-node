...
export class AuthorizationServiceUpdateAuthorizationRequest {
  /**
  ...
  constructor(data?: Partial<AuthorizationServiceUpdateAuthorizationRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof AuthorizationServiceUpdateAuthorizationRequest)) {
      return false;
    }
    if (
      !AuthorizationServiceUpdateAuthorizationRequest.__deepEquals(
        this.id,
        (other as AuthorizationServiceUpdateAuthorizationRequest).id,
      )
    ) {
      return false;
    }
    if (
      !AuthorizationServiceUpdateAuthorizationRequest.__deepEquals(
        this.roleKeys,
        (other as AuthorizationServiceUpdateAuthorizationRequest).roleKeys,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        AuthorizationServiceUpdateAuthorizationRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          AuthorizationServiceUpdateAuthorizationRequest.__deepEquals(v, w),
        ),
      );
    }
