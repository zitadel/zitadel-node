...
export class BetaInstanceServiceDomainsQuery {
  /**
  ...
  constructor(data?: Partial<BetaInstanceServiceDomainsQuery>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaInstanceServiceDomainsQuery)) {
      return false;
    }
    if (
      !BetaInstanceServiceDomainsQuery.__deepEquals(
        this.domains,
        (other as BetaInstanceServiceDomainsQuery).domains,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaInstanceServiceDomainsQuery.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaInstanceServiceDomainsQuery.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaInstanceServiceDomainsQuery.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaInstanceServiceDomainsQuery.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
