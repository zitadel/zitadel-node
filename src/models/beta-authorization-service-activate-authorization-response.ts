...
export class BetaAuthorizationServiceActivateAuthorizationResponse {
  /**
  ...
  constructor(
    data?: Partial<BetaAuthorizationServiceActivateAuthorizationResponse>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !(other instanceof BetaAuthorizationServiceActivateAuthorizationResponse)
    ) {
      return false;
    }
    if (
      !BetaAuthorizationServiceActivateAuthorizationResponse.__deepEquals(
        this.changeDate,
        (other as BetaAuthorizationServiceActivateAuthorizationResponse)
          .changeDate,
      )
    ) {
      return false;
