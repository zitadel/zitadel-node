...
export class BetaUserServiceListDetails {
  /**
  ...
  constructor(data?: Partial<BetaUserServiceListDetails>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaUserServiceListDetails)) {
      return false;
    }
    if (
      !BetaUserServiceListDetails.__deepEquals(
        this.totalResult,
        (other as BetaUserServiceListDetails).totalResult,
      )
    ) {
      return false;
    }
    if (
      !BetaUserServiceListDetails.__deepEquals(
        ...
        (other as BetaUserServiceListDetails).processedSequence,
      )
    ) {
      return false;
    }
    if (
      !BetaUserServiceListDetails.__deepEquals(
        this.timestamp,
        (other as BetaUserServiceListDetails).timestamp,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaUserServiceListDetails.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaUserServiceListDetails.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaUserServiceListDetails.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaUserServiceListDetails.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
