...
export class ProjectServiceProjectRoleKeyFilter {
  /**
  ...
  constructor(data?: Partial<ProjectServiceProjectRoleKeyFilter>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ProjectServiceProjectRoleKeyFilter)) {
      return false;
    }
    if (
      !ProjectServiceProjectRoleKeyFilter.__deepEquals(
        this.key,
        (other as ProjectServiceProjectRoleKeyFilter).key,
      )
    ) {
      return false;
    }
    if (
      !ProjectServiceProjectRoleKeyFilter.__deepEquals(
        this.method,
        (other as ProjectServiceProjectRoleKeyFilter).method,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ProjectServiceProjectRoleKeyFilter.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          ProjectServiceProjectRoleKeyFilter.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !ProjectServiceProjectRoleKeyFilter.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ProjectServiceProjectRoleKeyFilter.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
