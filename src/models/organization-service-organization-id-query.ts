...
export class OrganizationServiceOrganizationIDQuery {
  /**
  ...
  constructor(data?: Partial<OrganizationServiceOrganizationIDQuery>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof OrganizationServiceOrganizationIDQuery)) {
      return false;
    }
    if (
      !OrganizationServiceOrganizationIDQuery.__deepEquals(
        this.id,
        (other as OrganizationServiceOrganizationIDQuery).id,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        OrganizationServiceOrganizationIDQuery.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          OrganizationServiceOrganizationIDQuery.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !OrganizationServiceOrganizationIDQuery.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          OrganizationServiceOrganizationIDQuery.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
