...
export class BetaProjectServiceCreateProjectGrantResponse {
  /**
  ...
  constructor(data?: Partial<BetaProjectServiceCreateProjectGrantResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaProjectServiceCreateProjectGrantResponse)) {
      return false;
    }
    if (
      !BetaProjectServiceCreateProjectGrantResponse.__deepEquals(
        this.creationDate,
        (other as BetaProjectServiceCreateProjectGrantResponse).creationDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaProjectServiceCreateProjectGrantResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaProjectServiceCreateProjectGrantResponse.__deepEquals(v, w),
        ),
      );
    }
