...
export class ApplicationServiceCreateAPIApplicationResponse {
  /**
  ...
  constructor(data?: Partial<ApplicationServiceCreateAPIApplicationResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ApplicationServiceCreateAPIApplicationResponse)) {
      return false;
    }
    if (
      !ApplicationServiceCreateAPIApplicationResponse.__deepEquals(
        this.clientId,
        (other as ApplicationServiceCreateAPIApplicationResponse).clientId,
      )
    ) {
      return false;
    }
    if (
      !ApplicationServiceCreateAPIApplicationResponse.__deepEquals(
        this.clientSecret,
        (other as ApplicationServiceCreateAPIApplicationResponse).clientSecret,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ApplicationServiceCreateAPIApplicationResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          ApplicationServiceCreateAPIApplicationResponse.__deepEquals(v, w),
        ),
      );
    }
