...
export class ActionServiceRESTWebhook {
  /**
  ...
  constructor(data?: Partial<ActionServiceRESTWebhook>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ActionServiceRESTWebhook)) {
      return false;
    }
    if (
      !ActionServiceRESTWebhook.__deepEquals(
        this.interruptOnError,
        (other as ActionServiceRESTWebhook).interruptOnError,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => ActionServiceRESTWebhook.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => ActionServiceRESTWebhook.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !ActionServiceRESTWebhook.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ActionServiceRESTWebhook.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
