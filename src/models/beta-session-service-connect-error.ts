...
import { BetaSessionServiceAny } from "./beta-session-service-any.js";
import { Expose, Type } from "class-transformer";

/**
 * Error type returned by Connect: https://connectrpc.com/docs/go/errors/#http-representation
 */
export class BetaSessionServiceConnectError {
  /**
  ...
  constructor(data?: Partial<BetaSessionServiceConnectError>) {
    ...
    if (this.code != null) {
      const codeValues = Object.values(
        BetaSessionServiceConnectErrorCodeEnum,
      ).filter(
        (v) =>
          typeof (
            BetaSessionServiceConnectErrorCodeEnum as Record<string, unknown>
          )[v as string] !== "number",
      );
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaSessionServiceConnectError)) {
      return false;
    }
    if (
      !BetaSessionServiceConnectError.__deepEquals(
        this.code,
        (other as BetaSessionServiceConnectError).code,
      )
    ) {
      return false;
    }
    if (
      !BetaSessionServiceConnectError.__deepEquals(
        this.message,
        (other as BetaSessionServiceConnectError).message,
      )
    ) {
      return false;
    }
    if (
      !BetaSessionServiceConnectError.__deepEquals(
        this.details,
        (other as BetaSessionServiceConnectError).details,
      )
    ) {
      return false;
    }
    {
      ...
      for (const k of selfKeys) {
        ...
        if (
          !BetaSessionServiceConnectError.__deepEquals(selfRec[k], otherRec[k])
        ) {
          return false;
        }
      }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaSessionServiceConnectError.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaSessionServiceConnectError.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaSessionServiceConnectError.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaSessionServiceConnectError.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
...
export enum BetaSessionServiceConnectErrorCodeEnum {
  Canceled = "canceled",
  Unknown = "unknown",
