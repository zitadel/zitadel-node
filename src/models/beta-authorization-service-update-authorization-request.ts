...
export class BetaAuthorizationServiceUpdateAuthorizationRequest {
  /**
  ...
  constructor(
    data?: Partial<BetaAuthorizationServiceUpdateAuthorizationRequest>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !(other instanceof BetaAuthorizationServiceUpdateAuthorizationRequest)
    ) {
      return false;
    }
    if (
      !BetaAuthorizationServiceUpdateAuthorizationRequest.__deepEquals(
        this.id,
        (other as BetaAuthorizationServiceUpdateAuthorizationRequest).id,
      )
    ) {
      return false;
    }
    if (
      !BetaAuthorizationServiceUpdateAuthorizationRequest.__deepEquals(
        this.roleKeys,
        (other as BetaAuthorizationServiceUpdateAuthorizationRequest).roleKeys,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaAuthorizationServiceUpdateAuthorizationRequest.__deepEquals(v, w),
        ),
      );
    }
