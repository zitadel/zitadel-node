...
export class InstanceServiceRemoveCustomDomainResponse {
  /**
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof InstanceServiceRemoveCustomDomainResponse)) {
      return false;
    }
    if (
      !InstanceServiceRemoveCustomDomainResponse.__deepEquals(
        this.deletionDate,
        (other as InstanceServiceRemoveCustomDomainResponse).deletionDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        InstanceServiceRemoveCustomDomainResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          InstanceServiceRemoveCustomDomainResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !InstanceServiceRemoveCustomDomainResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          InstanceServiceRemoveCustomDomainResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
