...
export class IdentityProviderServiceGitLabConfig {
  /**
  ...
  constructor(data?: Partial<IdentityProviderServiceGitLabConfig>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof IdentityProviderServiceGitLabConfig)) {
      return false;
    }
    if (
      !IdentityProviderServiceGitLabConfig.__deepEquals(
        this.clientId,
        (other as IdentityProviderServiceGitLabConfig).clientId,
      )
    ) {
      return false;
    }
    if (
      !IdentityProviderServiceGitLabConfig.__deepEquals(
        this.scopes,
        (other as IdentityProviderServiceGitLabConfig).scopes,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        IdentityProviderServiceGitLabConfig.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          IdentityProviderServiceGitLabConfig.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !IdentityProviderServiceGitLabConfig.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          IdentityProviderServiceGitLabConfig.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
