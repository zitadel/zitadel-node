...
export class UserServiceAddIDPLinkResponse {
  /**
  ...
  constructor(data?: Partial<UserServiceAddIDPLinkResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceAddIDPLinkResponse)) {
      return false;
    }
    if (
      !UserServiceAddIDPLinkResponse.__deepEquals(
        this.details,
        (other as UserServiceAddIDPLinkResponse).details,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceAddIDPLinkResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceAddIDPLinkResponse.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceAddIDPLinkResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceAddIDPLinkResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
