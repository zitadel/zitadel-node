...
import { BetaInternalPermissionServiceAny } from "./beta-internal-permission-service-any.js";
import { Expose, Type } from "class-transformer";

/**
 * Error type returned by Connect: https://connectrpc.com/docs/go/errors/#http-representation
 */
export class BetaInternalPermissionServiceConnectError {
  /**
  ...
  constructor(data?: Partial<BetaInternalPermissionServiceConnectError>) {
    ...
    if (this.code != null) {
      const codeValues = Object.values(
        BetaInternalPermissionServiceConnectErrorCodeEnum,
      ).filter(
        (v) =>
          typeof (
            BetaInternalPermissionServiceConnectErrorCodeEnum as Record<
              string,
              unknown
            >
          )[v as string] !== "number",
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaInternalPermissionServiceConnectError)) {
      return false;
    }
    if (
      !BetaInternalPermissionServiceConnectError.__deepEquals(
        this.code,
        (other as BetaInternalPermissionServiceConnectError).code,
      )
    ) {
      return false;
    }
    if (
      !BetaInternalPermissionServiceConnectError.__deepEquals(
        this.message,
        (other as BetaInternalPermissionServiceConnectError).message,
      )
    ) {
      return false;
    }
    if (
      !BetaInternalPermissionServiceConnectError.__deepEquals(
        this.details,
        (other as BetaInternalPermissionServiceConnectError).details,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaInternalPermissionServiceConnectError.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaInternalPermissionServiceConnectError.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaInternalPermissionServiceConnectError.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaInternalPermissionServiceConnectError.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
...
export enum BetaInternalPermissionServiceConnectErrorCodeEnum {
  Canceled = "canceled",
  Unknown = "unknown",
