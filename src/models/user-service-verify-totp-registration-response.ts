...
export class UserServiceVerifyTOTPRegistrationResponse {
  /**
  ...
  constructor(data?: Partial<UserServiceVerifyTOTPRegistrationResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceVerifyTOTPRegistrationResponse)) {
      return false;
    }
    if (
      !UserServiceVerifyTOTPRegistrationResponse.__deepEquals(
        this.details,
        (other as UserServiceVerifyTOTPRegistrationResponse).details,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceVerifyTOTPRegistrationResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          UserServiceVerifyTOTPRegistrationResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceVerifyTOTPRegistrationResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceVerifyTOTPRegistrationResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
