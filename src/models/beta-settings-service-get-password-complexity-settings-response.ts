...
import { BetaSettingsServicePasswordComplexitySettings } from "./beta-settings-service-password-complexity-settings.js";
import { Expose, Type } from "class-transformer";

export class BetaSettingsServiceGetPasswordComplexitySettingsResponse {
  /**
  ...
  constructor(
    data?: Partial<BetaSettingsServiceGetPasswordComplexitySettingsResponse>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !BetaSettingsServiceGetPasswordComplexitySettingsResponse.__deepEquals(
        this.details,
        (other as BetaSettingsServiceGetPasswordComplexitySettingsResponse)
          .details,
      )
    ) {
      return false;
