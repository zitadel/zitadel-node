...
import { SessionServiceChallenges } from "./session-service-challenges.js";
import { SessionServiceDetails } from "./session-service-details.js";
...
export class SessionServiceCreateSessionResponse {
  ...
  constructor(data?: Partial<SessionServiceCreateSessionResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof SessionServiceCreateSessionResponse)) {
      return false;
    }
    if (
      !SessionServiceCreateSessionResponse.__deepEquals(
        this.details,
        (other as SessionServiceCreateSessionResponse).details,
      )
    ) {
      return false;
    }
    if (
      !SessionServiceCreateSessionResponse.__deepEquals(
        this.sessionId,
        (other as SessionServiceCreateSessionResponse).sessionId,
      )
    ) {
      return false;
    }
    if (
      !SessionServiceCreateSessionResponse.__deepEquals(
        this.sessionToken,
        (other as SessionServiceCreateSessionResponse).sessionToken,
      )
    ) {
      return false;
    }
    if (
      !SessionServiceCreateSessionResponse.__deepEquals(
        this.challenges,
        (other as SessionServiceCreateSessionResponse).challenges,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        SessionServiceCreateSessionResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          SessionServiceCreateSessionResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !SessionServiceCreateSessionResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          SessionServiceCreateSessionResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
