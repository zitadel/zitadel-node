...
import { BetaActionServiceTextFilterMethod } from "./beta-action-service-text-filter-method.js";
import { Expose } from "class-transformer";

export class BetaActionServiceTargetNameFilter {
  /**
  ...
  constructor(data?: Partial<BetaActionServiceTargetNameFilter>) {
    ...
    if (this.method != null) {
      const methodValues = Object.values(
        ...
        (v) =>
          typeof (BetaActionServiceTextFilterMethod as Record<string, unknown>)[
            v as string
          ] !== "number",
      );
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaActionServiceTargetNameFilter)) {
      return false;
    }
    if (
      !BetaActionServiceTargetNameFilter.__deepEquals(
        this.targetName,
        (other as BetaActionServiceTargetNameFilter).targetName,
      )
    ) {
      return false;
    }
    if (
      !BetaActionServiceTargetNameFilter.__deepEquals(
        this.method,
        (other as BetaActionServiceTargetNameFilter).method,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaActionServiceTargetNameFilter.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaActionServiceTargetNameFilter.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaActionServiceTargetNameFilter.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaActionServiceTargetNameFilter.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
