...
import { InstanceServiceCustomDomainFilter } from "./instance-service-custom-domain-filter.js";
import { InstanceServiceDomainFieldName } from "./instance-service-domain-field-name.js";
import { InstanceServicePaginationRequest } from "./instance-service-pagination-request.js";
import { Expose, Type } from "class-transformer";

export class InstanceServiceListCustomDomainsRequest {
  /**
   ...
   */
  @Expose({ name: "filters" })
  @Type(() => InstanceServiceCustomDomainFilter)
  filters?: Array<InstanceServiceCustomDomainFilter>;

  constructor(data?: Partial<InstanceServiceListCustomDomainsRequest>) {
    ...
    if (this.sortingColumn != null) {
      const sortingColumnValues = Object.values(
        ...
        (v) =>
          typeof (InstanceServiceDomainFieldName as Record<string, unknown>)[
            v as string
          ] !== "number",
      );
      if (
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof InstanceServiceListCustomDomainsRequest)) {
      return false;
    }
    if (
      !InstanceServiceListCustomDomainsRequest.__deepEquals(
        this.instanceId,
        (other as InstanceServiceListCustomDomainsRequest).instanceId,
      )
    ) {
      return false;
    }
    if (
      !InstanceServiceListCustomDomainsRequest.__deepEquals(
        this.pagination,
        (other as InstanceServiceListCustomDomainsRequest).pagination,
      )
    ) {
      return false;
    }
    if (
      !InstanceServiceListCustomDomainsRequest.__deepEquals(
        this.sortingColumn,
        (other as InstanceServiceListCustomDomainsRequest).sortingColumn,
      )
    ) {
      return false;
    }
    if (
      !InstanceServiceListCustomDomainsRequest.__deepEquals(
        this.filters,
        (other as InstanceServiceListCustomDomainsRequest).filters,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        InstanceServiceListCustomDomainsRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          InstanceServiceListCustomDomainsRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !InstanceServiceListCustomDomainsRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          InstanceServiceListCustomDomainsRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
