...
export class ApplicationServiceOIDCConfiguration {
  /**
  ...
  constructor(data?: Partial<ApplicationServiceOIDCConfiguration>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ApplicationServiceOIDCConfiguration)) {
      return false;
    }
    if (
      !ApplicationServiceOIDCConfiguration.__deepEquals(
        this.redirectUris,
        (other as ApplicationServiceOIDCConfiguration).redirectUris,
      )
    ) {
      return false;
    }
    if (
      !ApplicationServiceOIDCConfiguration.__deepEquals(
        this.responseTypes,
        (other as ApplicationServiceOIDCConfiguration).responseTypes,
      )
    ) {
      return false;
    }
    if (
      !ApplicationServiceOIDCConfiguration.__deepEquals(
        this.grantTypes,
        (other as ApplicationServiceOIDCConfiguration).grantTypes,
      )
    ) {
      return false;
    }
    if (
      !ApplicationServiceOIDCConfiguration.__deepEquals(
        this.applicationType,
        (other as ApplicationServiceOIDCConfiguration).applicationType,
      )
    ) {
      return false;
    }
    if (
      !ApplicationServiceOIDCConfiguration.__deepEquals(
        this.clientId,
        (other as ApplicationServiceOIDCConfiguration).clientId,
      )
    ) {
      return false;
    }
    if (
      !ApplicationServiceOIDCConfiguration.__deepEquals(
        this.authMethodType,
        (other as ApplicationServiceOIDCConfiguration).authMethodType,
      )
    ) {
      return false;
    }
    if (
      !ApplicationServiceOIDCConfiguration.__deepEquals(
        ...
        (other as ApplicationServiceOIDCConfiguration).postLogoutRedirectUris,
      )
    ) {
      return false;
    }
    if (
      !ApplicationServiceOIDCConfiguration.__deepEquals(
        this.version,
        (other as ApplicationServiceOIDCConfiguration).version,
      )
    ) {
      return false;
    }
    if (
      !ApplicationServiceOIDCConfiguration.__deepEquals(
        this.nonCompliant,
        (other as ApplicationServiceOIDCConfiguration).nonCompliant,
      )
    ) {
      return false;
    }
    if (
      !ApplicationServiceOIDCConfiguration.__deepEquals(
        ...
        (other as ApplicationServiceOIDCConfiguration).complianceProblems,
      )
    ) {
      return false;
    }
    if (
      !ApplicationServiceOIDCConfiguration.__deepEquals(
        ...
        (other as ApplicationServiceOIDCConfiguration).developmentMode,
      )
    ) {
      return false;
    }
    if (
      !ApplicationServiceOIDCConfiguration.__deepEquals(
        this.accessTokenType,
        (other as ApplicationServiceOIDCConfiguration).accessTokenType,
      )
    ) {
      return false;
    }
    if (
      !ApplicationServiceOIDCConfiguration.__deepEquals(
        ...
        (other as ApplicationServiceOIDCConfiguration).accessTokenRoleAssertion,
      )
    ) {
      return false;
    }
    if (
      !ApplicationServiceOIDCConfiguration.__deepEquals(
        ...
        (other as ApplicationServiceOIDCConfiguration).idTokenRoleAssertion,
      )
    ) {
      return false;
    }
    if (
      !ApplicationServiceOIDCConfiguration.__deepEquals(
        ...
        (other as ApplicationServiceOIDCConfiguration).idTokenUserinfoAssertion,
      )
    ) {
      return false;
    }
    if (
      !ApplicationServiceOIDCConfiguration.__deepEquals(
        this.clockSkew,
        (other as ApplicationServiceOIDCConfiguration).clockSkew,
      )
    ) {
      return false;
    }
    if (
      !ApplicationServiceOIDCConfiguration.__deepEquals(
        ...
        (other as ApplicationServiceOIDCConfiguration).additionalOrigins,
      )
    ) {
      return false;
    }
    if (
      !ApplicationServiceOIDCConfiguration.__deepEquals(
        this.allowedOrigins,
        (other as ApplicationServiceOIDCConfiguration).allowedOrigins,
      )
    ) {
      return false;
    }
    if (
      !ApplicationServiceOIDCConfiguration.__deepEquals(
        ...
        (other as ApplicationServiceOIDCConfiguration).skipNativeAppSuccessPage,
      )
    ) {
      return false;
    }
    if (
      !ApplicationServiceOIDCConfiguration.__deepEquals(
        ...
        (other as ApplicationServiceOIDCConfiguration).backChannelLogoutUri,
      )
    ) {
      return false;
    }
    if (
      !ApplicationServiceOIDCConfiguration.__deepEquals(
        this.loginVersion,
        (other as ApplicationServiceOIDCConfiguration).loginVersion,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ApplicationServiceOIDCConfiguration.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          ApplicationServiceOIDCConfiguration.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !ApplicationServiceOIDCConfiguration.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ApplicationServiceOIDCConfiguration.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
