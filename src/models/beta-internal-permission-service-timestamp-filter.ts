...
import { BetaInternalPermissionServiceTimestampFilterMethod } from "./beta-internal-permission-service-timestamp-filter-method.js";
import { Expose, Type } from "class-transformer";

export class BetaInternalPermissionServiceTimestampFilter {
  /**
  ...
  constructor(data?: Partial<BetaInternalPermissionServiceTimestampFilter>) {
    ...
    if (this.method != null) {
      const methodValues = Object.values(
        ...
        (v) =>
          typeof (
            BetaInternalPermissionServiceTimestampFilterMethod as Record<
              string,
              unknown
            >
          )[v as string] !== "number",
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaInternalPermissionServiceTimestampFilter)) {
      return false;
    }
    if (
      !BetaInternalPermissionServiceTimestampFilter.__deepEquals(
        this.timestamp,
        (other as BetaInternalPermissionServiceTimestampFilter).timestamp,
      )
    ) {
      return false;
    }
    if (
      !BetaInternalPermissionServiceTimestampFilter.__deepEquals(
        this.method,
        (other as BetaInternalPermissionServiceTimestampFilter).method,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaInternalPermissionServiceTimestampFilter.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaInternalPermissionServiceTimestampFilter.__deepEquals(v, w),
        ),
      );
    }
