...
export class BetaSessionServiceCheckWebAuthN {
  /**
  ...
  constructor(data?: Partial<BetaSessionServiceCheckWebAuthN>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaSessionServiceCheckWebAuthN)) {
      return false;
    }
    if (
      !BetaSessionServiceCheckWebAuthN.__deepEquals(
        this.credentialAssertionData,
        (other as BetaSessionServiceCheckWebAuthN).credentialAssertionData,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaSessionServiceCheckWebAuthN.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaSessionServiceCheckWebAuthN.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaSessionServiceCheckWebAuthN.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaSessionServiceCheckWebAuthN.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
