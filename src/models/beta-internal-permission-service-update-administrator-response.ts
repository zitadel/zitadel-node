...
export class BetaInternalPermissionServiceUpdateAdministratorResponse {
  /**
  ...
  constructor(
    data?: Partial<BetaInternalPermissionServiceUpdateAdministratorResponse>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !BetaInternalPermissionServiceUpdateAdministratorResponse.__deepEquals(
        this.changeDate,
        (other as BetaInternalPermissionServiceUpdateAdministratorResponse)
          .changeDate,
      )
    ) {
      return false;
