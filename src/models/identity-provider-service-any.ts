 ...
 */
export class IdentityProviderServiceAny {
  /**
  ...
  constructor(data?: Partial<IdentityProviderServiceAny>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof IdentityProviderServiceAny)) {
      return false;
    }
    if (
      !IdentityProviderServiceAny.__deepEquals(
        this.type,
        (other as IdentityProviderServiceAny).type,
      )
    ) {
      return false;
    }
    if (
      !IdentityProviderServiceAny.__deepEquals(
        this.value,
        (other as IdentityProviderServiceAny).value,
      )
    ) {
      return false;
    }
    if (
      !IdentityProviderServiceAny.__deepEquals(
        this.debug,
        (other as IdentityProviderServiceAny).debug,
      )
    ) {
      return false;
    }
    {
      ...
      for (const k of selfKeys) {
        ...
        if (!IdentityProviderServiceAny.__deepEquals(selfRec[k], otherRec[k])) {
          return false;
        }
      }
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        IdentityProviderServiceAny.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => IdentityProviderServiceAny.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !IdentityProviderServiceAny.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          IdentityProviderServiceAny.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
