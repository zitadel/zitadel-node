...
export class WebKeyServiceDeleteWebKeyRequest {
  /**
  ...
  constructor(data?: Partial<WebKeyServiceDeleteWebKeyRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof WebKeyServiceDeleteWebKeyRequest)) {
      return false;
    }
    if (
      !WebKeyServiceDeleteWebKeyRequest.__deepEquals(
        this.id,
        (other as WebKeyServiceDeleteWebKeyRequest).id,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        WebKeyServiceDeleteWebKeyRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => WebKeyServiceDeleteWebKeyRequest.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !WebKeyServiceDeleteWebKeyRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          WebKeyServiceDeleteWebKeyRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
