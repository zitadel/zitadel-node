...
import { BetaAuthorizationServiceTextFilterMethod } from "./beta-authorization-service-text-filter-method.js";
import { Expose } from "class-transformer";

export class BetaAuthorizationServiceProjectNameQuery {
  /**
  ...
  constructor(data?: Partial<BetaAuthorizationServiceProjectNameQuery>) {
    ...
    if (this.method != null) {
      const methodValues = Object.values(
        ...
        (v) =>
          typeof (
            BetaAuthorizationServiceTextFilterMethod as Record<string, unknown>
          )[v as string] !== "number",
      );
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaAuthorizationServiceProjectNameQuery)) {
      return false;
    }
    if (
      !BetaAuthorizationServiceProjectNameQuery.__deepEquals(
        this.name,
        (other as BetaAuthorizationServiceProjectNameQuery).name,
      )
    ) {
      return false;
    }
    if (
      !BetaAuthorizationServiceProjectNameQuery.__deepEquals(
        this.method,
        (other as BetaAuthorizationServiceProjectNameQuery).method,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaAuthorizationServiceProjectNameQuery.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaAuthorizationServiceProjectNameQuery.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaAuthorizationServiceProjectNameQuery.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaAuthorizationServiceProjectNameQuery.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
