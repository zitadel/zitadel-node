 ...
 */
export class BetaFeatureServiceFeatureFlag {
  /**
  ...
  constructor(data?: Partial<BetaFeatureServiceFeatureFlag>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaFeatureServiceFeatureFlag)) {
      return false;
    }
    if (
      !BetaFeatureServiceFeatureFlag.__deepEquals(
        this.enabled,
        (other as BetaFeatureServiceFeatureFlag).enabled,
      )
    ) {
      return false;
    }
    if (
      !BetaFeatureServiceFeatureFlag.__deepEquals(
        this.source,
        (other as BetaFeatureServiceFeatureFlag).source,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaFeatureServiceFeatureFlag.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaFeatureServiceFeatureFlag.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaFeatureServiceFeatureFlag.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaFeatureServiceFeatureFlag.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
