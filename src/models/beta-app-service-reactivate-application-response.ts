...
export class BetaAppServiceReactivateApplicationResponse {
  /**
   ...
   */
  @Expose({ name: "reactivationDate" })
  @Type(() => Date)
  reactivationDate?: Date;

  constructor(data?: Partial<BetaAppServiceReactivateApplicationResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaAppServiceReactivateApplicationResponse)) {
      return false;
    }
    if (
      !BetaAppServiceReactivateApplicationResponse.__deepEquals(
        this.reactivationDate,
        (other as BetaAppServiceReactivateApplicationResponse).reactivationDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaAppServiceReactivateApplicationResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaAppServiceReactivateApplicationResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaAppServiceReactivateApplicationResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
