...
export class BetaUserServiceRegisterTOTPRequest {
  /**
  ...
  constructor(data?: Partial<BetaUserServiceRegisterTOTPRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaUserServiceRegisterTOTPRequest)) {
      return false;
    }
    if (
      !BetaUserServiceRegisterTOTPRequest.__deepEquals(
        this.userId,
        (other as BetaUserServiceRegisterTOTPRequest).userId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaUserServiceRegisterTOTPRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaUserServiceRegisterTOTPRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaUserServiceRegisterTOTPRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaUserServiceRegisterTOTPRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
