...
export class BetaFeatureServiceResetSystemFeaturesResponse {
  /**
  ...
  constructor(data?: Partial<BetaFeatureServiceResetSystemFeaturesResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaFeatureServiceResetSystemFeaturesResponse)) {
      return false;
    }
    if (
      !BetaFeatureServiceResetSystemFeaturesResponse.__deepEquals(
        this.details,
        (other as BetaFeatureServiceResetSystemFeaturesResponse).details,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaFeatureServiceResetSystemFeaturesResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaFeatureServiceResetSystemFeaturesResponse.__deepEquals(v, w),
        ),
      );
    }
