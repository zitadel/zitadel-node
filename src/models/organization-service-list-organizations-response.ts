...
import { OrganizationServiceListDetails } from "./organization-service-list-details.js";
...
export class OrganizationServiceListOrganizationsResponse {
  /**
  ...
  constructor(data?: Partial<OrganizationServiceListOrganizationsResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof OrganizationServiceListOrganizationsResponse)) {
      return false;
    }
    if (
      !OrganizationServiceListOrganizationsResponse.__deepEquals(
        this.details,
        (other as OrganizationServiceListOrganizationsResponse).details,
      )
    ) {
      return false;
    }
    if (
      !OrganizationServiceListOrganizationsResponse.__deepEquals(
        this.sortingColumn,
        (other as OrganizationServiceListOrganizationsResponse).sortingColumn,
      )
    ) {
      return false;
    }
    if (
      !OrganizationServiceListOrganizationsResponse.__deepEquals(
        this.result,
        (other as OrganizationServiceListOrganizationsResponse).result,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        OrganizationServiceListOrganizationsResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          OrganizationServiceListOrganizationsResponse.__deepEquals(v, w),
        ),
      );
    }
