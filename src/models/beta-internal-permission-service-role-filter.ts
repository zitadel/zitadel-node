...
export class BetaInternalPermissionServiceRoleFilter {
  /**
  ...
  constructor(data?: Partial<BetaInternalPermissionServiceRoleFilter>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaInternalPermissionServiceRoleFilter)) {
      return false;
    }
    if (
      !BetaInternalPermissionServiceRoleFilter.__deepEquals(
        this.roleKey,
        (other as BetaInternalPermissionServiceRoleFilter).roleKey,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaInternalPermissionServiceRoleFilter.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaInternalPermissionServiceRoleFilter.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaInternalPermissionServiceRoleFilter.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaInternalPermissionServiceRoleFilter.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
