...
export class ApplicationServiceProjectIDFilter {
  /**
  ...
  constructor(data?: Partial<ApplicationServiceProjectIDFilter>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ApplicationServiceProjectIDFilter)) {
      return false;
    }
    if (
      !ApplicationServiceProjectIDFilter.__deepEquals(
        this.projectId,
        (other as ApplicationServiceProjectIDFilter).projectId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ApplicationServiceProjectIDFilter.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => ApplicationServiceProjectIDFilter.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !ApplicationServiceProjectIDFilter.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ApplicationServiceProjectIDFilter.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
