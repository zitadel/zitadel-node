...
export class BetaAppServiceOIDCLocalizedMessage {
  /**
  ...
  constructor(data?: Partial<BetaAppServiceOIDCLocalizedMessage>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaAppServiceOIDCLocalizedMessage)) {
      return false;
    }
    if (
      !BetaAppServiceOIDCLocalizedMessage.__deepEquals(
        this.key,
        (other as BetaAppServiceOIDCLocalizedMessage).key,
      )
    ) {
      return false;
    }
    if (
      !BetaAppServiceOIDCLocalizedMessage.__deepEquals(
        ...
        (other as BetaAppServiceOIDCLocalizedMessage).localizedMessage,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaAppServiceOIDCLocalizedMessage.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaAppServiceOIDCLocalizedMessage.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaAppServiceOIDCLocalizedMessage.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaAppServiceOIDCLocalizedMessage.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
