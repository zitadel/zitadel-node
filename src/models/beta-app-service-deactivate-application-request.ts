...
export class BetaAppServiceDeactivateApplicationRequest {
  /**
  ...
  constructor(data?: Partial<BetaAppServiceDeactivateApplicationRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaAppServiceDeactivateApplicationRequest)) {
      return false;
    }
    if (
      !BetaAppServiceDeactivateApplicationRequest.__deepEquals(
        this.projectId,
        (other as BetaAppServiceDeactivateApplicationRequest).projectId,
      )
    ) {
      return false;
    }
    if (
      !BetaAppServiceDeactivateApplicationRequest.__deepEquals(
        this.id,
        (other as BetaAppServiceDeactivateApplicationRequest).id,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaAppServiceDeactivateApplicationRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaAppServiceDeactivateApplicationRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaAppServiceDeactivateApplicationRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaAppServiceDeactivateApplicationRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
