...
export class UserServiceSendPasskeyRegistrationLink {
  /**
  ...
  constructor(data?: Partial<UserServiceSendPasskeyRegistrationLink>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceSendPasskeyRegistrationLink)) {
      return false;
    }
    if (
      !UserServiceSendPasskeyRegistrationLink.__deepEquals(
        this.urlTemplate,
        (other as UserServiceSendPasskeyRegistrationLink).urlTemplate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceSendPasskeyRegistrationLink.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          UserServiceSendPasskeyRegistrationLink.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceSendPasskeyRegistrationLink.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceSendPasskeyRegistrationLink.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
