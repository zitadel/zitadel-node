...
export class BetaUserServiceAddOTPSMSRequest {
  /**
  ...
  constructor(data?: Partial<BetaUserServiceAddOTPSMSRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaUserServiceAddOTPSMSRequest)) {
      return false;
    }
    if (
      !BetaUserServiceAddOTPSMSRequest.__deepEquals(
        this.userId,
        (other as BetaUserServiceAddOTPSMSRequest).userId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaUserServiceAddOTPSMSRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaUserServiceAddOTPSMSRequest.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaUserServiceAddOTPSMSRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaUserServiceAddOTPSMSRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
