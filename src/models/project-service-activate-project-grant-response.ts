...
export class ProjectServiceActivateProjectGrantResponse {
  /**
  ...
  constructor(data?: Partial<ProjectServiceActivateProjectGrantResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ProjectServiceActivateProjectGrantResponse)) {
      return false;
    }
    if (
      !ProjectServiceActivateProjectGrantResponse.__deepEquals(
        this.changeDate,
        (other as ProjectServiceActivateProjectGrantResponse).changeDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ProjectServiceActivateProjectGrantResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          ProjectServiceActivateProjectGrantResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !ProjectServiceActivateProjectGrantResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ProjectServiceActivateProjectGrantResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
