...
export class OIDCServiceDetails {
  /**
  ...
  constructor(data?: Partial<OIDCServiceDetails>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof OIDCServiceDetails)) {
      return false;
    }
    if (
      !OIDCServiceDetails.__deepEquals(
        this.sequence,
        (other as OIDCServiceDetails).sequence,
      )
    ) {
      return false;
    }
    if (
      !OIDCServiceDetails.__deepEquals(
        this.changeDate,
        (other as OIDCServiceDetails).changeDate,
      )
    ) {
      return false;
    }
    if (
      !OIDCServiceDetails.__deepEquals(
        this.resourceOwner,
        (other as OIDCServiceDetails).resourceOwner,
      )
    ) {
      return false;
    }
    if (
      !OIDCServiceDetails.__deepEquals(
        this.creationDate,
        (other as OIDCServiceDetails).creationDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => OIDCServiceDetails.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => OIDCServiceDetails.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !OIDCServiceDetails.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          OIDCServiceDetails.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
