...
export class BetaFeatureServiceSetInstanceFeaturesResponse {
  /**
  ...
  constructor(data?: Partial<BetaFeatureServiceSetInstanceFeaturesResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaFeatureServiceSetInstanceFeaturesResponse)) {
      return false;
    }
    if (
      !BetaFeatureServiceSetInstanceFeaturesResponse.__deepEquals(
        this.details,
        (other as BetaFeatureServiceSetInstanceFeaturesResponse).details,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaFeatureServiceSetInstanceFeaturesResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaFeatureServiceSetInstanceFeaturesResponse.__deepEquals(v, w),
        ),
      );
    }
