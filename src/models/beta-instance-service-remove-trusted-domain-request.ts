...
export class BetaInstanceServiceRemoveTrustedDomainRequest {
  /**
  ...
  constructor(data?: Partial<BetaInstanceServiceRemoveTrustedDomainRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaInstanceServiceRemoveTrustedDomainRequest)) {
      return false;
    }
    if (
      !BetaInstanceServiceRemoveTrustedDomainRequest.__deepEquals(
        this.instanceId,
        (other as BetaInstanceServiceRemoveTrustedDomainRequest).instanceId,
      )
    ) {
      return false;
    }
    if (
      !BetaInstanceServiceRemoveTrustedDomainRequest.__deepEquals(
        this.domain,
        (other as BetaInstanceServiceRemoveTrustedDomainRequest).domain,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaInstanceServiceRemoveTrustedDomainRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaInstanceServiceRemoveTrustedDomainRequest.__deepEquals(v, w),
        ),
      );
    }
