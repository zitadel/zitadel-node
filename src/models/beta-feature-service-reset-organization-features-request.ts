...
export class BetaFeatureServiceResetOrganizationFeaturesRequest {
  /**
  ...
  constructor(
    data?: Partial<BetaFeatureServiceResetOrganizationFeaturesRequest>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !(other instanceof BetaFeatureServiceResetOrganizationFeaturesRequest)
    ) {
      return false;
    }
    if (
      !BetaFeatureServiceResetOrganizationFeaturesRequest.__deepEquals(
        this.organizationId,
        (other as BetaFeatureServiceResetOrganizationFeaturesRequest)
          .organizationId,
      )
    ) {
      return false;
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaFeatureServiceResetOrganizationFeaturesRequest.__deepEquals(v, w),
        ),
      );
    }
