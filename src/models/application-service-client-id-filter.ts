...
export class ApplicationServiceClientIDFilter {
  /**
  ...
  constructor(data?: Partial<ApplicationServiceClientIDFilter>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ApplicationServiceClientIDFilter)) {
      return false;
    }
    if (
      !ApplicationServiceClientIDFilter.__deepEquals(
        this.clientId,
        (other as ApplicationServiceClientIDFilter).clientId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ApplicationServiceClientIDFilter.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => ApplicationServiceClientIDFilter.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !ApplicationServiceClientIDFilter.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ApplicationServiceClientIDFilter.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
