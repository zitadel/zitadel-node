...
export class ActionServiceGetTargetRequest {
  /**
  ...
  constructor(data?: Partial<ActionServiceGetTargetRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ActionServiceGetTargetRequest)) {
      return false;
    }
    if (
      !ActionServiceGetTargetRequest.__deepEquals(
        this.id,
        (other as ActionServiceGetTargetRequest).id,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ActionServiceGetTargetRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => ActionServiceGetTargetRequest.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !ActionServiceGetTargetRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ActionServiceGetTargetRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
