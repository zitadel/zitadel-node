...
import { ActionServiceCondition } from "./action-service-condition.js";
import { Expose, Type } from "class-transformer";

export class ActionServiceExecution {
  /**
  ...
  constructor(data?: Partial<ActionServiceExecution>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ActionServiceExecution)) {
      return false;
    }
    if (
      !ActionServiceExecution.__deepEquals(
        this.condition,
        (other as ActionServiceExecution).condition,
      )
    ) {
      return false;
    }
    if (
      !ActionServiceExecution.__deepEquals(
        this.creationDate,
        (other as ActionServiceExecution).creationDate,
      )
    ) {
      return false;
    }
    if (
      !ActionServiceExecution.__deepEquals(
        this.changeDate,
        (other as ActionServiceExecution).changeDate,
      )
    ) {
      return false;
    }
    if (
      !ActionServiceExecution.__deepEquals(
        this.targets,
        (other as ActionServiceExecution).targets,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => ActionServiceExecution.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => ActionServiceExecution.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !ActionServiceExecution.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ActionServiceExecution.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
