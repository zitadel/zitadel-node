...
export class ActionServiceInTargetIDsFilter {
  /**
  ...
  constructor(data?: Partial<ActionServiceInTargetIDsFilter>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ActionServiceInTargetIDsFilter)) {
      return false;
    }
    if (
      !ActionServiceInTargetIDsFilter.__deepEquals(
        this.targetIds,
        (other as ActionServiceInTargetIDsFilter).targetIds,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ActionServiceInTargetIDsFilter.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => ActionServiceInTargetIDsFilter.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !ActionServiceInTargetIDsFilter.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ActionServiceInTargetIDsFilter.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
