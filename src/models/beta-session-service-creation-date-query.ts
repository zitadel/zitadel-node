...
import { BetaSessionServiceTimestampQueryMethod } from "./beta-session-service-timestamp-query-method.js";
import { Expose, Type } from "class-transformer";

export class BetaSessionServiceCreationDateQuery {
  /**
  ...
  constructor(data?: Partial<BetaSessionServiceCreationDateQuery>) {
    ...
    if (this.method != null) {
      const methodValues = Object.values(
        ...
        (v) =>
          typeof (
            BetaSessionServiceTimestampQueryMethod as Record<string, unknown>
          )[v as string] !== "number",
      );
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaSessionServiceCreationDateQuery)) {
      return false;
    }
    if (
      !BetaSessionServiceCreationDateQuery.__deepEquals(
        this.creationDate,
        (other as BetaSessionServiceCreationDateQuery).creationDate,
      )
    ) {
      return false;
    }
    if (
      !BetaSessionServiceCreationDateQuery.__deepEquals(
        this.method,
        (other as BetaSessionServiceCreationDateQuery).method,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaSessionServiceCreationDateQuery.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaSessionServiceCreationDateQuery.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaSessionServiceCreationDateQuery.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaSessionServiceCreationDateQuery.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
