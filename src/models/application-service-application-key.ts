...
export class ApplicationServiceApplicationKey {
  /**
  ...
  constructor(data?: Partial<ApplicationServiceApplicationKey>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ApplicationServiceApplicationKey)) {
      return false;
    }
    if (
      !ApplicationServiceApplicationKey.__deepEquals(
        this.keyId,
        (other as ApplicationServiceApplicationKey).keyId,
      )
    ) {
      return false;
    }
    if (
      !ApplicationServiceApplicationKey.__deepEquals(
        this.applicationId,
        (other as ApplicationServiceApplicationKey).applicationId,
      )
    ) {
      return false;
    }
    if (
      !ApplicationServiceApplicationKey.__deepEquals(
        this.projectId,
        (other as ApplicationServiceApplicationKey).projectId,
      )
    ) {
      return false;
    }
    if (
      !ApplicationServiceApplicationKey.__deepEquals(
        this.creationDate,
        (other as ApplicationServiceApplicationKey).creationDate,
      )
    ) {
      return false;
    }
    if (
      !ApplicationServiceApplicationKey.__deepEquals(
        this.organizationId,
        (other as ApplicationServiceApplicationKey).organizationId,
      )
    ) {
      return false;
    }
    if (
      !ApplicationServiceApplicationKey.__deepEquals(
        this.expirationDate,
        (other as ApplicationServiceApplicationKey).expirationDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ApplicationServiceApplicationKey.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => ApplicationServiceApplicationKey.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !ApplicationServiceApplicationKey.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ApplicationServiceApplicationKey.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
