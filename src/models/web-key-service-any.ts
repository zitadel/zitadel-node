...
export class WebKeyServiceAny {
  ...
  constructor(data?: Partial<WebKeyServiceAny>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof WebKeyServiceAny)) {
      return false;
    }
    if (
      !WebKeyServiceAny.__deepEquals(
        this.type,
        (other as WebKeyServiceAny).type,
      )
    ) {
      return false;
    }
    if (
      !WebKeyServiceAny.__deepEquals(
        this.value,
        (other as WebKeyServiceAny).value,
      )
    ) {
      return false;
    }
    if (
      !WebKeyServiceAny.__deepEquals(
        this.debug,
        (other as WebKeyServiceAny).debug,
      )
    ) {
      return false;
    }
    {
      ...
      for (const k of selfKeys) {
        ...
        if (!WebKeyServiceAny.__deepEquals(selfRec[k], otherRec[k])) {
          return false;
        }
      }
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => WebKeyServiceAny.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => WebKeyServiceAny.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !WebKeyServiceAny.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          WebKeyServiceAny.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
