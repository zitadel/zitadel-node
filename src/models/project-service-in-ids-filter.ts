...
export class ProjectServiceInIDsFilter {
  /**
  ...
  constructor(data?: Partial<ProjectServiceInIDsFilter>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ProjectServiceInIDsFilter)) {
      return false;
    }
    if (
      !ProjectServiceInIDsFilter.__deepEquals(
        this.ids,
        (other as ProjectServiceInIDsFilter).ids,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => ProjectServiceInIDsFilter.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => ProjectServiceInIDsFilter.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !ProjectServiceInIDsFilter.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ProjectServiceInIDsFilter.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
