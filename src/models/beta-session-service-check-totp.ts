...
export class BetaSessionServiceCheckTOTP {
  /**
  ...
  constructor(data?: Partial<BetaSessionServiceCheckTOTP>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaSessionServiceCheckTOTP)) {
      return false;
    }
    if (
      !BetaSessionServiceCheckTOTP.__deepEquals(
        this.code,
        (other as BetaSessionServiceCheckTOTP).code,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaSessionServiceCheckTOTP.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaSessionServiceCheckTOTP.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaSessionServiceCheckTOTP.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaSessionServiceCheckTOTP.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
