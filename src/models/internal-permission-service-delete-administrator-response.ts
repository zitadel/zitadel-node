...
export class InternalPermissionServiceDeleteAdministratorResponse {
  /**
  ...
  constructor(
    data?: Partial<InternalPermissionServiceDeleteAdministratorResponse>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !(other instanceof InternalPermissionServiceDeleteAdministratorResponse)
    ) {
      return false;
    }
    if (
      !InternalPermissionServiceDeleteAdministratorResponse.__deepEquals(
        this.deletionDate,
        (other as InternalPermissionServiceDeleteAdministratorResponse)
          .deletionDate,
      )
    ) {
      return false;
