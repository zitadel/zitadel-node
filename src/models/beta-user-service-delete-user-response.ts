...
export class BetaUserServiceDeleteUserResponse {
  /**
  ...
  constructor(data?: Partial<BetaUserServiceDeleteUserResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaUserServiceDeleteUserResponse)) {
      return false;
    }
    if (
      !BetaUserServiceDeleteUserResponse.__deepEquals(
        this.details,
        (other as BetaUserServiceDeleteUserResponse).details,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaUserServiceDeleteUserResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaUserServiceDeleteUserResponse.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaUserServiceDeleteUserResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaUserServiceDeleteUserResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
