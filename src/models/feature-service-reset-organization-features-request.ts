...
export class FeatureServiceResetOrganizationFeaturesRequest {
  /**
  ...
  constructor(data?: Partial<FeatureServiceResetOrganizationFeaturesRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof FeatureServiceResetOrganizationFeaturesRequest)) {
      return false;
    }
    if (
      !FeatureServiceResetOrganizationFeaturesRequest.__deepEquals(
        this.organizationId,
        (other as FeatureServiceResetOrganizationFeaturesRequest)
          .organizationId,
      )
    ) {
      return false;
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        FeatureServiceResetOrganizationFeaturesRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          FeatureServiceResetOrganizationFeaturesRequest.__deepEquals(v, w),
        ),
      );
    }
