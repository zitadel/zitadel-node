...
export class InternalPermissionServicePaginationRequest {
  ...
  constructor(data?: Partial<InternalPermissionServicePaginationRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof InternalPermissionServicePaginationRequest)) {
      return false;
    }
    if (
      !InternalPermissionServicePaginationRequest.__deepEquals(
        this.offset,
        (other as InternalPermissionServicePaginationRequest).offset,
      )
    ) {
      return false;
    }
    if (
      !InternalPermissionServicePaginationRequest.__deepEquals(
        this.limit,
        (other as InternalPermissionServicePaginationRequest).limit,
      )
    ) {
      return false;
    }
    if (
      !InternalPermissionServicePaginationRequest.__deepEquals(
        this.asc,
        (other as InternalPermissionServicePaginationRequest).asc,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        InternalPermissionServicePaginationRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          InternalPermissionServicePaginationRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !InternalPermissionServicePaginationRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          InternalPermissionServicePaginationRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
