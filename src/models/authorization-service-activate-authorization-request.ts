...
export class AuthorizationServiceActivateAuthorizationRequest {
  /**
  ...
  constructor(
    data?: Partial<AuthorizationServiceActivateAuthorizationRequest>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof AuthorizationServiceActivateAuthorizationRequest)) {
      return false;
    }
    if (
      !AuthorizationServiceActivateAuthorizationRequest.__deepEquals(
        this.id,
        (other as AuthorizationServiceActivateAuthorizationRequest).id,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        AuthorizationServiceActivateAuthorizationRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          AuthorizationServiceActivateAuthorizationRequest.__deepEquals(v, w),
        ),
      );
    }
