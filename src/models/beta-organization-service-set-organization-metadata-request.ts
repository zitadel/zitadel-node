...
export class BetaOrganizationServiceSetOrganizationMetadataRequest {
  /**
  ...
  constructor(
    data?: Partial<BetaOrganizationServiceSetOrganizationMetadataRequest>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !(other instanceof BetaOrganizationServiceSetOrganizationMetadataRequest)
    ) {
      return false;
    }
    if (
      !BetaOrganizationServiceSetOrganizationMetadataRequest.__deepEquals(
        this.organizationId,
        (other as BetaOrganizationServiceSetOrganizationMetadataRequest)
          .organizationId,
      )
    ) {
      return false;
