...
import { OIDCServiceDetails } from "./oidc-service-details.js";
import { Expose, Type } from "class-transformer";

export class OIDCServiceCreateCallbackResponse {
  /**
  ...
  constructor(data?: Partial<OIDCServiceCreateCallbackResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof OIDCServiceCreateCallbackResponse)) {
      return false;
    }
    if (
      !OIDCServiceCreateCallbackResponse.__deepEquals(
        this.details,
        (other as OIDCServiceCreateCallbackResponse).details,
      )
    ) {
      return false;
    }
    if (
      !OIDCServiceCreateCallbackResponse.__deepEquals(
        this.callbackUrl,
        (other as OIDCServiceCreateCallbackResponse).callbackUrl,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        OIDCServiceCreateCallbackResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => OIDCServiceCreateCallbackResponse.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !OIDCServiceCreateCallbackResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          OIDCServiceCreateCallbackResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
