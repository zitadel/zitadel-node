...
import { OrganizationServiceAny } from "./organization-service-any.js";
import { Expose, Type } from "class-transformer";

/**
 * Error type returned by Connect: https://connectrpc.com/docs/go/errors/#http-representation
 */
export class OrganizationServiceConnectError {
  /**
  ...
  constructor(data?: Partial<OrganizationServiceConnectError>) {
    ...
    if (this.code != null) {
      const codeValues = Object.values(
        OrganizationServiceConnectErrorCodeEnum,
      ).filter(
        (v) =>
          typeof (
            OrganizationServiceConnectErrorCodeEnum as Record<string, unknown>
          )[v as string] !== "number",
      );
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof OrganizationServiceConnectError)) {
      return false;
    }
    if (
      !OrganizationServiceConnectError.__deepEquals(
        this.code,
        (other as OrganizationServiceConnectError).code,
      )
    ) {
      return false;
    }
    if (
      !OrganizationServiceConnectError.__deepEquals(
        this.message,
        (other as OrganizationServiceConnectError).message,
      )
    ) {
      return false;
    }
    if (
      !OrganizationServiceConnectError.__deepEquals(
        this.details,
        (other as OrganizationServiceConnectError).details,
      )
    ) {
      return false;
    }
    {
      ...
      for (const k of selfKeys) {
        ...
        if (
          !OrganizationServiceConnectError.__deepEquals(selfRec[k], otherRec[k])
        ) {
          return false;
        }
      }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        OrganizationServiceConnectError.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => OrganizationServiceConnectError.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !OrganizationServiceConnectError.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          OrganizationServiceConnectError.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
...
export enum OrganizationServiceConnectErrorCodeEnum {
  Canceled = "canceled",
  Unknown = "unknown",
