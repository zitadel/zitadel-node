...
import { UserServiceSendPasswordResetLink } from "./user-service-send-password-reset-link.js";
import { Expose, Type } from "class-transformer";

export class UserServicePasswordResetRequest {
  /**
  ...
  constructor(data?: Partial<UserServicePasswordResetRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServicePasswordResetRequest)) {
      return false;
    }
    if (
      !UserServicePasswordResetRequest.__deepEquals(
        this.userId,
        (other as UserServicePasswordResetRequest).userId,
      )
    ) {
      return false;
    }
    if (
      !UserServicePasswordResetRequest.__deepEquals(
        this.returnCode,
        (other as UserServicePasswordResetRequest).returnCode,
      )
    ) {
      return false;
    }
    if (
      !UserServicePasswordResetRequest.__deepEquals(
        this.sendLink,
        (other as UserServicePasswordResetRequest).sendLink,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServicePasswordResetRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServicePasswordResetRequest.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServicePasswordResetRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServicePasswordResetRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
