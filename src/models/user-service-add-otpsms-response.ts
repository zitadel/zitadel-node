...
export class UserServiceAddOTPSMSResponse {
  /**
  ...
  constructor(data?: Partial<UserServiceAddOTPSMSResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceAddOTPSMSResponse)) {
      return false;
    }
    if (
      !UserServiceAddOTPSMSResponse.__deepEquals(
        this.details,
        (other as UserServiceAddOTPSMSResponse).details,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceAddOTPSMSResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceAddOTPSMSResponse.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceAddOTPSMSResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceAddOTPSMSResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
