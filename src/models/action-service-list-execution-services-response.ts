...
export class ActionServiceListExecutionServicesResponse {
  /**
  ...
  constructor(data?: Partial<ActionServiceListExecutionServicesResponse>) {
    Object.assign(this, data);
    if (
      this.services != null &&
      !Array.isArray(this.services) &&
      !((this.services as unknown) instanceof Set)
    ) {
      throw new TypeError(
        `services must be an array, got ${typeof this.services}`,
      );
    }
  }
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ActionServiceListExecutionServicesResponse)) {
      return false;
    }
    if (
      !ActionServiceListExecutionServicesResponse.__deepEquals(
        this.services,
        (other as ActionServiceListExecutionServicesResponse).services,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ActionServiceListExecutionServicesResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          ActionServiceListExecutionServicesResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !ActionServiceListExecutionServicesResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ActionServiceListExecutionServicesResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
