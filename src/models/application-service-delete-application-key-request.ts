...
export class ApplicationServiceDeleteApplicationKeyRequest {
  /**
  ...
  constructor(data?: Partial<ApplicationServiceDeleteApplicationKeyRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ApplicationServiceDeleteApplicationKeyRequest)) {
      return false;
    }
    if (
      !ApplicationServiceDeleteApplicationKeyRequest.__deepEquals(
        this.keyId,
        (other as ApplicationServiceDeleteApplicationKeyRequest).keyId,
      )
    ) {
      return false;
    }
    if (
      !ApplicationServiceDeleteApplicationKeyRequest.__deepEquals(
        this.applicationId,
        (other as ApplicationServiceDeleteApplicationKeyRequest).applicationId,
      )
    ) {
      return false;
    }
    if (
      !ApplicationServiceDeleteApplicationKeyRequest.__deepEquals(
        this.projectId,
        (other as ApplicationServiceDeleteApplicationKeyRequest).projectId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ApplicationServiceDeleteApplicationKeyRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          ApplicationServiceDeleteApplicationKeyRequest.__deepEquals(v, w),
        ),
      );
    }
