...
export class BetaInternalPermissionServiceIDFilter {
  /**
  ...
  constructor(data?: Partial<BetaInternalPermissionServiceIDFilter>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaInternalPermissionServiceIDFilter)) {
      return false;
    }
    if (
      !BetaInternalPermissionServiceIDFilter.__deepEquals(
        this.id,
        (other as BetaInternalPermissionServiceIDFilter).id,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaInternalPermissionServiceIDFilter.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaInternalPermissionServiceIDFilter.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaInternalPermissionServiceIDFilter.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaInternalPermissionServiceIDFilter.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
