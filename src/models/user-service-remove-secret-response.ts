...
export class UserServiceRemoveSecretResponse {
  /**
  ...
  constructor(data?: Partial<UserServiceRemoveSecretResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceRemoveSecretResponse)) {
      return false;
    }
    if (
      !UserServiceRemoveSecretResponse.__deepEquals(
        this.deletionDate,
        (other as UserServiceRemoveSecretResponse).deletionDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceRemoveSecretResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceRemoveSecretResponse.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceRemoveSecretResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceRemoveSecretResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
