...
import { UserServiceType } from "./user-service-type.js";
import { Expose } from "class-transformer";

/**
 * Query for users with a specific type.
 */
export class UserServiceTypeQuery {
  /**
  ...
  constructor(data?: Partial<UserServiceTypeQuery>) {
    Object.assign(this, data);
    if (this.type != null) {
      const typeValues = Object.values(UserServiceType).filter(
        (v) =>
          typeof (UserServiceType as Record<string, unknown>)[v as string] !==
          "number",
      );
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceTypeQuery)) {
      return false;
    }
    if (
      !UserServiceTypeQuery.__deepEquals(
        this.type,
        (other as UserServiceTypeQuery).type,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => UserServiceTypeQuery.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceTypeQuery.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !UserServiceTypeQuery.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceTypeQuery.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
