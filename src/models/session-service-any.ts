 ...
 */
export class SessionServiceAny {
  /**
  ...
  constructor(data?: Partial<SessionServiceAny>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof SessionServiceAny)) {
      return false;
    }
    if (
      !SessionServiceAny.__deepEquals(
        this.type,
        (other as SessionServiceAny).type,
      )
    ) {
      return false;
    }
    if (
      !SessionServiceAny.__deepEquals(
        this.value,
        (other as SessionServiceAny).value,
      )
    ) {
      return false;
    }
    if (
      !SessionServiceAny.__deepEquals(
        this.debug,
        (other as SessionServiceAny).debug,
      )
    ) {
      return false;
    }
    {
      ...
      for (const k of selfKeys) {
        ...
        if (!SessionServiceAny.__deepEquals(selfRec[k], otherRec[k])) {
          return false;
        }
      }
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => SessionServiceAny.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => SessionServiceAny.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !SessionServiceAny.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          SessionServiceAny.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
