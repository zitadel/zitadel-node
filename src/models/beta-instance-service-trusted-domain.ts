...
export class BetaInstanceServiceTrustedDomain {
  /**
  ...
  constructor(data?: Partial<BetaInstanceServiceTrustedDomain>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaInstanceServiceTrustedDomain)) {
      return false;
    }
    if (
      !BetaInstanceServiceTrustedDomain.__deepEquals(
        this.instanceId,
        (other as BetaInstanceServiceTrustedDomain).instanceId,
      )
    ) {
      return false;
    }
    if (
      !BetaInstanceServiceTrustedDomain.__deepEquals(
        this.creationDate,
        (other as BetaInstanceServiceTrustedDomain).creationDate,
      )
    ) {
      return false;
    }
    if (
      !BetaInstanceServiceTrustedDomain.__deepEquals(
        this.domain,
        (other as BetaInstanceServiceTrustedDomain).domain,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaInstanceServiceTrustedDomain.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaInstanceServiceTrustedDomain.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaInstanceServiceTrustedDomain.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaInstanceServiceTrustedDomain.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
