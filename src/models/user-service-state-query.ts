 ...
 */
export class UserServiceStateQuery {
  /**
  ...
  constructor(data?: Partial<UserServiceStateQuery>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceStateQuery)) {
      return false;
    }
    if (
      !UserServiceStateQuery.__deepEquals(
        this.state,
        (other as UserServiceStateQuery).state,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => UserServiceStateQuery.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceStateQuery.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !UserServiceStateQuery.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceStateQuery.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
