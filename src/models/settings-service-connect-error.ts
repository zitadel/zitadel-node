...
import { SettingsServiceAny } from "./settings-service-any.js";
import { Expose, Type } from "class-transformer";

/**
 * Error type returned by Connect: https://connectrpc.com/docs/go/errors/#http-representation
 */
export class SettingsServiceConnectError {
  /**
  ...
  constructor(data?: Partial<SettingsServiceConnectError>) {
    ...
    if (this.code != null) {
      const codeValues = Object.values(
        SettingsServiceConnectErrorCodeEnum,
      ).filter(
        (v) =>
          typeof (
            SettingsServiceConnectErrorCodeEnum as Record<string, unknown>
          )[v as string] !== "number",
      );
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof SettingsServiceConnectError)) {
      return false;
    }
    if (
      !SettingsServiceConnectError.__deepEquals(
        this.code,
        (other as SettingsServiceConnectError).code,
      )
    ) {
      return false;
    }
    if (
      !SettingsServiceConnectError.__deepEquals(
        this.message,
        (other as SettingsServiceConnectError).message,
      )
    ) {
      return false;
    }
    if (
      !SettingsServiceConnectError.__deepEquals(
        this.details,
        (other as SettingsServiceConnectError).details,
      )
    ) {
      return false;
    }
    {
      ...
      for (const k of selfKeys) {
        ...
        if (
          !SettingsServiceConnectError.__deepEquals(selfRec[k], otherRec[k])
        ) {
          return false;
        }
      }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        SettingsServiceConnectError.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => SettingsServiceConnectError.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !SettingsServiceConnectError.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          SettingsServiceConnectError.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
...
export enum SettingsServiceConnectErrorCodeEnum {
  Canceled = "canceled",
  Unknown = "unknown",
