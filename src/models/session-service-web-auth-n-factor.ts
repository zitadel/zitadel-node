...
export class SessionServiceWebAuthNFactor {
  /**
  ...
  constructor(data?: Partial<SessionServiceWebAuthNFactor>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof SessionServiceWebAuthNFactor)) {
      return false;
    }
    if (
      !SessionServiceWebAuthNFactor.__deepEquals(
        this.verifiedAt,
        (other as SessionServiceWebAuthNFactor).verifiedAt,
      )
    ) {
      return false;
    }
    if (
      !SessionServiceWebAuthNFactor.__deepEquals(
        this.userVerified,
        (other as SessionServiceWebAuthNFactor).userVerified,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        SessionServiceWebAuthNFactor.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => SessionServiceWebAuthNFactor.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !SessionServiceWebAuthNFactor.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          SessionServiceWebAuthNFactor.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
