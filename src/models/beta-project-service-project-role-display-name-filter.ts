...
export class BetaProjectServiceProjectRoleDisplayNameFilter {
  /**
  ...
  constructor(data?: Partial<BetaProjectServiceProjectRoleDisplayNameFilter>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaProjectServiceProjectRoleDisplayNameFilter)) {
      return false;
    }
    if (
      !BetaProjectServiceProjectRoleDisplayNameFilter.__deepEquals(
        this.displayName,
        (other as BetaProjectServiceProjectRoleDisplayNameFilter).displayName,
      )
    ) {
      return false;
    }
    if (
      !BetaProjectServiceProjectRoleDisplayNameFilter.__deepEquals(
        this.method,
        (other as BetaProjectServiceProjectRoleDisplayNameFilter).method,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaProjectServiceProjectRoleDisplayNameFilter.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaProjectServiceProjectRoleDisplayNameFilter.__deepEquals(v, w),
        ),
      );
    }
