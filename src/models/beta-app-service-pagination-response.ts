...
export class BetaAppServicePaginationResponse {
  /**
  ...
  constructor(data?: Partial<BetaAppServicePaginationResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaAppServicePaginationResponse)) {
      return false;
    }
    if (
      !BetaAppServicePaginationResponse.__deepEquals(
        this.totalResult,
        (other as BetaAppServicePaginationResponse).totalResult,
      )
    ) {
      return false;
    }
    if (
      !BetaAppServicePaginationResponse.__deepEquals(
        this.appliedLimit,
        (other as BetaAppServicePaginationResponse).appliedLimit,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaAppServicePaginationResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaAppServicePaginationResponse.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaAppServicePaginationResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaAppServicePaginationResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
