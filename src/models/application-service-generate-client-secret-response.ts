...
export class ApplicationServiceGenerateClientSecretResponse {
  /**
  ...
  constructor(data?: Partial<ApplicationServiceGenerateClientSecretResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ApplicationServiceGenerateClientSecretResponse)) {
      return false;
    }
    if (
      !ApplicationServiceGenerateClientSecretResponse.__deepEquals(
        this.clientSecret,
        (other as ApplicationServiceGenerateClientSecretResponse).clientSecret,
      )
    ) {
      return false;
    }
    if (
      !ApplicationServiceGenerateClientSecretResponse.__deepEquals(
        this.creationDate,
        (other as ApplicationServiceGenerateClientSecretResponse).creationDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ApplicationServiceGenerateClientSecretResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          ApplicationServiceGenerateClientSecretResponse.__deepEquals(v, w),
        ),
      );
    }
