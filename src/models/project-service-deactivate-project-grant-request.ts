...
export class ProjectServiceDeactivateProjectGrantRequest {
  /**
  ...
  constructor(data?: Partial<ProjectServiceDeactivateProjectGrantRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ProjectServiceDeactivateProjectGrantRequest)) {
      return false;
    }
    if (
      !ProjectServiceDeactivateProjectGrantRequest.__deepEquals(
        this.projectId,
        (other as ProjectServiceDeactivateProjectGrantRequest).projectId,
      )
    ) {
      return false;
    }
    if (
      !ProjectServiceDeactivateProjectGrantRequest.__deepEquals(
        ...
        (other as ProjectServiceDeactivateProjectGrantRequest)
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ProjectServiceDeactivateProjectGrantRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          ProjectServiceDeactivateProjectGrantRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !ProjectServiceDeactivateProjectGrantRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
