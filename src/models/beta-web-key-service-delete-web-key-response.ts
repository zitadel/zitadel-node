...
export class BetaWebKeyServiceDeleteWebKeyResponse {
  /**
  ...
  constructor(data?: Partial<BetaWebKeyServiceDeleteWebKeyResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaWebKeyServiceDeleteWebKeyResponse)) {
      return false;
    }
    if (
      !BetaWebKeyServiceDeleteWebKeyResponse.__deepEquals(
        this.deletionDate,
        (other as BetaWebKeyServiceDeleteWebKeyResponse).deletionDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaWebKeyServiceDeleteWebKeyResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaWebKeyServiceDeleteWebKeyResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaWebKeyServiceDeleteWebKeyResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaWebKeyServiceDeleteWebKeyResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
