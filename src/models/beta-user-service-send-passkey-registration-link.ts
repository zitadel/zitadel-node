...
export class BetaUserServiceSendPasskeyRegistrationLink {
  /**
  ...
  constructor(data?: Partial<BetaUserServiceSendPasskeyRegistrationLink>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaUserServiceSendPasskeyRegistrationLink)) {
      return false;
    }
    if (
      !BetaUserServiceSendPasskeyRegistrationLink.__deepEquals(
        this.urlTemplate,
        (other as BetaUserServiceSendPasskeyRegistrationLink).urlTemplate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaUserServiceSendPasskeyRegistrationLink.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaUserServiceSendPasskeyRegistrationLink.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaUserServiceSendPasskeyRegistrationLink.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaUserServiceSendPasskeyRegistrationLink.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
