...
export class BetaInstanceServicePaginationRequest {
  /**
  ...
  constructor(data?: Partial<BetaInstanceServicePaginationRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaInstanceServicePaginationRequest)) {
      return false;
    }
    if (
      !BetaInstanceServicePaginationRequest.__deepEquals(
        this.offset,
        (other as BetaInstanceServicePaginationRequest).offset,
      )
    ) {
      return false;
    }
    if (
      !BetaInstanceServicePaginationRequest.__deepEquals(
        this.limit,
        (other as BetaInstanceServicePaginationRequest).limit,
      )
    ) {
      return false;
    }
    if (
      !BetaInstanceServicePaginationRequest.__deepEquals(
        this.asc,
        (other as BetaInstanceServicePaginationRequest).asc,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaInstanceServicePaginationRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaInstanceServicePaginationRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaInstanceServicePaginationRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaInstanceServicePaginationRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
