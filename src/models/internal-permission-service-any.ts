 ...
 */
export class InternalPermissionServiceAny {
  /**
  ...
  constructor(data?: Partial<InternalPermissionServiceAny>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof InternalPermissionServiceAny)) {
      return false;
    }
    if (
      !InternalPermissionServiceAny.__deepEquals(
        this.type,
        (other as InternalPermissionServiceAny).type,
      )
    ) {
      return false;
    }
    if (
      !InternalPermissionServiceAny.__deepEquals(
        this.value,
        (other as InternalPermissionServiceAny).value,
      )
    ) {
      return false;
    }
    if (
      !InternalPermissionServiceAny.__deepEquals(
        this.debug,
        (other as InternalPermissionServiceAny).debug,
      )
    ) {
      return false;
    }
    {
      ...
      for (const k of selfKeys) {
        ...
        if (
          !InternalPermissionServiceAny.__deepEquals(selfRec[k], otherRec[k])
        ) {
          return false;
        }
      }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        InternalPermissionServiceAny.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => InternalPermissionServiceAny.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !InternalPermissionServiceAny.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          InternalPermissionServiceAny.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
