...
export class BetaProjectServiceUpdateProjectGrantRequest {
  /**
  ...
  constructor(data?: Partial<BetaProjectServiceUpdateProjectGrantRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaProjectServiceUpdateProjectGrantRequest)) {
      return false;
    }
    if (
      !BetaProjectServiceUpdateProjectGrantRequest.__deepEquals(
        this.projectId,
        (other as BetaProjectServiceUpdateProjectGrantRequest).projectId,
      )
    ) {
      return false;
    }
    if (
      !BetaProjectServiceUpdateProjectGrantRequest.__deepEquals(
        ...
        (other as BetaProjectServiceUpdateProjectGrantRequest)
    ...
    if (
      !BetaProjectServiceUpdateProjectGrantRequest.__deepEquals(
        this.roleKeys,
        (other as BetaProjectServiceUpdateProjectGrantRequest).roleKeys,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaProjectServiceUpdateProjectGrantRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaProjectServiceUpdateProjectGrantRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaProjectServiceUpdateProjectGrantRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
