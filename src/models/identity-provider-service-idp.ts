...
import { IdentityProviderServiceDetails } from "./identity-provider-service-details.js";
import { IdentityProviderServiceIDPConfig } from "./identity-provider-service-idp-config.js";
import { IdentityProviderServiceIDPState } from "./identity-provider-service-idp-state.js";
import { IdentityProviderServiceIDPType } from "./identity-provider-service-idp-type.js";
...
export class IdentityProviderServiceIDP {
  ...
  constructor(data?: Partial<IdentityProviderServiceIDP>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof IdentityProviderServiceIDP)) {
      return false;
    }
    if (
      !IdentityProviderServiceIDP.__deepEquals(
        this.id,
        (other as IdentityProviderServiceIDP).id,
      )
    ) {
      return false;
    }
    if (
      !IdentityProviderServiceIDP.__deepEquals(
        this.details,
        (other as IdentityProviderServiceIDP).details,
      )
    ) {
      return false;
    }
    if (
      !IdentityProviderServiceIDP.__deepEquals(
        this.state,
        (other as IdentityProviderServiceIDP).state,
      )
    ) {
      return false;
    }
    if (
      !IdentityProviderServiceIDP.__deepEquals(
        this.name,
        (other as IdentityProviderServiceIDP).name,
      )
    ) {
      return false;
    }
    if (
      !IdentityProviderServiceIDP.__deepEquals(
        this.type,
        (other as IdentityProviderServiceIDP).type,
      )
    ) {
      return false;
    }
    if (
      !IdentityProviderServiceIDP.__deepEquals(
        this.config,
        (other as IdentityProviderServiceIDP).config,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        IdentityProviderServiceIDP.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => IdentityProviderServiceIDP.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !IdentityProviderServiceIDP.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          IdentityProviderServiceIDP.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
