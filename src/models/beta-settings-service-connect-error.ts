...
import { BetaSettingsServiceAny } from "./beta-settings-service-any.js";
import { Expose, Type } from "class-transformer";

/**
 * Error type returned by Connect: https://connectrpc.com/docs/go/errors/#http-representation
 */
export class BetaSettingsServiceConnectError {
  /**
  ...
  constructor(data?: Partial<BetaSettingsServiceConnectError>) {
    ...
    if (this.code != null) {
      const codeValues = Object.values(
        BetaSettingsServiceConnectErrorCodeEnum,
      ).filter(
        (v) =>
          typeof (
            BetaSettingsServiceConnectErrorCodeEnum as Record<string, unknown>
          )[v as string] !== "number",
      );
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaSettingsServiceConnectError)) {
      return false;
    }
    if (
      !BetaSettingsServiceConnectError.__deepEquals(
        this.code,
        (other as BetaSettingsServiceConnectError).code,
      )
    ) {
      return false;
    }
    if (
      !BetaSettingsServiceConnectError.__deepEquals(
        this.message,
        (other as BetaSettingsServiceConnectError).message,
      )
    ) {
      return false;
    }
    if (
      !BetaSettingsServiceConnectError.__deepEquals(
        this.details,
        (other as BetaSettingsServiceConnectError).details,
      )
    ) {
      return false;
    }
    {
      ...
      for (const k of selfKeys) {
        ...
        if (
          !BetaSettingsServiceConnectError.__deepEquals(selfRec[k], otherRec[k])
        ) {
          return false;
        }
      }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaSettingsServiceConnectError.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaSettingsServiceConnectError.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaSettingsServiceConnectError.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaSettingsServiceConnectError.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
...
export enum BetaSettingsServiceConnectErrorCodeEnum {
  Canceled = "canceled",
  Unknown = "unknown",
