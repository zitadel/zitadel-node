...
export class BetaSettingsServiceGetActiveIdentityProvidersRequest {
  /**
  ...
  constructor(
    data?: Partial<BetaSettingsServiceGetActiveIdentityProvidersRequest>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !(other instanceof BetaSettingsServiceGetActiveIdentityProvidersRequest)
    ) {
      return false;
    }
    if (
      !BetaSettingsServiceGetActiveIdentityProvidersRequest.__deepEquals(
        this.ctx,
        (other as BetaSettingsServiceGetActiveIdentityProvidersRequest).ctx,
      )
    ) {
      return false;
    }
