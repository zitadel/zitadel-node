 ...
 */
export class FeatureServiceAny {
  /**
  ...
  constructor(data?: Partial<FeatureServiceAny>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof FeatureServiceAny)) {
      return false;
    }
    if (
      !FeatureServiceAny.__deepEquals(
        this.type,
        (other as FeatureServiceAny).type,
      )
    ) {
      return false;
    }
    if (
      !FeatureServiceAny.__deepEquals(
        this.value,
        (other as FeatureServiceAny).value,
      )
    ) {
      return false;
    }
    if (
      !FeatureServiceAny.__deepEquals(
        this.debug,
        (other as FeatureServiceAny).debug,
      )
    ) {
      return false;
    }
    {
      ...
      for (const k of selfKeys) {
        ...
        if (!FeatureServiceAny.__deepEquals(selfRec[k], otherRec[k])) {
          return false;
        }
      }
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => FeatureServiceAny.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => FeatureServiceAny.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !FeatureServiceAny.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          FeatureServiceAny.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
