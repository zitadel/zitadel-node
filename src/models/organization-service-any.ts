 ...
 */
export class OrganizationServiceAny {
  /**
  ...
  constructor(data?: Partial<OrganizationServiceAny>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof OrganizationServiceAny)) {
      return false;
    }
    if (
      !OrganizationServiceAny.__deepEquals(
        this.type,
        (other as OrganizationServiceAny).type,
      )
    ) {
      return false;
    }
    if (
      !OrganizationServiceAny.__deepEquals(
        this.value,
        (other as OrganizationServiceAny).value,
      )
    ) {
      return false;
    }
    if (
      !OrganizationServiceAny.__deepEquals(
        this.debug,
        (other as OrganizationServiceAny).debug,
      )
    ) {
      return false;
    }
    {
      ...
      for (const k of selfKeys) {
        ...
        if (!OrganizationServiceAny.__deepEquals(selfRec[k], otherRec[k])) {
          return false;
        }
      }
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => OrganizationServiceAny.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => OrganizationServiceAny.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !OrganizationServiceAny.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          OrganizationServiceAny.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
