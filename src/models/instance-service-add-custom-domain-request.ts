...
export class InstanceServiceAddCustomDomainRequest {
  /**
  ...
  constructor(data?: Partial<InstanceServiceAddCustomDomainRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof InstanceServiceAddCustomDomainRequest)) {
      return false;
    }
    if (
      !InstanceServiceAddCustomDomainRequest.__deepEquals(
        this.instanceId,
        (other as InstanceServiceAddCustomDomainRequest).instanceId,
      )
    ) {
      return false;
    }
    if (
      !InstanceServiceAddCustomDomainRequest.__deepEquals(
        this.customDomain,
        (other as InstanceServiceAddCustomDomainRequest).customDomain,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        InstanceServiceAddCustomDomainRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          InstanceServiceAddCustomDomainRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !InstanceServiceAddCustomDomainRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          InstanceServiceAddCustomDomainRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
