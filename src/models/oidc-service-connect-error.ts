...
export class OIDCServiceConnectError {
  ...
  constructor(data?: Partial<OIDCServiceConnectError>) {
    ...
    if (this.code != null) {
      const codeValues = Object.values(OIDCServiceConnectErrorCodeEnum).filter(
        (v) =>
          typeof (OIDCServiceConnectErrorCodeEnum as Record<string, unknown>)[
            v as string
          ] !== "number",
      );
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof OIDCServiceConnectError)) {
      return false;
    }
    if (
      !OIDCServiceConnectError.__deepEquals(
        this.code,
        (other as OIDCServiceConnectError).code,
      )
    ) {
      return false;
    }
    if (
      !OIDCServiceConnectError.__deepEquals(
        this.message,
        (other as OIDCServiceConnectError).message,
      )
    ) {
      return false;
    }
    if (
      !OIDCServiceConnectError.__deepEquals(
        this.details,
        (other as OIDCServiceConnectError).details,
      )
    ) {
      return false;
    }
    {
      ...
      for (const k of selfKeys) {
        ...
        if (!OIDCServiceConnectError.__deepEquals(selfRec[k], otherRec[k])) {
          return false;
        }
      }
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => OIDCServiceConnectError.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => OIDCServiceConnectError.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !OIDCServiceConnectError.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          OIDCServiceConnectError.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
...
export enum OIDCServiceConnectErrorCodeEnum {
  Canceled = "canceled",
  Unknown = "unknown",
