 ...
 */
export class BetaUserServiceNickNameQuery {
  /**
  ...
  constructor(data?: Partial<BetaUserServiceNickNameQuery>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaUserServiceNickNameQuery)) {
      return false;
    }
    if (
      !BetaUserServiceNickNameQuery.__deepEquals(
        this.nickName,
        (other as BetaUserServiceNickNameQuery).nickName,
      )
    ) {
      return false;
    }
    if (
      !BetaUserServiceNickNameQuery.__deepEquals(
        this.method,
        (other as BetaUserServiceNickNameQuery).method,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaUserServiceNickNameQuery.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaUserServiceNickNameQuery.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaUserServiceNickNameQuery.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaUserServiceNickNameQuery.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
