...
export class BetaUserServiceVerifyEmailRequest {
  /**
  ...
  constructor(data?: Partial<BetaUserServiceVerifyEmailRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaUserServiceVerifyEmailRequest)) {
      return false;
    }
    if (
      !BetaUserServiceVerifyEmailRequest.__deepEquals(
        this.userId,
        (other as BetaUserServiceVerifyEmailRequest).userId,
      )
    ) {
      return false;
    }
    if (
      !BetaUserServiceVerifyEmailRequest.__deepEquals(
        ...
        (other as BetaUserServiceVerifyEmailRequest).verificationCode,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaUserServiceVerifyEmailRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaUserServiceVerifyEmailRequest.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaUserServiceVerifyEmailRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaUserServiceVerifyEmailRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
