...
export class UserServiceUpdateUserResponse {
  /**
  ...
  constructor(data?: Partial<UserServiceUpdateUserResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceUpdateUserResponse)) {
      return false;
    }
    if (
      !UserServiceUpdateUserResponse.__deepEquals(
        this.changeDate,
        (other as UserServiceUpdateUserResponse).changeDate,
      )
    ) {
      return false;
    }
    if (
      !UserServiceUpdateUserResponse.__deepEquals(
        this.emailCode,
        (other as UserServiceUpdateUserResponse).emailCode,
      )
    ) {
      return false;
    }
    if (
      !UserServiceUpdateUserResponse.__deepEquals(
        this.phoneCode,
        (other as UserServiceUpdateUserResponse).phoneCode,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceUpdateUserResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceUpdateUserResponse.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceUpdateUserResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceUpdateUserResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
