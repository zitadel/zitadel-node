...
export class BetaOIDCServiceDetails {
  /**
  ...
  constructor(data?: Partial<BetaOIDCServiceDetails>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaOIDCServiceDetails)) {
      return false;
    }
    if (
      !BetaOIDCServiceDetails.__deepEquals(
        this.sequence,
        (other as BetaOIDCServiceDetails).sequence,
      )
    ) {
      return false;
    }
    if (
      !BetaOIDCServiceDetails.__deepEquals(
        this.changeDate,
        (other as BetaOIDCServiceDetails).changeDate,
      )
    ) {
      return false;
    }
    if (
      !BetaOIDCServiceDetails.__deepEquals(
        this.resourceOwner,
        (other as BetaOIDCServiceDetails).resourceOwner,
      )
    ) {
      return false;
    }
    if (
      !BetaOIDCServiceDetails.__deepEquals(
        this.creationDate,
        (other as BetaOIDCServiceDetails).creationDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => BetaOIDCServiceDetails.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaOIDCServiceDetails.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !BetaOIDCServiceDetails.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaOIDCServiceDetails.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
