...
import { UserServiceTimestampFilterMethod } from "./user-service-timestamp-filter-method.js";
import { Expose, Type } from "class-transformer";

export class UserServiceTimestampFilter {
  /**
  ...
  constructor(data?: Partial<UserServiceTimestampFilter>) {
    ...
    if (this.method != null) {
      const methodValues = Object.values(
        ...
        (v) =>
          typeof (UserServiceTimestampFilterMethod as Record<string, unknown>)[
            v as string
          ] !== "number",
      );
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceTimestampFilter)) {
      return false;
    }
    if (
      !UserServiceTimestampFilter.__deepEquals(
        this.timestamp,
        (other as UserServiceTimestampFilter).timestamp,
      )
    ) {
      return false;
    }
    if (
      !UserServiceTimestampFilter.__deepEquals(
        this.method,
        (other as UserServiceTimestampFilter).method,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceTimestampFilter.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceTimestampFilter.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceTimestampFilter.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceTimestampFilter.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
