...
import { SettingsServiceEmbeddedIframeSettings } from "./settings-service-embedded-iframe-settings.js";
import { Expose, Type } from "class-transformer";

export class SettingsServiceSetSecuritySettingsRequest {
  /**
  ...
  constructor(data?: Partial<SettingsServiceSetSecuritySettingsRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof SettingsServiceSetSecuritySettingsRequest)) {
      return false;
    }
    if (
      !SettingsServiceSetSecuritySettingsRequest.__deepEquals(
        this.embeddedIframe,
        (other as SettingsServiceSetSecuritySettingsRequest).embeddedIframe,
      )
    ) {
      return false;
    }
    if (
      !SettingsServiceSetSecuritySettingsRequest.__deepEquals(
        ...
        (other as SettingsServiceSetSecuritySettingsRequest)
          .enableImpersonation,
      )
    ) {
      return false;
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        SettingsServiceSetSecuritySettingsRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          SettingsServiceSetSecuritySettingsRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !SettingsServiceSetSecuritySettingsRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          SettingsServiceSetSecuritySettingsRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
