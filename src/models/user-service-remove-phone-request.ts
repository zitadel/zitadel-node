...
export class UserServiceRemovePhoneRequest {
  /**
  ...
  constructor(data?: Partial<UserServiceRemovePhoneRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceRemovePhoneRequest)) {
      return false;
    }
    if (
      !UserServiceRemovePhoneRequest.__deepEquals(
        this.userId,
        (other as UserServiceRemovePhoneRequest).userId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceRemovePhoneRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceRemovePhoneRequest.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceRemovePhoneRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceRemovePhoneRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
