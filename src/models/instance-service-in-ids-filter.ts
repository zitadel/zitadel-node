...
export class InstanceServiceInIDsFilter {
  /**
  ...
  constructor(data?: Partial<InstanceServiceInIDsFilter>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof InstanceServiceInIDsFilter)) {
      return false;
    }
    if (
      !InstanceServiceInIDsFilter.__deepEquals(
        this.ids,
        (other as InstanceServiceInIDsFilter).ids,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        InstanceServiceInIDsFilter.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => InstanceServiceInIDsFilter.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !InstanceServiceInIDsFilter.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          InstanceServiceInIDsFilter.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
