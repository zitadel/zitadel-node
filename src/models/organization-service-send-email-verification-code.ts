...
export class OrganizationServiceSendEmailVerificationCode {
  /**
  ...
  constructor(data?: Partial<OrganizationServiceSendEmailVerificationCode>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof OrganizationServiceSendEmailVerificationCode)) {
      return false;
    }
    if (
      !OrganizationServiceSendEmailVerificationCode.__deepEquals(
        this.urlTemplate,
        (other as OrganizationServiceSendEmailVerificationCode).urlTemplate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        OrganizationServiceSendEmailVerificationCode.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          OrganizationServiceSendEmailVerificationCode.__deepEquals(v, w),
        ),
      );
    }
