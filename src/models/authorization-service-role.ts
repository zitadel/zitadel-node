...
export class AuthorizationServiceRole {
  /**
  ...
  constructor(data?: Partial<AuthorizationServiceRole>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof AuthorizationServiceRole)) {
      return false;
    }
    if (
      !AuthorizationServiceRole.__deepEquals(
        this.key,
        (other as AuthorizationServiceRole).key,
      )
    ) {
      return false;
    }
    if (
      !AuthorizationServiceRole.__deepEquals(
        this.displayName,
        (other as AuthorizationServiceRole).displayName,
      )
    ) {
      return false;
    }
    if (
      !AuthorizationServiceRole.__deepEquals(
        this.group,
        (other as AuthorizationServiceRole).group,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => AuthorizationServiceRole.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => AuthorizationServiceRole.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !AuthorizationServiceRole.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          AuthorizationServiceRole.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
