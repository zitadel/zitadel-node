...
export class OrganizationServiceVerifyOrganizationDomainResponse {
  /**
  ...
  constructor(
    data?: Partial<OrganizationServiceVerifyOrganizationDomainResponse>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !(other instanceof OrganizationServiceVerifyOrganizationDomainResponse)
    ) {
      return false;
    }
    if (
      !OrganizationServiceVerifyOrganizationDomainResponse.__deepEquals(
        this.changeDate,
        (other as OrganizationServiceVerifyOrganizationDomainResponse)
          .changeDate,
      )
    ) {
      return false;
