...
export class AuthorizationServiceProjectNameQuery {
  /**
  ...
  constructor(data?: Partial<AuthorizationServiceProjectNameQuery>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof AuthorizationServiceProjectNameQuery)) {
      return false;
    }
    if (
      !AuthorizationServiceProjectNameQuery.__deepEquals(
        this.name,
        (other as AuthorizationServiceProjectNameQuery).name,
      )
    ) {
      return false;
    }
    if (
      !AuthorizationServiceProjectNameQuery.__deepEquals(
        this.method,
        (other as AuthorizationServiceProjectNameQuery).method,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        AuthorizationServiceProjectNameQuery.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          AuthorizationServiceProjectNameQuery.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !AuthorizationServiceProjectNameQuery.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          AuthorizationServiceProjectNameQuery.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
