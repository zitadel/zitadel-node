...
export class BetaAuthorizationServiceUser {
  /**
  ...
  constructor(data?: Partial<BetaAuthorizationServiceUser>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaAuthorizationServiceUser)) {
      return false;
    }
    if (
      !BetaAuthorizationServiceUser.__deepEquals(
        this.id,
        (other as BetaAuthorizationServiceUser).id,
      )
    ) {
      return false;
    }
    if (
      !BetaAuthorizationServiceUser.__deepEquals(
        ...
        (other as BetaAuthorizationServiceUser).preferredLoginName,
      )
    ) {
      return false;
    }
    if (
      !BetaAuthorizationServiceUser.__deepEquals(
        this.displayName,
        (other as BetaAuthorizationServiceUser).displayName,
      )
    ) {
      return false;
    }
    if (
      !BetaAuthorizationServiceUser.__deepEquals(
        this.avatarUrl,
        (other as BetaAuthorizationServiceUser).avatarUrl,
      )
    ) {
      return false;
    }
    if (
      !BetaAuthorizationServiceUser.__deepEquals(
        this.organizationId,
        (other as BetaAuthorizationServiceUser).organizationId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaAuthorizationServiceUser.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaAuthorizationServiceUser.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaAuthorizationServiceUser.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaAuthorizationServiceUser.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
