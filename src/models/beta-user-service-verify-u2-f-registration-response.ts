...
export class BetaUserServiceVerifyU2FRegistrationResponse {
  /**
  ...
  constructor(data?: Partial<BetaUserServiceVerifyU2FRegistrationResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaUserServiceVerifyU2FRegistrationResponse)) {
      return false;
    }
    if (
      !BetaUserServiceVerifyU2FRegistrationResponse.__deepEquals(
        this.details,
        (other as BetaUserServiceVerifyU2FRegistrationResponse).details,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaUserServiceVerifyU2FRegistrationResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaUserServiceVerifyU2FRegistrationResponse.__deepEquals(v, w),
        ),
      );
    }
