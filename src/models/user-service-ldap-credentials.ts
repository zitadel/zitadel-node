...
export class UserServiceLDAPCredentials {
  /**
  ...
  constructor(data?: Partial<UserServiceLDAPCredentials>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceLDAPCredentials)) {
      return false;
    }
    if (
      !UserServiceLDAPCredentials.__deepEquals(
        this.username,
        (other as UserServiceLDAPCredentials).username,
      )
    ) {
      return false;
    }
    if (
      !UserServiceLDAPCredentials.__deepEquals(
        this.password,
        (other as UserServiceLDAPCredentials).password,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceLDAPCredentials.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceLDAPCredentials.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceLDAPCredentials.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceLDAPCredentials.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
