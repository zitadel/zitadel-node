...
export class BetaOrganizationServiceMetadataKeyQuery {
  ...
  constructor(data?: Partial<BetaOrganizationServiceMetadataKeyQuery>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaOrganizationServiceMetadataKeyQuery)) {
      return false;
    }
    if (
      !BetaOrganizationServiceMetadataKeyQuery.__deepEquals(
        this.key,
        (other as BetaOrganizationServiceMetadataKeyQuery).key,
      )
    ) {
      return false;
    }
    if (
      !BetaOrganizationServiceMetadataKeyQuery.__deepEquals(
        this.method,
        (other as BetaOrganizationServiceMetadataKeyQuery).method,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaOrganizationServiceMetadataKeyQuery.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaOrganizationServiceMetadataKeyQuery.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaOrganizationServiceMetadataKeyQuery.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaOrganizationServiceMetadataKeyQuery.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
