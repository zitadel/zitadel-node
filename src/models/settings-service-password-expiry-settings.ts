...
export class SettingsServicePasswordExpirySettings {
  /**
  ...
  constructor(data?: Partial<SettingsServicePasswordExpirySettings>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof SettingsServicePasswordExpirySettings)) {
      return false;
    }
    if (
      !SettingsServicePasswordExpirySettings.__deepEquals(
        this.maxAgeDays,
        (other as SettingsServicePasswordExpirySettings).maxAgeDays,
      )
    ) {
      return false;
    }
    if (
      !SettingsServicePasswordExpirySettings.__deepEquals(
        this.expireWarnDays,
        (other as SettingsServicePasswordExpirySettings).expireWarnDays,
      )
    ) {
      return false;
    }
    if (
      !SettingsServicePasswordExpirySettings.__deepEquals(
        this.resourceOwnerType,
        (other as SettingsServicePasswordExpirySettings).resourceOwnerType,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        SettingsServicePasswordExpirySettings.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          SettingsServicePasswordExpirySettings.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !SettingsServicePasswordExpirySettings.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          SettingsServicePasswordExpirySettings.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
