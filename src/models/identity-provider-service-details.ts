...
export class IdentityProviderServiceDetails {
  /**
  ...
  constructor(data?: Partial<IdentityProviderServiceDetails>) {
    Object.assign(this, data);
    if (this.resourceOwner != null && typeof this.resourceOwner !== "string") {
      throw new TypeError(
        `resourceOwner must be a string, got ${typeof this.resourceOwner}`,
      );
    }
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof IdentityProviderServiceDetails)) {
      return false;
    }
    if (
      !IdentityProviderServiceDetails.__deepEquals(
        this.sequence,
        (other as IdentityProviderServiceDetails).sequence,
      )
    ) {
      return false;
    }
    if (
      !IdentityProviderServiceDetails.__deepEquals(
        this.changeDate,
        (other as IdentityProviderServiceDetails).changeDate,
      )
    ) {
      return false;
    }
    if (
      !IdentityProviderServiceDetails.__deepEquals(
        this.resourceOwner,
        (other as IdentityProviderServiceDetails).resourceOwner,
      )
    ) {
      return false;
    }
    if (
      !IdentityProviderServiceDetails.__deepEquals(
        this.creationDate,
        (other as IdentityProviderServiceDetails).creationDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        IdentityProviderServiceDetails.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => IdentityProviderServiceDetails.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !IdentityProviderServiceDetails.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          IdentityProviderServiceDetails.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
