...
import { OIDCServicePrompt } from "./oidc-service-prompt.js";
...
export class OIDCServiceAuthRequest {
  ...
  constructor(data?: Partial<OIDCServiceAuthRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof OIDCServiceAuthRequest)) {
      return false;
    }
    if (
      !OIDCServiceAuthRequest.__deepEquals(
        this.id,
        (other as OIDCServiceAuthRequest).id,
      )
    ) {
      return false;
    }
    if (
      !OIDCServiceAuthRequest.__deepEquals(
        this.creationDate,
        (other as OIDCServiceAuthRequest).creationDate,
      )
    ) {
      return false;
    }
    if (
      !OIDCServiceAuthRequest.__deepEquals(
        this.clientId,
        (other as OIDCServiceAuthRequest).clientId,
      )
    ) {
      return false;
    }
    if (
      !OIDCServiceAuthRequest.__deepEquals(
        this.scope,
        (other as OIDCServiceAuthRequest).scope,
      )
    ) {
      return false;
    }
    if (
      !OIDCServiceAuthRequest.__deepEquals(
        this.redirectUri,
        (other as OIDCServiceAuthRequest).redirectUri,
      )
    ) {
      return false;
    }
    if (
      !OIDCServiceAuthRequest.__deepEquals(
        this.prompt,
        (other as OIDCServiceAuthRequest).prompt,
      )
    ) {
      return false;
    }
    if (
      !OIDCServiceAuthRequest.__deepEquals(
        this.uiLocales,
        (other as OIDCServiceAuthRequest).uiLocales,
      )
    ) {
      return false;
    }
    if (
      !OIDCServiceAuthRequest.__deepEquals(
        this.loginHint,
        (other as OIDCServiceAuthRequest).loginHint,
      )
    ) {
      return false;
    }
    if (
      !OIDCServiceAuthRequest.__deepEquals(
        this.maxAge,
        (other as OIDCServiceAuthRequest).maxAge,
      )
    ) {
      return false;
    }
    if (
      !OIDCServiceAuthRequest.__deepEquals(
        this.hintUserId,
        (other as OIDCServiceAuthRequest).hintUserId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => OIDCServiceAuthRequest.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => OIDCServiceAuthRequest.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !OIDCServiceAuthRequest.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          OIDCServiceAuthRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
