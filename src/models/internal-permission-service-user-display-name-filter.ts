...
import { InternalPermissionServiceTextFilterMethod } from "./internal-permission-service-text-filter-method.js";
import { Expose } from "class-transformer";

export class InternalPermissionServiceUserDisplayNameFilter {
  /**
  ...
  constructor(data?: Partial<InternalPermissionServiceUserDisplayNameFilter>) {
    ...
    if (this.method != null) {
      const methodValues = Object.values(
        ...
        (v) =>
          typeof (
            InternalPermissionServiceTextFilterMethod as Record<string, unknown>
          )[v as string] !== "number",
      );
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof InternalPermissionServiceUserDisplayNameFilter)) {
      return false;
    }
    if (
      !InternalPermissionServiceUserDisplayNameFilter.__deepEquals(
        this.displayName,
        (other as InternalPermissionServiceUserDisplayNameFilter).displayName,
      )
    ) {
      return false;
    }
    if (
      !InternalPermissionServiceUserDisplayNameFilter.__deepEquals(
        this.method,
        (other as InternalPermissionServiceUserDisplayNameFilter).method,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        InternalPermissionServiceUserDisplayNameFilter.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          InternalPermissionServiceUserDisplayNameFilter.__deepEquals(v, w),
        ),
      );
    }
