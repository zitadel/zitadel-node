...
export class BetaOrganizationServiceGenerateOrganizationDomainValidationRequest {
  /**
  ...
  constructor(
    data?: Partial<BetaOrganizationServiceGenerateOrganizationDomainValidationRequest>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !BetaOrganizationServiceGenerateOrganizationDomainValidationRequest.__deepEquals(
        this.organizationId,
        (
          other as BetaOrganizationServiceGenerateOrganizationDomainValidationRequest
        ).organizationId,
      )
    ) {
      return false;
