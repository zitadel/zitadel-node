...
import { IdentityProviderServiceAny } from "./identity-provider-service-any.js";
import { Expose, Type } from "class-transformer";

/**
 * Error type returned by Connect: https://connectrpc.com/docs/go/errors/#http-representation
 */
export class IdentityProviderServiceConnectError {
  /**
  ...
  constructor(data?: Partial<IdentityProviderServiceConnectError>) {
    ...
    if (this.code != null) {
      const codeValues = Object.values(
        IdentityProviderServiceConnectErrorCodeEnum,
      ).filter(
        (v) =>
          typeof (
            IdentityProviderServiceConnectErrorCodeEnum as Record<
              string,
              unknown
            >
          )[v as string] !== "number",
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof IdentityProviderServiceConnectError)) {
      return false;
    }
    if (
      !IdentityProviderServiceConnectError.__deepEquals(
        this.code,
        (other as IdentityProviderServiceConnectError).code,
      )
    ) {
      return false;
    }
    if (
      !IdentityProviderServiceConnectError.__deepEquals(
        this.message,
        (other as IdentityProviderServiceConnectError).message,
      )
    ) {
      return false;
    }
    if (
      !IdentityProviderServiceConnectError.__deepEquals(
        this.details,
        (other as IdentityProviderServiceConnectError).details,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        IdentityProviderServiceConnectError.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          IdentityProviderServiceConnectError.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !IdentityProviderServiceConnectError.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          IdentityProviderServiceConnectError.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
...
export enum IdentityProviderServiceConnectErrorCodeEnum {
  Canceled = "canceled",
  Unknown = "unknown",
