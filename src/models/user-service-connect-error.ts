...
export class UserServiceConnectError {
  ...
  constructor(data?: Partial<UserServiceConnectError>) {
    ...
    if (this.code != null) {
      const codeValues = Object.values(UserServiceConnectErrorCodeEnum).filter(
        (v) =>
          typeof (UserServiceConnectErrorCodeEnum as Record<string, unknown>)[
            v as string
          ] !== "number",
      );
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceConnectError)) {
      return false;
    }
    if (
      !UserServiceConnectError.__deepEquals(
        this.code,
        (other as UserServiceConnectError).code,
      )
    ) {
      return false;
    }
    if (
      !UserServiceConnectError.__deepEquals(
        this.message,
        (other as UserServiceConnectError).message,
      )
    ) {
      return false;
    }
    if (
      !UserServiceConnectError.__deepEquals(
        this.details,
        (other as UserServiceConnectError).details,
      )
    ) {
      return false;
    }
    {
      ...
      for (const k of selfKeys) {
        ...
        if (!UserServiceConnectError.__deepEquals(selfRec[k], otherRec[k])) {
          return false;
        }
      }
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => UserServiceConnectError.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceConnectError.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !UserServiceConnectError.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceConnectError.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
...
export enum UserServiceConnectErrorCodeEnum {
  Canceled = "canceled",
  Unknown = "unknown",
