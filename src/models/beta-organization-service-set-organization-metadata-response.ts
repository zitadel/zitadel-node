...
export class BetaOrganizationServiceSetOrganizationMetadataResponse {
  /**
  ...
  constructor(
    data?: Partial<BetaOrganizationServiceSetOrganizationMetadataResponse>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !(other instanceof BetaOrganizationServiceSetOrganizationMetadataResponse)
    ) {
      return false;
    }
    if (
      !BetaOrganizationServiceSetOrganizationMetadataResponse.__deepEquals(
        this.setDate,
        (other as BetaOrganizationServiceSetOrganizationMetadataResponse)
          .setDate,
      )
    ) {
      return false;
