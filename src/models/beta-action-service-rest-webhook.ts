...
export class BetaActionServiceRESTWebhook {
  /**
  ...
  constructor(data?: Partial<BetaActionServiceRESTWebhook>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaActionServiceRESTWebhook)) {
      return false;
    }
    if (
      !BetaActionServiceRESTWebhook.__deepEquals(
        this.interruptOnError,
        (other as BetaActionServiceRESTWebhook).interruptOnError,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaActionServiceRESTWebhook.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaActionServiceRESTWebhook.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaActionServiceRESTWebhook.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaActionServiceRESTWebhook.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
