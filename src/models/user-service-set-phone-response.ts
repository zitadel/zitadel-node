...
export class UserServiceSetPhoneResponse {
  /**
  ...
  constructor(data?: Partial<UserServiceSetPhoneResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceSetPhoneResponse)) {
      return false;
    }
    if (
      !UserServiceSetPhoneResponse.__deepEquals(
        this.details,
        (other as UserServiceSetPhoneResponse).details,
      )
    ) {
      return false;
    }
    if (
      !UserServiceSetPhoneResponse.__deepEquals(
        ...
        (other as UserServiceSetPhoneResponse).verificationCode,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceSetPhoneResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceSetPhoneResponse.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceSetPhoneResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceSetPhoneResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
