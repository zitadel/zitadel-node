...
export class BetaUserServiceVerifyPhoneRequest {
  /**
  ...
  constructor(data?: Partial<BetaUserServiceVerifyPhoneRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaUserServiceVerifyPhoneRequest)) {
      return false;
    }
    if (
      !BetaUserServiceVerifyPhoneRequest.__deepEquals(
        this.userId,
        (other as BetaUserServiceVerifyPhoneRequest).userId,
      )
    ) {
      return false;
    }
    if (
      !BetaUserServiceVerifyPhoneRequest.__deepEquals(
        ...
        (other as BetaUserServiceVerifyPhoneRequest).verificationCode,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaUserServiceVerifyPhoneRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaUserServiceVerifyPhoneRequest.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaUserServiceVerifyPhoneRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaUserServiceVerifyPhoneRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
