...
export class InternalPermissionServiceUpdateAdministratorResponse {
  /**
  ...
  constructor(
    data?: Partial<InternalPermissionServiceUpdateAdministratorResponse>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !(other instanceof InternalPermissionServiceUpdateAdministratorResponse)
    ) {
      return false;
    }
    if (
      !InternalPermissionServiceUpdateAdministratorResponse.__deepEquals(
        this.changeDate,
        (other as InternalPermissionServiceUpdateAdministratorResponse)
          .changeDate,
      )
    ) {
      return false;
