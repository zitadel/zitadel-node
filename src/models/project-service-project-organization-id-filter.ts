...
import { ProjectServiceType } from "./project-service-type.js";
import { Expose } from "class-transformer";

export class ProjectServiceProjectOrganizationIDFilter {
  /**
  ...
  constructor(data?: Partial<ProjectServiceProjectOrganizationIDFilter>) {
    ...
    if (this.type != null) {
      const typeValues = Object.values(ProjectServiceType).filter(
        (v) =>
          typeof (ProjectServiceType as Record<string, unknown>)[
            v as string
          ] !== "number",
      );
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ProjectServiceProjectOrganizationIDFilter)) {
      return false;
    }
    if (
      !ProjectServiceProjectOrganizationIDFilter.__deepEquals(
        this.organizationId,
        (other as ProjectServiceProjectOrganizationIDFilter).organizationId,
      )
    ) {
      return false;
    }
    if (
      !ProjectServiceProjectOrganizationIDFilter.__deepEquals(
        this.type,
        (other as ProjectServiceProjectOrganizationIDFilter).type,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ProjectServiceProjectOrganizationIDFilter.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          ProjectServiceProjectOrganizationIDFilter.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !ProjectServiceProjectOrganizationIDFilter.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ProjectServiceProjectOrganizationIDFilter.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
