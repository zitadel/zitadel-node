...
export class UserServiceSetUserMetadataResponse {
  /**
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceSetUserMetadataResponse)) {
      return false;
    }
    if (
      !UserServiceSetUserMetadataResponse.__deepEquals(
        this.setDate,
        (other as UserServiceSetUserMetadataResponse).setDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceSetUserMetadataResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          UserServiceSetUserMetadataResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceSetUserMetadataResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceSetUserMetadataResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
