...
export class BetaInstanceServiceRemoveCustomDomainResponse {
  /**
  ...
  constructor(data?: Partial<BetaInstanceServiceRemoveCustomDomainResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaInstanceServiceRemoveCustomDomainResponse)) {
      return false;
    }
    if (
      !BetaInstanceServiceRemoveCustomDomainResponse.__deepEquals(
        this.deletionDate,
        (other as BetaInstanceServiceRemoveCustomDomainResponse).deletionDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaInstanceServiceRemoveCustomDomainResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaInstanceServiceRemoveCustomDomainResponse.__deepEquals(v, w),
        ),
      );
    }
