...
export class AuthorizationServiceActivateAuthorizationResponse {
  /**
  ...
  constructor(
    data?: Partial<AuthorizationServiceActivateAuthorizationResponse>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof AuthorizationServiceActivateAuthorizationResponse)) {
      return false;
    }
    if (
      !AuthorizationServiceActivateAuthorizationResponse.__deepEquals(
        this.changeDate,
        (other as AuthorizationServiceActivateAuthorizationResponse).changeDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        AuthorizationServiceActivateAuthorizationResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          AuthorizationServiceActivateAuthorizationResponse.__deepEquals(v, w),
        ),
      );
    }
