...
export class ApplicationServiceReactivateApplicationResponse {
  /**
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ApplicationServiceReactivateApplicationResponse)) {
      return false;
    }
    if (
      !ApplicationServiceReactivateApplicationResponse.__deepEquals(
        this.reactivationDate,
        (other as ApplicationServiceReactivateApplicationResponse)
          .reactivationDate,
      )
    ) {
      return false;
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ApplicationServiceReactivateApplicationResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          ApplicationServiceReactivateApplicationResponse.__deepEquals(v, w),
        ),
      );
    }
