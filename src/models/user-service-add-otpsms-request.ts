...
export class UserServiceAddOTPSMSRequest {
  /**
  ...
  constructor(data?: Partial<UserServiceAddOTPSMSRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceAddOTPSMSRequest)) {
      return false;
    }
    if (
      !UserServiceAddOTPSMSRequest.__deepEquals(
        this.userId,
        (other as UserServiceAddOTPSMSRequest).userId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceAddOTPSMSRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceAddOTPSMSRequest.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceAddOTPSMSRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceAddOTPSMSRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
