...
export class BetaFeatureServiceDetails {
  /**
  ...
  constructor(data?: Partial<BetaFeatureServiceDetails>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaFeatureServiceDetails)) {
      return false;
    }
    if (
      !BetaFeatureServiceDetails.__deepEquals(
        this.sequence,
        (other as BetaFeatureServiceDetails).sequence,
      )
    ) {
      return false;
    }
    if (
      !BetaFeatureServiceDetails.__deepEquals(
        this.changeDate,
        (other as BetaFeatureServiceDetails).changeDate,
      )
    ) {
      return false;
    }
    if (
      !BetaFeatureServiceDetails.__deepEquals(
        this.resourceOwner,
        (other as BetaFeatureServiceDetails).resourceOwner,
      )
    ) {
      return false;
    }
    if (
      !BetaFeatureServiceDetails.__deepEquals(
        this.creationDate,
        (other as BetaFeatureServiceDetails).creationDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => BetaFeatureServiceDetails.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaFeatureServiceDetails.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !BetaFeatureServiceDetails.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaFeatureServiceDetails.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
