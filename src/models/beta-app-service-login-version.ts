...
import { BetaAppServiceLoginV2 } from "./beta-app-service-login-v2.js";
import { Expose, Type } from "class-transformer";

export class BetaAppServiceLoginVersion {
  /**
  ...
  constructor(data?: Partial<BetaAppServiceLoginVersion>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaAppServiceLoginVersion)) {
      return false;
    }
    if (
      !BetaAppServiceLoginVersion.__deepEquals(
        this.loginV1,
        (other as BetaAppServiceLoginVersion).loginV1,
      )
    ) {
      return false;
    }
    if (
      !BetaAppServiceLoginVersion.__deepEquals(
        this.loginV2,
        (other as BetaAppServiceLoginVersion).loginV2,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaAppServiceLoginVersion.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaAppServiceLoginVersion.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaAppServiceLoginVersion.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaAppServiceLoginVersion.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
