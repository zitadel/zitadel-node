...
import { SessionServiceListDetails } from "./session-service-list-details.js";
import { SessionServiceSession } from "./session-service-session.js";
import { Expose, Type } from "class-transformer";

export class SessionServiceListSessionsResponse {
  /**
  ...
  constructor(data?: Partial<SessionServiceListSessionsResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof SessionServiceListSessionsResponse)) {
      return false;
    }
    if (
      !SessionServiceListSessionsResponse.__deepEquals(
        this.details,
        (other as SessionServiceListSessionsResponse).details,
      )
    ) {
      return false;
    }
    if (
      !SessionServiceListSessionsResponse.__deepEquals(
        this.sessions,
        (other as SessionServiceListSessionsResponse).sessions,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        SessionServiceListSessionsResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          SessionServiceListSessionsResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !SessionServiceListSessionsResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          SessionServiceListSessionsResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
