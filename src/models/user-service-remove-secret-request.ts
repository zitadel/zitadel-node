...
export class UserServiceRemoveSecretRequest {
  /**
  ...
  constructor(data?: Partial<UserServiceRemoveSecretRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceRemoveSecretRequest)) {
      return false;
    }
    if (
      !UserServiceRemoveSecretRequest.__deepEquals(
        this.userId,
        (other as UserServiceRemoveSecretRequest).userId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceRemoveSecretRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceRemoveSecretRequest.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceRemoveSecretRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceRemoveSecretRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
