...
export class ProjectServiceDeleteProjectGrantResponse {
  /**
  ...
  constructor(data?: Partial<ProjectServiceDeleteProjectGrantResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ProjectServiceDeleteProjectGrantResponse)) {
      return false;
    }
    if (
      !ProjectServiceDeleteProjectGrantResponse.__deepEquals(
        this.deletionDate,
        (other as ProjectServiceDeleteProjectGrantResponse).deletionDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ProjectServiceDeleteProjectGrantResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          ProjectServiceDeleteProjectGrantResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !ProjectServiceDeleteProjectGrantResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ProjectServiceDeleteProjectGrantResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
