...
import { InstanceServiceAny } from "./instance-service-any.js";
import { Expose, Type } from "class-transformer";

/**
 * Error type returned by Connect: https://connectrpc.com/docs/go/errors/#http-representation
 */
export class InstanceServiceConnectError {
  /**
  ...
  constructor(data?: Partial<InstanceServiceConnectError>) {
    ...
    if (this.code != null) {
      const codeValues = Object.values(
        InstanceServiceConnectErrorCodeEnum,
      ).filter(
        (v) =>
          typeof (
            InstanceServiceConnectErrorCodeEnum as Record<string, unknown>
          )[v as string] !== "number",
      );
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof InstanceServiceConnectError)) {
      return false;
    }
    if (
      !InstanceServiceConnectError.__deepEquals(
        this.code,
        (other as InstanceServiceConnectError).code,
      )
    ) {
      return false;
    }
    if (
      !InstanceServiceConnectError.__deepEquals(
        this.message,
        (other as InstanceServiceConnectError).message,
      )
    ) {
      return false;
    }
    if (
      !InstanceServiceConnectError.__deepEquals(
        this.details,
        (other as InstanceServiceConnectError).details,
      )
    ) {
      return false;
    }
    {
      ...
      for (const k of selfKeys) {
        ...
        if (
          !InstanceServiceConnectError.__deepEquals(selfRec[k], otherRec[k])
        ) {
          return false;
        }
      }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        InstanceServiceConnectError.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => InstanceServiceConnectError.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !InstanceServiceConnectError.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          InstanceServiceConnectError.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
...
export enum InstanceServiceConnectErrorCodeEnum {
  Canceled = "canceled",
  Unknown = "unknown",
