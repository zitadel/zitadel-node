...
export class ApplicationServiceUpdateSAMLApplicationConfigurationRequest {
  /**
  ...
  constructor(
    data?: Partial<ApplicationServiceUpdateSAMLApplicationConfigurationRequest>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !ApplicationServiceUpdateSAMLApplicationConfigurationRequest.__deepEquals(
        this.loginVersion,
        (other as ApplicationServiceUpdateSAMLApplicationConfigurationRequest)
          .loginVersion,
      )
    ) {
      return false;
