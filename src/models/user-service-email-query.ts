 ...
 */
export class UserServiceEmailQuery {
  /**
  ...
  constructor(data?: Partial<UserServiceEmailQuery>) {
    Object.assign(this, data);
    if (this.emailAddress != null && typeof this.emailAddress !== "string") {
      throw new TypeError(
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceEmailQuery)) {
      return false;
    }
    if (
      !UserServiceEmailQuery.__deepEquals(
        this.emailAddress,
        (other as UserServiceEmailQuery).emailAddress,
      )
    ) {
      return false;
    }
    if (
      !UserServiceEmailQuery.__deepEquals(
        this.method,
        (other as UserServiceEmailQuery).method,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => UserServiceEmailQuery.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceEmailQuery.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !UserServiceEmailQuery.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceEmailQuery.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
