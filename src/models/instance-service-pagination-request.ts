...
export class InstanceServicePaginationRequest {
  /**
  ...
  constructor(data?: Partial<InstanceServicePaginationRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof InstanceServicePaginationRequest)) {
      return false;
    }
    if (
      !InstanceServicePaginationRequest.__deepEquals(
        this.offset,
        (other as InstanceServicePaginationRequest).offset,
      )
    ) {
      return false;
    }
    if (
      !InstanceServicePaginationRequest.__deepEquals(
        this.limit,
        (other as InstanceServicePaginationRequest).limit,
      )
    ) {
      return false;
    }
    if (
      !InstanceServicePaginationRequest.__deepEquals(
        this.asc,
        (other as InstanceServicePaginationRequest).asc,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        InstanceServicePaginationRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => InstanceServicePaginationRequest.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !InstanceServicePaginationRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          InstanceServicePaginationRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
