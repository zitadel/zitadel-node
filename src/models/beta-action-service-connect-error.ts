...
import { BetaActionServiceAny } from "./beta-action-service-any.js";
import { Expose, Type } from "class-transformer";

/**
 * Error type returned by Connect: https://connectrpc.com/docs/go/errors/#http-representation
 */
export class BetaActionServiceConnectError {
  /**
  ...
  constructor(data?: Partial<BetaActionServiceConnectError>) {
    ...
    if (this.code != null) {
      const codeValues = Object.values(
        BetaActionServiceConnectErrorCodeEnum,
      ).filter(
        (v) =>
          typeof (
            BetaActionServiceConnectErrorCodeEnum as Record<string, unknown>
          )[v as string] !== "number",
      );
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaActionServiceConnectError)) {
      return false;
    }
    if (
      !BetaActionServiceConnectError.__deepEquals(
        this.code,
        (other as BetaActionServiceConnectError).code,
      )
    ) {
      return false;
    }
    if (
      !BetaActionServiceConnectError.__deepEquals(
        this.message,
        (other as BetaActionServiceConnectError).message,
      )
    ) {
      return false;
    }
    if (
      !BetaActionServiceConnectError.__deepEquals(
        this.details,
        (other as BetaActionServiceConnectError).details,
      )
    ) {
      return false;
    }
    {
      ...
      for (const k of selfKeys) {
        ...
        if (
          !BetaActionServiceConnectError.__deepEquals(selfRec[k], otherRec[k])
        ) {
          return false;
        }
      }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaActionServiceConnectError.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaActionServiceConnectError.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaActionServiceConnectError.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaActionServiceConnectError.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
...
export enum BetaActionServiceConnectErrorCodeEnum {
  Canceled = "canceled",
  Unknown = "unknown",
