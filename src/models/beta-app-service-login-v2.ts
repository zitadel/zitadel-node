...
export class BetaAppServiceLoginV2 {
  /**
  ...
  constructor(data?: Partial<BetaAppServiceLoginV2>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaAppServiceLoginV2)) {
      return false;
    }
    if (
      !BetaAppServiceLoginV2.__deepEquals(
        this.baseUri,
        (other as BetaAppServiceLoginV2).baseUri,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => BetaAppServiceLoginV2.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaAppServiceLoginV2.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !BetaAppServiceLoginV2.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaAppServiceLoginV2.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
