...
export class UserServiceMachine {
  /**
  ...
  constructor(data?: Partial<UserServiceMachine>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceMachine)) {
      return false;
    }
    if (
      !UserServiceMachine.__deepEquals(
        this.name,
        (other as UserServiceMachine).name,
      )
    ) {
      return false;
    }
    if (
      !UserServiceMachine.__deepEquals(
        this.description,
        (other as UserServiceMachine).description,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => UserServiceMachine.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceMachine.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !UserServiceMachine.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceMachine.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
