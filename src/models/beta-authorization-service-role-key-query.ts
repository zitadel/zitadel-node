...
export class BetaAuthorizationServiceRoleKeyQuery {
  /**
  ...
  constructor(data?: Partial<BetaAuthorizationServiceRoleKeyQuery>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaAuthorizationServiceRoleKeyQuery)) {
      return false;
    }
    if (
      !BetaAuthorizationServiceRoleKeyQuery.__deepEquals(
        this.key,
        (other as BetaAuthorizationServiceRoleKeyQuery).key,
      )
    ) {
      return false;
    }
    if (
      !BetaAuthorizationServiceRoleKeyQuery.__deepEquals(
        this.method,
        (other as BetaAuthorizationServiceRoleKeyQuery).method,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaAuthorizationServiceRoleKeyQuery.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaAuthorizationServiceRoleKeyQuery.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaAuthorizationServiceRoleKeyQuery.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaAuthorizationServiceRoleKeyQuery.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
