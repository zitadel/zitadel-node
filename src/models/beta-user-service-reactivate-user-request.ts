...
export class BetaUserServiceReactivateUserRequest {
  /**
  ...
  constructor(data?: Partial<BetaUserServiceReactivateUserRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaUserServiceReactivateUserRequest)) {
      return false;
    }
    if (
      !BetaUserServiceReactivateUserRequest.__deepEquals(
        this.userId,
        (other as BetaUserServiceReactivateUserRequest).userId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaUserServiceReactivateUserRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaUserServiceReactivateUserRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaUserServiceReactivateUserRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaUserServiceReactivateUserRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
