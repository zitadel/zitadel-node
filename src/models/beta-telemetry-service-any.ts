 ...
 */
export class BetaTelemetryServiceAny {
  /**
  ...
  constructor(data?: Partial<BetaTelemetryServiceAny>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaTelemetryServiceAny)) {
      return false;
    }
    if (
      !BetaTelemetryServiceAny.__deepEquals(
        this.type,
        (other as BetaTelemetryServiceAny).type,
      )
    ) {
      return false;
    }
    if (
      !BetaTelemetryServiceAny.__deepEquals(
        this.value,
        (other as BetaTelemetryServiceAny).value,
      )
    ) {
      return false;
    }
    if (
      !BetaTelemetryServiceAny.__deepEquals(
        this.debug,
        (other as BetaTelemetryServiceAny).debug,
      )
    ) {
      return false;
    }
    {
      ...
      for (const k of selfKeys) {
        ...
        if (!BetaTelemetryServiceAny.__deepEquals(selfRec[k], otherRec[k])) {
          return false;
        }
      }
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => BetaTelemetryServiceAny.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaTelemetryServiceAny.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !BetaTelemetryServiceAny.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaTelemetryServiceAny.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
