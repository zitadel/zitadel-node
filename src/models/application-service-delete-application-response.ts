...
export class ApplicationServiceDeleteApplicationResponse {
  /**
  ...
  constructor(data?: Partial<ApplicationServiceDeleteApplicationResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ApplicationServiceDeleteApplicationResponse)) {
      return false;
    }
    if (
      !ApplicationServiceDeleteApplicationResponse.__deepEquals(
        this.deletionDate,
        (other as ApplicationServiceDeleteApplicationResponse).deletionDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ApplicationServiceDeleteApplicationResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          ApplicationServiceDeleteApplicationResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !ApplicationServiceDeleteApplicationResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
