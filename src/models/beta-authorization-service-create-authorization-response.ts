...
export class BetaAuthorizationServiceCreateAuthorizationResponse {
  /**
  ...
  constructor(
    data?: Partial<BetaAuthorizationServiceCreateAuthorizationResponse>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !(other instanceof BetaAuthorizationServiceCreateAuthorizationResponse)
    ) {
      return false;
    }
    if (
      !BetaAuthorizationServiceCreateAuthorizationResponse.__deepEquals(
        this.id,
        (other as BetaAuthorizationServiceCreateAuthorizationResponse).id,
      )
    ) {
      return false;
    }
    if (
      !BetaAuthorizationServiceCreateAuthorizationResponse.__deepEquals(
        this.creationDate,
        (other as BetaAuthorizationServiceCreateAuthorizationResponse)
          .creationDate,
      )
    ) {
      return false;
