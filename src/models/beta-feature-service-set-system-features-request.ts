...
export class BetaFeatureServiceSetSystemFeaturesRequest {
  ...
  constructor(data?: Partial<BetaFeatureServiceSetSystemFeaturesRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaFeatureServiceSetSystemFeaturesRequest)) {
      return false;
    }
    if (
      !BetaFeatureServiceSetSystemFeaturesRequest.__deepEquals(
        this.loginDefaultOrg,
        (other as BetaFeatureServiceSetSystemFeaturesRequest).loginDefaultOrg,
      )
    ) {
      return false;
    }
    if (
      !BetaFeatureServiceSetSystemFeaturesRequest.__deepEquals(
        this.userSchema,
        (other as BetaFeatureServiceSetSystemFeaturesRequest).userSchema,
      )
    ) {
      return false;
    }
    if (
      !BetaFeatureServiceSetSystemFeaturesRequest.__deepEquals(
        ...
        (other as BetaFeatureServiceSetSystemFeaturesRequest).oidcTokenExchange,
      )
    ) {
      return false;
    }
    if (
      !BetaFeatureServiceSetSystemFeaturesRequest.__deepEquals(
        this.improvedPerformance,
        (other as BetaFeatureServiceSetSystemFeaturesRequest)
          .improvedPerformance,
      )
    ) {
      return false;
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaFeatureServiceSetSystemFeaturesRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaFeatureServiceSetSystemFeaturesRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaFeatureServiceSetSystemFeaturesRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaFeatureServiceSetSystemFeaturesRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
