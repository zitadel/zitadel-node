...
export class ActionServiceRemovePublicKeyResponse {
  /**
  ...
  constructor(data?: Partial<ActionServiceRemovePublicKeyResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ActionServiceRemovePublicKeyResponse)) {
      return false;
    }
    if (
      !ActionServiceRemovePublicKeyResponse.__deepEquals(
        this.deletionDate,
        (other as ActionServiceRemovePublicKeyResponse).deletionDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ActionServiceRemovePublicKeyResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          ActionServiceRemovePublicKeyResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !ActionServiceRemovePublicKeyResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ActionServiceRemovePublicKeyResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
