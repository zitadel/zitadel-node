 ...
 */
export class BetaOIDCServiceAny {
  /**
  ...
  constructor(data?: Partial<BetaOIDCServiceAny>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaOIDCServiceAny)) {
      return false;
    }
    if (
      !BetaOIDCServiceAny.__deepEquals(
        this.type,
        (other as BetaOIDCServiceAny).type,
      )
    ) {
      return false;
    }
    if (
      !BetaOIDCServiceAny.__deepEquals(
        this.value,
        (other as BetaOIDCServiceAny).value,
      )
    ) {
      return false;
    }
    if (
      !BetaOIDCServiceAny.__deepEquals(
        this.debug,
        (other as BetaOIDCServiceAny).debug,
      )
    ) {
      return false;
    }
    {
      ...
      for (const k of selfKeys) {
        ...
        if (!BetaOIDCServiceAny.__deepEquals(selfRec[k], otherRec[k])) {
          return false;
        }
      }
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => BetaOIDCServiceAny.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaOIDCServiceAny.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !BetaOIDCServiceAny.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaOIDCServiceAny.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
