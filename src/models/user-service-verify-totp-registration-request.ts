...
export class UserServiceVerifyTOTPRegistrationRequest {
  /**
  ...
  constructor(data?: Partial<UserServiceVerifyTOTPRegistrationRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceVerifyTOTPRegistrationRequest)) {
      return false;
    }
    if (
      !UserServiceVerifyTOTPRegistrationRequest.__deepEquals(
        this.userId,
        (other as UserServiceVerifyTOTPRegistrationRequest).userId,
      )
    ) {
      return false;
    }
    if (
      !UserServiceVerifyTOTPRegistrationRequest.__deepEquals(
        this.code,
        (other as UserServiceVerifyTOTPRegistrationRequest).code,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceVerifyTOTPRegistrationRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          UserServiceVerifyTOTPRegistrationRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceVerifyTOTPRegistrationRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceVerifyTOTPRegistrationRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
