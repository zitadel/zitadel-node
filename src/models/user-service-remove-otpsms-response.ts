...
export class UserServiceRemoveOTPSMSResponse {
  /**
  ...
  constructor(data?: Partial<UserServiceRemoveOTPSMSResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceRemoveOTPSMSResponse)) {
      return false;
    }
    if (
      !UserServiceRemoveOTPSMSResponse.__deepEquals(
        this.details,
        (other as UserServiceRemoveOTPSMSResponse).details,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceRemoveOTPSMSResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceRemoveOTPSMSResponse.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceRemoveOTPSMSResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceRemoveOTPSMSResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
