...
export class ApplicationServicePaginationRequest {
  /**
  ...
  constructor(data?: Partial<ApplicationServicePaginationRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ApplicationServicePaginationRequest)) {
      return false;
    }
    if (
      !ApplicationServicePaginationRequest.__deepEquals(
        this.offset,
        (other as ApplicationServicePaginationRequest).offset,
      )
    ) {
      return false;
    }
    if (
      !ApplicationServicePaginationRequest.__deepEquals(
        this.limit,
        (other as ApplicationServicePaginationRequest).limit,
      )
    ) {
      return false;
    }
    if (
      !ApplicationServicePaginationRequest.__deepEquals(
        this.asc,
        (other as ApplicationServicePaginationRequest).asc,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ApplicationServicePaginationRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          ApplicationServicePaginationRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !ApplicationServicePaginationRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ApplicationServicePaginationRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
