...
export class ProjectServiceRemoveProjectRoleResponse {
  /**
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ProjectServiceRemoveProjectRoleResponse)) {
      return false;
    }
    if (
      !ProjectServiceRemoveProjectRoleResponse.__deepEquals(
        this.removalDate,
        (other as ProjectServiceRemoveProjectRoleResponse).removalDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ProjectServiceRemoveProjectRoleResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          ProjectServiceRemoveProjectRoleResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !ProjectServiceRemoveProjectRoleResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ProjectServiceRemoveProjectRoleResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
