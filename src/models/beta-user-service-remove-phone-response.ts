...
export class BetaUserServiceRemovePhoneResponse {
  /**
  ...
  constructor(data?: Partial<BetaUserServiceRemovePhoneResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaUserServiceRemovePhoneResponse)) {
      return false;
    }
    if (
      !BetaUserServiceRemovePhoneResponse.__deepEquals(
        this.details,
        (other as BetaUserServiceRemovePhoneResponse).details,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaUserServiceRemovePhoneResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaUserServiceRemovePhoneResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaUserServiceRemovePhoneResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaUserServiceRemovePhoneResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
