 ...
 */
export class BetaUserServiceAny {
  /**
  ...
  constructor(data?: Partial<BetaUserServiceAny>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaUserServiceAny)) {
      return false;
    }
    if (
      !BetaUserServiceAny.__deepEquals(
        this.type,
        (other as BetaUserServiceAny).type,
      )
    ) {
      return false;
    }
    if (
      !BetaUserServiceAny.__deepEquals(
        this.value,
        (other as BetaUserServiceAny).value,
      )
    ) {
      return false;
    }
    if (
      !BetaUserServiceAny.__deepEquals(
        this.debug,
        (other as BetaUserServiceAny).debug,
      )
    ) {
      return false;
    }
    {
      ...
      for (const k of selfKeys) {
        ...
        if (!BetaUserServiceAny.__deepEquals(selfRec[k], otherRec[k])) {
          return false;
        }
      }
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => BetaUserServiceAny.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaUserServiceAny.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !BetaUserServiceAny.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaUserServiceAny.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
