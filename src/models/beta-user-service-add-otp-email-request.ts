...
export class BetaUserServiceAddOTPEmailRequest {
  /**
  ...
  constructor(data?: Partial<BetaUserServiceAddOTPEmailRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaUserServiceAddOTPEmailRequest)) {
      return false;
    }
    if (
      !BetaUserServiceAddOTPEmailRequest.__deepEquals(
        this.userId,
        (other as BetaUserServiceAddOTPEmailRequest).userId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaUserServiceAddOTPEmailRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaUserServiceAddOTPEmailRequest.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaUserServiceAddOTPEmailRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaUserServiceAddOTPEmailRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
