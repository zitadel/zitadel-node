...
export class UserServiceResendInviteCodeRequest {
  /**
  ...
  constructor(data?: Partial<UserServiceResendInviteCodeRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceResendInviteCodeRequest)) {
      return false;
    }
    if (
      !UserServiceResendInviteCodeRequest.__deepEquals(
        this.userId,
        (other as UserServiceResendInviteCodeRequest).userId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceResendInviteCodeRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          UserServiceResendInviteCodeRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceResendInviteCodeRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceResendInviteCodeRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
