...
export class BetaUserServicePasswordResetResponse {
  /**
  ...
  constructor(data?: Partial<BetaUserServicePasswordResetResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaUserServicePasswordResetResponse)) {
      return false;
    }
    if (
      !BetaUserServicePasswordResetResponse.__deepEquals(
        this.details,
        (other as BetaUserServicePasswordResetResponse).details,
      )
    ) {
      return false;
    }
    if (
      !BetaUserServicePasswordResetResponse.__deepEquals(
        ...
        (other as BetaUserServicePasswordResetResponse).verificationCode,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaUserServicePasswordResetResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaUserServicePasswordResetResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaUserServicePasswordResetResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaUserServicePasswordResetResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
