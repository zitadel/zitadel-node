...
export class SettingsServiceSecuritySettings {
  ...
  constructor(data?: Partial<SettingsServiceSecuritySettings>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof SettingsServiceSecuritySettings)) {
      return false;
    }
    if (
      !SettingsServiceSecuritySettings.__deepEquals(
        this.embeddedIframe,
        (other as SettingsServiceSecuritySettings).embeddedIframe,
      )
    ) {
      return false;
    }
    if (
      !SettingsServiceSecuritySettings.__deepEquals(
        ...
        (other as SettingsServiceSecuritySettings).enableImpersonation,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        SettingsServiceSecuritySettings.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => SettingsServiceSecuritySettings.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !SettingsServiceSecuritySettings.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          SettingsServiceSecuritySettings.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
