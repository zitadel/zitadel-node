...
export class InstanceServiceAddCustomDomainResponse {
  /**
  ...
  constructor(data?: Partial<InstanceServiceAddCustomDomainResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof InstanceServiceAddCustomDomainResponse)) {
      return false;
    }
    if (
      !InstanceServiceAddCustomDomainResponse.__deepEquals(
        this.creationDate,
        (other as InstanceServiceAddCustomDomainResponse).creationDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        InstanceServiceAddCustomDomainResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          InstanceServiceAddCustomDomainResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !InstanceServiceAddCustomDomainResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          InstanceServiceAddCustomDomainResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
