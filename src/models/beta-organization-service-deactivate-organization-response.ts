...
export class BetaOrganizationServiceDeactivateOrganizationResponse {
  /**
  ...
  constructor(
    data?: Partial<BetaOrganizationServiceDeactivateOrganizationResponse>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !(other instanceof BetaOrganizationServiceDeactivateOrganizationResponse)
    ) {
      return false;
    }
    if (
      !BetaOrganizationServiceDeactivateOrganizationResponse.__deepEquals(
        this.changeDate,
        (other as BetaOrganizationServiceDeactivateOrganizationResponse)
          .changeDate,
      )
    ) {
      return false;
