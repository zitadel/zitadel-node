...
import { BetaOrganizationServiceAddHumanUserRequest } from "./beta-organization-service-add-human-user-request.js";
import { Expose, Type } from "class-transformer";

/**
 * The Admin for the newly created Organization.
 */
export class BetaOrganizationServiceAdmin {
  /**
  ...
  constructor(data?: Partial<BetaOrganizationServiceAdmin>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaOrganizationServiceAdmin)) {
      return false;
    }
    if (
      !BetaOrganizationServiceAdmin.__deepEquals(
        this.roles,
        (other as BetaOrganizationServiceAdmin).roles,
      )
    ) {
      return false;
    }
    if (
      !BetaOrganizationServiceAdmin.__deepEquals(
        this.human,
        (other as BetaOrganizationServiceAdmin).human,
      )
    ) {
      return false;
    }
    if (
      !BetaOrganizationServiceAdmin.__deepEquals(
        this.userId,
        (other as BetaOrganizationServiceAdmin).userId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaOrganizationServiceAdmin.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaOrganizationServiceAdmin.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaOrganizationServiceAdmin.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaOrganizationServiceAdmin.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
