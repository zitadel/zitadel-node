...
export class InstanceServiceRemoveCustomDomainRequest {
  /**
  ...
  constructor(data?: Partial<InstanceServiceRemoveCustomDomainRequest>) {
    ...
    if (this.customDomain != null && typeof this.customDomain !== "string") {
      throw new TypeError(
        `customDomain must be a string, got ${typeof this.customDomain}`,
      );
    }
  }
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof InstanceServiceRemoveCustomDomainRequest)) {
      return false;
    }
    if (
      !InstanceServiceRemoveCustomDomainRequest.__deepEquals(
        this.instanceId,
        (other as InstanceServiceRemoveCustomDomainRequest).instanceId,
      )
    ) {
      return false;
    }
    if (
      !InstanceServiceRemoveCustomDomainRequest.__deepEquals(
        this.customDomain,
        (other as InstanceServiceRemoveCustomDomainRequest).customDomain,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        InstanceServiceRemoveCustomDomainRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          InstanceServiceRemoveCustomDomainRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !InstanceServiceRemoveCustomDomainRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          InstanceServiceRemoveCustomDomainRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
