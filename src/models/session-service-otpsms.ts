...
export class SessionServiceOTPSMS {
  /**
  ...
  constructor(data?: Partial<SessionServiceOTPSMS>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof SessionServiceOTPSMS)) {
      return false;
    }
    if (
      !SessionServiceOTPSMS.__deepEquals(
        this.returnCode,
        (other as SessionServiceOTPSMS).returnCode,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => SessionServiceOTPSMS.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => SessionServiceOTPSMS.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !SessionServiceOTPSMS.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          SessionServiceOTPSMS.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
