...
export class ApplicationServiceSAMLConfiguration {
  ...
  constructor(data?: Partial<ApplicationServiceSAMLConfiguration>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ApplicationServiceSAMLConfiguration)) {
      return false;
    }
    if (
      !ApplicationServiceSAMLConfiguration.__deepEquals(
        this.metadataXml,
        (other as ApplicationServiceSAMLConfiguration).metadataXml,
      )
    ) {
      return false;
    }
    if (
      !ApplicationServiceSAMLConfiguration.__deepEquals(
        this.metadataUrl,
        (other as ApplicationServiceSAMLConfiguration).metadataUrl,
      )
    ) {
      return false;
    }
    if (
      !ApplicationServiceSAMLConfiguration.__deepEquals(
        this.loginVersion,
        (other as ApplicationServiceSAMLConfiguration).loginVersion,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ApplicationServiceSAMLConfiguration.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          ApplicationServiceSAMLConfiguration.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !ApplicationServiceSAMLConfiguration.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ApplicationServiceSAMLConfiguration.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
