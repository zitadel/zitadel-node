...
export class ProjectServiceIDFilter {
  /**
  ...
  constructor(data?: Partial<ProjectServiceIDFilter>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ProjectServiceIDFilter)) {
      return false;
    }
    if (
      !ProjectServiceIDFilter.__deepEquals(
        this.id,
        (other as ProjectServiceIDFilter).id,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => ProjectServiceIDFilter.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => ProjectServiceIDFilter.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !ProjectServiceIDFilter.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ProjectServiceIDFilter.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
