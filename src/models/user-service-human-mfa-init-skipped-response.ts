...
export class UserServiceHumanMFAInitSkippedResponse {
  /**
  ...
  constructor(data?: Partial<UserServiceHumanMFAInitSkippedResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceHumanMFAInitSkippedResponse)) {
      return false;
    }
    if (
      !UserServiceHumanMFAInitSkippedResponse.__deepEquals(
        this.details,
        (other as UserServiceHumanMFAInitSkippedResponse).details,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceHumanMFAInitSkippedResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          UserServiceHumanMFAInitSkippedResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceHumanMFAInitSkippedResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceHumanMFAInitSkippedResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
