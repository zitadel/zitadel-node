...
export class BetaFeatureServiceSetUserFeatureRequest {
  /**
  ...
  constructor(data?: Partial<BetaFeatureServiceSetUserFeatureRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaFeatureServiceSetUserFeatureRequest)) {
      return false;
    }
    if (
      !BetaFeatureServiceSetUserFeatureRequest.__deepEquals(
        this.userId,
        (other as BetaFeatureServiceSetUserFeatureRequest).userId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaFeatureServiceSetUserFeatureRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaFeatureServiceSetUserFeatureRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaFeatureServiceSetUserFeatureRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaFeatureServiceSetUserFeatureRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
