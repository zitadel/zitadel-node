...
export class SettingsServiceRequestContext {
  /**
  ...
  constructor(data?: Partial<SettingsServiceRequestContext>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof SettingsServiceRequestContext)) {
      return false;
    }
    if (
      !SettingsServiceRequestContext.__deepEquals(
        this.instance,
        (other as SettingsServiceRequestContext).instance,
      )
    ) {
      return false;
    }
    if (
      !SettingsServiceRequestContext.__deepEquals(
        this.orgId,
        (other as SettingsServiceRequestContext).orgId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        SettingsServiceRequestContext.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => SettingsServiceRequestContext.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !SettingsServiceRequestContext.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          SettingsServiceRequestContext.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
