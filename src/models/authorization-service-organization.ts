...
export class AuthorizationServiceOrganization {
  /**
  ...
  constructor(data?: Partial<AuthorizationServiceOrganization>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof AuthorizationServiceOrganization)) {
      return false;
    }
    if (
      !AuthorizationServiceOrganization.__deepEquals(
        this.id,
        (other as AuthorizationServiceOrganization).id,
      )
    ) {
      return false;
    }
    if (
      !AuthorizationServiceOrganization.__deepEquals(
        this.name,
        (other as AuthorizationServiceOrganization).name,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        AuthorizationServiceOrganization.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => AuthorizationServiceOrganization.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !AuthorizationServiceOrganization.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          AuthorizationServiceOrganization.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
