 ...
 */
export class BetaAppServiceAny {
  /**
  ...
  constructor(data?: Partial<BetaAppServiceAny>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaAppServiceAny)) {
      return false;
    }
    if (
      !BetaAppServiceAny.__deepEquals(
        this.type,
        (other as BetaAppServiceAny).type,
      )
    ) {
      return false;
    }
    if (
      !BetaAppServiceAny.__deepEquals(
        this.value,
        (other as BetaAppServiceAny).value,
      )
    ) {
      return false;
    }
    if (
      !BetaAppServiceAny.__deepEquals(
        this.debug,
        (other as BetaAppServiceAny).debug,
      )
    ) {
      return false;
    }
    {
      ...
      for (const k of selfKeys) {
        ...
        if (!BetaAppServiceAny.__deepEquals(selfRec[k], otherRec[k])) {
          return false;
        }
      }
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => BetaAppServiceAny.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaAppServiceAny.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !BetaAppServiceAny.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaAppServiceAny.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
