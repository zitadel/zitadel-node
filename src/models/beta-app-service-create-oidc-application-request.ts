...
export class BetaAppServiceCreateOIDCApplicationRequest {
  /**
  ...
  constructor(data?: Partial<BetaAppServiceCreateOIDCApplicationRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaAppServiceCreateOIDCApplicationRequest)) {
      return false;
    }
    if (
      !BetaAppServiceCreateOIDCApplicationRequest.__deepEquals(
        this.redirectUris,
        (other as BetaAppServiceCreateOIDCApplicationRequest).redirectUris,
      )
    ) {
      return false;
    }
    if (
      !BetaAppServiceCreateOIDCApplicationRequest.__deepEquals(
        this.responseTypes,
        (other as BetaAppServiceCreateOIDCApplicationRequest).responseTypes,
      )
    ) {
      return false;
    }
    if (
      !BetaAppServiceCreateOIDCApplicationRequest.__deepEquals(
        this.grantTypes,
        (other as BetaAppServiceCreateOIDCApplicationRequest).grantTypes,
      )
    ) {
      return false;
    }
    if (
      !BetaAppServiceCreateOIDCApplicationRequest.__deepEquals(
        this.appType,
        (other as BetaAppServiceCreateOIDCApplicationRequest).appType,
      )
    ) {
      return false;
    }
    if (
      !BetaAppServiceCreateOIDCApplicationRequest.__deepEquals(
        this.authMethodType,
        (other as BetaAppServiceCreateOIDCApplicationRequest).authMethodType,
      )
    ) {
      return false;
    }
    if (
      !BetaAppServiceCreateOIDCApplicationRequest.__deepEquals(
        ...
        (other as BetaAppServiceCreateOIDCApplicationRequest)
    ...
    if (
      !BetaAppServiceCreateOIDCApplicationRequest.__deepEquals(
        this.version,
        (other as BetaAppServiceCreateOIDCApplicationRequest).version,
      )
    ) {
      return false;
    }
    if (
      !BetaAppServiceCreateOIDCApplicationRequest.__deepEquals(
        this.devMode,
        (other as BetaAppServiceCreateOIDCApplicationRequest).devMode,
      )
    ) {
      return false;
    }
    if (
      !BetaAppServiceCreateOIDCApplicationRequest.__deepEquals(
        this.accessTokenType,
        (other as BetaAppServiceCreateOIDCApplicationRequest).accessTokenType,
      )
    ) {
      return false;
    }
    ...
    if (
      !BetaAppServiceCreateOIDCApplicationRequest.__deepEquals(
        this.clockSkew,
        (other as BetaAppServiceCreateOIDCApplicationRequest).clockSkew,
      )
    ) {
      return false;
    }
    if (
      !BetaAppServiceCreateOIDCApplicationRequest.__deepEquals(
        ...
        (other as BetaAppServiceCreateOIDCApplicationRequest).additionalOrigins,
      )
    ) {
      return false;
    }
    ...
    if (
      !BetaAppServiceCreateOIDCApplicationRequest.__deepEquals(
        this.loginVersion,
        (other as BetaAppServiceCreateOIDCApplicationRequest).loginVersion,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaAppServiceCreateOIDCApplicationRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaAppServiceCreateOIDCApplicationRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaAppServiceCreateOIDCApplicationRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaAppServiceCreateOIDCApplicationRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
