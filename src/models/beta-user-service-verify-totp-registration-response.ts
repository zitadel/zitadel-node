...
export class BetaUserServiceVerifyTOTPRegistrationResponse {
  /**
  ...
  constructor(data?: Partial<BetaUserServiceVerifyTOTPRegistrationResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaUserServiceVerifyTOTPRegistrationResponse)) {
      return false;
    }
    if (
      !BetaUserServiceVerifyTOTPRegistrationResponse.__deepEquals(
        this.details,
        (other as BetaUserServiceVerifyTOTPRegistrationResponse).details,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaUserServiceVerifyTOTPRegistrationResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaUserServiceVerifyTOTPRegistrationResponse.__deepEquals(v, w),
        ),
      );
    }
