...
export class UserServiceSetMetadataEntry {
  /**
  ...
  constructor(data?: Partial<UserServiceSetMetadataEntry>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceSetMetadataEntry)) {
      return false;
    }
    if (
      !UserServiceSetMetadataEntry.__deepEquals(
        this.key,
        (other as UserServiceSetMetadataEntry).key,
      )
    ) {
      return false;
    }
    if (
      !UserServiceSetMetadataEntry.__deepEquals(
        this.value,
        (other as UserServiceSetMetadataEntry).value,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceSetMetadataEntry.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceSetMetadataEntry.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceSetMetadataEntry.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceSetMetadataEntry.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
