...
import { BetaSessionServiceOTPEmail } from "./beta-session-service-otp-email.js";
...
export class BetaSessionServiceRequestChallenges {
  ...
  constructor(data?: Partial<BetaSessionServiceRequestChallenges>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaSessionServiceRequestChallenges)) {
      return false;
    }
    if (
      !BetaSessionServiceRequestChallenges.__deepEquals(
        this.webAuthN,
        (other as BetaSessionServiceRequestChallenges).webAuthN,
      )
    ) {
      return false;
    }
    if (
      !BetaSessionServiceRequestChallenges.__deepEquals(
        this.otpSms,
        (other as BetaSessionServiceRequestChallenges).otpSms,
      )
    ) {
      return false;
    }
    if (
      !BetaSessionServiceRequestChallenges.__deepEquals(
        this.otpEmail,
        (other as BetaSessionServiceRequestChallenges).otpEmail,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaSessionServiceRequestChallenges.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaSessionServiceRequestChallenges.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaSessionServiceRequestChallenges.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaSessionServiceRequestChallenges.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
