...
export class BetaInstanceServiceAddTrustedDomainRequest {
  /**
  ...
  constructor(data?: Partial<BetaInstanceServiceAddTrustedDomainRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaInstanceServiceAddTrustedDomainRequest)) {
      return false;
    }
    if (
      !BetaInstanceServiceAddTrustedDomainRequest.__deepEquals(
        this.instanceId,
        (other as BetaInstanceServiceAddTrustedDomainRequest).instanceId,
      )
    ) {
      return false;
    }
    if (
      !BetaInstanceServiceAddTrustedDomainRequest.__deepEquals(
        this.domain,
        (other as BetaInstanceServiceAddTrustedDomainRequest).domain,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaInstanceServiceAddTrustedDomainRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaInstanceServiceAddTrustedDomainRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaInstanceServiceAddTrustedDomainRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaInstanceServiceAddTrustedDomainRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
