...
export class BetaAuthorizationServiceActivateAuthorizationRequest {
  /**
  ...
  constructor(
    data?: Partial<BetaAuthorizationServiceActivateAuthorizationRequest>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !(other instanceof BetaAuthorizationServiceActivateAuthorizationRequest)
    ) {
      return false;
    }
    if (
      !BetaAuthorizationServiceActivateAuthorizationRequest.__deepEquals(
        this.id,
        (other as BetaAuthorizationServiceActivateAuthorizationRequest).id,
      )
    ) {
      return false;
    }
