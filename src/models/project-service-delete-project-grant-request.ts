...
export class ProjectServiceDeleteProjectGrantRequest {
  /**
  ...
  constructor(data?: Partial<ProjectServiceDeleteProjectGrantRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ProjectServiceDeleteProjectGrantRequest)) {
      return false;
    }
    if (
      !ProjectServiceDeleteProjectGrantRequest.__deepEquals(
        this.projectId,
        (other as ProjectServiceDeleteProjectGrantRequest).projectId,
      )
    ) {
      return false;
    }
    if (
      !ProjectServiceDeleteProjectGrantRequest.__deepEquals(
        ...
        (other as ProjectServiceDeleteProjectGrantRequest)
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ProjectServiceDeleteProjectGrantRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          ProjectServiceDeleteProjectGrantRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !ProjectServiceDeleteProjectGrantRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ProjectServiceDeleteProjectGrantRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
