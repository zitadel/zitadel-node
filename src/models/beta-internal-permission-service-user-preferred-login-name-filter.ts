...
export class BetaInternalPermissionServiceUserPreferredLoginNameFilter {
  /**
  ...
  constructor(
    data?: Partial<BetaInternalPermissionServiceUserPreferredLoginNameFilter>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !BetaInternalPermissionServiceUserPreferredLoginNameFilter.__deepEquals(
        this.preferredLoginName,
        (other as BetaInternalPermissionServiceUserPreferredLoginNameFilter)
          .preferredLoginName,
      )
    ) {
      return false;
