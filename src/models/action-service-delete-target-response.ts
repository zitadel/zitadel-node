...
export class ActionServiceDeleteTargetResponse {
  /**
  ...
  constructor(data?: Partial<ActionServiceDeleteTargetResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ActionServiceDeleteTargetResponse)) {
      return false;
    }
    if (
      !ActionServiceDeleteTargetResponse.__deepEquals(
        this.deletionDate,
        (other as ActionServiceDeleteTargetResponse).deletionDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ActionServiceDeleteTargetResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => ActionServiceDeleteTargetResponse.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !ActionServiceDeleteTargetResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ActionServiceDeleteTargetResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
