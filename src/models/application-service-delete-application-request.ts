...
export class ApplicationServiceDeleteApplicationRequest {
  /**
  ...
  constructor(data?: Partial<ApplicationServiceDeleteApplicationRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ApplicationServiceDeleteApplicationRequest)) {
      return false;
    }
    if (
      !ApplicationServiceDeleteApplicationRequest.__deepEquals(
        this.applicationId,
        (other as ApplicationServiceDeleteApplicationRequest).applicationId,
      )
    ) {
      return false;
    }
    if (
      !ApplicationServiceDeleteApplicationRequest.__deepEquals(
        this.projectId,
        (other as ApplicationServiceDeleteApplicationRequest).projectId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ApplicationServiceDeleteApplicationRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          ApplicationServiceDeleteApplicationRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !ApplicationServiceDeleteApplicationRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ApplicationServiceDeleteApplicationRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
