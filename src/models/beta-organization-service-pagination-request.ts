...
export class BetaOrganizationServicePaginationRequest {
  /**
  ...
  constructor(data?: Partial<BetaOrganizationServicePaginationRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaOrganizationServicePaginationRequest)) {
      return false;
    }
    if (
      !BetaOrganizationServicePaginationRequest.__deepEquals(
        this.offset,
        (other as BetaOrganizationServicePaginationRequest).offset,
      )
    ) {
      return false;
    }
    if (
      !BetaOrganizationServicePaginationRequest.__deepEquals(
        this.limit,
        (other as BetaOrganizationServicePaginationRequest).limit,
      )
    ) {
      return false;
    }
    if (
      !BetaOrganizationServicePaginationRequest.__deepEquals(
        this.asc,
        (other as BetaOrganizationServicePaginationRequest).asc,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaOrganizationServicePaginationRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaOrganizationServicePaginationRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaOrganizationServicePaginationRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaOrganizationServicePaginationRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
