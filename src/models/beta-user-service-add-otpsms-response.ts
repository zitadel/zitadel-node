...
export class BetaUserServiceAddOTPSMSResponse {
  /**
  ...
  constructor(data?: Partial<BetaUserServiceAddOTPSMSResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaUserServiceAddOTPSMSResponse)) {
      return false;
    }
    if (
      !BetaUserServiceAddOTPSMSResponse.__deepEquals(
        this.details,
        (other as BetaUserServiceAddOTPSMSResponse).details,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaUserServiceAddOTPSMSResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaUserServiceAddOTPSMSResponse.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaUserServiceAddOTPSMSResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaUserServiceAddOTPSMSResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
