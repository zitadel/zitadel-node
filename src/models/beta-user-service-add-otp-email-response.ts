...
export class BetaUserServiceAddOTPEmailResponse {
  /**
  ...
  constructor(data?: Partial<BetaUserServiceAddOTPEmailResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaUserServiceAddOTPEmailResponse)) {
      return false;
    }
    if (
      !BetaUserServiceAddOTPEmailResponse.__deepEquals(
        this.details,
        (other as BetaUserServiceAddOTPEmailResponse).details,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaUserServiceAddOTPEmailResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaUserServiceAddOTPEmailResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaUserServiceAddOTPEmailResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaUserServiceAddOTPEmailResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
