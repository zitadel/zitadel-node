...
export class UserServiceListPasskeysRequest {
  /**
  ...
  constructor(data?: Partial<UserServiceListPasskeysRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceListPasskeysRequest)) {
      return false;
    }
    if (
      !UserServiceListPasskeysRequest.__deepEquals(
        this.userId,
        (other as UserServiceListPasskeysRequest).userId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceListPasskeysRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceListPasskeysRequest.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceListPasskeysRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceListPasskeysRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
