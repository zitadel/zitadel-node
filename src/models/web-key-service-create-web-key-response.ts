...
export class WebKeyServiceCreateWebKeyResponse {
  /**
  ...
  constructor(data?: Partial<WebKeyServiceCreateWebKeyResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof WebKeyServiceCreateWebKeyResponse)) {
      return false;
    }
    if (
      !WebKeyServiceCreateWebKeyResponse.__deepEquals(
        this.id,
        (other as WebKeyServiceCreateWebKeyResponse).id,
      )
    ) {
      return false;
    }
    if (
      !WebKeyServiceCreateWebKeyResponse.__deepEquals(
        this.creationDate,
        (other as WebKeyServiceCreateWebKeyResponse).creationDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        WebKeyServiceCreateWebKeyResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => WebKeyServiceCreateWebKeyResponse.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !WebKeyServiceCreateWebKeyResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          WebKeyServiceCreateWebKeyResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
