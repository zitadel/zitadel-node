...
export class BetaAppServiceUpdateAPIApplicationConfigurationRequest {
  /**
  ...
  constructor(
    data?: Partial<BetaAppServiceUpdateAPIApplicationConfigurationRequest>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !(other instanceof BetaAppServiceUpdateAPIApplicationConfigurationRequest)
    ) {
      return false;
    }
    if (
      !BetaAppServiceUpdateAPIApplicationConfigurationRequest.__deepEquals(
        this.authMethodType,
        (other as BetaAppServiceUpdateAPIApplicationConfigurationRequest)
          .authMethodType,
      )
    ) {
      return false;
