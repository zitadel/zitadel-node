 ...
 */
export class BetaSettingsServiceAny {
  /**
  ...
  constructor(data?: Partial<BetaSettingsServiceAny>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaSettingsServiceAny)) {
      return false;
    }
    if (
      !BetaSettingsServiceAny.__deepEquals(
        this.type,
        (other as BetaSettingsServiceAny).type,
      )
    ) {
      return false;
    }
    if (
      !BetaSettingsServiceAny.__deepEquals(
        this.value,
        (other as BetaSettingsServiceAny).value,
      )
    ) {
      return false;
    }
    if (
      !BetaSettingsServiceAny.__deepEquals(
        this.debug,
        (other as BetaSettingsServiceAny).debug,
      )
    ) {
      return false;
    }
    {
      ...
      for (const k of selfKeys) {
        ...
        if (!BetaSettingsServiceAny.__deepEquals(selfRec[k], otherRec[k])) {
          return false;
        }
      }
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => BetaSettingsServiceAny.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaSettingsServiceAny.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !BetaSettingsServiceAny.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaSettingsServiceAny.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
