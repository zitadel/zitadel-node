...
export class ActionServiceAddPublicKeyRequest {
  /**
  ...
  constructor(data?: Partial<ActionServiceAddPublicKeyRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ActionServiceAddPublicKeyRequest)) {
      return false;
    }
    if (
      !ActionServiceAddPublicKeyRequest.__deepEquals(
        this.targetId,
        (other as ActionServiceAddPublicKeyRequest).targetId,
      )
    ) {
      return false;
    }
    if (
      !ActionServiceAddPublicKeyRequest.__deepEquals(
        this.publicKey,
        (other as ActionServiceAddPublicKeyRequest).publicKey,
      )
    ) {
      return false;
    }
    if (
      !ActionServiceAddPublicKeyRequest.__deepEquals(
        this.expirationDate,
        (other as ActionServiceAddPublicKeyRequest).expirationDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ActionServiceAddPublicKeyRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => ActionServiceAddPublicKeyRequest.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !ActionServiceAddPublicKeyRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ActionServiceAddPublicKeyRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
