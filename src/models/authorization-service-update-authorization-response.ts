...
export class AuthorizationServiceUpdateAuthorizationResponse {
  /**
  ...
  constructor(data?: Partial<AuthorizationServiceUpdateAuthorizationResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof AuthorizationServiceUpdateAuthorizationResponse)) {
      return false;
    }
    if (
      !AuthorizationServiceUpdateAuthorizationResponse.__deepEquals(
        this.changeDate,
        (other as AuthorizationServiceUpdateAuthorizationResponse).changeDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        AuthorizationServiceUpdateAuthorizationResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          AuthorizationServiceUpdateAuthorizationResponse.__deepEquals(v, w),
        ),
      );
    }
