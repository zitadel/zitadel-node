...
export class BetaInternalPermissionServiceCreateAdministratorResponse {
  /**
  ...
  constructor(
    data?: Partial<BetaInternalPermissionServiceCreateAdministratorResponse>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !BetaInternalPermissionServiceCreateAdministratorResponse.__deepEquals(
        this.creationDate,
        (other as BetaInternalPermissionServiceCreateAdministratorResponse)
          .creationDate,
      )
    ) {
      return false;
