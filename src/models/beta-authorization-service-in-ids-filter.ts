...
export class BetaAuthorizationServiceInIDsFilter {
  /**
  ...
  constructor(data?: Partial<BetaAuthorizationServiceInIDsFilter>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaAuthorizationServiceInIDsFilter)) {
      return false;
    }
    if (
      !BetaAuthorizationServiceInIDsFilter.__deepEquals(
        this.ids,
        (other as BetaAuthorizationServiceInIDsFilter).ids,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaAuthorizationServiceInIDsFilter.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaAuthorizationServiceInIDsFilter.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaAuthorizationServiceInIDsFilter.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaAuthorizationServiceInIDsFilter.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
