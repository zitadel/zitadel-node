...
export class ApplicationServiceGetApplicationRequest {
  /**
  ...
  constructor(data?: Partial<ApplicationServiceGetApplicationRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ApplicationServiceGetApplicationRequest)) {
      return false;
    }
    if (
      !ApplicationServiceGetApplicationRequest.__deepEquals(
        this.applicationId,
        (other as ApplicationServiceGetApplicationRequest).applicationId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ApplicationServiceGetApplicationRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          ApplicationServiceGetApplicationRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !ApplicationServiceGetApplicationRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ApplicationServiceGetApplicationRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
