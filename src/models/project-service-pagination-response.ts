...
export class ProjectServicePaginationResponse {
  /**
  ...
  constructor(data?: Partial<ProjectServicePaginationResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ProjectServicePaginationResponse)) {
      return false;
    }
    if (
      !ProjectServicePaginationResponse.__deepEquals(
        this.totalResult,
        (other as ProjectServicePaginationResponse).totalResult,
      )
    ) {
      return false;
    }
    if (
      !ProjectServicePaginationResponse.__deepEquals(
        this.appliedLimit,
        (other as ProjectServicePaginationResponse).appliedLimit,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ProjectServicePaginationResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => ProjectServicePaginationResponse.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !ProjectServicePaginationResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ProjectServicePaginationResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
