 ...
 */
export class BetaAuthorizationServiceAny {
  /**
  ...
  constructor(data?: Partial<BetaAuthorizationServiceAny>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaAuthorizationServiceAny)) {
      return false;
    }
    if (
      !BetaAuthorizationServiceAny.__deepEquals(
        this.type,
        (other as BetaAuthorizationServiceAny).type,
      )
    ) {
      return false;
    }
    if (
      !BetaAuthorizationServiceAny.__deepEquals(
        this.value,
        (other as BetaAuthorizationServiceAny).value,
      )
    ) {
      return false;
    }
    if (
      !BetaAuthorizationServiceAny.__deepEquals(
        this.debug,
        (other as BetaAuthorizationServiceAny).debug,
      )
    ) {
      return false;
    }
    {
      ...
      for (const k of selfKeys) {
        ...
        if (
          !BetaAuthorizationServiceAny.__deepEquals(selfRec[k], otherRec[k])
        ) {
          return false;
        }
      }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaAuthorizationServiceAny.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaAuthorizationServiceAny.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaAuthorizationServiceAny.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaAuthorizationServiceAny.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
