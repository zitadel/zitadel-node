...
export class ApplicationServiceReactivateApplicationRequest {
  /**
  ...
  constructor(data?: Partial<ApplicationServiceReactivateApplicationRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ApplicationServiceReactivateApplicationRequest)) {
      return false;
    }
    if (
      !ApplicationServiceReactivateApplicationRequest.__deepEquals(
        this.applicationId,
        (other as ApplicationServiceReactivateApplicationRequest).applicationId,
      )
    ) {
      return false;
    }
    if (
      !ApplicationServiceReactivateApplicationRequest.__deepEquals(
        this.projectId,
        (other as ApplicationServiceReactivateApplicationRequest).projectId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ApplicationServiceReactivateApplicationRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          ApplicationServiceReactivateApplicationRequest.__deepEquals(v, w),
        ),
      );
    }
