...
export class OrganizationServiceSetOrganizationMetadataResponse {
  /**
  ...
  constructor(
    data?: Partial<OrganizationServiceSetOrganizationMetadataResponse>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !(other instanceof OrganizationServiceSetOrganizationMetadataResponse)
    ) {
      return false;
    }
    if (
      !OrganizationServiceSetOrganizationMetadataResponse.__deepEquals(
        this.setDate,
        (other as OrganizationServiceSetOrganizationMetadataResponse).setDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          OrganizationServiceSetOrganizationMetadataResponse.__deepEquals(v, w),
        ),
      );
    }
