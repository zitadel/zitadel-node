...
export class BetaFeatureServiceGetInstanceFeaturesRequest {
  /**
  ...
  constructor(data?: Partial<BetaFeatureServiceGetInstanceFeaturesRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaFeatureServiceGetInstanceFeaturesRequest)) {
      return false;
    }
    if (
      !BetaFeatureServiceGetInstanceFeaturesRequest.__deepEquals(
        this.inheritance,
        (other as BetaFeatureServiceGetInstanceFeaturesRequest).inheritance,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaFeatureServiceGetInstanceFeaturesRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaFeatureServiceGetInstanceFeaturesRequest.__deepEquals(v, w),
        ),
      );
    }
