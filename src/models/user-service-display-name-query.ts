 ...
 */
export class UserServiceDisplayNameQuery {
  /**
  ...
  constructor(data?: Partial<UserServiceDisplayNameQuery>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceDisplayNameQuery)) {
      return false;
    }
    if (
      !UserServiceDisplayNameQuery.__deepEquals(
        this.displayName,
        (other as UserServiceDisplayNameQuery).displayName,
      )
    ) {
      return false;
    }
    if (
      !UserServiceDisplayNameQuery.__deepEquals(
        this.method,
        (other as UserServiceDisplayNameQuery).method,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceDisplayNameQuery.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceDisplayNameQuery.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceDisplayNameQuery.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceDisplayNameQuery.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
