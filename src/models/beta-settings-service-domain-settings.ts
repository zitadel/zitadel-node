...
export class BetaSettingsServiceDomainSettings {
  /**
  ...
  constructor(data?: Partial<BetaSettingsServiceDomainSettings>) {
    Object.assign(this, data);
    if (
      this.loginNameIncludesDomain != null &&
      typeof this.loginNameIncludesDomain !== "boolean"
    ) {
      throw new TypeError(
        `loginNameIncludesDomain must be a boolean, got ${typeof this.loginNameIncludesDomain}`,
      );
    }
    if (
      this.requireOrgDomainVerification != null &&
      typeof this.requireOrgDomainVerification !== "boolean"
    ) {
      throw new TypeError(
        `requireOrgDomainVerification must be a boolean, got ${typeof this.requireOrgDomainVerification}`,
      );
    }
    if (
      this.smtpSenderAddressMatchesInstanceDomain != null &&
      typeof this.smtpSenderAddressMatchesInstanceDomain !== "boolean"
    ) {
      throw new TypeError(
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaSettingsServiceDomainSettings)) {
      return false;
    }
    if (
      !BetaSettingsServiceDomainSettings.__deepEquals(
        this.loginNameIncludesDomain,
        (other as BetaSettingsServiceDomainSettings).loginNameIncludesDomain,
      )
    ) {
      return false;
    }
    if (
      !BetaSettingsServiceDomainSettings.__deepEquals(
        ...
        (other as BetaSettingsServiceDomainSettings)
    ...
    if (
      !BetaSettingsServiceDomainSettings.__deepEquals(
        this.resourceOwnerType,
        (other as BetaSettingsServiceDomainSettings).resourceOwnerType,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaSettingsServiceDomainSettings.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaSettingsServiceDomainSettings.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaSettingsServiceDomainSettings.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaSettingsServiceDomainSettings.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
