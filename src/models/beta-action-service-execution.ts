...
import { BetaActionServiceCondition } from "./beta-action-service-condition.js";
import { Expose, Type } from "class-transformer";

export class BetaActionServiceExecution {
  /**
  ...
  constructor(data?: Partial<BetaActionServiceExecution>) {
    Object.assign(this, data);
    if (
      this.targets != null &&
      !Array.isArray(this.targets) &&
      !((this.targets as unknown) instanceof Set)
    ) {
      throw new TypeError(
        `targets must be an array, got ${typeof this.targets}`,
      );
    }
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaActionServiceExecution)) {
      return false;
    }
    if (
      !BetaActionServiceExecution.__deepEquals(
        this.condition,
        (other as BetaActionServiceExecution).condition,
      )
    ) {
      return false;
    }
    if (
      !BetaActionServiceExecution.__deepEquals(
        this.creationDate,
        (other as BetaActionServiceExecution).creationDate,
      )
    ) {
      return false;
    }
    if (
      !BetaActionServiceExecution.__deepEquals(
        this.changeDate,
        (other as BetaActionServiceExecution).changeDate,
      )
    ) {
      return false;
    }
    if (
      !BetaActionServiceExecution.__deepEquals(
        this.targets,
        (other as BetaActionServiceExecution).targets,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaActionServiceExecution.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaActionServiceExecution.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaActionServiceExecution.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaActionServiceExecution.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
