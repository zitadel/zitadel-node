...
export class BetaAppServiceDeleteApplicationKeyResponse {
  /**
  ...
  constructor(data?: Partial<BetaAppServiceDeleteApplicationKeyResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaAppServiceDeleteApplicationKeyResponse)) {
      return false;
    }
    if (
      !BetaAppServiceDeleteApplicationKeyResponse.__deepEquals(
        this.deletionDate,
        (other as BetaAppServiceDeleteApplicationKeyResponse).deletionDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaAppServiceDeleteApplicationKeyResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaAppServiceDeleteApplicationKeyResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaAppServiceDeleteApplicationKeyResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaAppServiceDeleteApplicationKeyResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
