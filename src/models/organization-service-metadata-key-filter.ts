...
import { OrganizationServiceTextFilterMethod } from "./organization-service-text-filter-method.js";
import { Expose, Type } from "class-transformer";

export class OrganizationServiceMetadataKeyFilter {
  /**
  ...
  constructor(data?: Partial<OrganizationServiceMetadataKeyFilter>) {
    ...
    if (this.method != null) {
      const methodValues = Object.values(
        ...
        (v) =>
          typeof (
            OrganizationServiceTextFilterMethod as Record<string, unknown>
          )[v as string] !== "number",
      );
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof OrganizationServiceMetadataKeyFilter)) {
      return false;
    }
    if (
      !OrganizationServiceMetadataKeyFilter.__deepEquals(
        this.key,
        (other as OrganizationServiceMetadataKeyFilter).key,
      )
    ) {
      return false;
    }
    if (
      !OrganizationServiceMetadataKeyFilter.__deepEquals(
        this.method,
        (other as OrganizationServiceMetadataKeyFilter).method,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        OrganizationServiceMetadataKeyFilter.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          OrganizationServiceMetadataKeyFilter.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !OrganizationServiceMetadataKeyFilter.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          OrganizationServiceMetadataKeyFilter.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
