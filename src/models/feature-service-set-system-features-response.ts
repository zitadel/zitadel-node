...
export class FeatureServiceSetSystemFeaturesResponse {
  /**
  ...
  constructor(data?: Partial<FeatureServiceSetSystemFeaturesResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof FeatureServiceSetSystemFeaturesResponse)) {
      return false;
    }
    if (
      !FeatureServiceSetSystemFeaturesResponse.__deepEquals(
        this.details,
        (other as FeatureServiceSetSystemFeaturesResponse).details,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        FeatureServiceSetSystemFeaturesResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          FeatureServiceSetSystemFeaturesResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !FeatureServiceSetSystemFeaturesResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          FeatureServiceSetSystemFeaturesResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
