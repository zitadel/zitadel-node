...
export class UserServiceVerifyEmailRequest {
  /**
  ...
  constructor(data?: Partial<UserServiceVerifyEmailRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceVerifyEmailRequest)) {
      return false;
    }
    if (
      !UserServiceVerifyEmailRequest.__deepEquals(
        this.userId,
        (other as UserServiceVerifyEmailRequest).userId,
      )
    ) {
      return false;
    }
    if (
      !UserServiceVerifyEmailRequest.__deepEquals(
        ...
        (other as UserServiceVerifyEmailRequest).verificationCode,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceVerifyEmailRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceVerifyEmailRequest.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceVerifyEmailRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceVerifyEmailRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
