...
export class BetaAuthorizationServicePaginationRequest {
  /**
  ...
  constructor(data?: Partial<BetaAuthorizationServicePaginationRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaAuthorizationServicePaginationRequest)) {
      return false;
    }
    if (
      !BetaAuthorizationServicePaginationRequest.__deepEquals(
        this.offset,
        (other as BetaAuthorizationServicePaginationRequest).offset,
      )
    ) {
      return false;
    }
    if (
      !BetaAuthorizationServicePaginationRequest.__deepEquals(
        this.limit,
        (other as BetaAuthorizationServicePaginationRequest).limit,
      )
    ) {
      return false;
    }
    if (
      !BetaAuthorizationServicePaginationRequest.__deepEquals(
        this.asc,
        (other as BetaAuthorizationServicePaginationRequest).asc,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaAuthorizationServicePaginationRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaAuthorizationServicePaginationRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaAuthorizationServicePaginationRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaAuthorizationServicePaginationRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
