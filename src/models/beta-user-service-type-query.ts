...
import { BetaUserServiceType } from "./beta-user-service-type.js";
import { Expose } from "class-transformer";

/**
 * Query for users with a specific type.
 */
export class BetaUserServiceTypeQuery {
  /**
  ...
  constructor(data?: Partial<BetaUserServiceTypeQuery>) {
    Object.assign(this, data);
    if (this.type != null) {
      const typeValues = Object.values(BetaUserServiceType).filter(
        (v) =>
          typeof (BetaUserServiceType as Record<string, unknown>)[
            v as string
          ] !== "number",
      );
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaUserServiceTypeQuery)) {
      return false;
    }
    if (
      !BetaUserServiceTypeQuery.__deepEquals(
        this.type,
        (other as BetaUserServiceTypeQuery).type,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => BetaUserServiceTypeQuery.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaUserServiceTypeQuery.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !BetaUserServiceTypeQuery.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaUserServiceTypeQuery.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
