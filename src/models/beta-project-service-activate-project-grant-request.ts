...
export class BetaProjectServiceActivateProjectGrantRequest {
  /**
  ...
  constructor(data?: Partial<BetaProjectServiceActivateProjectGrantRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaProjectServiceActivateProjectGrantRequest)) {
      return false;
    }
    if (
      !BetaProjectServiceActivateProjectGrantRequest.__deepEquals(
        this.projectId,
        (other as BetaProjectServiceActivateProjectGrantRequest).projectId,
      )
    ) {
      return false;
    }
    if (
      !BetaProjectServiceActivateProjectGrantRequest.__deepEquals(
        ...
        (other as BetaProjectServiceActivateProjectGrantRequest)
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaProjectServiceActivateProjectGrantRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaProjectServiceActivateProjectGrantRequest.__deepEquals(v, w),
        ),
      );
    }
