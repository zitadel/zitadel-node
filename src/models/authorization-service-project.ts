...
export class AuthorizationServiceProject {
  /**
  ...
  constructor(data?: Partial<AuthorizationServiceProject>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof AuthorizationServiceProject)) {
      return false;
    }
    if (
      !AuthorizationServiceProject.__deepEquals(
        this.id,
        (other as AuthorizationServiceProject).id,
      )
    ) {
      return false;
    }
    if (
      !AuthorizationServiceProject.__deepEquals(
        this.name,
        (other as AuthorizationServiceProject).name,
      )
    ) {
      return false;
    }
    if (
      !AuthorizationServiceProject.__deepEquals(
        this.organizationId,
        (other as AuthorizationServiceProject).organizationId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        AuthorizationServiceProject.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => AuthorizationServiceProject.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !AuthorizationServiceProject.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          AuthorizationServiceProject.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
