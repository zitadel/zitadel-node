...
import { BetaOrganizationServiceAny } from "./beta-organization-service-any.js";
import { Expose, Type } from "class-transformer";

/**
 * Error type returned by Connect: https://connectrpc.com/docs/go/errors/#http-representation
 */
export class BetaOrganizationServiceConnectError {
  /**
  ...
  constructor(data?: Partial<BetaOrganizationServiceConnectError>) {
    ...
    if (this.code != null) {
      const codeValues = Object.values(
        BetaOrganizationServiceConnectErrorCodeEnum,
      ).filter(
        (v) =>
          typeof (
            BetaOrganizationServiceConnectErrorCodeEnum as Record<
              string,
              unknown
            >
          )[v as string] !== "number",
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaOrganizationServiceConnectError)) {
      return false;
    }
    if (
      !BetaOrganizationServiceConnectError.__deepEquals(
        this.code,
        (other as BetaOrganizationServiceConnectError).code,
      )
    ) {
      return false;
    }
    if (
      !BetaOrganizationServiceConnectError.__deepEquals(
        this.message,
        (other as BetaOrganizationServiceConnectError).message,
      )
    ) {
      return false;
    }
    if (
      !BetaOrganizationServiceConnectError.__deepEquals(
        this.details,
        (other as BetaOrganizationServiceConnectError).details,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaOrganizationServiceConnectError.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaOrganizationServiceConnectError.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaOrganizationServiceConnectError.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaOrganizationServiceConnectError.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
...
export enum BetaOrganizationServiceConnectErrorCodeEnum {
  Canceled = "canceled",
  Unknown = "unknown",
