...
export class AuthorizationServiceRoleKeyQuery {
  /**
  ...
  constructor(data?: Partial<AuthorizationServiceRoleKeyQuery>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof AuthorizationServiceRoleKeyQuery)) {
      return false;
    }
    if (
      !AuthorizationServiceRoleKeyQuery.__deepEquals(
        this.key,
        (other as AuthorizationServiceRoleKeyQuery).key,
      )
    ) {
      return false;
    }
    if (
      !AuthorizationServiceRoleKeyQuery.__deepEquals(
        this.method,
        (other as AuthorizationServiceRoleKeyQuery).method,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        AuthorizationServiceRoleKeyQuery.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => AuthorizationServiceRoleKeyQuery.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !AuthorizationServiceRoleKeyQuery.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          AuthorizationServiceRoleKeyQuery.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
