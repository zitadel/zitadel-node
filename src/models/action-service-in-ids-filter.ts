...
export class ActionServiceInIDsFilter {
  /**
  ...
  constructor(data?: Partial<ActionServiceInIDsFilter>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ActionServiceInIDsFilter)) {
      return false;
    }
    if (
      !ActionServiceInIDsFilter.__deepEquals(
        this.ids,
        (other as ActionServiceInIDsFilter).ids,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => ActionServiceInIDsFilter.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => ActionServiceInIDsFilter.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !ActionServiceInIDsFilter.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ActionServiceInIDsFilter.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
