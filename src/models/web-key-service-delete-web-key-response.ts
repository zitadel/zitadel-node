...
export class WebKeyServiceDeleteWebKeyResponse {
  /**
  ...
  constructor(data?: Partial<WebKeyServiceDeleteWebKeyResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof WebKeyServiceDeleteWebKeyResponse)) {
      return false;
    }
    if (
      !WebKeyServiceDeleteWebKeyResponse.__deepEquals(
        this.deletionDate,
        (other as WebKeyServiceDeleteWebKeyResponse).deletionDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        WebKeyServiceDeleteWebKeyResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => WebKeyServiceDeleteWebKeyResponse.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !WebKeyServiceDeleteWebKeyResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          WebKeyServiceDeleteWebKeyResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
