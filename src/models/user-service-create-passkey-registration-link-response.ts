...
export class UserServiceCreatePasskeyRegistrationLinkResponse {
  /**
  ...
  constructor(
    data?: Partial<UserServiceCreatePasskeyRegistrationLinkResponse>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceCreatePasskeyRegistrationLinkResponse)) {
      return false;
    }
    if (
      !UserServiceCreatePasskeyRegistrationLinkResponse.__deepEquals(
        this.details,
        (other as UserServiceCreatePasskeyRegistrationLinkResponse).details,
      )
    ) {
      return false;
    }
    if (
      !UserServiceCreatePasskeyRegistrationLinkResponse.__deepEquals(
        this.code,
        (other as UserServiceCreatePasskeyRegistrationLinkResponse).code,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceCreatePasskeyRegistrationLinkResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          UserServiceCreatePasskeyRegistrationLinkResponse.__deepEquals(v, w),
        ),
      );
    }
