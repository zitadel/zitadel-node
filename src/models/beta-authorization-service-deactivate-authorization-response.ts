...
export class BetaAuthorizationServiceDeactivateAuthorizationResponse {
  /**
  ...
  constructor(
    data?: Partial<BetaAuthorizationServiceDeactivateAuthorizationResponse>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !(
        other instanceof BetaAuthorizationServiceDeactivateAuthorizationResponse
      )
    ) {
      return false;
    }
    if (
      !BetaAuthorizationServiceDeactivateAuthorizationResponse.__deepEquals(
        this.changeDate,
        (other as BetaAuthorizationServiceDeactivateAuthorizationResponse)
          .changeDate,
      )
    ) {
      return false;
