...
export class BetaUserServiceReactivateUserResponse {
  /**
  ...
  constructor(data?: Partial<BetaUserServiceReactivateUserResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaUserServiceReactivateUserResponse)) {
      return false;
    }
    if (
      !BetaUserServiceReactivateUserResponse.__deepEquals(
        this.details,
        (other as BetaUserServiceReactivateUserResponse).details,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaUserServiceReactivateUserResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaUserServiceReactivateUserResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaUserServiceReactivateUserResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaUserServiceReactivateUserResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
