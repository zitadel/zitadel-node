...
import { UserServiceAddHumanUserRequest } from "./user-service-add-human-user-request.js";
import { UserServiceDetails } from "./user-service-details.js";
import { UserServiceIDPInformation } from "./user-service-idp-information.js";
import { UserServiceUpdateHumanUserRequest } from "./user-service-update-human-user-request.js";
import { Expose, Type } from "class-transformer";

export class UserServiceRetrieveIdentityProviderIntentResponse {
  /**
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceRetrieveIdentityProviderIntentResponse)) {
      return false;
    }
    if (
      !UserServiceRetrieveIdentityProviderIntentResponse.__deepEquals(
        this.details,
        (other as UserServiceRetrieveIdentityProviderIntentResponse).details,
      )
    ) {
      return false;
    }
    if (
      !UserServiceRetrieveIdentityProviderIntentResponse.__deepEquals(
        this.idpInformation,
        (other as UserServiceRetrieveIdentityProviderIntentResponse)
          .idpInformation,
      )
    ) {
      return false;
    ...
    if (
      !UserServiceRetrieveIdentityProviderIntentResponse.__deepEquals(
        this.userId,
        (other as UserServiceRetrieveIdentityProviderIntentResponse).userId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceRetrieveIdentityProviderIntentResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          UserServiceRetrieveIdentityProviderIntentResponse.__deepEquals(v, w),
        ),
      );
    }
