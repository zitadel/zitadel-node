...
export class UserServiceMetadata {
  /**
  ...
  constructor(data?: Partial<UserServiceMetadata>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceMetadata)) {
      return false;
    }
    if (
      !UserServiceMetadata.__deepEquals(
        this.key,
        (other as UserServiceMetadata).key,
      )
    ) {
      return false;
    }
    if (
      !UserServiceMetadata.__deepEquals(
        this.value,
        (other as UserServiceMetadata).value,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => UserServiceMetadata.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceMetadata.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !UserServiceMetadata.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceMetadata.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
