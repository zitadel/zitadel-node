 ...
 */
export class ProjectServiceAny {
  /**
  ...
  constructor(data?: Partial<ProjectServiceAny>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ProjectServiceAny)) {
      return false;
    }
    if (
      !ProjectServiceAny.__deepEquals(
        this.type,
        (other as ProjectServiceAny).type,
      )
    ) {
      return false;
    }
    if (
      !ProjectServiceAny.__deepEquals(
        this.value,
        (other as ProjectServiceAny).value,
      )
    ) {
      return false;
    }
    if (
      !ProjectServiceAny.__deepEquals(
        this.debug,
        (other as ProjectServiceAny).debug,
      )
    ) {
      return false;
    }
    {
      ...
      for (const k of selfKeys) {
        ...
        if (!ProjectServiceAny.__deepEquals(selfRec[k], otherRec[k])) {
          return false;
        }
      }
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => ProjectServiceAny.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => ProjectServiceAny.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !ProjectServiceAny.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ProjectServiceAny.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
