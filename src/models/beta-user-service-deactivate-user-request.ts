...
export class BetaUserServiceDeactivateUserRequest {
  /**
  ...
  constructor(data?: Partial<BetaUserServiceDeactivateUserRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaUserServiceDeactivateUserRequest)) {
      return false;
    }
    if (
      !BetaUserServiceDeactivateUserRequest.__deepEquals(
        this.userId,
        (other as BetaUserServiceDeactivateUserRequest).userId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaUserServiceDeactivateUserRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaUserServiceDeactivateUserRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaUserServiceDeactivateUserRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaUserServiceDeactivateUserRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
