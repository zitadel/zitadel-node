...
import { BetaSessionServiceListQuery } from "./beta-session-service-list-query.js";
import { BetaSessionServiceSearchQuery } from "./beta-session-service-search-query.js";
import { BetaSessionServiceSessionFieldName } from "./beta-session-service-session-field-name.js";
...
export class BetaSessionServiceListSessionsRequest {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaSessionServiceListSessionsRequest)) {
      return false;
    }
    if (
      !BetaSessionServiceListSessionsRequest.__deepEquals(
        this.query,
        (other as BetaSessionServiceListSessionsRequest).query,
      )
    ) {
      return false;
    }
    if (
      !BetaSessionServiceListSessionsRequest.__deepEquals(
        this.queries,
        (other as BetaSessionServiceListSessionsRequest).queries,
      )
    ) {
      return false;
    }
    if (
      !BetaSessionServiceListSessionsRequest.__deepEquals(
        this.sortingColumn,
        (other as BetaSessionServiceListSessionsRequest).sortingColumn,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaSessionServiceListSessionsRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaSessionServiceListSessionsRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaSessionServiceListSessionsRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaSessionServiceListSessionsRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
