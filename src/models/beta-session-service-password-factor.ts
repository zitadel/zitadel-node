...
export class BetaSessionServicePasswordFactor {
  /**
  ...
  constructor(data?: Partial<BetaSessionServicePasswordFactor>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaSessionServicePasswordFactor)) {
      return false;
    }
    if (
      !BetaSessionServicePasswordFactor.__deepEquals(
        this.verifiedAt,
        (other as BetaSessionServicePasswordFactor).verifiedAt,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaSessionServicePasswordFactor.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaSessionServicePasswordFactor.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaSessionServicePasswordFactor.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaSessionServicePasswordFactor.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
