...
export class ApplicationServiceGenerateClientSecretRequest {
  /**
  ...
  constructor(data?: Partial<ApplicationServiceGenerateClientSecretRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ApplicationServiceGenerateClientSecretRequest)) {
      return false;
    }
    if (
      !ApplicationServiceGenerateClientSecretRequest.__deepEquals(
        this.applicationId,
        (other as ApplicationServiceGenerateClientSecretRequest).applicationId,
      )
    ) {
      return false;
    }
    if (
      !ApplicationServiceGenerateClientSecretRequest.__deepEquals(
        this.projectId,
        (other as ApplicationServiceGenerateClientSecretRequest).projectId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ApplicationServiceGenerateClientSecretRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          ApplicationServiceGenerateClientSecretRequest.__deepEquals(v, w),
        ),
      );
    }
