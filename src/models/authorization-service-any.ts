...
export class AuthorizationServiceAny {
  ...
  constructor(data?: Partial<AuthorizationServiceAny>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof AuthorizationServiceAny)) {
      return false;
    }
    if (
      !AuthorizationServiceAny.__deepEquals(
        this.type,
        (other as AuthorizationServiceAny).type,
      )
    ) {
      return false;
    }
    if (
      !AuthorizationServiceAny.__deepEquals(
        this.value,
        (other as AuthorizationServiceAny).value,
      )
    ) {
      return false;
    }
    if (
      !AuthorizationServiceAny.__deepEquals(
        this.debug,
        (other as AuthorizationServiceAny).debug,
      )
    ) {
      return false;
    }
    {
      ...
      for (const k of selfKeys) {
        ...
        if (!AuthorizationServiceAny.__deepEquals(selfRec[k], otherRec[k])) {
          return false;
        }
      }
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => AuthorizationServiceAny.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => AuthorizationServiceAny.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !AuthorizationServiceAny.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          AuthorizationServiceAny.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
