...
export class SessionServiceTOTPFactor {
  /**
  ...
  constructor(data?: Partial<SessionServiceTOTPFactor>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof SessionServiceTOTPFactor)) {
      return false;
    }
    if (
      !SessionServiceTOTPFactor.__deepEquals(
        this.verifiedAt,
        (other as SessionServiceTOTPFactor).verifiedAt,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => SessionServiceTOTPFactor.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => SessionServiceTOTPFactor.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !SessionServiceTOTPFactor.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          SessionServiceTOTPFactor.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
