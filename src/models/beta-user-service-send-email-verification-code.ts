...
export class BetaUserServiceSendEmailVerificationCode {
  /**
  ...
  constructor(data?: Partial<BetaUserServiceSendEmailVerificationCode>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaUserServiceSendEmailVerificationCode)) {
      return false;
    }
    if (
      !BetaUserServiceSendEmailVerificationCode.__deepEquals(
        this.urlTemplate,
        (other as BetaUserServiceSendEmailVerificationCode).urlTemplate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaUserServiceSendEmailVerificationCode.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaUserServiceSendEmailVerificationCode.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaUserServiceSendEmailVerificationCode.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaUserServiceSendEmailVerificationCode.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
