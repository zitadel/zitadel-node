...
export class InstanceServiceGetInstanceResponse {
  /**
  ...
  constructor(data?: Partial<InstanceServiceGetInstanceResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof InstanceServiceGetInstanceResponse)) {
      return false;
    }
    if (
      !InstanceServiceGetInstanceResponse.__deepEquals(
        this.instance,
        (other as InstanceServiceGetInstanceResponse).instance,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        InstanceServiceGetInstanceResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          InstanceServiceGetInstanceResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !InstanceServiceGetInstanceResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          InstanceServiceGetInstanceResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
