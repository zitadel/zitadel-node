...
export class InternalPermissionServiceInIDsFilter {
  /**
  ...
  constructor(data?: Partial<InternalPermissionServiceInIDsFilter>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof InternalPermissionServiceInIDsFilter)) {
      return false;
    }
    if (
      !InternalPermissionServiceInIDsFilter.__deepEquals(
        this.ids,
        (other as InternalPermissionServiceInIDsFilter).ids,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        InternalPermissionServiceInIDsFilter.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          InternalPermissionServiceInIDsFilter.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !InternalPermissionServiceInIDsFilter.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          InternalPermissionServiceInIDsFilter.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
