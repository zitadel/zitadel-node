...
export class UserServiceGenerateRecoveryCodesRequest {
  /**
  ...
  constructor(data?: Partial<UserServiceGenerateRecoveryCodesRequest>) {
    ...
    if (this.count != null && typeof this.count !== "number") {
      throw new TypeError(`count must be a number, got ${typeof this.count}`);
    }
  }
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceGenerateRecoveryCodesRequest)) {
      return false;
    }
    if (
      !UserServiceGenerateRecoveryCodesRequest.__deepEquals(
        this.userId,
        (other as UserServiceGenerateRecoveryCodesRequest).userId,
      )
    ) {
      return false;
    }
    if (
      !UserServiceGenerateRecoveryCodesRequest.__deepEquals(
        this.count,
        (other as UserServiceGenerateRecoveryCodesRequest).count,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceGenerateRecoveryCodesRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          UserServiceGenerateRecoveryCodesRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceGenerateRecoveryCodesRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceGenerateRecoveryCodesRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
