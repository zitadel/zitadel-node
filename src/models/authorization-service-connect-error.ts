...
import { AuthorizationServiceAny } from "./authorization-service-any.js";
import { Expose, Type } from "class-transformer";

/**
 * Error type returned by Connect: https://connectrpc.com/docs/go/errors/#http-representation
 */
export class AuthorizationServiceConnectError {
  /**
  ...
  constructor(data?: Partial<AuthorizationServiceConnectError>) {
    ...
    if (this.code != null) {
      const codeValues = Object.values(
        AuthorizationServiceConnectErrorCodeEnum,
      ).filter(
        (v) =>
          typeof (
            AuthorizationServiceConnectErrorCodeEnum as Record<string, unknown>
          )[v as string] !== "number",
      );
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof AuthorizationServiceConnectError)) {
      return false;
    }
    if (
      !AuthorizationServiceConnectError.__deepEquals(
        this.code,
        (other as AuthorizationServiceConnectError).code,
      )
    ) {
      return false;
    }
    if (
      !AuthorizationServiceConnectError.__deepEquals(
        this.message,
        (other as AuthorizationServiceConnectError).message,
      )
    ) {
      return false;
    }
    if (
      !AuthorizationServiceConnectError.__deepEquals(
        this.details,
        (other as AuthorizationServiceConnectError).details,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        AuthorizationServiceConnectError.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => AuthorizationServiceConnectError.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !AuthorizationServiceConnectError.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          AuthorizationServiceConnectError.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
...
export enum AuthorizationServiceConnectErrorCodeEnum {
  Canceled = "canceled",
  Unknown = "unknown",
