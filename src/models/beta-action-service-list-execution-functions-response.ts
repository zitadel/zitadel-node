...
export class BetaActionServiceListExecutionFunctionsResponse {
  /**
  ...
  constructor(data?: Partial<BetaActionServiceListExecutionFunctionsResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaActionServiceListExecutionFunctionsResponse)) {
      return false;
    }
    if (
      !BetaActionServiceListExecutionFunctionsResponse.__deepEquals(
        this.functions,
        (other as BetaActionServiceListExecutionFunctionsResponse).functions,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaActionServiceListExecutionFunctionsResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaActionServiceListExecutionFunctionsResponse.__deepEquals(v, w),
        ),
      );
    }
