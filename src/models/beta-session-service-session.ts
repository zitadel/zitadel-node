...
import { BetaSessionServiceFactors } from "./beta-session-service-factors.js";
import { BetaSessionServiceUserAgent } from "./beta-session-service-user-agent.js";
import { Expose, Type } from "class-transformer";

export class BetaSessionServiceSession {
  /**
  ...
  constructor(data?: Partial<BetaSessionServiceSession>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaSessionServiceSession)) {
      return false;
    }
    if (
      !BetaSessionServiceSession.__deepEquals(
        this.id,
        (other as BetaSessionServiceSession).id,
      )
    ) {
      return false;
    }
    if (
      !BetaSessionServiceSession.__deepEquals(
        this.creationDate,
        (other as BetaSessionServiceSession).creationDate,
      )
    ) {
      return false;
    }
    if (
      !BetaSessionServiceSession.__deepEquals(
        this.changeDate,
        (other as BetaSessionServiceSession).changeDate,
      )
    ) {
      return false;
    }
    if (
      !BetaSessionServiceSession.__deepEquals(
        this.sequence,
        (other as BetaSessionServiceSession).sequence,
      )
    ) {
      return false;
    }
    if (
      !BetaSessionServiceSession.__deepEquals(
        this.factors,
        (other as BetaSessionServiceSession).factors,
      )
    ) {
      return false;
    }
    if (
      !BetaSessionServiceSession.__deepEquals(
        this.metadata,
        (other as BetaSessionServiceSession).metadata,
      )
    ) {
      return false;
    }
    if (
      !BetaSessionServiceSession.__deepEquals(
        this.userAgent,
        (other as BetaSessionServiceSession).userAgent,
      )
    ) {
      return false;
    }
    if (
      !BetaSessionServiceSession.__deepEquals(
        this.expirationDate,
        (other as BetaSessionServiceSession).expirationDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => BetaSessionServiceSession.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaSessionServiceSession.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !BetaSessionServiceSession.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaSessionServiceSession.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
