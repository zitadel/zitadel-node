...
import { SessionServiceUserVerificationRequirement } from "./session-service-user-verification-requirement.js";
import { Expose, Type } from "class-transformer";

export class SessionServiceWebAuthN {
  /**
  ...
  constructor(data?: Partial<SessionServiceWebAuthN>) {
    ...
    if (this.userVerificationRequirement != null) {
      const userVerificationRequirementValues = Object.values(
        ...
        (v) =>
          typeof (
            SessionServiceUserVerificationRequirement as Record<string, unknown>
          )[v as string] !== "number",
      );
      if (
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof SessionServiceWebAuthN)) {
      return false;
    }
    if (
      !SessionServiceWebAuthN.__deepEquals(
        this.domain,
        (other as SessionServiceWebAuthN).domain,
      )
    ) {
      return false;
    }
    if (
      !SessionServiceWebAuthN.__deepEquals(
        this.userVerificationRequirement,
        (other as SessionServiceWebAuthN).userVerificationRequirement,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => SessionServiceWebAuthN.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => SessionServiceWebAuthN.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !SessionServiceWebAuthN.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          SessionServiceWebAuthN.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
