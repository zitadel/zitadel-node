...
export class SAMLServiceDetails {
  /**
  ...
  constructor(data?: Partial<SAMLServiceDetails>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof SAMLServiceDetails)) {
      return false;
    }
    if (
      !SAMLServiceDetails.__deepEquals(
        this.sequence,
        (other as SAMLServiceDetails).sequence,
      )
    ) {
      return false;
    }
    if (
      !SAMLServiceDetails.__deepEquals(
        this.changeDate,
        (other as SAMLServiceDetails).changeDate,
      )
    ) {
      return false;
    }
    if (
      !SAMLServiceDetails.__deepEquals(
        this.resourceOwner,
        (other as SAMLServiceDetails).resourceOwner,
      )
    ) {
      return false;
    }
    if (
      !SAMLServiceDetails.__deepEquals(
        this.creationDate,
        (other as SAMLServiceDetails).creationDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => SAMLServiceDetails.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => SAMLServiceDetails.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !SAMLServiceDetails.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          SAMLServiceDetails.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
