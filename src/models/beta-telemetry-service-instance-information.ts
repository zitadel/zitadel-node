...
export class BetaTelemetryServiceInstanceInformation {
  /**
  ...
  constructor(data?: Partial<BetaTelemetryServiceInstanceInformation>) {
    ...
    if (
      ...
      !((this.domains as unknown) instanceof Set)
    ) {
      throw new TypeError(
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaTelemetryServiceInstanceInformation)) {
      return false;
    }
    if (
      !BetaTelemetryServiceInstanceInformation.__deepEquals(
        this.id,
        (other as BetaTelemetryServiceInstanceInformation).id,
      )
    ) {
      return false;
    }
    if (
      !BetaTelemetryServiceInstanceInformation.__deepEquals(
        this.domains,
        (other as BetaTelemetryServiceInstanceInformation).domains,
      )
    ) {
      return false;
    }
    if (
      !BetaTelemetryServiceInstanceInformation.__deepEquals(
        this.createdAt,
        (other as BetaTelemetryServiceInstanceInformation).createdAt,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaTelemetryServiceInstanceInformation.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaTelemetryServiceInstanceInformation.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaTelemetryServiceInstanceInformation.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaTelemetryServiceInstanceInformation.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
