...
import { BetaInstanceServiceAny } from "./beta-instance-service-any.js";
import { Expose, Type } from "class-transformer";

/**
 * Error type returned by Connect: https://connectrpc.com/docs/go/errors/#http-representation
 */
export class BetaInstanceServiceConnectError {
  /**
  ...
  constructor(data?: Partial<BetaInstanceServiceConnectError>) {
    ...
    if (this.code != null) {
      const codeValues = Object.values(
        BetaInstanceServiceConnectErrorCodeEnum,
      ).filter(
        (v) =>
          typeof (
            BetaInstanceServiceConnectErrorCodeEnum as Record<string, unknown>
          )[v as string] !== "number",
      );
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaInstanceServiceConnectError)) {
      return false;
    }
    if (
      !BetaInstanceServiceConnectError.__deepEquals(
        this.code,
        (other as BetaInstanceServiceConnectError).code,
      )
    ) {
      return false;
    }
    if (
      !BetaInstanceServiceConnectError.__deepEquals(
        this.message,
        (other as BetaInstanceServiceConnectError).message,
      )
    ) {
      return false;
    }
    if (
      !BetaInstanceServiceConnectError.__deepEquals(
        this.details,
        (other as BetaInstanceServiceConnectError).details,
      )
    ) {
      return false;
    }
    {
      ...
      for (const k of selfKeys) {
        ...
        if (
          !BetaInstanceServiceConnectError.__deepEquals(selfRec[k], otherRec[k])
        ) {
          return false;
        }
      }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaInstanceServiceConnectError.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaInstanceServiceConnectError.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaInstanceServiceConnectError.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaInstanceServiceConnectError.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
...
export enum BetaInstanceServiceConnectErrorCodeEnum {
  Canceled = "canceled",
  Unknown = "unknown",
