...
export class ApplicationServiceUpdateAPIApplicationConfigurationRequest {
  /**
  ...
  constructor(
    data?: Partial<ApplicationServiceUpdateAPIApplicationConfigurationRequest>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !ApplicationServiceUpdateAPIApplicationConfigurationRequest.__deepEquals(
        this.authMethodType,
        (other as ApplicationServiceUpdateAPIApplicationConfigurationRequest)
          .authMethodType,
      )
    ) {
      return false;
