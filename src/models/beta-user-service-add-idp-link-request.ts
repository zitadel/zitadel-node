...
export class BetaUserServiceAddIDPLinkRequest {
  /**
  ...
  constructor(data?: Partial<BetaUserServiceAddIDPLinkRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaUserServiceAddIDPLinkRequest)) {
      return false;
    }
    if (
      !BetaUserServiceAddIDPLinkRequest.__deepEquals(
        this.userId,
        (other as BetaUserServiceAddIDPLinkRequest).userId,
      )
    ) {
      return false;
    }
    if (
      !BetaUserServiceAddIDPLinkRequest.__deepEquals(
        this.idpLink,
        (other as BetaUserServiceAddIDPLinkRequest).idpLink,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaUserServiceAddIDPLinkRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaUserServiceAddIDPLinkRequest.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaUserServiceAddIDPLinkRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaUserServiceAddIDPLinkRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
