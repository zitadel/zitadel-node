...
export class SessionServiceIDsQuery {
  /**
  ...
  constructor(data?: Partial<SessionServiceIDsQuery>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof SessionServiceIDsQuery)) {
      return false;
    }
    if (
      !SessionServiceIDsQuery.__deepEquals(
        this.ids,
        (other as SessionServiceIDsQuery).ids,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => SessionServiceIDsQuery.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => SessionServiceIDsQuery.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !SessionServiceIDsQuery.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          SessionServiceIDsQuery.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
