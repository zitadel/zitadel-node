...
export class UserServiceDetails {
  ...
  constructor(data?: Partial<UserServiceDetails>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceDetails)) {
      return false;
    }
    if (
      !UserServiceDetails.__deepEquals(
        this.sequence,
        (other as UserServiceDetails).sequence,
      )
    ) {
      return false;
    }
    if (
      !UserServiceDetails.__deepEquals(
        this.changeDate,
        (other as UserServiceDetails).changeDate,
      )
    ) {
      return false;
    }
    if (
      !UserServiceDetails.__deepEquals(
        this.resourceOwner,
        (other as UserServiceDetails).resourceOwner,
      )
    ) {
      return false;
    }
    if (
      !UserServiceDetails.__deepEquals(
        this.creationDate,
        (other as UserServiceDetails).creationDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => UserServiceDetails.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceDetails.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !UserServiceDetails.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceDetails.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
