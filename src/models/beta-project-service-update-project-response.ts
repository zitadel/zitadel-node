...
export class BetaProjectServiceUpdateProjectResponse {
  /**
  ...
  constructor(data?: Partial<BetaProjectServiceUpdateProjectResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaProjectServiceUpdateProjectResponse)) {
      return false;
    }
    if (
      !BetaProjectServiceUpdateProjectResponse.__deepEquals(
        this.changeDate,
        (other as BetaProjectServiceUpdateProjectResponse).changeDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaProjectServiceUpdateProjectResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaProjectServiceUpdateProjectResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaProjectServiceUpdateProjectResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaProjectServiceUpdateProjectResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
