...
export class UserServiceVerifyPasskeyRegistrationResponse {
  /**
  ...
  constructor(data?: Partial<UserServiceVerifyPasskeyRegistrationResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceVerifyPasskeyRegistrationResponse)) {
      return false;
    }
    if (
      !UserServiceVerifyPasskeyRegistrationResponse.__deepEquals(
        this.details,
        (other as UserServiceVerifyPasskeyRegistrationResponse).details,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceVerifyPasskeyRegistrationResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          UserServiceVerifyPasskeyRegistrationResponse.__deepEquals(v, w),
        ),
      );
    }
