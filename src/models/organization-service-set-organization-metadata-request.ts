...
export class OrganizationServiceSetOrganizationMetadataRequest {
  ...
  constructor(
    data?: Partial<OrganizationServiceSetOrganizationMetadataRequest>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof OrganizationServiceSetOrganizationMetadataRequest)) {
      return false;
    }
    if (
      !OrganizationServiceSetOrganizationMetadataRequest.__deepEquals(
        this.organizationId,
        (other as OrganizationServiceSetOrganizationMetadataRequest)
          .organizationId,
      )
    ) {
      return false;
    ...
    if (
      !OrganizationServiceSetOrganizationMetadataRequest.__deepEquals(
        this.metadata,
        (other as OrganizationServiceSetOrganizationMetadataRequest).metadata,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        OrganizationServiceSetOrganizationMetadataRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          OrganizationServiceSetOrganizationMetadataRequest.__deepEquals(v, w),
        ),
      );
    }
