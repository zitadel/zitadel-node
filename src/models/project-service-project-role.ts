...
export class ProjectServiceProjectRole {
  /**
  ...
  constructor(data?: Partial<ProjectServiceProjectRole>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ProjectServiceProjectRole)) {
      return false;
    }
    if (
      !ProjectServiceProjectRole.__deepEquals(
        this.projectId,
        (other as ProjectServiceProjectRole).projectId,
      )
    ) {
      return false;
    }
    if (
      !ProjectServiceProjectRole.__deepEquals(
        this.key,
        (other as ProjectServiceProjectRole).key,
      )
    ) {
      return false;
    }
    if (
      !ProjectServiceProjectRole.__deepEquals(
        this.creationDate,
        (other as ProjectServiceProjectRole).creationDate,
      )
    ) {
      return false;
    }
    if (
      !ProjectServiceProjectRole.__deepEquals(
        this.changeDate,
        (other as ProjectServiceProjectRole).changeDate,
      )
    ) {
      return false;
    }
    if (
      !ProjectServiceProjectRole.__deepEquals(
        this.displayName,
        (other as ProjectServiceProjectRole).displayName,
      )
    ) {
      return false;
    }
    if (
      !ProjectServiceProjectRole.__deepEquals(
        this.group,
        (other as ProjectServiceProjectRole).group,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => ProjectServiceProjectRole.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => ProjectServiceProjectRole.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !ProjectServiceProjectRole.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ProjectServiceProjectRole.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
