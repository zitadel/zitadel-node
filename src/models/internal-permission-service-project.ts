...
export class InternalPermissionServiceProject {
  /**
  ...
  constructor(data?: Partial<InternalPermissionServiceProject>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof InternalPermissionServiceProject)) {
      return false;
    }
    if (
      !InternalPermissionServiceProject.__deepEquals(
        this.id,
        (other as InternalPermissionServiceProject).id,
      )
    ) {
      return false;
    }
    if (
      !InternalPermissionServiceProject.__deepEquals(
        this.name,
        (other as InternalPermissionServiceProject).name,
      )
    ) {
      return false;
    }
    if (
      !InternalPermissionServiceProject.__deepEquals(
        this.organizationId,
        (other as InternalPermissionServiceProject).organizationId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        InternalPermissionServiceProject.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => InternalPermissionServiceProject.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !InternalPermissionServiceProject.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          InternalPermissionServiceProject.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
