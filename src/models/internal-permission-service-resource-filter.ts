...
export class InternalPermissionServiceResourceFilter {
  /**
  ...
  constructor(data?: Partial<InternalPermissionServiceResourceFilter>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof InternalPermissionServiceResourceFilter)) {
      return false;
    }
    if (
      !InternalPermissionServiceResourceFilter.__deepEquals(
        this.instance,
        (other as InternalPermissionServiceResourceFilter).instance,
      )
    ) {
      return false;
    }
    if (
      !InternalPermissionServiceResourceFilter.__deepEquals(
        this.organizationId,
        (other as InternalPermissionServiceResourceFilter).organizationId,
      )
    ) {
      return false;
    }
    if (
      !InternalPermissionServiceResourceFilter.__deepEquals(
        this.projectGrant,
        (other as InternalPermissionServiceResourceFilter).projectGrant,
      )
    ) {
      return false;
    }
    if (
      !InternalPermissionServiceResourceFilter.__deepEquals(
        this.projectId,
        (other as InternalPermissionServiceResourceFilter).projectId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        InternalPermissionServiceResourceFilter.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          InternalPermissionServiceResourceFilter.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !InternalPermissionServiceResourceFilter.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          InternalPermissionServiceResourceFilter.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
