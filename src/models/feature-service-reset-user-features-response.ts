...
export class FeatureServiceResetUserFeaturesResponse {
  /**
  ...
  constructor(data?: Partial<FeatureServiceResetUserFeaturesResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof FeatureServiceResetUserFeaturesResponse)) {
      return false;
    }
    if (
      !FeatureServiceResetUserFeaturesResponse.__deepEquals(
        this.details,
        (other as FeatureServiceResetUserFeaturesResponse).details,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        FeatureServiceResetUserFeaturesResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          FeatureServiceResetUserFeaturesResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !FeatureServiceResetUserFeaturesResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          FeatureServiceResetUserFeaturesResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
