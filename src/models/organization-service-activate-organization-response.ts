...
export class OrganizationServiceActivateOrganizationResponse {
  /**
  ...
  constructor(data?: Partial<OrganizationServiceActivateOrganizationResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof OrganizationServiceActivateOrganizationResponse)) {
      return false;
    }
    if (
      !OrganizationServiceActivateOrganizationResponse.__deepEquals(
        this.changeDate,
        (other as OrganizationServiceActivateOrganizationResponse).changeDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        OrganizationServiceActivateOrganizationResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          OrganizationServiceActivateOrganizationResponse.__deepEquals(v, w),
        ),
      );
    }
