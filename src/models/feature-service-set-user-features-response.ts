...
export class FeatureServiceSetUserFeaturesResponse {
  /**
  ...
  constructor(data?: Partial<FeatureServiceSetUserFeaturesResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof FeatureServiceSetUserFeaturesResponse)) {
      return false;
    }
    if (
      !FeatureServiceSetUserFeaturesResponse.__deepEquals(
        this.details,
        (other as FeatureServiceSetUserFeaturesResponse).details,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        FeatureServiceSetUserFeaturesResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          FeatureServiceSetUserFeaturesResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !FeatureServiceSetUserFeaturesResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          FeatureServiceSetUserFeaturesResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
