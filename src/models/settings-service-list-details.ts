...
export class SettingsServiceListDetails {
  /**
  ...
  constructor(data?: Partial<SettingsServiceListDetails>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof SettingsServiceListDetails)) {
      return false;
    }
    if (
      !SettingsServiceListDetails.__deepEquals(
        this.totalResult,
        (other as SettingsServiceListDetails).totalResult,
      )
    ) {
      return false;
    }
    if (
      !SettingsServiceListDetails.__deepEquals(
        ...
        (other as SettingsServiceListDetails).processedSequence,
      )
    ) {
      return false;
    }
    if (
      !SettingsServiceListDetails.__deepEquals(
        this.timestamp,
        (other as SettingsServiceListDetails).timestamp,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        SettingsServiceListDetails.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => SettingsServiceListDetails.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !SettingsServiceListDetails.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          SettingsServiceListDetails.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
