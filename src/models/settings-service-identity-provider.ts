...
import { SettingsServiceIdentityProviderType } from "./settings-service-identity-provider-type.js";
import { SettingsServiceOptions } from "./settings-service-options.js";
...
export class SettingsServiceIdentityProvider {
  ...
  constructor(data?: Partial<SettingsServiceIdentityProvider>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof SettingsServiceIdentityProvider)) {
      return false;
    }
    if (
      !SettingsServiceIdentityProvider.__deepEquals(
        this.id,
        (other as SettingsServiceIdentityProvider).id,
      )
    ) {
      return false;
    }
    if (
      !SettingsServiceIdentityProvider.__deepEquals(
        this.name,
        (other as SettingsServiceIdentityProvider).name,
      )
    ) {
      return false;
    }
    if (
      !SettingsServiceIdentityProvider.__deepEquals(
        this.type,
        (other as SettingsServiceIdentityProvider).type,
      )
    ) {
      return false;
    }
    if (
      !SettingsServiceIdentityProvider.__deepEquals(
        this.options,
        (other as SettingsServiceIdentityProvider).options,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        SettingsServiceIdentityProvider.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => SettingsServiceIdentityProvider.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !SettingsServiceIdentityProvider.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          SettingsServiceIdentityProvider.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
