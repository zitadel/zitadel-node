...
export class WebKeyServiceCreateWebKeyRequest {
  ...
  constructor(data?: Partial<WebKeyServiceCreateWebKeyRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof WebKeyServiceCreateWebKeyRequest)) {
      return false;
    }
    if (
      !WebKeyServiceCreateWebKeyRequest.__deepEquals(
        this.ecdsa,
        (other as WebKeyServiceCreateWebKeyRequest).ecdsa,
      )
    ) {
      return false;
    }
    if (
      !WebKeyServiceCreateWebKeyRequest.__deepEquals(
        this.ed25519,
        (other as WebKeyServiceCreateWebKeyRequest).ed25519,
      )
    ) {
      return false;
    }
    if (
      !WebKeyServiceCreateWebKeyRequest.__deepEquals(
        this.rsa,
        (other as WebKeyServiceCreateWebKeyRequest).rsa,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        WebKeyServiceCreateWebKeyRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => WebKeyServiceCreateWebKeyRequest.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !WebKeyServiceCreateWebKeyRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          WebKeyServiceCreateWebKeyRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
