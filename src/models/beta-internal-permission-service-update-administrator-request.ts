...
import { BetaInternalPermissionServiceResourceType } from "./beta-internal-permission-service-resource-type.js";
import { Expose, Type } from "class-transformer";

export class BetaInternalPermissionServiceUpdateAdministratorRequest {
  /**
  ...
  constructor(
    data?: Partial<BetaInternalPermissionServiceUpdateAdministratorRequest>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !(
        other instanceof BetaInternalPermissionServiceUpdateAdministratorRequest
      )
    ) {
      return false;
    }
    if (
      !BetaInternalPermissionServiceUpdateAdministratorRequest.__deepEquals(
        this.userId,
        (other as BetaInternalPermissionServiceUpdateAdministratorRequest)
          .userId,
      )
    ) {
      return false;
