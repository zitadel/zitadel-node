...
export class BetaSettingsServiceListDetails {
  /**
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaSettingsServiceListDetails)) {
      return false;
    }
    if (
      !BetaSettingsServiceListDetails.__deepEquals(
        this.totalResult,
        (other as BetaSettingsServiceListDetails).totalResult,
      )
    ) {
      return false;
    }
    if (
      !BetaSettingsServiceListDetails.__deepEquals(
        ...
        (other as BetaSettingsServiceListDetails).processedSequence,
      )
    ) {
      return false;
    }
    if (
      !BetaSettingsServiceListDetails.__deepEquals(
        this.timestamp,
        (other as BetaSettingsServiceListDetails).timestamp,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaSettingsServiceListDetails.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaSettingsServiceListDetails.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaSettingsServiceListDetails.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaSettingsServiceListDetails.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
