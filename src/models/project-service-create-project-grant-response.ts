...
export class ProjectServiceCreateProjectGrantResponse {
  /**
  ...
  constructor(data?: Partial<ProjectServiceCreateProjectGrantResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ProjectServiceCreateProjectGrantResponse)) {
      return false;
    }
    if (
      !ProjectServiceCreateProjectGrantResponse.__deepEquals(
        this.creationDate,
        (other as ProjectServiceCreateProjectGrantResponse).creationDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ProjectServiceCreateProjectGrantResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          ProjectServiceCreateProjectGrantResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !ProjectServiceCreateProjectGrantResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ProjectServiceCreateProjectGrantResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
