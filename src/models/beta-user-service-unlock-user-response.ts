...
export class BetaUserServiceUnlockUserResponse {
  /**
  ...
  constructor(data?: Partial<BetaUserServiceUnlockUserResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaUserServiceUnlockUserResponse)) {
      return false;
    }
    if (
      !BetaUserServiceUnlockUserResponse.__deepEquals(
        this.details,
        (other as BetaUserServiceUnlockUserResponse).details,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaUserServiceUnlockUserResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaUserServiceUnlockUserResponse.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaUserServiceUnlockUserResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaUserServiceUnlockUserResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
