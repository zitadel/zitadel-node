...
export class BetaUserServiceIDPLDAPAccessInformation {
  /**
  ...
  constructor(data?: Partial<BetaUserServiceIDPLDAPAccessInformation>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaUserServiceIDPLDAPAccessInformation)) {
      return false;
    }
    if (
      !BetaUserServiceIDPLDAPAccessInformation.__deepEquals(
        this.attributes,
        (other as BetaUserServiceIDPLDAPAccessInformation).attributes,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaUserServiceIDPLDAPAccessInformation.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaUserServiceIDPLDAPAccessInformation.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaUserServiceIDPLDAPAccessInformation.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaUserServiceIDPLDAPAccessInformation.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
