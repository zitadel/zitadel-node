...
export class BetaSessionServiceUserIDQuery {
  /**
  ...
  constructor(data?: Partial<BetaSessionServiceUserIDQuery>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaSessionServiceUserIDQuery)) {
      return false;
    }
    if (
      !BetaSessionServiceUserIDQuery.__deepEquals(
        this.id,
        (other as BetaSessionServiceUserIDQuery).id,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaSessionServiceUserIDQuery.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaSessionServiceUserIDQuery.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaSessionServiceUserIDQuery.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaSessionServiceUserIDQuery.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
