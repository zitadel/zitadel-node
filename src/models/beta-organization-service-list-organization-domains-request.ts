...
import { BetaOrganizationServiceDomainSearchFilter } from "./beta-organization-service-domain-search-filter.js";
import { BetaOrganizationServicePaginationRequest } from "./beta-organization-service-pagination-request.js";
import { Expose, Type } from "class-transformer";

export class BetaOrganizationServiceListOrganizationDomainsRequest {
  /**
   ...
   */
  @Expose({ name: "filters" })
  @Type(() => BetaOrganizationServiceDomainSearchFilter)
  filters?: Array<BetaOrganizationServiceDomainSearchFilter>;

  constructor(
    data?: Partial<BetaOrganizationServiceListOrganizationDomainsRequest>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !(other instanceof BetaOrganizationServiceListOrganizationDomainsRequest)
    ) {
      return false;
    }
    if (
      !BetaOrganizationServiceListOrganizationDomainsRequest.__deepEquals(
        this.organizationId,
        (other as BetaOrganizationServiceListOrganizationDomainsRequest)
          .organizationId,
      )
    ) {
      return false;
