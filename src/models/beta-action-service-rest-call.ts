...
export class BetaActionServiceRESTCall {
  /**
   ...
   */
  @Expose({ name: "interruptOnError" })
  interruptOnError?: boolean;

  constructor(data?: Partial<BetaActionServiceRESTCall>) {
    Object.assign(this, data);
    if (
      this.interruptOnError != null &&
      typeof this.interruptOnError !== "boolean"
    ) {
      throw new TypeError(
        `interruptOnError must be a boolean, got ${typeof this.interruptOnError}`,
      );
    }
  }
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaActionServiceRESTCall)) {
      return false;
    }
    if (
      !BetaActionServiceRESTCall.__deepEquals(
        this.interruptOnError,
        (other as BetaActionServiceRESTCall).interruptOnError,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => BetaActionServiceRESTCall.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaActionServiceRESTCall.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !BetaActionServiceRESTCall.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaActionServiceRESTCall.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
