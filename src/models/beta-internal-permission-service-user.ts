...
export class BetaInternalPermissionServiceUser {
  /**
  ...
  constructor(data?: Partial<BetaInternalPermissionServiceUser>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaInternalPermissionServiceUser)) {
      return false;
    }
    if (
      !BetaInternalPermissionServiceUser.__deepEquals(
        this.id,
        (other as BetaInternalPermissionServiceUser).id,
      )
    ) {
      return false;
    }
    if (
      !BetaInternalPermissionServiceUser.__deepEquals(
        ...
        (other as BetaInternalPermissionServiceUser).preferredLoginName,
      )
    ) {
      return false;
    }
    if (
      !BetaInternalPermissionServiceUser.__deepEquals(
        this.displayName,
        (other as BetaInternalPermissionServiceUser).displayName,
      )
    ) {
      return false;
    }
    if (
      !BetaInternalPermissionServiceUser.__deepEquals(
        this.organizationId,
        (other as BetaInternalPermissionServiceUser).organizationId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaInternalPermissionServiceUser.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaInternalPermissionServiceUser.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaInternalPermissionServiceUser.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaInternalPermissionServiceUser.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
