...
export class BetaAppServiceUpdateOIDCApplicationConfigurationRequest {
  ...
  constructor(
    data?: Partial<BetaAppServiceUpdateOIDCApplicationConfigurationRequest>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !(
        other instanceof BetaAppServiceUpdateOIDCApplicationConfigurationRequest
      )
    ) {
      return false;
    }
    if (
      !BetaAppServiceUpdateOIDCApplicationConfigurationRequest.__deepEquals(
        this.redirectUris,
        (other as BetaAppServiceUpdateOIDCApplicationConfigurationRequest)
          .redirectUris,
      )
    ) {
      return false;
