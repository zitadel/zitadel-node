...
export class UserServiceVerifyInviteCodeRequest {
  /**
  ...
  constructor(data?: Partial<UserServiceVerifyInviteCodeRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceVerifyInviteCodeRequest)) {
      return false;
    }
    if (
      !UserServiceVerifyInviteCodeRequest.__deepEquals(
        this.userId,
        (other as UserServiceVerifyInviteCodeRequest).userId,
      )
    ) {
      return false;
    }
    if (
      !UserServiceVerifyInviteCodeRequest.__deepEquals(
        ...
        (other as UserServiceVerifyInviteCodeRequest).verificationCode,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceVerifyInviteCodeRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          UserServiceVerifyInviteCodeRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceVerifyInviteCodeRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceVerifyInviteCodeRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
