...
export class BetaSessionServiceWebAuthNFactor {
  /**
  ...
  constructor(data?: Partial<BetaSessionServiceWebAuthNFactor>) {
    Object.assign(this, data);
    if (this.userVerified != null && typeof this.userVerified !== "boolean") {
      throw new TypeError(
        `userVerified must be a boolean, got ${typeof this.userVerified}`,
      );
    }
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaSessionServiceWebAuthNFactor)) {
      return false;
    }
    if (
      !BetaSessionServiceWebAuthNFactor.__deepEquals(
        this.verifiedAt,
        (other as BetaSessionServiceWebAuthNFactor).verifiedAt,
      )
    ) {
      return false;
    }
    if (
      !BetaSessionServiceWebAuthNFactor.__deepEquals(
        this.userVerified,
        (other as BetaSessionServiceWebAuthNFactor).userVerified,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaSessionServiceWebAuthNFactor.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaSessionServiceWebAuthNFactor.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaSessionServiceWebAuthNFactor.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaSessionServiceWebAuthNFactor.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
