...
export class InstanceServiceDeleteInstanceResponse {
  /**
  ...
  constructor(data?: Partial<InstanceServiceDeleteInstanceResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof InstanceServiceDeleteInstanceResponse)) {
      return false;
    }
    if (
      !InstanceServiceDeleteInstanceResponse.__deepEquals(
        this.deletionDate,
        (other as InstanceServiceDeleteInstanceResponse).deletionDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        InstanceServiceDeleteInstanceResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          InstanceServiceDeleteInstanceResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !InstanceServiceDeleteInstanceResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          InstanceServiceDeleteInstanceResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
