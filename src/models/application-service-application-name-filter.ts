...
import { ApplicationServiceTextFilterMethod } from "./application-service-text-filter-method.js";
import { Expose, Type } from "class-transformer";

export class ApplicationServiceApplicationNameFilter {
  /**
  ...
  constructor(data?: Partial<ApplicationServiceApplicationNameFilter>) {
    ...
    if (this.method != null) {
      const methodValues = Object.values(
        ...
        (v) =>
          typeof (
            ApplicationServiceTextFilterMethod as Record<string, unknown>
          )[v as string] !== "number",
      );
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ApplicationServiceApplicationNameFilter)) {
      return false;
    }
    if (
      !ApplicationServiceApplicationNameFilter.__deepEquals(
        this.name,
        (other as ApplicationServiceApplicationNameFilter).name,
      )
    ) {
      return false;
    }
    if (
      !ApplicationServiceApplicationNameFilter.__deepEquals(
        this.method,
        (other as ApplicationServiceApplicationNameFilter).method,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ApplicationServiceApplicationNameFilter.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          ApplicationServiceApplicationNameFilter.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !ApplicationServiceApplicationNameFilter.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ApplicationServiceApplicationNameFilter.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
