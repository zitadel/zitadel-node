...
export class ActionServiceUpdateTargetResponse {
  /**
  ...
  constructor(data?: Partial<ActionServiceUpdateTargetResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ActionServiceUpdateTargetResponse)) {
      return false;
    }
    if (
      !ActionServiceUpdateTargetResponse.__deepEquals(
        this.changeDate,
        (other as ActionServiceUpdateTargetResponse).changeDate,
      )
    ) {
      return false;
    }
    if (
      !ActionServiceUpdateTargetResponse.__deepEquals(
        this.signingKey,
        (other as ActionServiceUpdateTargetResponse).signingKey,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ActionServiceUpdateTargetResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => ActionServiceUpdateTargetResponse.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !ActionServiceUpdateTargetResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ActionServiceUpdateTargetResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
