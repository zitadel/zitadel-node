...
export class UserServicePaginationResponse {
  /**
  ...
  constructor(data?: Partial<UserServicePaginationResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServicePaginationResponse)) {
      return false;
    }
    if (
      !UserServicePaginationResponse.__deepEquals(
        this.totalResult,
        (other as UserServicePaginationResponse).totalResult,
      )
    ) {
      return false;
    }
    if (
      !UserServicePaginationResponse.__deepEquals(
        this.appliedLimit,
        (other as UserServicePaginationResponse).appliedLimit,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServicePaginationResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServicePaginationResponse.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServicePaginationResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServicePaginationResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
