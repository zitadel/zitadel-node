...
export class SessionServiceGetSessionResponse {
  /**
  ...
  constructor(data?: Partial<SessionServiceGetSessionResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof SessionServiceGetSessionResponse)) {
      return false;
    }
    if (
      !SessionServiceGetSessionResponse.__deepEquals(
        this.session,
        (other as SessionServiceGetSessionResponse).session,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        SessionServiceGetSessionResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => SessionServiceGetSessionResponse.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !SessionServiceGetSessionResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          SessionServiceGetSessionResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
