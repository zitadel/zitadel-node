...
export class InstanceServiceAddTrustedDomainResponse {
  /**
  ...
  constructor(data?: Partial<InstanceServiceAddTrustedDomainResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof InstanceServiceAddTrustedDomainResponse)) {
      return false;
    }
    if (
      !InstanceServiceAddTrustedDomainResponse.__deepEquals(
        this.creationDate,
        (other as InstanceServiceAddTrustedDomainResponse).creationDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        InstanceServiceAddTrustedDomainResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          InstanceServiceAddTrustedDomainResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !InstanceServiceAddTrustedDomainResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          InstanceServiceAddTrustedDomainResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
