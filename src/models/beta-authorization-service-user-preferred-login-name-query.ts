...
export class BetaAuthorizationServiceUserPreferredLoginNameQuery {
  /**
  ...
  constructor(
    data?: Partial<BetaAuthorizationServiceUserPreferredLoginNameQuery>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !(other instanceof BetaAuthorizationServiceUserPreferredLoginNameQuery)
    ) {
      return false;
    }
    if (
      !BetaAuthorizationServiceUserPreferredLoginNameQuery.__deepEquals(
        this.loginName,
        (other as BetaAuthorizationServiceUserPreferredLoginNameQuery)
          .loginName,
      )
    ) {
      return false;
    ...
    if (
      !BetaAuthorizationServiceUserPreferredLoginNameQuery.__deepEquals(
        this.method,
        (other as BetaAuthorizationServiceUserPreferredLoginNameQuery).method,
      )
    ) {
      return false;
    }
