...
export class SAMLServiceSession {
  /**
  ...
  constructor(data?: Partial<SAMLServiceSession>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof SAMLServiceSession)) {
      return false;
    }
    if (
      !SAMLServiceSession.__deepEquals(
        this.sessionId,
        (other as SAMLServiceSession).sessionId,
      )
    ) {
      return false;
    }
    if (
      !SAMLServiceSession.__deepEquals(
        this.sessionToken,
        (other as SAMLServiceSession).sessionToken,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => SAMLServiceSession.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => SAMLServiceSession.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !SAMLServiceSession.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          SAMLServiceSession.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
