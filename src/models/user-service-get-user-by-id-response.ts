...
export class UserServiceGetUserByIDResponse {
  /**
  ...
  constructor(data?: Partial<UserServiceGetUserByIDResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceGetUserByIDResponse)) {
      return false;
    }
    if (
      !UserServiceGetUserByIDResponse.__deepEquals(
        this.details,
        (other as UserServiceGetUserByIDResponse).details,
      )
    ) {
      return false;
    }
    if (
      !UserServiceGetUserByIDResponse.__deepEquals(
        this.user,
        (other as UserServiceGetUserByIDResponse).user,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceGetUserByIDResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceGetUserByIDResponse.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceGetUserByIDResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceGetUserByIDResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
