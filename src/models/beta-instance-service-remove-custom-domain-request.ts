...
export class BetaInstanceServiceRemoveCustomDomainRequest {
  /**
  ...
  constructor(data?: Partial<BetaInstanceServiceRemoveCustomDomainRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaInstanceServiceRemoveCustomDomainRequest)) {
      return false;
    }
    if (
      !BetaInstanceServiceRemoveCustomDomainRequest.__deepEquals(
        this.instanceId,
        (other as BetaInstanceServiceRemoveCustomDomainRequest).instanceId,
      )
    ) {
      return false;
    }
    if (
      !BetaInstanceServiceRemoveCustomDomainRequest.__deepEquals(
        this.domain,
        (other as BetaInstanceServiceRemoveCustomDomainRequest).domain,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaInstanceServiceRemoveCustomDomainRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaInstanceServiceRemoveCustomDomainRequest.__deepEquals(v, w),
        ),
      );
    }
