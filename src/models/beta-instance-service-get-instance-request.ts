...
export class BetaInstanceServiceGetInstanceRequest {
  /**
  ...
  constructor(data?: Partial<BetaInstanceServiceGetInstanceRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaInstanceServiceGetInstanceRequest)) {
      return false;
    }
    if (
      !BetaInstanceServiceGetInstanceRequest.__deepEquals(
        this.instanceId,
        (other as BetaInstanceServiceGetInstanceRequest).instanceId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaInstanceServiceGetInstanceRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaInstanceServiceGetInstanceRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaInstanceServiceGetInstanceRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaInstanceServiceGetInstanceRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
