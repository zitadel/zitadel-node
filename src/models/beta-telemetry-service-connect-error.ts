...
import { BetaTelemetryServiceAny } from "./beta-telemetry-service-any.js";
import { Expose, Type } from "class-transformer";

/**
 * Error type returned by Connect: https://connectrpc.com/docs/go/errors/#http-representation
 */
export class BetaTelemetryServiceConnectError {
  /**
  ...
  constructor(data?: Partial<BetaTelemetryServiceConnectError>) {
    ...
    if (this.code != null) {
      const codeValues = Object.values(
        BetaTelemetryServiceConnectErrorCodeEnum,
      ).filter(
        (v) =>
          typeof (
            BetaTelemetryServiceConnectErrorCodeEnum as Record<string, unknown>
          )[v as string] !== "number",
      );
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaTelemetryServiceConnectError)) {
      return false;
    }
    if (
      !BetaTelemetryServiceConnectError.__deepEquals(
        this.code,
        (other as BetaTelemetryServiceConnectError).code,
      )
    ) {
      return false;
    }
    if (
      !BetaTelemetryServiceConnectError.__deepEquals(
        this.message,
        (other as BetaTelemetryServiceConnectError).message,
      )
    ) {
      return false;
    }
    if (
      !BetaTelemetryServiceConnectError.__deepEquals(
        this.details,
        (other as BetaTelemetryServiceConnectError).details,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaTelemetryServiceConnectError.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaTelemetryServiceConnectError.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaTelemetryServiceConnectError.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaTelemetryServiceConnectError.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
...
export enum BetaTelemetryServiceConnectErrorCodeEnum {
  Canceled = "canceled",
  Unknown = "unknown",
