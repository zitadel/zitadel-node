...
import { BetaFeatureServiceAny } from "./beta-feature-service-any.js";
import { Expose, Type } from "class-transformer";

/**
 * Error type returned by Connect: https://connectrpc.com/docs/go/errors/#http-representation
 */
export class BetaFeatureServiceConnectError {
  /**
  ...
  constructor(data?: Partial<BetaFeatureServiceConnectError>) {
    ...
    if (this.code != null) {
      const codeValues = Object.values(
        BetaFeatureServiceConnectErrorCodeEnum,
      ).filter(
        (v) =>
          typeof (
            BetaFeatureServiceConnectErrorCodeEnum as Record<string, unknown>
          )[v as string] !== "number",
      );
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaFeatureServiceConnectError)) {
      return false;
    }
    if (
      !BetaFeatureServiceConnectError.__deepEquals(
        this.code,
        (other as BetaFeatureServiceConnectError).code,
      )
    ) {
      return false;
    }
    if (
      !BetaFeatureServiceConnectError.__deepEquals(
        this.message,
        (other as BetaFeatureServiceConnectError).message,
      )
    ) {
      return false;
    }
    if (
      !BetaFeatureServiceConnectError.__deepEquals(
        this.details,
        (other as BetaFeatureServiceConnectError).details,
      )
    ) {
      return false;
    }
    {
      ...
      for (const k of selfKeys) {
        ...
        if (
          !BetaFeatureServiceConnectError.__deepEquals(selfRec[k], otherRec[k])
        ) {
          return false;
        }
      }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaFeatureServiceConnectError.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaFeatureServiceConnectError.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaFeatureServiceConnectError.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaFeatureServiceConnectError.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
...
export enum BetaFeatureServiceConnectErrorCodeEnum {
  Canceled = "canceled",
  Unknown = "unknown",
