...
export class InternalPermissionServiceResourceType {
  /**
  ...
  constructor(data?: Partial<InternalPermissionServiceResourceType>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof InternalPermissionServiceResourceType)) {
      return false;
    }
    if (
      !InternalPermissionServiceResourceType.__deepEquals(
        this.instance,
        (other as InternalPermissionServiceResourceType).instance,
      )
    ) {
      return false;
    }
    if (
      !InternalPermissionServiceResourceType.__deepEquals(
        this.organizationId,
        (other as InternalPermissionServiceResourceType).organizationId,
      )
    ) {
      return false;
    }
    if (
      !InternalPermissionServiceResourceType.__deepEquals(
        this.projectGrant,
        (other as InternalPermissionServiceResourceType).projectGrant,
      )
    ) {
      return false;
    }
    if (
      !InternalPermissionServiceResourceType.__deepEquals(
        this.projectId,
        (other as InternalPermissionServiceResourceType).projectId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        InternalPermissionServiceResourceType.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          InternalPermissionServiceResourceType.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !InternalPermissionServiceResourceType.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          InternalPermissionServiceResourceType.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
