...
export class UserServiceSetEmailResponse {
  /**
  ...
  constructor(data?: Partial<UserServiceSetEmailResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceSetEmailResponse)) {
      return false;
    }
    if (
      !UserServiceSetEmailResponse.__deepEquals(
        this.details,
        (other as UserServiceSetEmailResponse).details,
      )
    ) {
      return false;
    }
    if (
      !UserServiceSetEmailResponse.__deepEquals(
        ...
        (other as UserServiceSetEmailResponse).verificationCode,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceSetEmailResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceSetEmailResponse.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceSetEmailResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceSetEmailResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
