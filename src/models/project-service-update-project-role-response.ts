...
export class ProjectServiceUpdateProjectRoleResponse {
  /**
  ...
  constructor(data?: Partial<ProjectServiceUpdateProjectRoleResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ProjectServiceUpdateProjectRoleResponse)) {
      return false;
    }
    if (
      !ProjectServiceUpdateProjectRoleResponse.__deepEquals(
        this.changeDate,
        (other as ProjectServiceUpdateProjectRoleResponse).changeDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ProjectServiceUpdateProjectRoleResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          ProjectServiceUpdateProjectRoleResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !ProjectServiceUpdateProjectRoleResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ProjectServiceUpdateProjectRoleResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
