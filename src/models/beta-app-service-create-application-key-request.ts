...
export class BetaAppServiceCreateApplicationKeyRequest {
  /**
  ...
  constructor(data?: Partial<BetaAppServiceCreateApplicationKeyRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaAppServiceCreateApplicationKeyRequest)) {
      return false;
    }
    if (
      !BetaAppServiceCreateApplicationKeyRequest.__deepEquals(
        this.appId,
        (other as BetaAppServiceCreateApplicationKeyRequest).appId,
      )
    ) {
      return false;
    }
    if (
      !BetaAppServiceCreateApplicationKeyRequest.__deepEquals(
        this.projectId,
        (other as BetaAppServiceCreateApplicationKeyRequest).projectId,
      )
    ) {
      return false;
    }
    if (
      !BetaAppServiceCreateApplicationKeyRequest.__deepEquals(
        this.expirationDate,
        (other as BetaAppServiceCreateApplicationKeyRequest).expirationDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaAppServiceCreateApplicationKeyRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaAppServiceCreateApplicationKeyRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaAppServiceCreateApplicationKeyRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaAppServiceCreateApplicationKeyRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
