...
import { InstanceServiceFieldName } from "./instance-service-field-name.js";
import { InstanceServiceFilter } from "./instance-service-filter.js";
import { InstanceServicePaginationRequest } from "./instance-service-pagination-request.js";
import { Expose, Type } from "class-transformer";

export class InstanceServiceListInstancesRequest {
  /**
   ...
   */
  @Expose({ name: "filters" })
  @Type(() => InstanceServiceFilter)
  filters?: Array<InstanceServiceFilter>;

  constructor(data?: Partial<InstanceServiceListInstancesRequest>) {
    ...
    if (this.sortingColumn != null) {
      const sortingColumnValues = Object.values(
        ...
        (v) =>
          typeof (InstanceServiceFieldName as Record<string, unknown>)[
            v as string
          ] !== "number",
      );
      if (
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof InstanceServiceListInstancesRequest)) {
      return false;
    }
    if (
      !InstanceServiceListInstancesRequest.__deepEquals(
        this.pagination,
        (other as InstanceServiceListInstancesRequest).pagination,
      )
    ) {
      return false;
    }
    if (
      !InstanceServiceListInstancesRequest.__deepEquals(
        this.sortingColumn,
        (other as InstanceServiceListInstancesRequest).sortingColumn,
      )
    ) {
      return false;
    }
    if (
      !InstanceServiceListInstancesRequest.__deepEquals(
        this.filters,
        (other as InstanceServiceListInstancesRequest).filters,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        InstanceServiceListInstancesRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          InstanceServiceListInstancesRequest.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !InstanceServiceListInstancesRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          InstanceServiceListInstancesRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
