...
export class FeatureServiceConnectError {
  ...
  constructor(data?: Partial<FeatureServiceConnectError>) {
    ...
    if (this.code != null) {
      const codeValues = Object.values(
        FeatureServiceConnectErrorCodeEnum,
      ).filter(
        (v) =>
          typeof (
            FeatureServiceConnectErrorCodeEnum as Record<string, unknown>
          )[v as string] !== "number",
      );
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof FeatureServiceConnectError)) {
      return false;
    }
    if (
      !FeatureServiceConnectError.__deepEquals(
        this.code,
        (other as FeatureServiceConnectError).code,
      )
    ) {
      return false;
    }
    if (
      !FeatureServiceConnectError.__deepEquals(
        this.message,
        (other as FeatureServiceConnectError).message,
      )
    ) {
      return false;
    }
    if (
      !FeatureServiceConnectError.__deepEquals(
        this.details,
        (other as FeatureServiceConnectError).details,
      )
    ) {
      return false;
    }
    {
      ...
      for (const k of selfKeys) {
        ...
        if (!FeatureServiceConnectError.__deepEquals(selfRec[k], otherRec[k])) {
          return false;
        }
      }
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        FeatureServiceConnectError.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => FeatureServiceConnectError.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !FeatureServiceConnectError.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          FeatureServiceConnectError.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
...
export enum FeatureServiceConnectErrorCodeEnum {
  Canceled = "canceled",
  Unknown = "unknown",
