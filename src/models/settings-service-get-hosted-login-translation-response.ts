...
export class SettingsServiceGetHostedLoginTranslationResponse {
  /**
  ...
  constructor(
    data?: Partial<SettingsServiceGetHostedLoginTranslationResponse>,
  ) {
    Object.assign(this, data);
    if (this.etag != null && typeof this.etag !== "string") {
      throw new TypeError(`etag must be a string, got ${typeof this.etag}`);
    }
  }
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof SettingsServiceGetHostedLoginTranslationResponse)) {
      return false;
    }
    if (
      !SettingsServiceGetHostedLoginTranslationResponse.__deepEquals(
        this.etag,
        (other as SettingsServiceGetHostedLoginTranslationResponse).etag,
      )
    ) {
      return false;
    }
    if (
      !SettingsServiceGetHostedLoginTranslationResponse.__deepEquals(
        this.translations,
        (other as SettingsServiceGetHostedLoginTranslationResponse)
          .translations,
      )
    ) {
      return false;
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        SettingsServiceGetHostedLoginTranslationResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          SettingsServiceGetHostedLoginTranslationResponse.__deepEquals(v, w),
        ),
      );
    }
