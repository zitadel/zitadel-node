...
export class UserServiceRemovePasskeyRequest {
  /**
  ...
  constructor(data?: Partial<UserServiceRemovePasskeyRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceRemovePasskeyRequest)) {
      return false;
    }
    if (
      !UserServiceRemovePasskeyRequest.__deepEquals(
        this.userId,
        (other as UserServiceRemovePasskeyRequest).userId,
      )
    ) {
      return false;
    }
    if (
      !UserServiceRemovePasskeyRequest.__deepEquals(
        this.passkeyId,
        (other as UserServiceRemovePasskeyRequest).passkeyId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceRemovePasskeyRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceRemovePasskeyRequest.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceRemovePasskeyRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceRemovePasskeyRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
