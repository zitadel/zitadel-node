...
import { InstanceServiceTextQueryMethod } from "./instance-service-text-query-method.js";
import { Expose, Type } from "class-transformer";

export class InstanceServiceDomainFilter {
  /**
  ...
  constructor(data?: Partial<InstanceServiceDomainFilter>) {
    Object.assign(this, data);
    if (this.domain != null && typeof this.domain !== "string") {
      throw new TypeError(`domain must be a string, got ${typeof this.domain}`);
    }
    if (this.method != null) {
      const methodValues = Object.values(InstanceServiceTextQueryMethod).filter(
        (v) =>
          typeof (InstanceServiceTextQueryMethod as Record<string, unknown>)[
            v as string
          ] !== "number",
      );
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof InstanceServiceDomainFilter)) {
      return false;
    }
    if (
      !InstanceServiceDomainFilter.__deepEquals(
        this.domain,
        (other as InstanceServiceDomainFilter).domain,
      )
    ) {
      return false;
    }
    if (
      !InstanceServiceDomainFilter.__deepEquals(
        this.method,
        (other as InstanceServiceDomainFilter).method,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        InstanceServiceDomainFilter.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => InstanceServiceDomainFilter.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !InstanceServiceDomainFilter.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          InstanceServiceDomainFilter.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
