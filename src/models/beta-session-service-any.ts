 ...
 */
export class BetaSessionServiceAny {
  /**
  ...
  constructor(data?: Partial<BetaSessionServiceAny>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaSessionServiceAny)) {
      return false;
    }
    if (
      !BetaSessionServiceAny.__deepEquals(
        this.type,
        (other as BetaSessionServiceAny).type,
      )
    ) {
      return false;
    }
    if (
      !BetaSessionServiceAny.__deepEquals(
        this.value,
        (other as BetaSessionServiceAny).value,
      )
    ) {
      return false;
    }
    if (
      !BetaSessionServiceAny.__deepEquals(
        this.debug,
        (other as BetaSessionServiceAny).debug,
      )
    ) {
      return false;
    }
    {
      ...
      for (const k of selfKeys) {
        ...
        if (!BetaSessionServiceAny.__deepEquals(selfRec[k], otherRec[k])) {
          return false;
        }
      }
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => BetaSessionServiceAny.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaSessionServiceAny.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !BetaSessionServiceAny.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaSessionServiceAny.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
