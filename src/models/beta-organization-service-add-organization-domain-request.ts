...
export class BetaOrganizationServiceAddOrganizationDomainRequest {
  /**
  ...
  constructor(
    data?: Partial<BetaOrganizationServiceAddOrganizationDomainRequest>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !(other instanceof BetaOrganizationServiceAddOrganizationDomainRequest)
    ) {
      return false;
    }
    if (
      !BetaOrganizationServiceAddOrganizationDomainRequest.__deepEquals(
        this.organizationId,
        (other as BetaOrganizationServiceAddOrganizationDomainRequest)
          .organizationId,
      )
    ) {
      return false;
    ...
    if (
      !BetaOrganizationServiceAddOrganizationDomainRequest.__deepEquals(
        this.domain,
        (other as BetaOrganizationServiceAddOrganizationDomainRequest).domain,
      )
    ) {
      return false;
    }
