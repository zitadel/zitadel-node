...
export class InternalPermissionServicePaginationResponse {
  /**
  ...
  constructor(data?: Partial<InternalPermissionServicePaginationResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof InternalPermissionServicePaginationResponse)) {
      return false;
    }
    if (
      !InternalPermissionServicePaginationResponse.__deepEquals(
        this.totalResult,
        (other as InternalPermissionServicePaginationResponse).totalResult,
      )
    ) {
      return false;
    }
    if (
      !InternalPermissionServicePaginationResponse.__deepEquals(
        this.appliedLimit,
        (other as InternalPermissionServicePaginationResponse).appliedLimit,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        InternalPermissionServicePaginationResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          InternalPermissionServicePaginationResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !InternalPermissionServicePaginationResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
