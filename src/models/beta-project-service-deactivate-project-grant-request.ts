...
export class BetaProjectServiceDeactivateProjectGrantRequest {
  /**
  ...
  constructor(data?: Partial<BetaProjectServiceDeactivateProjectGrantRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaProjectServiceDeactivateProjectGrantRequest)) {
      return false;
    }
    if (
      !BetaProjectServiceDeactivateProjectGrantRequest.__deepEquals(
        this.projectId,
        (other as BetaProjectServiceDeactivateProjectGrantRequest).projectId,
      )
    ) {
      return false;
    }
    if (
      !BetaProjectServiceDeactivateProjectGrantRequest.__deepEquals(
        ...
        (other as BetaProjectServiceDeactivateProjectGrantRequest)
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaProjectServiceDeactivateProjectGrantRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaProjectServiceDeactivateProjectGrantRequest.__deepEquals(v, w),
        ),
      );
    }
