...
export class SettingsServiceSetHostedLoginTranslationResponse {
  /**
  ...
  constructor(
    data?: Partial<SettingsServiceSetHostedLoginTranslationResponse>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof SettingsServiceSetHostedLoginTranslationResponse)) {
      return false;
    }
    if (
      !SettingsServiceSetHostedLoginTranslationResponse.__deepEquals(
        this.etag,
        (other as SettingsServiceSetHostedLoginTranslationResponse).etag,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        SettingsServiceSetHostedLoginTranslationResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          SettingsServiceSetHostedLoginTranslationResponse.__deepEquals(v, w),
        ),
      );
    }
