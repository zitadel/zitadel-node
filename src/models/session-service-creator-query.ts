...
export class SessionServiceCreatorQuery {
  /**
  ...
  constructor(data?: Partial<SessionServiceCreatorQuery>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof SessionServiceCreatorQuery)) {
      return false;
    }
    if (
      !SessionServiceCreatorQuery.__deepEquals(
        this.id,
        (other as SessionServiceCreatorQuery).id,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        SessionServiceCreatorQuery.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => SessionServiceCreatorQuery.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !SessionServiceCreatorQuery.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          SessionServiceCreatorQuery.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
