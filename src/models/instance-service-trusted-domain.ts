...
export class InstanceServiceTrustedDomain {
  /**
  ...
  constructor(data?: Partial<InstanceServiceTrustedDomain>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof InstanceServiceTrustedDomain)) {
      return false;
    }
    if (
      !InstanceServiceTrustedDomain.__deepEquals(
        this.instanceId,
        (other as InstanceServiceTrustedDomain).instanceId,
      )
    ) {
      return false;
    }
    if (
      !InstanceServiceTrustedDomain.__deepEquals(
        this.creationDate,
        (other as InstanceServiceTrustedDomain).creationDate,
      )
    ) {
      return false;
    }
    if (
      !InstanceServiceTrustedDomain.__deepEquals(
        this.domain,
        (other as InstanceServiceTrustedDomain).domain,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        InstanceServiceTrustedDomain.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => InstanceServiceTrustedDomain.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !InstanceServiceTrustedDomain.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          InstanceServiceTrustedDomain.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
