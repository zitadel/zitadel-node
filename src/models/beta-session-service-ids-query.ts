...
export class BetaSessionServiceIDsQuery {
  /**
  ...
  constructor(data?: Partial<BetaSessionServiceIDsQuery>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaSessionServiceIDsQuery)) {
      return false;
    }
    if (
      !BetaSessionServiceIDsQuery.__deepEquals(
        this.ids,
        (other as BetaSessionServiceIDsQuery).ids,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaSessionServiceIDsQuery.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaSessionServiceIDsQuery.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaSessionServiceIDsQuery.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaSessionServiceIDsQuery.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
