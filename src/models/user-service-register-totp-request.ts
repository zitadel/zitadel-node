...
export class UserServiceRegisterTOTPRequest {
  /**
  ...
  constructor(data?: Partial<UserServiceRegisterTOTPRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceRegisterTOTPRequest)) {
      return false;
    }
    if (
      !UserServiceRegisterTOTPRequest.__deepEquals(
        this.userId,
        (other as UserServiceRegisterTOTPRequest).userId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceRegisterTOTPRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceRegisterTOTPRequest.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceRegisterTOTPRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceRegisterTOTPRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
