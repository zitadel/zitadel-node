...
export class UserServiceResendPhoneCodeRequest {
  /**
  ...
  constructor(data?: Partial<UserServiceResendPhoneCodeRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceResendPhoneCodeRequest)) {
      return false;
    }
    if (
      !UserServiceResendPhoneCodeRequest.__deepEquals(
        this.userId,
        (other as UserServiceResendPhoneCodeRequest).userId,
      )
    ) {
      return false;
    }
    if (
      !UserServiceResendPhoneCodeRequest.__deepEquals(
        this.returnCode,
        (other as UserServiceResendPhoneCodeRequest).returnCode,
      )
    ) {
      return false;
    }
    if (
      !UserServiceResendPhoneCodeRequest.__deepEquals(
        this.sendCode,
        (other as UserServiceResendPhoneCodeRequest).sendCode,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceResendPhoneCodeRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceResendPhoneCodeRequest.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceResendPhoneCodeRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceResendPhoneCodeRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
