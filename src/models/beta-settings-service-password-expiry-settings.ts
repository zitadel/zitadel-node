...
export class BetaSettingsServicePasswordExpirySettings {
  /**
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaSettingsServicePasswordExpirySettings)) {
      return false;
    }
    if (
      !BetaSettingsServicePasswordExpirySettings.__deepEquals(
        this.maxAgeDays,
        (other as BetaSettingsServicePasswordExpirySettings).maxAgeDays,
      )
    ) {
      return false;
    }
    if (
      !BetaSettingsServicePasswordExpirySettings.__deepEquals(
        this.expireWarnDays,
        (other as BetaSettingsServicePasswordExpirySettings).expireWarnDays,
      )
    ) {
      return false;
    }
    if (
      !BetaSettingsServicePasswordExpirySettings.__deepEquals(
        this.resourceOwnerType,
        (other as BetaSettingsServicePasswordExpirySettings).resourceOwnerType,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaSettingsServicePasswordExpirySettings.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaSettingsServicePasswordExpirySettings.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaSettingsServicePasswordExpirySettings.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaSettingsServicePasswordExpirySettings.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
