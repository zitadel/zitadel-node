...
export class ProjectServiceAddProjectRoleResponse {
  /**
  ...
  constructor(data?: Partial<ProjectServiceAddProjectRoleResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ProjectServiceAddProjectRoleResponse)) {
      return false;
    }
    if (
      !ProjectServiceAddProjectRoleResponse.__deepEquals(
        this.creationDate,
        (other as ProjectServiceAddProjectRoleResponse).creationDate,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ProjectServiceAddProjectRoleResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          ProjectServiceAddProjectRoleResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !ProjectServiceAddProjectRoleResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ProjectServiceAddProjectRoleResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
