...
export class UserServiceRemovePasskeyResponse {
  /**
  ...
  constructor(data?: Partial<UserServiceRemovePasskeyResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof UserServiceRemovePasskeyResponse)) {
      return false;
    }
    if (
      !UserServiceRemovePasskeyResponse.__deepEquals(
        this.details,
        (other as UserServiceRemovePasskeyResponse).details,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        UserServiceRemovePasskeyResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => UserServiceRemovePasskeyResponse.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !UserServiceRemovePasskeyResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          UserServiceRemovePasskeyResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
