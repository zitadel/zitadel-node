...
export class SettingsServiceEmbeddedIframeSettings {
  /**
  ...
  constructor(data?: Partial<SettingsServiceEmbeddedIframeSettings>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof SettingsServiceEmbeddedIframeSettings)) {
      return false;
    }
    if (
      !SettingsServiceEmbeddedIframeSettings.__deepEquals(
        this.enabled,
        (other as SettingsServiceEmbeddedIframeSettings).enabled,
      )
    ) {
      return false;
    }
    if (
      !SettingsServiceEmbeddedIframeSettings.__deepEquals(
        this.allowedOrigins,
        (other as SettingsServiceEmbeddedIframeSettings).allowedOrigins,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        SettingsServiceEmbeddedIframeSettings.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          SettingsServiceEmbeddedIframeSettings.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !SettingsServiceEmbeddedIframeSettings.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          SettingsServiceEmbeddedIframeSettings.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
