 ...
 */
export class SessionServiceHeaderValues {
  /**
  ...
  constructor(data?: Partial<SessionServiceHeaderValues>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof SessionServiceHeaderValues)) {
      return false;
    }
    if (
      !SessionServiceHeaderValues.__deepEquals(
        this.values,
        (other as SessionServiceHeaderValues).values,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        SessionServiceHeaderValues.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => SessionServiceHeaderValues.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !SessionServiceHeaderValues.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          SessionServiceHeaderValues.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
