...
export class ProjectServiceGetProjectRequest {
  /**
  ...
  constructor(data?: Partial<ProjectServiceGetProjectRequest>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof ProjectServiceGetProjectRequest)) {
      return false;
    }
    if (
      !ProjectServiceGetProjectRequest.__deepEquals(
        this.projectId,
        (other as ProjectServiceGetProjectRequest).projectId,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        ProjectServiceGetProjectRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => ProjectServiceGetProjectRequest.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !ProjectServiceGetProjectRequest.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          ProjectServiceGetProjectRequest.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
