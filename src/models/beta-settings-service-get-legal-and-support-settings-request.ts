...
export class BetaSettingsServiceGetLegalAndSupportSettingsRequest {
  /**
  ...
  constructor(
    data?: Partial<BetaSettingsServiceGetLegalAndSupportSettingsRequest>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !(other instanceof BetaSettingsServiceGetLegalAndSupportSettingsRequest)
    ) {
      return false;
    }
    if (
      !BetaSettingsServiceGetLegalAndSupportSettingsRequest.__deepEquals(
        this.ctx,
        (other as BetaSettingsServiceGetLegalAndSupportSettingsRequest).ctx,
      )
    ) {
      return false;
    }
