...
export class BetaActionServiceCreateTargetResponse {
  /**
  ...
  constructor(data?: Partial<BetaActionServiceCreateTargetResponse>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaActionServiceCreateTargetResponse)) {
      return false;
    }
    if (
      !BetaActionServiceCreateTargetResponse.__deepEquals(
        this.id,
        (other as BetaActionServiceCreateTargetResponse).id,
      )
    ) {
      return false;
    }
    if (
      !BetaActionServiceCreateTargetResponse.__deepEquals(
        this.creationDate,
        (other as BetaActionServiceCreateTargetResponse).creationDate,
      )
    ) {
      return false;
    }
    if (
      !BetaActionServiceCreateTargetResponse.__deepEquals(
        this.signingKey,
        (other as BetaActionServiceCreateTargetResponse).signingKey,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaActionServiceCreateTargetResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaActionServiceCreateTargetResponse.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaActionServiceCreateTargetResponse.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaActionServiceCreateTargetResponse.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
