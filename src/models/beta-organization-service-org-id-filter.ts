...
export class BetaOrganizationServiceOrgIDFilter {
  /**
  ...
  constructor(data?: Partial<BetaOrganizationServiceOrgIDFilter>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaOrganizationServiceOrgIDFilter)) {
      return false;
    }
    if (
      !BetaOrganizationServiceOrgIDFilter.__deepEquals(
        this.id,
        (other as BetaOrganizationServiceOrgIDFilter).id,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaOrganizationServiceOrgIDFilter.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaOrganizationServiceOrgIDFilter.__deepEquals(v, w),
        ),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaOrganizationServiceOrgIDFilter.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaOrganizationServiceOrgIDFilter.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
