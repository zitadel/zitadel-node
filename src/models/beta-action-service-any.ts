 ...
 */
export class BetaActionServiceAny {
  /**
  ...
  constructor(data?: Partial<BetaActionServiceAny>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaActionServiceAny)) {
      return false;
    }
    if (
      !BetaActionServiceAny.__deepEquals(
        this.type,
        (other as BetaActionServiceAny).type,
      )
    ) {
      return false;
    }
    if (
      !BetaActionServiceAny.__deepEquals(
        this.value,
        (other as BetaActionServiceAny).value,
      )
    ) {
      return false;
    }
    if (
      !BetaActionServiceAny.__deepEquals(
        this.debug,
        (other as BetaActionServiceAny).debug,
      )
    ) {
      return false;
    }
    {
      ...
      for (const k of selfKeys) {
        ...
        if (!BetaActionServiceAny.__deepEquals(selfRec[k], otherRec[k])) {
          return false;
        }
      }
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => BetaActionServiceAny.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaActionServiceAny.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !BetaActionServiceAny.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaActionServiceAny.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
