...
export class BetaUserServiceVerifyPasskeyRegistrationResponse {
  /**
  ...
  constructor(
    data?: Partial<BetaUserServiceVerifyPasskeyRegistrationResponse>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaUserServiceVerifyPasskeyRegistrationResponse)) {
      return false;
    }
    if (
      !BetaUserServiceVerifyPasskeyRegistrationResponse.__deepEquals(
        this.details,
        (other as BetaUserServiceVerifyPasskeyRegistrationResponse).details,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaUserServiceVerifyPasskeyRegistrationResponse.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaUserServiceVerifyPasskeyRegistrationResponse.__deepEquals(v, w),
        ),
      );
    }
