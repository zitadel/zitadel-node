...
export class BetaSessionServiceCheckOTP {
  /**
  ...
  constructor(data?: Partial<BetaSessionServiceCheckOTP>) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaSessionServiceCheckOTP)) {
      return false;
    }
    if (
      !BetaSessionServiceCheckOTP.__deepEquals(
        this.code,
        (other as BetaSessionServiceCheckOTP).code,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaSessionServiceCheckOTP.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => BetaSessionServiceCheckOTP.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (
          !b.has(k) ||
          !BetaSessionServiceCheckOTP.__deepEquals(v, b.get(k))
        ) {
          return false;
        }
      }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          BetaSessionServiceCheckOTP.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
