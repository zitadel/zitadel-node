...
export class BetaOrganizationServiceDeleteOrganizationRequest {
  /**
  ...
  constructor(
    data?: Partial<BetaOrganizationServiceDeleteOrganizationRequest>,
  ) {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof BetaOrganizationServiceDeleteOrganizationRequest)) {
      return false;
    }
    if (
      !BetaOrganizationServiceDeleteOrganizationRequest.__deepEquals(
        this.id,
        (other as BetaOrganizationServiceDeleteOrganizationRequest).id,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) =>
        BetaOrganizationServiceDeleteOrganizationRequest.__deepEquals(v, b[i]),
      );
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      return [...a].every((v) =>
        bvals.some((w) =>
          BetaOrganizationServiceDeleteOrganizationRequest.__deepEquals(v, w),
        ),
      );
    }
