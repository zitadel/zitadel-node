...
export class IdentityProviderServiceApi extends runtime.BaseAPI {
     ...
     * GetIDPByID
     */
    private async getIDPByIDRaw(requestParameters: GetIDPByIDRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<IdentityProviderServiceGetIDPByIDResponse>> {
