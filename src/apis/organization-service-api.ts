...
export class OrganizationServiceApi extends runtime.BaseAPI {
     ...
     * AddOrganization
     */
    private async addOrganizationRaw(requestParameters: AddOrganizationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<OrganizationServiceAddOrganizationResponse>> {
     ...
     * ListOrganizations
     */
    private async listOrganizationsRaw(requestParameters: ListOrganizationsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<OrganizationServiceListOrganizationsResponse>> {
