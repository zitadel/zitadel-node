...
export class SAMLServiceApi extends runtime.BaseAPI {
     ...
     * CreateResponse
     */
    private async createResponseRaw(requestParameters: CreateResponseRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SAMLServiceCreateResponseResponse>> {
     ...
     * GetSAMLRequest
     */
    private async getSAMLRequestRaw(requestParameters: GetSAMLRequestRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SAMLServiceGetSAMLRequestResponse>> {
