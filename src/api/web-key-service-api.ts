 ...
 */
export class WebKeyServiceApi extends BaseApi {
  constructor(
    apiClient?: ApiClient,
  ...
  async activateWebKey(
    webKeyServiceActivateWebKeyRequest: DeepInput<WebKeyServiceActivateWebKeyRequest>,
  ): Promise<WebKeyServiceActivateWebKeyResponse> {
    ...
    return activateWebKeyResult.data as WebKeyServiceActivateWebKeyResponse;
  }
  ...
  async activateWebKeyWithHttpInfo(
    webKeyServiceActivateWebKeyRequest: DeepInput<WebKeyServiceActivateWebKeyRequest>,
  ): Promise<ApiResult<WebKeyServiceActivateWebKeyResponse>> {
    if (webKeyServiceActivateWebKeyRequest == null) {
      throw new Error(
        'Missing required parameter "webKeyServiceActivateWebKeyRequest" when calling activateWebKey',
      );
    }
    const path = `/zitadel.webkey.v2.WebKeyService/ActivateWebKey`;
   ...
   */
  async createWebKey(
    webKeyServiceCreateWebKeyRequest: DeepInput<WebKeyServiceCreateWebKeyRequest>,
  ): Promise<WebKeyServiceCreateWebKeyResponse> {
    ...
    return createWebKeyResult.data as WebKeyServiceCreateWebKeyResponse;
  }
  ...
  async createWebKeyWithHttpInfo(
    webKeyServiceCreateWebKeyRequest: DeepInput<WebKeyServiceCreateWebKeyRequest>,
  ): Promise<ApiResult<WebKeyServiceCreateWebKeyResponse>> {
    if (webKeyServiceCreateWebKeyRequest == null) {
      throw new Error(
        'Missing required parameter "webKeyServiceCreateWebKeyRequest" when calling createWebKey',
      );
    }
    const path = `/zitadel.webkey.v2.WebKeyService/CreateWebKey`;
    const queryParams: Record<string, unknown> = {};
    const headerParams: Record<string, string> = {};
    return await this.invokeApiForResult(
      "POST",
   ...
   */
  async deleteWebKey(
    webKeyServiceDeleteWebKeyRequest: DeepInput<WebKeyServiceDeleteWebKeyRequest>,
  ): Promise<WebKeyServiceDeleteWebKeyResponse> {
    ...
    return deleteWebKeyResult.data as WebKeyServiceDeleteWebKeyResponse;
  }
  ...
  async deleteWebKeyWithHttpInfo(
    webKeyServiceDeleteWebKeyRequest: DeepInput<WebKeyServiceDeleteWebKeyRequest>,
  ): Promise<ApiResult<WebKeyServiceDeleteWebKeyResponse>> {
    if (webKeyServiceDeleteWebKeyRequest == null) {
      throw new Error(
        'Missing required parameter "webKeyServiceDeleteWebKeyRequest" when calling deleteWebKey',
      );
    }
    const path = `/zitadel.webkey.v2.WebKeyService/DeleteWebKey`;
    const queryParams: Record<string, unknown> = {};
    const headerParams: Record<string, string> = {};
    return await this.invokeApiForResult(
      "POST",
   ...
   * @throws {ApiError} if fails to make API call
   */
  async listWebKeys(body: object): Promise<WebKeyServiceListWebKeysResponse> {
    ...
    return listWebKeysResult.data as WebKeyServiceListWebKeysResponse;
  }
  ...
  async listWebKeysWithHttpInfo(
    body: object,
  ): Promise<ApiResult<WebKeyServiceListWebKeysResponse>> {
    if (body == null) {
      throw new Error(
        'Missing required parameter "body" when calling listWebKeys',
      );
    }
    const path = `/zitadel.webkey.v2.WebKeyService/ListWebKeys`;
    const queryParams: Record<string, unknown> = {};
    const headerParams: Record<string, string> = {};
    return await this.invokeApiForResult(
      "POST",
